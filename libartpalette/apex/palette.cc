...
palette_status_t PaletteDebugStoreIsDebugStoreEnabled(bool* enabled) {
  PaletteDebugStoreIsDebugStoreEnabledMethod m =
      PaletteLoader::Instance().GetPaletteDebugStoreIsDebugStoreEnabledMethod();
  return m(enabled);
}
