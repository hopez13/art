...
palette_status_t PaletteShouldReportDex2oatCompilations(int* value) {
  PaletteShouldReportDex2oatCompilationsMethod m =
      PaletteLoader::Instance().GetPaletteShouldReportDex2oatCompilationsMethod();
  return m(value);
}
