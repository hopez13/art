...
palette_status_t PaletteTraceBegin(const char* name [[maybe_unused]]) { return PALETTE_STATUS_OK; }

palette_status_t PaletteTraceEnd() {
  return PALETTE_STATUS_OK;
}

palette_status_t PaletteTraceIntegerValue(const char* name [[maybe_unused]],
                                          int32_t value [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}

palette_status_t PaletteAshmemCreateRegion(const char* name [[maybe_unused]],
...
palette_status_t PaletteAshmemSetProtRegion(int fd [[maybe_unused]], int prot [[maybe_unused]]) {
  return PALETTE_STATUS_NOT_SUPPORTED;
}
...
palette_status_t PaletteNotifyStartDex2oatCompilation(int source_fd [[maybe_unused]],
                                                      int art_fd [[maybe_unused]],
                                                      int oat_fd [[maybe_unused]],
                                                      int vdex_fd [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}

palette_status_t PaletteNotifyEndDex2oatCompilation(int source_fd [[maybe_unused]],
                                                    int art_fd [[maybe_unused]],
                                                    int oat_fd [[maybe_unused]],
                                                    int vdex_fd [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
...
palette_status_t PaletteNotifyDexFileLoaded(const char* path [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}

palette_status_t PaletteNotifyOatFileLoaded(const char* path [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}
...
palette_status_t PaletteNotifyBeginJniInvocation(JNIEnv* env [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}

palette_status_t PaletteNotifyEndJniInvocation(JNIEnv* env [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}

// Methods in version 2 API, corresponding to SDK level 33.

palette_status_t PaletteReportLockContention(JNIEnv* env [[maybe_unused]],
                                             int32_t wait_ms [[maybe_unused]],
                                             const char* filename [[maybe_unused]],
                                             int32_t line_number [[maybe_unused]],
                                             const char* method_name [[maybe_unused]],
                                             const char* owner_filename [[maybe_unused]],
                                             int32_t owner_line_number [[maybe_unused]],
                                             const char* owner_method_name [[maybe_unused]],
                                             const char* proc_name [[maybe_unused]],
                                             const char* thread_name [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}

// Methods in version 3 API, corresponding to SDK level 34.

palette_status_t PaletteSetTaskProfiles(int32_t tid [[maybe_unused]],
                                        [[maybe_unused]] const char* const profiles[],
                                        size_t profiles_len [[maybe_unused]]) {
  return PALETTE_STATUS_OK;
}
