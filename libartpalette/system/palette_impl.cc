...
PaletteStatus PaletteGetVersion(int32_t* version) {
...
enum PaletteStatus PaletteSchedSetPriority(int32_t /*tid*/, int32_t priority ATTRIBUTE_UNUSED) {
  return PaletteStatus::kOkay;
}

enum PaletteStatus PaletteSchedGetPriority(int32_t /*tid*/,
                                           /*out*/int32_t* priority ATTRIBUTE_UNUSED) {
  *priority = art::palette::kNormalManagedThreadPriority;
  return PaletteStatus::kOkay;
}

enum PaletteStatus PaletteTraceEnabled(/*out*/int32_t* enabled ATTRIBUTE_UNUSED) {
  return PaletteStatus::kNotSupported;
}
