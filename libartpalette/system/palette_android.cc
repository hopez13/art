...
//
// This is problematic because the event logging fails in static initializers on Linux, so need
// not to link against it. There is some soong hackery in art.go to help with this (b/79671158).
