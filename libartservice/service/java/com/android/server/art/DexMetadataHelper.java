...
public class DexMetadataHelper {
     ...
     * @param DexMetadataConfig The config deserialized from `config.pb`, if exists. Or the default
     *         instance if the file doesn't exist or an error occurred.
     */
    ...
    public static class Injector {
        ...
        String getDmPath(@NonNull String dexPath) {
            ...
            return new StringBuilder()
                    .append(pos != -1 ? dexPath.substring(0, pos) : dexPath)
                    .append(".dm")
                    .toString();
        }
    }
