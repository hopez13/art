...
public class DexMetadataHelper {
    ...
    public DexMetadataInfo getDexMetadataInfo(@Nullable DexMetadataPath dmPath) {
        ...
        String realDmPath = getDmPath(dmPath.dexPath);
    ...
    @NonNull
    private static String getDmPath(@NonNull String dexPath) {
        int pos = dexPath.lastIndexOf(".");
        return (pos != -1 ? dexPath.substring(0, pos) : dexPath) + ".dm";
    }

    /**
     * @param dmPath Represents the path to the dm file, if exists. Or null if the file doesn't
