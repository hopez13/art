            ...
            try {
                ...
                if (!mClosed) {
                    ...
                    synchronized (mLock) {
                        ...
                        if (mPinCount == 0) {
                            // During the timeout:
                            // - If there is no more pinning and unpinning, the cache will be
                            //   dropped.
                            // - If there are pinnings and unpinnings, and `mPinCount` never reaches
                            //   0 again, `dropIfNoPin` will be run, but it will not drop the cache.
                            // - If there are pinnings and unpinnings, and `mPinCount` reaches 0
                            //   again, `dropIfNoPin` will be debounced.
