...
public final class AidlUtils {
    ...
    @NonNull
    public static ArtifactsPath buildArtifactsPath(@NonNull String dexPath, @NonNull String isa,
    ...
    @NonNull
    public static SecondaryRefProfilePath buildSecondaryRefProfilePath(
