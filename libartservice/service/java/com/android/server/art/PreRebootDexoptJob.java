...
public class PreRebootDexoptJob implements ArtServiceJobInterface {
    ...
    public synchronized boolean onStopJob(@NonNull JobParameters params) {
        if (mJobSchedulerRunningJob != null) {
            cancelOneLocked(mJobSchedulerRunningJob, false /* expectInterrupt */);
            mJobSchedulerRunningJob = null;
        }
    ...
    /** @see #cancelOneLocked */
    public synchronized void cancelOne(
            @NonNull CompletableFuture<Void> job, boolean expectInterrupt) {
        cancelOneLocked(job, expectInterrupt);
    }
     ...
     */
    @GuardedBy("this")
    private void cancelOneLocked(@NonNull CompletableFuture<Void> job, boolean expectInterrupt) {
