 ...
 * to another. In principle, a method here should be kept until the platform release that contains
 * the old version of the ART module that calls the method no longer receives Mainline updates,
 * unless there is a good reason to drop the Pre-reboot Dexopt support earlier for certain versions
 * of the ART module.
 *
