...
public class PreRebootDriver {
    ...
    private void tearDown() {
        // Two things can prevent the teardown from succeeding: a running Pre-reboot artd process
        // and the new `service-art.jar` opened and mapped by system server. They are managed by the
        // service manager and the runtime respectively. There aren't reliable APIs to kill the
        // former or close the latter, so we have to do them by triggering GC and finalization, with
        // sleep and retry mechanism.
