...
public class PreRebootDriver {
    ...
    private void tearDown() {
        for (int numRetries = 3; numRetries > 0;) {
            try {
                // Force run GC and finalization to trigger the shutdown of artd and unload the dex
                // file.
    ...
    private void runFromChroot(@NonNull CancellationSignal cancellationSignal)
        ...
        preRebootManagerClass
                ...
                .invoke(null /* obj */, ArtModuleServiceInitializer.getArtModuleServiceManager(),
