...
public class PreRebootStatsReporterTest {
    ...
    public void testSuccess() throws Exception {
        ...
        progressSession1.recordProgress(1 /* skippedPackageCount */, 2 /* optimizedPackageCount */,
        ...
        var progressSession2 = reporterInChroot2.new ProgressSession();

        progressSession2.recordProgress(1 /* skippedPackageCount */, 6 /* optimizedPackageCount */,
                3 /* failedPackageCount */, 10 /* totalPackageCount */);
        checkProto(PreRebootStats.newBuilder()
                           .setStatus(Status.STATUS_STARTED)
                           .setJobScheduledTimestampMillis(50)
