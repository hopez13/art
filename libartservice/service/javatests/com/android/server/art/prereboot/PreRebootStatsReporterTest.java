...
public class PreRebootStatsReporterTest {
    ...
    public void testSuccess() throws Exception {
        ...
        reporterInChroot1.load();

        reporterInChroot1.recordProgress(1 /* skippedPackageCount */, 2 /* optimizedPackageCount */,
        ...
        reporterInChroot1.recordJobEnded(Status.STATUS_CANCELLED);
        checkProto(PreRebootStats.newBuilder()
        ...
        var reporterInChroot2 = new PreRebootStatsReporter(mInjector);
        reporterInChroot2.load();

        reporterInChroot2.recordProgress(1 /* skippedPackageCount */, 6 /* optimizedPackageCount */,
                3 /* failedPackageCount */, 10 /* totalPackageCount */);
        checkProto(PreRebootStats.newBuilder()
                           .setStatus(Status.STATUS_STARTED)
                           .setJobScheduledTimestampMillis(50)
        ...
        reporterInChroot2.recordJobEnded(Status.STATUS_FINISHED);
        checkProto(PreRebootStats.newBuilder()
        ...
        reporterAfterReboot.load();

        // For primary dex.
        reporterAfterReboot.recordPackageWithArtifacts(PKG_NAME_FOO);
        reporterAfterReboot.recordPackageWithArtifacts(PKG_NAME_BAR);

        // For secondary dex.
        reporterAfterReboot.recordPackageWithArtifacts(PKG_NAME_FOO);
        reporterAfterReboot.recordPackageWithArtifacts(PKG_NAME_BAZ);
