...
public class PrimaryDexopterParameterizedTest extends PrimaryDexopterTestBase {
    ...
    public void setUp() throws Exception {
        ...
        mDexoptParams =
                new DexoptParams.Builder("install")
                        ...
                        .setFlags(mParams.mNoProfile ? ArtFlags.FLAG_NO_PROFILE : 0,
                                ArtFlags.FLAG_NO_PROFILE)
                        .build();
    ...
    private static class Params {
        ...
        public boolean mNoProfile = false;
        ...
        public String toString() {
            return String.format("isInDalvikCache=%b,"
                    ...
                    mShouldDowngrade, mSkipIfStorageLow, mNoProfile, mAlwaysDebuggable,
