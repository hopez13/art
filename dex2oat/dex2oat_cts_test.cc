...
class Dex2oatCtsTest : public CommonArtTest, public Dex2oatScratchDirs {
 ...
 protected:
  int Dex2Oat(const std::vector<std::string>& dex2oat_args,
    ...
    // Stripped down counterpart to Dex2oatEnvironmentTest::Dex2Oat that only
    // adds enough arguments for our purposes. This command line should work
    // regardless of bitness, ISA, etc.

    std::vector<std::string> argv = {"/apex/com.android.art/bin/dex2oat"};
