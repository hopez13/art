  ...
  void TryInitializeClass(Handle<mirror::Class> klass, Handle<mirror::ClassLoader>& class_loader)
    ...
    if (klass->IsVerified()) {
      ...
      if (!klass->IsInitialized()) {
        ...
        // fields.
        // Initialize dependencies first only for app image or boot image extension,
        // to make TryInitialize recursive.
        bool try_initialize_with_superclasses = (!is_app_image && !is_boot_image_extension)
            ? true
