...
TEST_F(OatTest, WriteRead) {
  ...
  SafeMap<std::string, std::string> key_value_store;
  key_value_store.Put(OatHeader::kBootImageChecksumsKey, "testkey");
  ...
  ASSERT_TRUE(oat_header.GetStoreValueByKey(OatHeader::kBootImageChecksumsKey) != nullptr);
  ASSERT_STREQ("testkey", oat_header.GetStoreValueByKey(OatHeader::kBootImageChecksumsKey));
