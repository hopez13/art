  ...
  class RelativePatcherNone final : public RelativePatcher {
   public:
    ...
    uint32_t ReserveSpace(uint32_t offset,
                          ...
                          MethodReference method_ref [[maybe_unused]]) override {
    ...
    uint32_t WriteThunks(OutputStream* out [[maybe_unused]], uint32_t offset) override {
      return offset;  // No thunks added; no patches expected.
    }

    void PatchCall(std::vector<uint8_t>* code [[maybe_unused]],
                   uint32_t literal_offset [[maybe_unused]],
                   uint32_t patch_offset [[maybe_unused]],
                   uint32_t target_offset [[maybe_unused]]) override {
