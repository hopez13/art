...
class ImageWriter final {
 ...
 private:
  ...
  struct ImageInfo {
    ...
    // excluding the bitmap and relocations.
   ...
   */
  std::vector<RefInfoPair> CollectStringReferenceInfo() REQUIRES_SHARED(Locks::mutator_lock_);
   ...
   *     objects
   */
  void VerifyNativeGCRootInvariants() REQUIRES_SHARED(Locks::mutator_lock_);
