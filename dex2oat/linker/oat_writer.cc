...
bool OatWriter::WriteAndOpenDexFiles(
  ...
  if (!WriteDexFiles(vdex_out.get(), vdex_file, update_input_vdex, compiler_filter) ||
...
bool OatWriter::WriteDexFiles(OutputStream* out,
  ...
  extract_dex_files_into_vdex_ = CompilerFilter::IsExtractionEnabled(compiler_filter);
