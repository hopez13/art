...
static HashMap<std::string_view, mirror::Object*> FindClassesByDescriptor(
  ...
  ClassFuncVisitor class_visitor =
      ClassFuncVisitor([&](ObjPtr<mirror::Class> klass) REQUIRES_SHARED(Locks::mutator_lock_) {
        std::string temp;
  ...
  class_linker->VisitClasses(&class_visitor);
