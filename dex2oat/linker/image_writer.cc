...
HashSet<mirror::Object*> ImageWriter::MatchDirtyObjectOffsets(
...
void ImageWriter::TryRecalculateOffsetsWithDirtyObjects() {
  const HashMap<uint32_t, ImageWriter::DirtyEntry> dirty_entries =
  ...
  dirty_objects_ = MatchDirtyObjectOffsets(dirty_entries);
...
HashMap<uint32_t, ImageWriter::DirtyEntry> ImageWriter::ParseDirtyObjectOffsets(
