...
void ImageWriter::CreateHeader(size_t oat_index, size_t component_count) {
  ...
  // NOTE: Bitmap section size does not need to be aligned up to kElfSegmentAlignment because it is
  // the last section. Sizes of previous sections are aligned so that the start of the next section
  // will be aligned.
