...
class ImageWriter::PruneObjectReferenceVisitor {
 public:
  ...
  ALWAYS_INLINE void VisitRootIfNonNull(mirror::CompressedReference<mirror::Object>* root
                                        [[maybe_unused]]) const
      REQUIRES_SHARED(Locks::mutator_lock_) {}

  ALWAYS_INLINE void VisitRoot(mirror::CompressedReference<mirror::Object>* root
                               [[maybe_unused]]) const REQUIRES_SHARED(Locks::mutator_lock_) {}

  ALWAYS_INLINE void operator()(ObjPtr<mirror::Object> obj,
                                MemberOffset offset,
                                bool is_static [[maybe_unused]]) const
      REQUIRES_SHARED(Locks::mutator_lock_) {
    mirror::Object* ref =
  ...
  ALWAYS_INLINE void operator()(ObjPtr<mirror::Class> klass [[maybe_unused]],
...
class ImageWriter::FixupRootVisitor : public RootVisitor {
 public:
  ...
  void VisitRoots(mirror::Object*** roots [[maybe_unused]],
                  size_t count [[maybe_unused]],
                  const RootInfo& info [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
...
class ImageWriter::FixupVisitor {
 public:
  ...
  void operator()(ObjPtr<Object> obj, MemberOffset offset, bool is_static [[maybe_unused]]) const
...
class ImageWriter::FixupClassVisitor final : public FixupVisitor {
 public:
  ...
  void operator()(ObjPtr<mirror::Class> klass [[maybe_unused]],
                  ObjPtr<mirror::Reference> ref [[maybe_unused]]) const
      REQUIRES_SHARED(Locks::mutator_lock_) REQUIRES(Locks::heap_bitmap_lock_) {
