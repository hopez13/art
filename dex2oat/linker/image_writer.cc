...
ObjPtr<mirror::ObjectArray<mirror::Object>> ImageWriter::CollectBootImageLiveObjects(
    Thread* self) const {
...
ObjectArray<Object>* ImageWriter::CreateImageRoots(size_t oat_index) const {
  ...
  if (!compile_app_image_) {
    ObjPtr<ObjectArray<Object>> boot_image_live_objects = CollectBootImageLiveObjects(self);
