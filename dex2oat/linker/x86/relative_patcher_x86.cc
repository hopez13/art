...
void X86RelativePatcher::PatchEntrypointCall(std::vector<uint8_t>* code [[maybe_unused]],
                                             const LinkerPatch& patch [[maybe_unused]],
                                             uint32_t patch_offset [[maybe_unused]]) {
  LOG(FATAL) << "UNIMPLEMENTED";
}

void X86RelativePatcher::PatchBakerReadBarrierBranch(std::vector<uint8_t>* code [[maybe_unused]],
                                                     const LinkerPatch& patch [[maybe_unused]],
                                                     uint32_t patch_offset [[maybe_unused]]) {
  LOG(FATAL) << "UNIMPLEMENTED";
}
