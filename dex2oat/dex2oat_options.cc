...
// First storage for base_options.
...
template struct CompilerOptionsMap<Dex2oatArgumentMap, Dex2oatArgumentMapKey>;
...
using Parser = M::Dex2oatArgumentParser;
...
std::unique_ptr<Dex2oatArgumentMap::Dex2oatArgumentParser>
Dex2oatArgumentMap::CreateArgumentParser() {
