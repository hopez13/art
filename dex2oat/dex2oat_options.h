...
#define DECLARE_KEY(Type, Name) static const Key<Type> Name
  ...
  //
  struct Dex2oatArgumentMap : VariantMap<Dex2oatArgumentMap, Dex2oatArgumentMapKey> {
    // This 'using' line is necessary to inherit the variadic constructor.
    using VariantMap<Dex2oatArgumentMap, Dex2oatArgumentMapKey>::VariantMap;
...
#undef DECLARE_KEY
  ...
  // using Dex2oatOptions = Dex2oatArgumentMap;
}  // namespace art
