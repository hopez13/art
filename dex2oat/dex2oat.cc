...
class Dex2Oat final {
 public:
  ...
  jobject Compile() {
    ...
    // to make the output both deterministic and most likely different for different inputs
    // (say, for primary boot image and different extensions that could be loaded together).
