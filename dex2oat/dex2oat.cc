 ...
 public:
  ...
  bool WriteOutputFiles(jobject class_loader) {
    ...
    if (IsImage()) {
      ...
      // compilation of boot image extension and using a lot of time to look up things now
      // in hope it will be somewhat useful later is undesirable in that scenario.
