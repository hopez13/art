...
NO_RETURN static void Usage(const char* fmt, ...) {
  ...
  UsageError("");
  UsageError("  --dirty-image-objects=<directory-path>: list of the class names of image objects");
  UsageError("      known to be dirty. The image writer will group them together.");
  UsageError("");
