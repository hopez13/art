...
NO_RETURN static void Usage(const char* fmt, ...) {
  ...
  UsageError("");
  UsageError("  --compact-dex-level=none|normal: None avoids generating compact dex, fast");
  UsageError("      generates compact dex with optimizations that don't require many resources.");
  UsageError("");
