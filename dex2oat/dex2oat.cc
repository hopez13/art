...
class Dex2Oat FINAL {
 public:
  ...
  dex2oat::ReturnCode Setup() {
    ...
    // Enable hidden APIs if we are compiling on host (proxy for building the boot image),
    // or installd invoked dex2oat with a command line option specifying that this is
    // a system app and should have unlimited access to hidden APIs.
