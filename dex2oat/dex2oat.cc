 ...
 private:
  ...
  bool PrepareDirtyObjects() {
    ...
    if (dirty_image_objects_fd_ != -1) {
      input_filename = StringPrintf("/proc/self/fd/%d", dirty_image_objects_fd_);
    } else if (dirty_image_objects_filename_ != nullptr) {
      input_filename = dirty_image_objects_filename_;
    }
  ...
  bool PrepareUpdatableBcpPackages() {
    ...
    if (updatable_bcp_packages_fd_ != -1) {
      input_filename = StringPrintf("/proc/self/fd/%d", updatable_bcp_packages_fd_);
    } else if (updatable_bcp_packages_filename_ != nullptr) {
      input_filename = updatable_bcp_packages_filename_;
    }
    if (!input_filename.empty()) {
