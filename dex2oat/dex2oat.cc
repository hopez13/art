...
NO_RETURN static void Usage(const char* fmt, ...) {
  ...
  UsageError("");
  UsageError("  --updatable-bcp-packages=<directory-path>: file with a list of updatable");
 ...
 public:
  ...
  void ProcessOptions(ParserOptions* parser_options) {
    ...
    if ((IsBootImage() || IsBootImageExtension()) && updatable_bcp_packages_filename_ != nullptr) {
      Usage("Do not specify --updatable-bcp-packages for boot image compilation.");
    }
  ...
  void ParseArgs(int argc, char** argv) {
    ...
    AssignIfExists(args, M::UpdatableBcpPackages, &updatable_bcp_packages_filename_);
