 ...
 public:
  ...
  bool OpenFile() {
    ...
    if (oat_fd_ == -1) {
      ...
      oat_file->DisableAutoClose();  // Do not close the FD passed as an argument when destroyed.
      ...
      vdex_file->DisableAutoClose();  // Do not close the FD passed as an argument when destroyed.
