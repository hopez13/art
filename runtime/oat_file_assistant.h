...
class OatFileAssistant {
 public:
  ...
  // compared to the current state. For eg, if the current compiler filter is
  ...
  // for this dex location. If the purpose of the dexopt is to downgrade the
  // compiler filter, set downgrade to true.
