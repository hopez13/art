...
class OatFileAssistant {
 public:
  ...
  // Constructs an OatFileAssistant, providing explicit image location and
  // should_relocate to use rather than the current runtime's image location
  // and ShouldRelocate setting.
  OatFileAssistant(const char* dex_location,
                   const char* oat_location,
                   const InstructionSet isa,
