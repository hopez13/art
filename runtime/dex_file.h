...
class DexFile {
 public:
  ...
  enum {
    ...
    kDexTypeMethodHandleItem         = 0x0007,  // NB(oth) ItemType.java defines this as 0x0008
    ...
    kDexTypeCallSiteIdItem           = 0x2007  // NB(oth) ItemType.java defines this as 0x0007, looks like 0x2000 suggests variable size.
  };
