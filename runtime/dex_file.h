 ...
 public:
  ...
  struct CodeItem {
   ...
   private:
    ...
    // holds and offset in the Vdex file containing both the actual debug_info_off and the
    // quickening info offset.
    // Don't use this field direclty, use DexFile::GetDebugInfoOffset instead.
