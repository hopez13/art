...
class CompilerCallbacks {
 public:
  ...
  virtual mirror::ClassStatus GetPreviousClassState(ClassReference ref ATTRIBUTE_UNUSED) {
    return mirror::ClassStatus::kStatusNotReady;
  }
