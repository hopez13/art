...
class TestInstrumentationListener final : public instrumentation::InstrumentationListener {
 public:
  ...
  void MethodEntered(Thread* thread [[maybe_unused]], ArtMethod* method [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
    received_method_enter_event = true;
  }

  void MethodExited(Thread* thread [[maybe_unused]],
                    ArtMethod* method [[maybe_unused]],
                    instrumentation::OptionalFrame frame [[maybe_unused]],
                    MutableHandle<mirror::Object>& return_value [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
  ...
  void MethodExited(Thread* thread [[maybe_unused]],
                    ArtMethod* method [[maybe_unused]],
                    instrumentation::OptionalFrame frame [[maybe_unused]],
                    JValue& return_value [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
    received_method_exit_event = true;
  }

  void MethodUnwind(Thread* thread [[maybe_unused]],
                    ArtMethod* method [[maybe_unused]],
  ...
  void DexPcMoved(Thread* thread [[maybe_unused]],
                  Handle<mirror::Object> this_object [[maybe_unused]],
                  ArtMethod* method [[maybe_unused]],
  ...
  void FieldRead(Thread* thread [[maybe_unused]],
                 Handle<mirror::Object> this_object [[maybe_unused]],
                 ArtMethod* method [[maybe_unused]],
                 uint32_t dex_pc [[maybe_unused]],
                 ArtField* field [[maybe_unused]]) override REQUIRES_SHARED(Locks::mutator_lock_) {
    received_field_read_event = true;
  }

  void FieldWritten(Thread* thread [[maybe_unused]],
                    Handle<mirror::Object> this_object [[maybe_unused]],
                    ArtMethod* method [[maybe_unused]],
                    uint32_t dex_pc [[maybe_unused]],
                    ArtField* field [[maybe_unused]],
                    Handle<mirror::Object> field_value [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
  ...
  void FieldWritten(Thread* thread [[maybe_unused]],
                    ...
                    uint32_t dex_pc [[maybe_unused]],
                    ArtField* field [[maybe_unused]],
                    const JValue& field_value [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
    received_field_written_event = true;
  }

  void ExceptionThrown(Thread* thread [[maybe_unused]],
                       Handle<mirror::Throwable> exception_object [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
    received_exception_thrown_event = true;
  }

  void ExceptionHandled(Thread* self [[maybe_unused]],
                        Handle<mirror::Throwable> throwable [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
    received_exception_handled_event = true;
  }

  void Branch(Thread* thread [[maybe_unused]],
              ArtMethod* method [[maybe_unused]],
              uint32_t dex_pc [[maybe_unused]],
  ...
  void WatchedFramePop(Thread* thread [[maybe_unused]],
                       const ShadowFrame& frame [[maybe_unused]]) override
      REQUIRES_SHARED(Locks::mutator_lock_) {
