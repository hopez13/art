...
ClassLoaderContext::ExtractClassLoaderType(const std::string& class_loader_spec) const {
...
std::string ClassLoaderContext::GetClassLoaderTypeName(ClassLoaderType type) const {
  switch (type) {
