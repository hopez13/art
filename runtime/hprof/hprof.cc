...
class EndianOutput {
 public:
  ...
  virtual void UpdateU4(size_t offset, uint32_t new_value [[maybe_unused]]) {
 ...
 protected:
  virtual void HandleU1List(const uint8_t* values [[maybe_unused]], size_t count [[maybe_unused]]) {
  }
  virtual void HandleU1AsU2List(const uint8_t* values [[maybe_unused]],
                                size_t count [[maybe_unused]]) {}
  virtual void HandleU2List(const uint16_t* values [[maybe_unused]],
                            size_t count [[maybe_unused]]) {}
  virtual void HandleU4List(const uint32_t* values [[maybe_unused]],
                            size_t count [[maybe_unused]]) {}
  virtual void HandleU8List(const uint64_t* values [[maybe_unused]],
                            size_t count [[maybe_unused]]) {}
...
class EndianOutputBuffered : public EndianOutput {
 ...
 protected:
  ...
  virtual void HandleFlush(const uint8_t* buffer [[maybe_unused]], size_t length [[maybe_unused]]) {
  }
...
class Hprof : public SingleRootVisitor {
 ...
 private:
  ...
  bool DumpToDdmsBuffered(size_t overall_size [[maybe_unused]], size_t max_length [[maybe_unused]])
      REQUIRES(Locks::mutator_lock_) {
