...
ArtMethod* WellKnownClasses::java_lang_ThreadGroup_removeThread;
...
void WellKnownClasses::InitFieldsAndMethodsOnly(JNIEnv* env) {
  ...
  java_lang_ThreadGroup_removeThread = CacheMethod(
      j_l_tg.Get(),
      /*is_static=*/ false,
      "threadTerminated",
      "(Ljava/lang/Thread;)V",
  ...
  java_lang_Thread_nativePeer = CacheField(j_l_Thread.Get(), /*is_static=*/ false, "nativePeer", "J");
