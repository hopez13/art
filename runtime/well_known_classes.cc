...
static ArtField* CacheField(ObjPtr<mirror::Class> klass,
  ...
  ArtField* field = is_static
      ? klass->FindStaticField(name, signature)
      : klass->FindInstanceField(name, signature);
...
void WellKnownClasses::InitFieldsAndMethodsOnly(JNIEnv* env) {
  ...
  ObjPtr<mirror::Class> d_s_bcl = soa.Decode<mirror::Class>(dalvik_system_BaseDexClassLoader);
  dalvik_system_BaseDexClassLoader_pathList = CacheField(
      d_s_bcl, /*is_static=*/ false, "pathList", "Ldalvik/system/DexPathList;");
  dalvik_system_BaseDexClassLoader_sharedLibraryLoaders = CacheField(
      d_s_bcl, /*is_static=*/ false, "sharedLibraryLoaders", "[Ljava/lang/ClassLoader;");
  dalvik_system_BaseDexClassLoader_sharedLibraryLoadersAfter = CacheField(
      d_s_bcl, /*is_static=*/ false, "sharedLibraryLoadersAfter", "[Ljava/lang/ClassLoader;");
  ...
  dalvik_system_DexPathList__Element_dexFile = CacheField(
      d_s_dpl, /*is_static=*/ false, "dexFile", "Ldalvik/system/DexFile;");
