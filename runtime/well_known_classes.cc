...
jfieldID WellKnownClasses::dalvik_system_BaseDexClassLoader_sharedLibraries;
...
void WellKnownClasses::Init(JNIEnv* env) {
  ...
  dalvik_system_BaseDexClassLoader_sharedLibraries = CacheField(env, dalvik_system_BaseDexClassLoader, false, "sharedLibraries", "[Ljava/lang/ClassLoader;");
