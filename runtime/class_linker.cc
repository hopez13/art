...
bool ClassLinker::InitializeClass(Thread* self, Handle<mirror::Class> klass,
  ...
  if (!klass->IsInterface() && klass->HasSuperClass()) {
    ...
    if (!super_class->IsInitialized()) {
      ...
      if (Runtime::Current()->IsActiveTransaction() && Runtime::Current()->GetTransaction()->IsAppImage()) {
...
bool ClassLinker::EnsureInitializedWithTransaction(Thread* self,
  ...
  if (runtime->IsActiveTransaction() && runtime->GetTransaction()->IsAppImage() && success) {
