  ...
  if (app_image) {
    ...
    if (special_root == nullptr) {
      *error_msg = "Unexpected null special root in app image";
      ...
      const VdexFile::VdexChecksum* art_checksums = reinterpret_cast<VdexFile::VdexChecksum*>(special_root->AsIntArray()->GetData());
      const VdexFile::VdexChecksum* vdex_checksums = oat_file->GetVdexFile()->GetDexChecksumsArray();
