...
bool ClassLinker::LinkMethods(Thread* self,
  ...
  HashMap<size_t, ClassLinker::MethodTranslation> default_translations;
...
static size_t FillIfTable(Thread* self,
  ...
  HashSet<mirror::Class*> classes_in_iftable;
  ...
  bool have_interfaces = interfaces != nullptr;
  for (size_t i = 0; i < num_interfaces; i++) {
...
bool ClassLinker::SetupInterfaceLookupTable(Thread* self,
  ...
  size_t new_ifcount =
      FillIfTable(self, klass, interfaces, iftable.Get(), super_ifcount, num_interfaces);
