...
ObjPtr<mirror::Class> ClassLinker::CreatePrimitiveClass(Thread* self, Primitive::Type type) {
  ...
  mirror::Class::SetStatus(h_class, ClassStatus::kVisiblyInitialized, self);
...
ObjPtr<mirror::Class> ClassLinker::CreateArrayClass(Thread* self,
  ...
  // TODO: Do we need MarkClassInitialized() for array classes?
  mirror::Class::SetStatus(new_class, ClassStatus::kVisiblyInitialized, self);
...
ObjPtr<mirror::Class> ClassLinker::CreateProxyClass(ScopedObjectAccessAlreadyRunnable& soa,
...

  {
    ...
    EnsureSkipAccessChecksMethods(klass, image_pointer_size_);
    // TODO: Do we need MarkClassInitialized() for proxy classes?
    mirror::Class::SetStatus(klass, ClassStatus::kVisiblyInitialized, self);
  }
