 ...
 public:
  ...
  void MakeVisible(Thread* self) {
    if (class_linker_->visibly_initialize_classes_with_membarier_) {
      // If the associated register command succeded, this command should never fail.
      int membarrier_result = art::membarrier(MembarrierCommand::kPrivateExpeditedSyncCore);
...
static bool RegisterMemBarrierForClassInitialization() {
  ...
  int membarrier_result = art::membarrier(MembarrierCommand::kRegisterPrivateExpeditedSyncCore);
