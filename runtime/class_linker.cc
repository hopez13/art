...
verifier::MethodVerifier::FailureKind ClassLinker::VerifyClass(
  ...
  DCHECK(!(oat_file_class_status == mirror::Class::kStatusErrorUnresolved) || !preverified);
...
bool ClassLinker::VerifyClassUsingOatFile(const DexFile& dex_file,
  ...
  if (oat_file_class_status == mirror::Class::kStatusErrorUnresolved ||
      oat_file_class_status == mirror::Class::kStatusErrorResolved) {
