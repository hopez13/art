...
bool ClassLinker::InitWithoutImage(std::vector<std::unique_ptr<const DexFile>> boot_class_path,
  ...
  // Create java.lang.Detour.class root and array root.
  class_root = FindSystemClass(self, "Ljava/lang/Detour;");
  CHECK(class_root != nullptr);
  SetClassRoot(kJavaLangDetour, class_root);
  mirror::Detour::SetClass(class_root);
  class_root = FindSystemClass(self, "[Ljava/lang/Detour;");
  CHECK(class_root != nullptr);
  SetClassRoot(kJavaLangDetourArrayClass, class_root);
...
bool ClassLinker::InitFromBootImage(std::string* error_msg) {
  ...
  mirror::Detour::SetClass(GetClassRoot(kJavaLangDetour));
  mirror::Detour::SetArrayClass(GetClassRoot(kJavaLangDetourArrayClass));
