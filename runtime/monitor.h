...
class Monitor {
 public:
  ...
  // mutator_lock_, though ImageWriter calls this without actually invoking SuspendAll,
  // during a Heap::VisitObjects() that does not allow a thread suspension in the middle.
