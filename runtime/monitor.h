...
class Monitor {
 ...
 private:
  ...
  //
  // timed_out will be set to true if we exited due to timeout, false otherwise.
  //
  // We return true if we waited successfully, false otherwise.
  bool Wait(Thread* self,
            int64_t msec,
            int32_t nsec,
