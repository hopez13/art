...
#ifndef ART_RUNTIME_UTILS_SCOPED_PRIMITIVE_ARRAY_H_
#define ART_RUNTIME_UTILS_SCOPED_PRIMITIVE_ARRAY_H_
...
class Scoped ## NAME ## ArrayRO { \
 public: /* NOLINT */ \
  ...
  Scoped ## NAME ## ArrayRO(JNIEnv* env, PRIMITIVE_TYPE ## Array javaArray) : mEnv(env) { \
    if (javaArray == nullptr) { \
      mJavaArray = nullptr; \
      mSize = 0; \
      mRawArray = nullptr; \
      ScopedObjectAccess soa(env); \
      ThrowNullPointerException("Null array"); \
    } else { \
      reset(javaArray); \
    } \
  } \
...
#endif  // ART_RUNTIME_UTILS_SCOPED_PRIMITIVE_ARRAY_H_
