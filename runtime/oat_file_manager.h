...
class OatFileManager {
 public:
  ...
  EXPORT const OatFile* RegisterOatFile(std::unique_ptr<const OatFile> oat_file, bool in_memory = false)
  ...
  // files.
  EXPORT std::vector<std::unique_ptr<const DexFile>> OpenDexFilesFromOat(
