...
bool ImageHeader::IsAppImage() const {
  // Unlike boot image and boot image extensions, app images are loaded separately from
  // oat files and their reservation size is the image size rounded up to full page.
