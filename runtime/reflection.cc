...
bool InvokeMethodImpl(const ScopedObjectAccessAlreadyRunnable& soa,
  ...
  *shorty = np_method->GetShorty(&shorty_len);
  ...
  if (soa.Self()->IsExceptionPending()) {
    ...
    jobject exception_instance = soa.Env()->NewObject(WellKnownClasses::java_lang_reflect_InvocationTargetException, WellKnownClasses::java_lang_reflect_InvocationTargetException_init, th.get());
