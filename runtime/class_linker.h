...
class ClassLinker {
 public:
  ...
  // result is not cached in the DexFile as instance will only be used
  // once in most circumstances.
  mirror::MethodHandleImpl* ResolveMethodHandle(uint32_t method_handle_idx,
                                                ArtMethod* referrer)
      REQUIRES_SHARED(Locks::mutator_lock_);
