...
class EXPORT ClassLinker {
 public:
  ...
  // Find a matching JNI stub from boot image that we could reuse as entrypoint.
 ...
 private:
  ...
  // Load unique JNI stubs from boot image. If the subsequently loaded native method could find a
