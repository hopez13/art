...
class ClassLinker {
 ...
 private:
  ...
  // Same as FindClassInBaseDexClassLoader but does not attempt to search the BootClassLoader.
  bool FindClassInBaseDexClassLoaderWithoutBoot(ScopedObjectAccessAlreadyRunnable& soa,
                                                Thread* self,
                                                const char* descriptor,
                                                size_t hash,
                                                Handle<mirror::ClassLoader> class_loader,
  ...
  ObjPtr<mirror::Class> FindClassInClassLoaderClassPath(ScopedObjectAccessAlreadyRunnable& soa,
                                                        Thread* self,
                                                        const char* descriptor,
                                                        size_t hash,
                                                        Handle<mirror::ClassLoader> class_loader)
