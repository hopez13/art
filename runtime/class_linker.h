 ...
 public:
  ...
  struct DexCacheData {
    ...
    DexCacheData() : weak_root(nullptr), class_table(nullptr) {
      static uint64_t s_registration_count = 0;
      registration_index = s_registration_count++;
    }
    ...
    // Monastically increasing integer which preserves the order in which DexFiles were registered.
