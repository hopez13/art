...
class ClassLinker {
 public:
  ...
  // Creates a PathClassLoader, DelegateLastClassLoader or InMemoryDexClassLoader (specified
  // by loader_class) that can be used to load classes from the given dex files. The parent of
  // the class loader will be set to `parent_loader`. If `parent_loader` is null the parent will
  // be the boot class loader.
  // If class_loader points to a different class than PathClassLoader, DelegateLastClassLoader
  // or InMemoryDexClassLoader this method will abort.
