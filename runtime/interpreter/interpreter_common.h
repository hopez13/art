...
EXPORT COLD_ATTR void UnlockHeldMonitors(Thread* self, ShadowFrame* shadow_frame)
    REQUIRES_SHARED(Locks::mutator_lock_);
...
EXPORT  // TODO: Move the transactional instantiation to `dex2oat/` and remove EXPORT.
