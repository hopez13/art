...
void UnstartedRuntime::UnstartedJNIVMRuntimeIs64Bit(
  ...
  // The clinit for java.lang.invoke.VarHandle needs to be able to
  // tell if the runtime is 32-bit or 64-bit. The clinit determines
  // sets of available VarHandle accessors and these differ based on
  // machine word size.
