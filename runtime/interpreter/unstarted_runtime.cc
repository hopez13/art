...
void UnstartedRuntime::UnstartedSystemGetSecurityManager(Thread* self [[maybe_unused]],
                                                         ShadowFrame* shadow_frame [[maybe_unused]],
                                                         JValue* result,
                                                         size_t arg_offset [[maybe_unused]]) {
  result->SetL(nullptr);
}
...
void UnstartedRuntime::UnstartedMathCeil(Thread* self [[maybe_unused]],
                                         ShadowFrame* shadow_frame,
                                         JValue* result,
                                         size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMathFloor(Thread* self [[maybe_unused]],
                                          ShadowFrame* shadow_frame,
                                          JValue* result,
                                          size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMathSin(Thread* self [[maybe_unused]],
                                        ShadowFrame* shadow_frame,
                                        JValue* result,
                                        size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMathCos(Thread* self [[maybe_unused]],
                                        ShadowFrame* shadow_frame,
                                        JValue* result,
                                        size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMathPow(Thread* self [[maybe_unused]],
                                        ShadowFrame* shadow_frame,
                                        JValue* result,
                                        size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMathTan(Thread* self [[maybe_unused]],
                                        ShadowFrame* shadow_frame,
                                        JValue* result,
                                        size_t arg_offset) {
...
void UnstartedRuntime::UnstartedObjectHashCode(Thread* self [[maybe_unused]],
                                               ShadowFrame* shadow_frame,
                                               JValue* result,
                                               size_t arg_offset) {
...
void UnstartedRuntime::UnstartedDoubleDoubleToRawLongBits(Thread* self [[maybe_unused]],
                                                          ShadowFrame* shadow_frame,
                                                          JValue* result,
                                                          size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMemoryPeekByte(Thread* self [[maybe_unused]],
                                               ShadowFrame* shadow_frame,
                                               JValue* result,
                                               size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMemoryPeekShort(Thread* self [[maybe_unused]],
                                                ShadowFrame* shadow_frame,
                                                JValue* result,
                                                size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMemoryPeekInt(Thread* self [[maybe_unused]],
                                              ShadowFrame* shadow_frame,
                                              JValue* result,
                                              size_t arg_offset) {
...
void UnstartedRuntime::UnstartedMemoryPeekLong(Thread* self [[maybe_unused]],
                                               ShadowFrame* shadow_frame,
                                               JValue* result,
                                               size_t arg_offset) {
...
void UnstartedRuntime::UnstartedSystemIdentityHashCode(Thread* self [[maybe_unused]],
                                                       ShadowFrame* shadow_frame,
                                                       JValue* result,
                                                       size_t arg_offset)
    REQUIRES_SHARED(Locks::mutator_lock_) {
...
// word size.
void UnstartedRuntime::UnstartedJNIVMRuntimeIs64Bit(Thread* self [[maybe_unused]],
                                                    ArtMethod* method [[maybe_unused]],
                                                    mirror::Object* receiver [[maybe_unused]],
                                                    uint32_t* args [[maybe_unused]],
                                                    JValue* result) {
  PointerSize pointer_size = Runtime::Current()->GetClassLinker()->GetImagePointerSize();
...
void UnstartedRuntime::UnstartedJNIVMStackGetCallingClassLoader(Thread* self [[maybe_unused]],
                                                                ArtMethod* method [[maybe_unused]],
                                                                mirror::Object* receiver
                                                                [[maybe_unused]],
                                                                uint32_t* args [[maybe_unused]],
...
void UnstartedRuntime::UnstartedJNIMathLog(Thread* self [[maybe_unused]],
                                           ArtMethod* method [[maybe_unused]],
                                           mirror::Object* receiver [[maybe_unused]],
                                           uint32_t* args,
                                           JValue* result) {
...
void UnstartedRuntime::UnstartedJNIMathExp(Thread* self [[maybe_unused]],
                                           ArtMethod* method [[maybe_unused]],
                                           mirror::Object* receiver [[maybe_unused]],
                                           uint32_t* args,
                                           JValue* result) {
...
void UnstartedRuntime::UnstartedJNIAtomicLongVMSupportsCS8(Thread* self [[maybe_unused]],
                                                           ArtMethod* method [[maybe_unused]],
                                                           mirror::Object* receiver
                                                           [[maybe_unused]],
                                                           uint32_t* args [[maybe_unused]],
...
void UnstartedRuntime::UnstartedJNIDoubleLongBitsToDouble(Thread* self [[maybe_unused]],
                                                          ArtMethod* method [[maybe_unused]],
                                                          mirror::Object* receiver [[maybe_unused]],
                                                          uint32_t* args,
                                                          JValue* result) {
...
void UnstartedRuntime::UnstartedJNIFloatFloatToRawIntBits(Thread* self [[maybe_unused]],
                                                          ArtMethod* method [[maybe_unused]],
                                                          mirror::Object* receiver [[maybe_unused]],
                                                          uint32_t* args,
                                                          JValue* result) {
...
void UnstartedRuntime::UnstartedJNIFloatIntBitsToFloat(Thread* self [[maybe_unused]],
                                                       ArtMethod* method [[maybe_unused]],
                                                       mirror::Object* receiver [[maybe_unused]],
                                                       uint32_t* args,
                                                       JValue* result) {
...
void UnstartedRuntime::UnstartedJNIStringIntern(Thread* self [[maybe_unused]],
                                                ArtMethod* method [[maybe_unused]],
                                                mirror::Object* receiver,
                                                uint32_t* args [[maybe_unused]],
                                                JValue* result) {
...
void UnstartedRuntime::UnstartedJNIJdkUnsafeAddressSize(Thread* self [[maybe_unused]],
                                                        ArtMethod* method [[maybe_unused]],
                                                        mirror::Object* receiver [[maybe_unused]],
                                                        uint32_t* args [[maybe_unused]],
                                                        JValue* result) {
...
void UnstartedRuntime::UnstartedJNIJdkUnsafeCompareAndSwapInt(Thread* self,
                                                              ArtMethod* method [[maybe_unused]],
                                                              mirror::Object* receiver
                                                              [[maybe_unused]],
                                                              uint32_t* args,
...
void UnstartedRuntime::UnstartedJNIFieldGetArtField(Thread* self [[maybe_unused]],
                                                    ArtMethod* method [[maybe_unused]],
                                                    mirror::Object* receiver,
                                                    uint32_t* args [[maybe_unused]],
                                                    JValue* result) {
...
void UnstartedRuntime::UnstartedJNIFieldGetNameInternal(Thread* self [[maybe_unused]],
                                                        ArtMethod* method [[maybe_unused]],
                                                        mirror::Object* receiver,
                                                        uint32_t* args [[maybe_unused]],
                                                        JValue* result) {
