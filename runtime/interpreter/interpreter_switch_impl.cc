  ...
  do {
    ...
    switch (inst->Opcode(inst_data)) {
      ...
      case Instruction::CONST_METHOD_HANDLE: {
        PREAMBLE();
        ObjPtr<mirror::MethodHandle> mh = ResolveMethodHandle(inst->VRegB_21c(), method);
      ...
      case Instruction::CONST_METHOD_TYPE: {
        PREAMBLE();
        ObjPtr<mirror::MethodType> mt = ResolveMethodType(self, inst->VRegB_21c(), method);
...
#pragma clang diagnostic pop
      ...
      case Instruction::UNUSED_F3 ... Instruction::UNUSED_F7:
