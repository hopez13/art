...
// Quickened invokes to methods identified as intrinics are routed here.  If
// there is no interpreter implementation, return false and a normal invoke will proceed.
