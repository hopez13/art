...
TEST_F(UnstartedRuntimeTest, MemoryPeekByte) {
  ...
  JValue result;
  auto tmp = CreateShadowFrame(10, nullptr, nullptr, 0);
...
TEST_F(UnstartedRuntimeTest, StringInit) {
  ...
  JValue result;
  auto shadow_frame = CreateShadowFrame(10, nullptr, method, 0);
...
TEST_F(UnstartedRuntimeTest, IsAnonymousClass) {
  ...
  JValue result;
  auto shadow_frame = CreateShadowFrame(10, nullptr, nullptr, 0);
...
TEST_F(UnstartedRuntimeTest, ThreadLocalGet) {
  ...
  // Positive test. See that We get something for float conversion.
  {
    ...
    auto caller_frame = CreateShadowFrame(10, nullptr, caller_method, 0);
 ...
 public:
  ...
  mirror::ClassLoader* GetBootClassLoader() REQUIRES_SHARED(Locks::mutator_lock_) {
...

    {
      ...
      JValue result;
      auto shadow_frame = CreateShadowFrame(10, nullptr, boot_cp_init, 0);
