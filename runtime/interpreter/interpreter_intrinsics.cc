...
static void SetupIntrinsic(Intrinsics intrinsic, jmethodID method)
    REQUIRES_SHARED(Locks::mutator_lock_) {
  ArtMethod* art_method = jni::DecodeArtMethod(method);
  DCHECK_EQ(art_method->GetInvokeType(), kPolymorphic);
  art_method->SetIntrinsic(static_cast<uint32_t>(intrinsic));
}

void InitializeSignaturePolymorphicIntrinsics() REQUIRES_SHARED(Locks::mutator_lock_) {
  // Java 8 Invoke Polymorphic methods list
  SetupIntrinsic(Intrinsics::kMethodHandleInvoke,
                 WellKnownClasses::java_lang_invoke_MethodHandle_invoke);
  SetupIntrinsic(Intrinsics::kMethodHandleInvokeExact,
                 WellKnownClasses::java_lang_invoke_MethodHandle_invokeExact);

  // Java 9 Invoke Polymorphic methods list
  SetupIntrinsic(Intrinsics::kVarHandleCompareAndExchange,
                 WellKnownClasses::java_lang_invoke_VarHandle_compareAndExchange);
  SetupIntrinsic(Intrinsics::kVarHandleCompareAndExchangeAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_compareAndExchangeAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleCompareAndExchangeRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_compareAndExchangeRelease);
  SetupIntrinsic(Intrinsics::kVarHandleCompareAndSet,
                 WellKnownClasses::java_lang_invoke_VarHandle_compareAndSet);
  SetupIntrinsic(Intrinsics::kVarHandleGet,
                 WellKnownClasses::java_lang_invoke_VarHandle_get);
  SetupIntrinsic(Intrinsics::kVarHandleGetAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndAdd,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndAdd);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndAddAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndAddAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndAddRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndAddRelease);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseAnd,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseAnd);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseAndAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseAndAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseAndRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseAndRelease);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseOr,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseOr);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseOrAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseOrAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseOrRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseOrRelease);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseXor,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseXor);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseXorAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseXorAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndBitwiseXorRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndBitwiseXorRelease);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndSet,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndSet);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndSetAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndSetAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleGetAndSetRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_getAndSetRelease);
  SetupIntrinsic(Intrinsics::kVarHandleGetOpaque,
                 WellKnownClasses::java_lang_invoke_VarHandle_getOpaque);
  SetupIntrinsic(Intrinsics::kVarHandleGetVolatile,
                 WellKnownClasses::java_lang_invoke_VarHandle_getVolatile);
  SetupIntrinsic(Intrinsics::kVarHandleSet,
                 WellKnownClasses::java_lang_invoke_VarHandle_set);
  SetupIntrinsic(Intrinsics::kVarHandleSetOpaque,
                 WellKnownClasses::java_lang_invoke_VarHandle_setOpaque);
  SetupIntrinsic(Intrinsics::kVarHandleSetRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_setRelease);
  SetupIntrinsic(Intrinsics::kVarHandleSetVolatile,
                 WellKnownClasses::java_lang_invoke_VarHandle_setVolatile);
  SetupIntrinsic(Intrinsics::kVarHandleWeakCompareAndSet,
                 WellKnownClasses::java_lang_invoke_VarHandle_weakCompareAndSet);
  SetupIntrinsic(Intrinsics::kVarHandleWeakCompareAndSetAcquire,
                 WellKnownClasses::java_lang_invoke_VarHandle_weakCompareAndSetAcquire);
  SetupIntrinsic(Intrinsics::kVarHandleWeakCompareAndSetPlain,
                 WellKnownClasses::java_lang_invoke_VarHandle_weakCompareAndSetPlain);
  SetupIntrinsic(Intrinsics::kVarHandleWeakCompareAndSetRelease,
                 WellKnownClasses::java_lang_invoke_VarHandle_weakCompareAndSetRelease);
}
