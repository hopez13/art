 ...
 */
#define DPC_PSEUDO_REG 127

/*
 * Some assemblers do not recognize .cfi_val_offset.  Define here using .cfi_escape
 */
#define DW_CFA_val_offset 0x14
#define DW_CFA_val_offset_sf 0x15

.macro CFI_VAL_OFFSET reg, offset
    .iflt \offset
      .cfi_escape DW_CFA_val_offset_sf, \reg, \offset
    .else
      .cfi_escape DW_CFA_val_offset, \reg, \offset
    .endif
.endm
