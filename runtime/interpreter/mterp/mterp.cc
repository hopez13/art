...
extern "C" ssize_t MterpSetUpHotnessCountdown(ArtMethod* method,
  ...
  if (jit != nullptr) {
    ...
    int32_t warm_threshold = jit->WarmMethodThreshold() + jit::kJitSamplesBatchSize;
    int32_t hot_threshold = jit->HotMethodThreshold() + jit::kJitSamplesBatchSize;
    int32_t osr_threshold = jit->OSRMethodThreshold() + jit::kJitSamplesBatchSize;
