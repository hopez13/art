...
extern "C" size_t MterpInvokeVirtual(Thread* self,
  ...
  return DoInvoke<kVirtual, /*is_range*/ false, /*access_check*/ false, /*is_mterp*/ true>(
...
extern "C" size_t MterpInvokeSuper(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kSuper, /*is_range*/ false, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeInterface(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kInterface, /*is_range*/ false, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeDirect(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kDirect, /*is_range*/ false, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeStatic(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kStatic, /*is_range*/ false, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeVirtualRange(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kVirtual, /*is_range*/ true, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeSuperRange(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kSuper, /*is_range*/ true, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeInterfaceRange(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kInterface, /*is_range*/ true, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeDirectRange(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kDirect, /*is_range*/ true, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
...
extern "C" size_t MterpInvokeStaticRange(Thread* self,
  ...
  JValue* result_register = shadow_frame->GetResultRegister();
  const Instruction* inst = Instruction::At(dex_pc_ptr);
  return DoInvoke<kStatic, /*is_range*/ true, /*access_check*/ false, /*is_mterp*/ true>(
      self, *shadow_frame, inst, inst_data, result_register);
}
