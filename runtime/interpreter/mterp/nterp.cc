...
ArrayRef<const uint8_t> NterpImpl() {
  const uint8_t* impl = reinterpret_cast<const uint8_t*>(ExecuteNterpImpl);
  size_t size = reinterpret_cast<const uint8_t*>(EndExecuteNterpImpl) - impl;
  return {reinterpret_cast<const uint8_t*>(EntryPointToCodePointer(impl)), size};
}
...
ArrayRef<const uint8_t> NterpWithClinitImpl() {
  const uint8_t* impl = reinterpret_cast<const uint8_t*>(ExecuteNterpWithClinitImpl);
  size_t size = reinterpret_cast<const uint8_t*>(EndExecuteNterpWithClinitImpl) - impl;
  return {reinterpret_cast<const uint8_t*>(EntryPointToCodePointer(impl)), size};
}
