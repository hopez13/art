...
class CIInstrumentationListener FINAL: public instrumentation::InstrumentationListener {
 public:
  CIInstrumentationListener() : counter(0), threshold_(100000) {}

  explicit CIInstrumentationListener(bool abort, int threshold)
      : counter(0), abort_(abort), threshold_(threshold) { }
