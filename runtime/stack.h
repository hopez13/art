...
class StackVisitor {
 ...
 private:
  ...
  // Sanity flag (used for DCHECK only) whether an implementation of the stack visitor expects
  ...
  // The explicit flag declaration and a possible check will make the behavior more robust
