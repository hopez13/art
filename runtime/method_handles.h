...
// Converts an the |index| argument from type expected by |callee_type| to type
// used by |callsite_type|. |value| represents the value to be converted. Returns
// true on success and updates |value|, false otherwise.
...
// Converts an the return value from return type that yielded by
