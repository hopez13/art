...
template<>
bool OatFile::CanUseCode<ArtMethodType::kNativeMethod>() const {
...
template<>
bool OatFile::CanUseCode<ArtMethodType::kDexMethod>() const {
...
template<>
bool OatFile::CanUseCode<ArtMethodType::kUnknown>() const {
