...
class ElfOatFile FINAL : public OatFileBase {
 public:
  ...
  static ElfOatFile* OpenElfFile(uint32_t zip_fd,
                                 File* file,
                                 const std::string& location,
                                 uint8_t* requested_base,
  ...
  bool InitializeFromElfFile(uint32_t zip_fd,
                             ElfFile* elf_file,
                             VdexFile* vdex_file,
                             const char* abs_dex_location,
                             std::string* error_msg);
...
ElfOatFile* ElfOatFile::OpenElfFile(uint32_t zip_fd,
                                    File* file,
                                    const std::string& location,
                                    uint8_t* requested_base,
                                    uint8_t* oat_file_begin,  // Override base if not null
...
bool ElfOatFile::InitializeFromElfFile(uint32_t zip_fd,
                                       ElfFile* elf_file,
                                       VdexFile* vdex_file,
                                       const char* abs_dex_location,
                                       std::string* error_msg) {
