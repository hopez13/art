...
class DlOpenOatFile final : public OatFileBase {
 ...
 protected:
  ...
  bool Load(int oat_fd [[maybe_unused]],
            bool writable [[maybe_unused]],
            bool executable [[maybe_unused]],
            bool low_4gb [[maybe_unused]],
            /*inout*/ MemMap* reservation [[maybe_unused]],
            /*out*/ std::string* error_msg [[maybe_unused]]) override {
    return false;
  }
...
void DlOpenOatFile::PreLoad() {
  ...
  struct dl_iterate_context {
    static int callback(dl_phdr_info* info [[maybe_unused]],
  ...
  *error_msg = "Dlopen unsupported on Mac.";
...
#else
  {
    ...
    if (reservation != nullptr && dlopen_handle_ != nullptr) {
      ...
      struct dl_iterate_context {
        static int callback(dl_phdr_info* info, size_t size [[maybe_unused]], void* data) {
...
class ElfOatFile final : public OatFileBase {
 ...
 protected:
  ...
  void PreSetup(const std::string& elf_filename [[maybe_unused]]) override {}
...
class OatFileBackedByVdex final : public OatFileBase {
 ...
 protected:
  ...
  bool Load(const std::string& elf_filename [[maybe_unused]],
            bool writable [[maybe_unused]],
            bool executable [[maybe_unused]],
            bool low_4gb [[maybe_unused]],
            MemMap* reservation [[maybe_unused]],
            std::string* error_msg [[maybe_unused]]) override {
  ...
  const uint8_t* FindDynamicSymbolAddress(const std::string& symbol_name [[maybe_unused]],
                                          std::string* error_msg) const override {
