 ...
 protected:
  ...
  void CheckQuickEntryPoints() {
    ...
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pReadBarrierSlow, pReadBarrierForRootSlow,
                         sizeof(void*));
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pReadBarrierForRootSlow, pTraceEntryHook, sizeof(void*));
    EXPECT_OFFSET_DIFFNP(QuickEntryPoints, pTraceEntryHook, pTraceExitHook, sizeof(void*));

    CHECKED(OFFSETOF_MEMBER(QuickEntryPoints, pTraceExitHook) + sizeof(void*) ==
