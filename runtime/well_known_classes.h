...
struct WellKnownClasses {
 public:
  ...
  static jmethodID java_lang_invoke_VarHandle_compareAndExchange;
  static jmethodID java_lang_invoke_VarHandle_compareAndExchangeAcquire;
  static jmethodID java_lang_invoke_VarHandle_compareAndExchangeRelease;
  static jmethodID java_lang_invoke_VarHandle_compareAndSet;
  static jmethodID java_lang_invoke_VarHandle_get;
  static jmethodID java_lang_invoke_VarHandle_getAcquire;
  static jmethodID java_lang_invoke_VarHandle_getAndAdd;
  static jmethodID java_lang_invoke_VarHandle_getAndAddAcquire;
  static jmethodID java_lang_invoke_VarHandle_getAndAddRelease;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseAnd;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseAndAcquire;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseAndRelease;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseOr;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseOrAcquire;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseOrRelease;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseXor;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseXorAcquire;
  static jmethodID java_lang_invoke_VarHandle_getAndBitwiseXorRelease;
  static jmethodID java_lang_invoke_VarHandle_getAndSet;
  static jmethodID java_lang_invoke_VarHandle_getAndSetAcquire;
  static jmethodID java_lang_invoke_VarHandle_getAndSetRelease;
  static jmethodID java_lang_invoke_VarHandle_getOpaque;
  static jmethodID java_lang_invoke_VarHandle_getVolatile;
  static jmethodID java_lang_invoke_VarHandle_set;
  static jmethodID java_lang_invoke_VarHandle_setOpaque;
  static jmethodID java_lang_invoke_VarHandle_setRelease;
  static jmethodID java_lang_invoke_VarHandle_setVolatile;
  static jmethodID java_lang_invoke_VarHandle_weakCompareAndSet;
  static jmethodID java_lang_invoke_VarHandle_weakCompareAndSetAcquire;
  static jmethodID java_lang_invoke_VarHandle_weakCompareAndSetPlain;
  static jmethodID java_lang_invoke_VarHandle_weakCompareAndSetRelease;
