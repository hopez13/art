...
extern "C" mirror::Object* art_quick_read_barrier_mark_reg30(mirror::Object*);
...
void UpdateReadBarrierEntrypoints(QuickEntryPoints* qpoints, bool is_marking) {
  ...
  qpoints->pReadBarrierMarkReg30 = is_marking ? art_quick_read_barrier_mark_reg30 : nullptr;
}
