...
TEST(Riscv64InstructionSetFeaturesTest, Riscv64FeaturesFromDefaultVariant) {
  ...
  uint32_t expected_extensions =
      ...
      Riscv64InstructionSetFeatures::kExtVector | Riscv64InstructionSetFeatures::kExtZba |
      Riscv64InstructionSetFeatures::kExtZbb | Riscv64InstructionSetFeatures::kExtZbs;
...
TEST(Riscv64InstructionSetFeaturesTest, Riscv64FeaturesFromString) {
  ...
  uint32_t expected_extensions =
      Riscv64InstructionSetFeatures::kExtGeneric | Riscv64InstructionSetFeatures::kExtVector;
  ...
  expected_extensions =
      Riscv64InstructionSetFeatures::kExtGeneric | Riscv64InstructionSetFeatures::kExtCompressed |
      Riscv64InstructionSetFeatures::kExtZba | Riscv64InstructionSetFeatures::kExtZbb;
