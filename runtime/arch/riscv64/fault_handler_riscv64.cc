...
void FaultManager::GetMethodAndReturnPcAndSp(siginfo_t*,
                                             void*,
                                             ArtMethod**,
                                             uintptr_t*,
                                             uintptr_t*,
...
void FaultManager::GetMethodAndReturnPcAndSp(siginfo_t* siginfo,
  ...
  struct sigaltstack *ss = reinterpret_cast<struct sigaltstack*>(&uc->uc_stack);
  ...
  *out_sp = static_cast<uintptr_t>(ss->ss_sp);
...
bool SuspensionHandler::Action(int, siginfo_t*,
                               void*) {
...
bool StackOverflowHandler::Action(int, siginfo_t*,
                                  void*) {
