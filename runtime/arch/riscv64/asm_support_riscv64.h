...
// FS0 - FS11, S0 - S11, RA and padding, total 8*(12 + 12 + 1 + 1) = 208
#define FRAME_SIZE_SAVE_ALL_CALLEE_SAVES 208
// FA0 - FA7, A1 - A7, S0, S2 - S11, RA and padding total 8*(8 + 7 + 11 + 1 + 1) = 224
// Not include A0, S1, because of A0 is a method pointer and S1 it a TR.
#define FRAME_SIZE_SAVE_REFS_AND_ARGS    224
// All 32 FPRs, 29 GPRs (excluding Zero, TP and GP) and padding, total 8*(32 + 29 + 1) = 496
