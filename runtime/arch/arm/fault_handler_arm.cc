...
uintptr_t FaultManager::GetFaultPc(siginfo_t* siginfo [[maybe_unused]], void* context) {
...
bool NullPointerHandler::Action(int sig [[maybe_unused]], siginfo_t* info, void* context) {
...
bool SuspensionHandler::Action(int sig [[maybe_unused]],
...
bool StackOverflowHandler::Action(int sig [[maybe_unused]],
                                  siginfo_t* info [[maybe_unused]],
                                  void* context) {
  ucontext_t* uc = reinterpret_cast<ucontext_t*>(context);
  mcontext_t* mc = reinterpret_cast<mcontext_t*>(&uc->uc_mcontext);
