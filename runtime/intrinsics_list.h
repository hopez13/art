...
//
// In the INTRINSICS_LIST below has the following format:
//
//   1. name
//   2. invocation-type (compiler use only)
//   3. needs-environment-flag (compiler use only)
//   4. side-effects (compiler user only)
//   5. throwing-flag (compiler use only)
