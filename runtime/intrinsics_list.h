...
//
// In the intrinsics lists in this file, the format is name, then
// whether it is expected to be a HInvokeStaticOrDirect node (compared
// to HInvokeVirtual), then whether it requires an environment, may
// have side effects, or may throw exceptions.
//
