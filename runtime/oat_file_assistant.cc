...
OatFileAssistant::OatStatus OatFileAssistant::GivenOatFileStatus(const OatFile& file) {
  ...
  if (only_load_trusted_executable_ &&
      !LocationIsTrusted(file.GetLocation(), !Runtime::Current()->GetArtApexDataIsUntrusted()) &&
...
bool OatFileAssistant::DexLocationToOatFilename(const std::string& location,
  ...
  if (!apex_data_file.empty() && !Runtime::Current()->GetArtApexDataIsUntrusted()) {
...
const OatFile* OatFileAssistant::OatFileInfo::GetFile() {
  ...
  if (LocationIsOnArtApexData(filename_) && Runtime::Current()->GetArtApexDataIsUntrusted()) {
