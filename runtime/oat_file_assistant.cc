...
bool OatFileAssistant::ImageInfo::ValidateBootClassPathChecksums(const OatFile& oat_file) const {
  ...
  // ending before the ':' delimiter . If it's not an exact match, we shall check
  // for class definition conflicts with the extra dex files when opening the oat file.
