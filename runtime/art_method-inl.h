...
template <> struct ShortyTraits<'V'> {
  using Type = void;
  static Type Get(const JValue& value [[maybe_unused]]) {}
...
template <char... ArgType>
inline ALWAYS_INLINE void FillVRegs(uint32_t* vregs [[maybe_unused]],
                                    typename ShortyTraits<ArgType>::Type... args [[maybe_unused]])
