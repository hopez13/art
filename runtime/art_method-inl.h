...
inline ObjPtr<mirror::Class> ArtMethod::LookupClassFromTypeIndex(dex::TypeIndex type_idx) {
...
inline bool ArtMethod::IsResolvedTypeIdx(dex::TypeIndex type_idx) {
  DCHECK(!IsProxyMethod());
  return LookupClassFromTypeIndex(type_idx) != nullptr;
}
...
inline ObjPtr<mirror::Class> ArtMethod::LookupReturnType() {
  return LookupClassFromTypeIndex(GetReturnTypeIndex());
}
