...
static jobject AbstractMethod_getAnnotationNative(JNIEnv* env, jobject javaMethod,
...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(AbstractMethod, getParameterAnnotationsNative, "!()[[Ljava/lang/annotation/Annotation;"),
