...
static jboolean DexFile_isReadOnlyJavaDclChecked(JNIEnv* env ATTRIBUTE_UNUSED,
                                                 jclass javeDexFileClass ATTRIBUTE_UNUSED) {
  return isReadOnlyJavaDclChecked() ? JNI_TRUE : JNI_FALSE;
}
...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(DexFile, isReadOnlyJavaDclChecked, "()Z"),
  NATIVE_METHOD(DexFile,
