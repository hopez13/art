...
static jobject DexFile_openDexFileNative(JNIEnv* env,
  ...
  // * Root: root processes always have write access to files.
  // * System: /data/app/**.apk are owned by AID_SYSTEM;
  //   loading installed APKs in system_server is allowed.
  // * Shell: directly calling dalvikvm/app_process in ADB shell
