...
template <typename T>
static
typename std::result_of<T(Thread*, const ScopedFastNativeObjectAccess&)>::type GetThreadStack(
    const ScopedFastNativeObjectAccess& soa,
    jobject peer,
    T fn)
    REQUIRES_SHARED(Locks::mutator_lock_) {
  typename std::result_of<T(Thread*, const ScopedFastNativeObjectAccess&)>::type trace = nullptr;
...
static JNINativeMethod gMethods[] = {
  ...
  FAST_NATIVE_METHOD(VMStack, getAnnotatedThreadStackTrace, "(Ljava/lang/Thread;)[[Ljava/lang/Object;"),
};
