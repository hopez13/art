...
static jint Unsafe_addressSize(JNIEnv* env [[maybe_unused]], jobject ob [[maybe_unused]]) {
  return sizeof(void*);
}

static jint Unsafe_pageSize(JNIEnv* env [[maybe_unused]], jobject ob [[maybe_unused]]) {
...
static void Unsafe_freeMemory(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  free(reinterpret_cast<void*>(static_cast<uintptr_t>(address)));
}

static void Unsafe_setMemory(
    JNIEnv* env [[maybe_unused]], jobject, jlong address, jlong bytes, jbyte value) {
  memset(reinterpret_cast<void*>(static_cast<uintptr_t>(address)), value, bytes);
}

static jbyte Unsafe_getByteJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jbyte*>(address);
}

static void Unsafe_putByteJB(JNIEnv* env [[maybe_unused]], jobject, jlong address, jbyte value) {
  *reinterpret_cast<jbyte*>(address) = value;
}

static jshort Unsafe_getShortJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jshort*>(address);
}

static void Unsafe_putShortJS(JNIEnv* env [[maybe_unused]], jobject, jlong address, jshort value) {
  *reinterpret_cast<jshort*>(address) = value;
}

static jchar Unsafe_getCharJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jchar*>(address);
}

static void Unsafe_putCharJC(JNIEnv* env [[maybe_unused]], jobject, jlong address, jchar value) {
  *reinterpret_cast<jchar*>(address) = value;
}

static jint Unsafe_getIntJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jint*>(address);
}

static void Unsafe_putIntJI(JNIEnv* env [[maybe_unused]], jobject, jlong address, jint value) {
  *reinterpret_cast<jint*>(address) = value;
}

static jlong Unsafe_getLongJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jlong*>(address);
}

static void Unsafe_putLongJJ(JNIEnv* env [[maybe_unused]], jobject, jlong address, jlong value) {
  *reinterpret_cast<jlong*>(address) = value;
}

static jfloat Unsafe_getFloatJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jfloat*>(address);
}

static void Unsafe_putFloatJF(JNIEnv* env [[maybe_unused]], jobject, jlong address, jfloat value) {
  *reinterpret_cast<jfloat*>(address) = value;
}
static jdouble Unsafe_getDoubleJ(JNIEnv* env [[maybe_unused]], jobject, jlong address) {
  return *reinterpret_cast<jdouble*>(address);
}

static void Unsafe_putDoubleJD(JNIEnv* env [[maybe_unused]],
                               jobject,
                               jlong address,
                               jdouble value) {
...
static void Unsafe_copyMemory(
    JNIEnv* env, jobject unsafe [[maybe_unused]], jlong src, jlong dst, jlong size) {
  if (size == 0) {
    return;
  }
