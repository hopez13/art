...
static void VMRuntime_setHiddenApiAccessReportingRate(JNIEnv*, jclass, jint rate) {
  Runtime::Current()->SetHiddenApiAccessReportingRate(rate);
}
...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(VMRuntime, setHiddenApiAccessReportingRate, "(I)V"),
