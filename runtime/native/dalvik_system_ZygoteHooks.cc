...
enum {
  ...
  API_LIST_ENFORCEMENT_DARK_GREY  = 2 << 12,
  API_LIST_ENFORCEMENT_LIGHT_GREY = 3 << 12,
};
  ...
  if ((runtime_flags & ENABLE_HIDDEN_API_CHECKS) != 0) {
    switch (runtime_flags & ENABLE_HIDDEN_API_CHECKS) {
      ...
      case API_LIST_ENFORCEMENT_BLACK:
        ...
        break;
      case API_LIST_ENFORCEMENT_DARK_GREY:
        api_enforcement_policy = Runtime::ApiEnforcementPolicy::kDarkGreyAndBlackList;
        break;
      case API_LIST_ENFORCEMENT_LIGHT_GREY:
        api_enforcement_policy = Runtime::ApiEnforcementPolicy::kLightGrey;
        break;
    }
