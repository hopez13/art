...
static void ZygoteHooks_nativePostForkChild(JNIEnv* env,
  ...
  // System server should have been set earlier in nativePostForkSystemServer.
  DCHECK(!is_system_server || Runtime::Current()->IsSystemServer());
  // Set the runtime state as the first thing, in case JIT and other services
  // start querying it.
  Runtime::Current()->SetAsZygoteChild();
