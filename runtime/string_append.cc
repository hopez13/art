...
size_t StringAppend::Builder::Uint64Length(uint64_t value)  {
  if (value == 0u) {
    return 1u;
  }
...
template <typename CharType, size_t size>
CharType* StringAppend::Builder::AppendLiteral(ObjPtr<mirror::String> new_string,
                                               CharType* data,
...
template <typename CharType>
CharType* StringAppend::Builder::AppendString(ObjPtr<mirror::String> new_string,
                                              CharType* data,
...
uint16_t* StringAppend::Builder::AppendChars(ObjPtr<mirror::String> new_string,
                                             uint16_t* data,
                                             ObjPtr<mirror::CharArray> chars,
                                             size_t length) {
  DCHECK_LE(length, RemainingSpace(new_string, data));
...
uint8_t* StringAppend::Builder::AppendChars(ObjPtr<mirror::String> new_string,
                                            uint8_t* data,
                                            ObjPtr<mirror::CharArray> chars,
                                            size_t length) {
  DCHECK_LE(length, RemainingSpace(new_string, data));
...
template <typename CharType>
CharType* StringAppend::Builder::AppendInt64(ObjPtr<mirror::String> new_string,
                                             CharType* data,
                                             int64_t value) {
...
int32_t StringAppend::Builder::CalculateLengthWithFlag() {
...
template <typename CharType>
void StringAppend::Builder::StoreData(ObjPtr<mirror::String> new_string, CharType* data) const {
...
void StringAppend::Builder::operator()(ObjPtr<mirror::Object> obj,
...
ObjPtr<mirror::String> StringAppend::AppendF(uint32_t format, const uint32_t* args, Thread* self) {
...
extern "C" void* artStringBuilderAppend(uint32_t format, const uint32_t* args, Thread* self)
    REQUIRES_SHARED(Locks::mutator_lock_) {
  return StringAppend::AppendF(format, args, self).Ptr();
}
