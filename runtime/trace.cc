...
// raw timestamp counter and also time using clock_gettime at the start and the end of the trace.
// We can compute the frequency of timestamp counter upadtes in the post processing step using
// these two samples. However, that would require a change in Android Studio which is the main
