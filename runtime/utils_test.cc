...
TEST_F(UtilsTest, JniShortName_JniLongName) {
  ...
  m = c->FindInstanceMethod("charAt", "(I)C", kRuntimePointerSize);
  ...
  m = c->FindInstanceMethod("indexOf", "(Ljava/lang/String;I)I", kRuntimePointerSize);
  ASSERT_TRUE(m != nullptr);
  ASSERT_FALSE(m->IsDirect());
  ...
  m = c->FindInstanceMethod("copyValueOf", "([CII)Ljava/lang/String;", kRuntimePointerSize);
  ASSERT_TRUE(m != nullptr);
