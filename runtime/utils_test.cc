...
TEST_F(UtilsTest, JniShortName_JniLongName) {
  ...
  m = c->FindDirectOrVirtualMethod("charAt", "(I)C", kRuntimePointerSize);
  ...
  m = c->FindDirectOrVirtualMethod("indexOf", "(Ljava/lang/String;I)I", kRuntimePointerSize);
  ASSERT_TRUE(m != nullptr);
  ASSERT_FALSE(m->IsDirect());
  ...
  m = c->FindDirectOrVirtualMethod("copyValueOf", "([CII)Ljava/lang/String;", kRuntimePointerSize);
  ASSERT_TRUE(m != nullptr);
