 ...
 public:
  ...
  void VerifyOpenDexFiles(
    ...
    if (only_read_checksums) {
      ASSERT_TRUE(context->dex_files_checksums_attempted_);
      ASSERT_TRUE(context->dex_files_checksums_result_);
    } else {
  ...
  void PretendContextOpenedDexFiles(ClassLoaderContext* context) {
    ...
    context->dex_files_checksums_attempted_ = true;
    context->dex_files_checksums_result_ = true;
  }
