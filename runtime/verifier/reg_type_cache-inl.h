...
inline const ConstantType& RegTypeCache::FromCat1Const(int32_t value, bool precise) {
  ...
  if (precise && (value >= kMinSmallConstant) && (value <= kMaxSmallConstant)) {
    return *reinterpret_cast<const ConstantType*>(entries_[value - kMinSmallConstant]);
  }
  return FromCat1NonSmallConstant(value, precise);
}

inline const BooleanType& RegTypeCache::Boolean() {
  return *reinterpret_cast<const BooleanType*>(entries_[kBooleanCacheId]);
}
inline const ByteType& RegTypeCache::Byte() {
  return *reinterpret_cast<const ByteType*>(entries_[kByteCacheId]);
}
inline const CharType& RegTypeCache::Char() {
  return *reinterpret_cast<const CharType*>(entries_[kCharCacheId]);
}
inline const ShortType& RegTypeCache::Short() {
  return *reinterpret_cast<const ShortType*>(entries_[kShortCacheId]);
}
inline const IntegerType& RegTypeCache::Integer() {
  return *reinterpret_cast<const IntegerType*>(entries_[kIntCacheId]);
}
inline const FloatType& RegTypeCache::Float() {
  return *reinterpret_cast<const FloatType*>(entries_[kFloatCacheId]);
}
inline const LongLoType& RegTypeCache::LongLo() {
  return *reinterpret_cast<const LongLoType*>(entries_[kLongLoCacheId]);
}
inline const LongHiType& RegTypeCache::LongHi() {
  return *reinterpret_cast<const LongHiType*>(entries_[kLongHiCacheId]);
}
inline const DoubleLoType& RegTypeCache::DoubleLo() {
  return *reinterpret_cast<const DoubleLoType*>(entries_[kDoubleLoCacheId]);
}
inline const DoubleHiType& RegTypeCache::DoubleHi() {
  return *reinterpret_cast<const DoubleHiType*>(entries_[kDoubleHiCacheId]);
}
inline const UndefinedType& RegTypeCache::Undefined() {
  return *reinterpret_cast<const UndefinedType*>(entries_[kUndefinedCacheId]);
}
inline const ConflictType& RegTypeCache::Conflict() {
  return *reinterpret_cast<const ConflictType*>(entries_[kConflictCacheId]);
}
inline const NullType& RegTypeCache::Null() {
  return *reinterpret_cast<const NullType*>(entries_[kNullCacheId]);
}
