    ...
    case Instruction::IF_NEZ: {
      ...
      if (!CurrentInsnFlags()->IsBranchTarget() &&
        ...
        if (!orig_type.Equals(cast_type) &&
            ...
            (orig_type.IsZero() ||
                orig_type.IsStrictlyAssignableFrom(cast_type.Merge(orig_type, this), this))) {
...
const RegType& MethodVerifier::ResolveClassAndCheckAccess(uint32_t class_idx) {
  ...
  VerifierDeps::MaybeRecordClassResolution(this, class_idx, klass);
        ...
        if (iterator.GetHandlerAddress() == (uint32_t) work_insn_idx_) {
          if (iterator.GetHandlerTypeIndex() == DexFile::kDexNoIndex16) {
            ...
            if (!reg_types_.JavaLangThrowable(false).IsAssignableFrom(exception, this)) {
              ...
              common_super = &common_super->Merge(exception, this);
              if (FailOrAbort(this,
...
ArtMethod* MethodVerifier::ResolveMethodAndCheckAccess(
  ...
  if (res_method == nullptr) {
    ...
    if (res_method != nullptr) {
      ...
      if (res_type != kDirectMethodResolution) {
        ...
        VerifierDeps::MaybeRecordMethodResolution(this, dex_method_idx, res_type, nullptr);
  ...
  VerifierDeps::MaybeRecordMethodResolution(this, dex_method_idx, res_type, res_method);
...
ArtField* MethodVerifier::GetStaticField(int field_idx) {
  ...
  VerifierDeps::MaybeRecordFieldResolution(this, field_idx, field);
