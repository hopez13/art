...
ArtMethod* MethodVerifier::ResolveMethodAndCheckAccess(
  ...
  if (res_method == nullptr) {
    if (res_kind == kDirectOrVirtualMethodResolution) {
      res_method = klass->FindDirectOrVirtualMethod(dex_cache_.Get(), dex_method_idx, pointer_size);
    } else {
    ...
    if (res_method != nullptr) {
      ...
      // If a method wasn't found with the expected type, look using the other type.
      ...
      if (res_kind == kDirectOrVirtualMethodResolution) {
        ...
        res_method =
            klass->FindDirectOrVirtualMethod(dex_cache_.Get(), dex_method_idx, pointer_size);
      }
    }
  }
