...
#include "leb128.h"
#include "method_verifier_enums.h"
...
ArtMethod* MethodVerifier::ResolveMethodAndCheckAccess(
  ...
  if (res_method == nullptr) {
    ...
    if (res_method != nullptr) {
      ...
      if (res_type != kDirectMethodResolution) {
        ...
        VerifierDeps::MaybeRecordMethodResolution(*dex_file_, dex_method_idx, res_type, nullptr);
  ...
  VerifierDeps::MaybeRecordMethodResolution(*dex_file_, dex_method_idx, res_type, res_method);
