...
class VerifierDeps {
 public:
  // Add `dex_file` to list of files which this class will collect dependencies for.
  // Note that this method can be called only during initialization, before any
  // classes are verified by MethodVerifier.
  ...
  // using `res_type` kind of method resolution algorithm. If `method` is null,
