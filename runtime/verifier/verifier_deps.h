...
class VerifierDeps {
 ...
 private:
  ...
  struct DexFileDeps {
    ...
    // List of classes that were not verified and were treated as external
    // because their descriptor resolved into a different dex file.
  ...
  // Kept as a vector of pairs to preserve DexFile order.
