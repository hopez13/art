...
// Verification dependency collector class invoked by MethodVerifier during
// code-flow verification of compiled bytecode. The class records all class/
// method/field resolution and type assignability dependencies on classes not
// defined in classpath DEX files.
class VerifierDeps {
 public:
  VerifierDeps();
