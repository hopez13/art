...
template<typename T>
static inline void EncodeSetVector(std::vector<uint8_t>* out, const std::vector<std::set<T>>& vector) {
...
static inline bool DecodeSetVector(const uint8_t** in, const uint8_t* end, std::vector<std::set<T>>* vector) {
