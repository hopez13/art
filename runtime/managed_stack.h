...
class PACKED(4) ManagedStack {
 public:
  ManagedStack()
      : tagged_top_quick_frame_(TaggedTopQuickFrame::Create(nullptr)),
        link_(nullptr),
  ...
  void SetTopQuickFrame(ArtMethod** top) {
    ...
    tagged_top_quick_frame_ = TaggedTopQuickFrame::Create(top);
  }
 ...
 private:
  ...
  class TaggedTopQuickFrame {
   public:
    static TaggedTopQuickFrame Create(ArtMethod** sp) {
