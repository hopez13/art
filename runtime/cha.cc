...
void ClassHierarchyAnalysis::ResetSIInHierarchyByDeletedAllocation(ObjPtr<mirror::Class> klass,
  ...
  // The class is going to be deleted. Iterate all over its virtual methods to see
  // if they represent SingleImplementations for methods of classes upper in the hierarchy.
  // Skip all virtual methods that are not overrode by the class since they cannot be
