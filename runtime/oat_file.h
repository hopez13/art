...
enum class ArtMethodType {
  kUnknown,       // We don't know or care what type the method is
...
class OatFile {
 public:
  ...
  // Indicates whether the oat file was compiled and loaded in such a way as some of it's code is
  ...
  template<ArtMethodType kMethodType = ArtMethodType::kUnknown>
