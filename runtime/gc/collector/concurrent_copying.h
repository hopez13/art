...
class ConcurrentCopying : public GarbageCollector {
 public:
  ...
  bool UseReadBarrierEntrypoints() const {
    return use_read_barrier_entrypoints_;
  }
  bool IsActive() const {
    return is_active_;
  }
 ...
 private:
  ...
  bool use_read_barrier_entrypoints_;
  ...
  class SwitchToReadBarrierEntrypointsCallback;
  class SwitchToReadBarrierEntrypointsCheckpoint;
