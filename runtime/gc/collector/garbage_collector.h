...
class GarbageCollector : public RootVisitor, public IsMarkedVisitor, public MarkObjectVisitor {
 public:
  ...
  // Extract RSS for GC-specific memory ranges from smaps using libmeminfo.
  uint64_t ExtractRssFromSmaps(std::list<std::pair<uint64_t, uint64_t>>* gc_ranges);
