...
void ConcurrentCopying::MarkingPhase() {
  ...
  if (kUseBakerReadBarrier) {
    ...
    // white object, breaking the to-space invariant (a to-space object shall not reference a
    // from-space object, i.e. a black object shall not reference a white object).
    //
