...
void ConcurrentCopying::CopyingPhase() {
...

  {
    ...
    // for the mutex before it could make some progress and then participate in the checkpoint.
    // Consequently, the gc-thread blocks forever as the checkpoint never finishes
    // (See runtime/mutator_gc_coord.md).
