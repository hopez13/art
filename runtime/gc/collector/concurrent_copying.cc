    ...
    if (space->GetGcRetentionPolicy() == space::kGcRetentionPolicyNeverCollect ||
      ...
      if (kEnableGenerationalConcurrentCopyingCollection) {
        ...
        if (young_gen_) {
          ...
          // In full-heap GC cycle, card-table corresponding to region-space and
          ...
          // Furthermore, if the next GC is a young-gen cycle, then it only needs
          // writes to be captured after thread-flip of this GC cycle, as that is when
          // the young-gen for next GC cycle starts getting populated.
