 ...
 * 2) Every path to a black-dirty object goes through some gray object.
 *    In other words, black-dirty objects convert to gray-dirty before access
 * 3) After card table scan
 * 4) There are no black-dirty objects
 * 5) Referents corresponding to root references are gray, black-clean or in
 *    to-space
 *
 * G) After copying phase
 * -----------------------
