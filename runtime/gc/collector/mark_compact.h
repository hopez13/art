 ...
 private:
  ...
  class LiveWordsBitmap : private MemoryRangeBitmap<kAlignment> {
   public:
    ...
    static constexpr size_t kBitmapWordsPerVectorWord = kBitsPerVectorWord / kBitsPerBitmapWord;
    ...
    size_t FindNthLiveWordOffset(size_t offset_vec_idx, size_t n);
  ...
  // pointer. We tend to access it's members in performance-sensitive
  // code-path.
