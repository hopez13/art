...
class MarkCompact : public GarbageCollector {
 ...
 private:
  ...
  void SweepSystemWeaks(Thread* self, const bool paused) REQUIRES(!Locks::heap_bitmap_lock_);
  ...
  void ProcessReferences(Thread* self) REQUIRES(!Locks::heap_bitmap_lock_);
