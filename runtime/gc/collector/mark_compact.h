...
class MarkCompact final : public GarbageCollector {
 ...
 private:
  ...
  std::map<ObjReference, ObjReference, LessByObjReference> class_after_obj_map_;
  ...
  std::map<ObjReference, ObjReference>::const_reverse_iterator class_after_obj_iter_;
