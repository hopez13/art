...
static bool SysPropSaysUffdGc() {
  // The phenotype can change at time time after boot, but it shouldn't take effect until a reboot.
  // Therefore, we read the phenotype flag from the cache info, which is generated on boot.
