...
// Concurrent compaction termination logic is different (and slightly more efficient)
// if the kernel has the fault-retry feature (allowing repeated faults on the same page),
// which was introduced in 5.7.
