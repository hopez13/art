...
class MarkCompact::FlipCallback : public Closure {
 public:
  ...
  void Run(Thread* thread [[maybe_unused]]) override REQUIRES(Locks::mutator_lock_) {
...
class MarkCompact::ConcurrentCompactionGcTask : public SelfDeletingTask {
 public:
  ...
  void Run(Thread* self [[maybe_unused]]) override REQUIRES_SHARED(Locks::mutator_lock_) {
...
class MarkCompact::RefsUpdateVisitor {
 public:
  ...
  void operator()(mirror::Object* old [[maybe_unused]],
                  MemberOffset offset,
...
class MarkCompact::CardModifiedVisitor {
 public:
  ...
  void operator()(uint8_t* card, uint8_t expected_value, uint8_t new_value [[maybe_unused]]) const {
