...
void MarkCompact::UpdateNonMovingSpace() {
  ...
  // the VisitRefsForCompaction() to work correctly.
  ...
  for (size_t i = non_moving_first_objs_count_; i > 0; i--) {
    mirror::Object* obj = first_objs_non_moving_space_[i - 1].AsMirrorPtr();
    page -= kPageSize;
