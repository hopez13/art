...
class ImageSpace : public MemMapSpace {
 public:
  ...
  //
  // Search paths for remaining extensions can be specified as one of
  //     <search-path>/*
  //     *
  // where the second form means that the path of a particular BCP component
  // should be used to search for that components boot image extension. These
  ...
  //           /system/framework.
  //     /apex/com.runtime.art/boot.art:/system/framework/*:*
  ...
  //     /apex/com.runtime.art/boot.art:*:boot-framework.jar
