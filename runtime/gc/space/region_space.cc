...
inline bool RegionSpace::Region::ShouldBeEvacuated() {
  ...
  // - if the region was allocated after the start of the previous GC (newly allocated region); or
  // - if the live ratio is below threshold (`kEvacuateLivePercentThreshold`).
  bool result;
