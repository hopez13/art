...
class AllocationInfo {
 public:
  ...
  // Return the number of LargeObjectSpace::ObjectAlignment()-sized blocks that the allocation
  // info covers.
  ...
  // Return how many LargeObjectSpace::ObjectAlignment() units there are before the free block.
 ...
 private:
  ...
  // Contains the size of the previous free block with LargeObjectSpace::ObjectAlignment() as the
  ...
  uint32_t prev_free_;
  // Allocation size of this object in LargeObjectSpace::ObjectAlignment() as the unit.
