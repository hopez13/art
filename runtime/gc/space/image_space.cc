...
class ImageSpace::BootImageLayout {
 ...
 private:
  ...
  // Getting APEX versions from the input instead of from the runtime if possible. If the input is
  // present, `ValidateFromSystem` can work without an active runtime.
