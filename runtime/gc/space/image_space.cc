...
bool ImageSpace::BootImageLayout::ValidateOatFile(
  ...
  auto dex_filenames = ArrayRef<const std::string>(boot_class_path_).SubArray(bcp_index, component_count);
  auto dex_fds = bcp_index + component_count < boot_class_path_fds_.size() ?
