 ...
 public:
  ...
  static void RemoveInternTableDuplicates(
    ...
    if (old_interns.Size() != 0u) {
      ...
      InternTable::RemoveDuplicates(old_set, new_set, intern_remap);
    }
  }
  ...
  static void RemoveInternTableDuplicates(
    ...
    if (new_interns.Size() != 0u) {
      ...
      for (const auto& old_space : old_spaces) {
        RemoveInternTableDuplicates(*old_space, &new_set, intern_remap);
      }
    }
  }
