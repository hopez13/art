...
class RegionSpace final : public ContinuousMemMapAllocSpace {
 public:
  ...
  bool IsInNewlyAllocatedRegionForIdx(size_t idx, mirror::Object* ref) const
      NO_THREAD_SAFETY_ANALYSIS {
    DCHECK(HasAddress(ref));
    DCHECK_LT(idx, num_regions_);
    DCHECK_EQ(idx, RegionIdxForRefUnsafe(ref));
  ...
  size_t RegionIdxForRefUnsafe(mirror::Object* ref) const NO_THREAD_SAFETY_ANALYSIS {
  ...
  size_t RegionIdxForRef(mirror::Object* ref) const NO_THREAD_SAFETY_ANALYSIS {
    if (HasAddress(ref)) {
      return RegionIdxForRefUnsafe(ref);
    } else {
