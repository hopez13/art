...
extern "C" void DlmallocBytesAllocatedCallback(void* start [[maybe_unused]],
                                               void* end [[maybe_unused]],
                                               size_t used_bytes,
                                               void* arg) {
  if (used_bytes == 0) {
    return;
...
extern "C" void DlmallocObjectsAllocatedCallback(void* start [[maybe_unused]],
                                                 void* end [[maybe_unused]],
                                                 size_t used_bytes,
                                                 void* arg) {
  if (used_bytes == 0) {
