...
void Heap::InitPerfettoJavaHeapProf() {
  ...
  AHeapInfo_setEnabledCallback(info, &EnableHeapSamplerCallback, &prof_heap_sampler);
  // Set the Disable Callback.
  AHeapInfo_setDisabledCallback(info, &DisableHeapSamplerCallback, &prof_heap_sampler);
