...
Heap::Heap(size_t initial_size,
  ...
  if (kUseReadBarrier) {
    CHECK_EQ(foreground_collector_type_, kCollectorTypeCC) << foreground_collector_type_;
    CHECK_EQ(background_collector_type_, kCollectorTypeCCBackground) << background_collector_type_;
  }
