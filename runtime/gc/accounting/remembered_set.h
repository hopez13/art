...
class RememberedSetObjectVisitor {
 public:
  RememberedSetObjectVisitor() : collector_(nullptr), target_space_(nullptr), contains_reference_to_target_space_(nullptr) { }
  ...
  inline virtual void operator()(ObjPtr<mirror::Object> obj) const REQUIRES(Locks::heap_bitmap_lock_)
  ...
  inline bool ContainsRefToTargetSpace() const { return contains_reference_to_target_space_; }
