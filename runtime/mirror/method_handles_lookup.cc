...
MethodHandlesLookup* MethodHandlesLookup::GetDefault(Thread* const self) {
  ...
  return ObjPtr<MethodHandlesLookup>::DownCast(ObjPtr<Object>(result.GetL())).Ptr();
}

mirror::MethodHandle* MethodHandlesLookup::FindConstructor(Thread* const self,
                                                           Handle<Class> klass,
  ...
  return ObjPtr<MethodHandle>::DownCast(ObjPtr<Object>(result.GetL())).Ptr();
}
