...
inline bool Object::CasFieldWeakRelaxed32(MemberOffset field_offset,
  ...
  return atomic_addr->compare_exchange_weak(old_value, new_value, std::memory_order_relaxed);
}
...
inline bool Object::CasFieldStrongRelaxedObjectWithoutWriteBarrier(
  ...
  bool success = atomic_addr->compare_exchange_strong(old_ref, new_ref, std::memory_order_relaxed);
  return success;
}
...
inline bool Object::CasFieldStrongReleaseObjectWithoutWriteBarrier(
  ...
  bool success = atomic_addr->compare_exchange_strong(old_ref, new_ref, std::memory_order_release);
  return success;
}
