...
inline ObjPtr<Object> Object::CompareAndExchangeFieldObject(MemberOffset field_offset,
  ...
  if (kIsDebugBuild) {
    // The caller should have done read barrier on the reference at
    // field_offset to ensure it is a to-space reference.
...
inline ObjPtr<Object> Object::ExchangeFieldObject(MemberOffset field_offset,
  ...
  if (kIsDebugBuild) {
    // The caller should have done read barrier on the reference at
    // field_offset to ensure it is in the to-space.
