...
inline bool Object::CasFieldWeakSequentiallyConsistent32(MemberOffset field_offset,
  ...
  return atomic_addr->compare_exchange_weak(old_value, new_value, std::memory_order_seq_cst);
}
...
inline bool Object::CasFieldWeakAcquire32(MemberOffset field_offset,
  ...
  return atomic_addr->compare_exchange_weak(old_value, new_value, std::memory_order_acquire);
}
...
inline bool Object::CasFieldWeakRelease32(MemberOffset field_offset,
  ...
  return atomic_addr->compare_exchange_weak(old_value, new_value, std::memory_order_release);
}
...
inline bool Object::CasFieldStrongSequentiallyConsistent32(MemberOffset field_offset,
  ...
  return atomic_addr->compare_exchange_strong(old_value, new_value, std::memory_order_seq_cst);
}
...
inline bool Object::CasFieldWeakSequentiallyConsistentObjectWithoutWriteBarrier(
  ...
  bool success = atomic_addr->compare_exchange_weak(old_ref, new_ref, std::memory_order_seq_cst);
  return success;
}
...
inline bool Object::CasFieldWeakRelaxedObjectWithoutWriteBarrier(
  ...
  bool success = atomic_addr->compare_exchange_weak(old_ref, new_ref, std::memory_order_relaxed);
  return success;
}
...
inline bool Object::CasFieldWeakReleaseObjectWithoutWriteBarrier(
  ...
  bool success = atomic_addr->compare_exchange_weak(old_ref, new_ref, std::memory_order_release);
  return success;
}
