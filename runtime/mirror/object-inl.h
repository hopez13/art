...
inline size_t Object::SizeOf() {
  ...
  DCHECK_GE(result, sizeof(Object)) << " class="
      ...
      // reference read from a constant reference field. See ReadBarrierOption. And, for
      // correctness, we actually have to avoid the read barrier here if Object::SizeOf()
      // is called on a from-space reference.
