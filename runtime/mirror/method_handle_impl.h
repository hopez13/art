...
#ifndef ART_RUNTIME_MIRROR_METHOD_HANDLE_H_
#define ART_RUNTIME_MIRROR_METHOD_HANDLE_H_
...
class MANAGED MethodHandle : public Object {
 public:
  ...
  static MemberOffset HandleTypeOffset() {
    return MemberOffset(OFFSETOF_MEMBER(MethodHandle, handle_type_));
  }
...
class MANAGED MethodHandleImpl : public MethodHandle {
 public:
  ...
  ArtMethod* GetTargetMethod() {
    return reinterpret_cast<ArtMethod*>(art_field_or_method_);
  }
...
#endif  // ART_RUNTIME_MIRROR_METHOD_HANDLE_H_
