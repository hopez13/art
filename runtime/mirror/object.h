...
class MANAGED LOCKABLE Object {
 public:
  ...
  // class.  This are used by VarHandle accessor methods to access fields with a wider range of
  ...
  // Updates method that expose the raw address of a value-type to an
