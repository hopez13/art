...
void DexCache::Init(const DexFile* dex_file,
  ...
  CHECK_EQ(num_resolved_methodtypes != 0u, resolved_methodtypes != nullptr);
  ...
  SetResolvedMethodtypes(resolved_methodtypes);
  ...
  SetField32<false>(NumResolvedMethodtypesOffset(), num_resolved_methodtypes);
