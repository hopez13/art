...
DexCache::ConversionPair64 DexCache::AtomicRelaxedLoad16B(std::atomic<ConversionPair64>* target) {
...
void DexCache::AtomicRelaxedStore16B(std::atomic<ConversionPair64>* target,
