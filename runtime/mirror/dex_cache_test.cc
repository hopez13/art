...
TEST_F(DexCacheTest, Open) {
  ...
  EXPECT_EQ(0u, dex_cache->ResolvedStrings().Size());
  EXPECT_EQ(0u, dex_cache->ResolvedTypes().Size());
  EXPECT_EQ(0u, dex_cache->ResolvedMethods().Size());
  EXPECT_EQ(0u, dex_cache->ResolvedFields().Size());
  EXPECT_EQ(0u, dex_cache->ResolvedMethodTypes().Size());
}
