...
inline ObjPtr<mirror::MethodType> MethodHandle::GetMethodType() REQUIRES_SHARED(Locks::mutator_lock_) {
  return GetFieldObject<mirror::MethodType>(OFFSET_OF_OBJECT_MEMBER(MethodHandle, method_type_));
}

inline ObjPtr<mirror::MethodHandle> MethodHandle::GetAsTypeCache() REQUIRES_SHARED(Locks::mutator_lock_) {
