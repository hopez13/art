...
class MANAGED Detour : public Object {
 ...
 private:
  static GcRoot<Class> static_class_;   // java.lang.reflect.Detour.class.
  static GcRoot<Class> array_class_;    // [java.lang.reflect.Detour.class.
