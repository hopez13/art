...
inline String* DexCache::GetResolvedString(dex::StringIndex string_idx) {
  ...
  return GetStrings()[slot_idx].load(
...
inline Class* DexCache::GetResolvedType(dex::TypeIndex type_idx) {
  ...
  return GetResolvedTypes()[slot_idx].load(
...
inline void DexCache::SetResolvedType(dex::TypeIndex type_idx, ObjPtr<Class> resolved) {
  ...
  // See b/32075261.
  GetResolvedTypes()[slot_idx].store(
...
inline MethodType* DexCache::GetResolvedMethodType(uint32_t proto_idx) {
  ...
  return GetResolvedMethodTypes()[slot_idx].load(
...
inline void DexCache::SetResolvedMethodType(uint32_t proto_idx, MethodType* resolved) {
  ...
  DCHECK_LT(slot_idx, NumResolvedMethodTypes());
  DCHECK(Runtime::Current()->IsMethodHandlesEnabled());
  GetResolvedMethodTypes()[slot_idx].store(
