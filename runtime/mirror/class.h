...
class MANAGED Class FINAL : public Object {
 ...
 private:
  ...
  // Aligned object size for allocation fast path. The value is kMaxTLABSize + 1 if the object
  // is uninitialized or finalizable. Not currently used for variable sized objects.
