...
class MANAGED Class FINAL : public Object {
 public:
  ...
  void SetObjectSizeAllocFastPath(uint32_t new_object_size) SHARED_REQUIRES(Locks::mutator_lock_);
 ...
 private:
  ...
  // Total aligned object size for allocation fast path. The value is  max tlab size if the object
  // is uninitialized or finalizable, object size aligned to the allocator alignment otherwise.
