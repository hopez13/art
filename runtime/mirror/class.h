...
class MANAGED Class FINAL : public Object {
 ...
 private:
  ...
  // Extraneous class data that is not always needed. This field is allocated dynamically and may
  // only be set with 'this' locked. This is syncronized on 'this'.
  // TODO We should probably syncronize it on something external to prevent possible deadlocks.
