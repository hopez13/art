...
class MANAGED ClassExt : public Object {
 public:
  ...
  void SetErroneousStateError(ObjPtr<Object> obj) REQUIRES_SHARED(Locks::mutator_lock_);

  ObjPtr<Object> GetErroneousStateError() REQUIRES_SHARED(Locks::mutator_lock_);
 ...
 private:
  ...
  HeapReference<Object> erroneous_state_error_;
