...
class MANAGED CallSite : public Object {
 public:
  static mirror::CallSite* Create(Thread* const self,
                                  Handle<MethodHandleImpl> method_handle)
  ...
  MethodHandleImpl* GetTarget() REQUIRES_SHARED(Locks::mutator_lock_) {
    return GetFieldObject<MethodHandleImpl>(TargetOffset());
  }
 ...
 private:
  ...
  HeapReference<mirror::MethodHandleImpl> target_;
