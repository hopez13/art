...
// We're using a `VariableSizedHandleScope` as a raw method type without allocating a managed
// object.  It must contain the return type followed by argument types an no other handles.
