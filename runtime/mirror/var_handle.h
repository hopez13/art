...
class MANAGED VarHandle : public Object {
 public:
  ...
  MatchKind GetMethodTypeMatchForAccessMode(AccessMode access_mode, Handle<MethodType> method_type)
        REQUIRES_SHARED(Locks::mutator_lock_);
  MatchKind GetMethodTypeMatchForAccessMode(AccessMode access_mode,
  ...
  void GetMethodTypeForAccessMode(AccessMode access_mode, VariableSizedHandleScope* method_type)
      REQUIRES_SHARED(Locks::mutator_lock_);
