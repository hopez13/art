...
ObjPtr<Class> Class::GetDirectInterface(Thread* self,
  ...
  if (klass->IsArrayClass()) {
    ...
    ObjectArray<Class>* interfaces = klass.Get()->GetInterfaces();
...
class CopyClassVisitor {
 public:
  ...
  void operator()(ObjPtr<Object> obj, size_t usable_size ATTRIBUTE_UNUSED) const
    ...
    Handle<Class> h_new_class_obj(hs.NewHandle(obj->AsClass()));
    Object::CopyObject(self_, h_new_class_obj.Get(), orig_->Get(), copy_bytes_);
    ...
    // roots.
    static_cast<ObjPtr<Object>>(h_new_class_obj.Get())->VisitReferences(
