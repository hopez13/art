...
template <typename SignatureType>
static inline ArtMethod* FindInstanceMethodWithSignature(ObjPtr<Class> this_klass,
                                                         const StringPiece& name,
                                                         const SignatureType& signature,
                                                         PointerSize pointer_size)
    REQUIRES_SHARED(Locks::mutator_lock_) {
...
ArtMethod* Class::FindInstanceMethod(const StringPiece& name,
                                     const StringPiece& signature,
                                     PointerSize pointer_size) {
  return FindInstanceMethodWithSignature(this, name, signature, pointer_size);
}
...
ArtMethod* Class::FindInstanceMethod(ObjPtr<DexCache> dex_cache,
                                     uint32_t dex_method_idx,
                                     PointerSize pointer_size) {
