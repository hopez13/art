...
inline bool Class::IsClassClass() {
  // Compare whether the `klass_` field points to itself. This happens only for j.l.Class.class .
  // OK to look at from-space copies since java.lang.Class.class is not movable. See b/114413743
  return this == GetClass<kVerifyFlags, kWithoutReadBarrier>();
