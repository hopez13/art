...
TEST_F(HiddenApiTest, CheckGetActionFromRuntimeFlags) {
  ...
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxP()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxO()), false);
  ...
  runtime_->SetTargetSdkVersion(hiddenapi::ApiList::BlacklistMaxO().GetMaxAllowedSdkVersion());
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Whitelist()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Greylist()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxP()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxO()), false);
  ...
  runtime_->SetHiddenApiEnforcementPolicy(hiddenapi::EnforcementPolicy::kEnabled);
  runtime_->SetTargetSdkVersion(hiddenapi::ApiList::BlacklistMaxO().GetMaxAllowedSdkVersion() + 1);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Whitelist()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Greylist()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxP()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxO()), true);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Blacklist()), true);

  runtime_->SetHiddenApiEnforcementPolicy(hiddenapi::EnforcementPolicy::kEnabled);
  runtime_->SetTargetSdkVersion(hiddenapi::ApiList::BlacklistMaxP().GetMaxAllowedSdkVersion() + 1);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Whitelist()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Greylist()), false);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxP()), true);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::BlacklistMaxO()), true);
  ASSERT_EQ(ShouldDenyAccess(hiddenapi::ApiList::Blacklist()), true);
}
