...
TEST_F(HiddenApiTest, DexDomain_DataDir) {
  ...
  bool success = LoadDexFiles(data_location_path, soa, &dex_files, &class_loader, &error_msg);
...
TEST_F(HiddenApiTest, DexDomain_SystemDir) {
  ...
  bool success = LoadDexFiles(system_location_path, soa, &dex_files, &class_loader, &error_msg);
  ASSERT_TRUE(success) << error_msg;
  ASSERT_GE(dex_files.size(), 1u);
  ASSERT_TRUE(CheckAllDexFilesInDomain(soa.Decode<mirror::ClassLoader>(class_loader),
                                       dex_files,
...
TEST_F(HiddenApiTest, DexDomain_SystemFrameworkDir) {
  ...
  bool success =
      LoadDexFiles(system_framework_location_path, soa, &dex_files, &class_loader, &error_msg);
  ASSERT_TRUE(success) << error_msg;
  ASSERT_GE(dex_files.size(), 1u);
  ASSERT_TRUE(CheckAllDexFilesInDomain(soa.Decode<mirror::ClassLoader>(class_loader),
                                       dex_files,
...
TEST_F(HiddenApiTest, DexDomain_DataDir_MultiDex) {
  ...
  bool success = LoadDexFiles(data_multi_location_path, soa, &dex_files, &class_loader, &error_msg);
  ASSERT_TRUE(success) << error_msg;
  ASSERT_GE(dex_files.size(), 1u);
  ASSERT_TRUE(CheckAllDexFilesInDomain(soa.Decode<mirror::ClassLoader>(class_loader),
                                       dex_files,
...
TEST_F(HiddenApiTest, DexDomain_SystemDir_MultiDex) {
  ...
  bool success =
      LoadDexFiles(system_multi_location_path, soa, &dex_files, &class_loader, &error_msg);
  ASSERT_TRUE(success) << error_msg;
