...
TEST_F(HiddenApiTest, DexDomain_SystemDir) {
  ...
  ASSERT_TRUE(CheckAllDexFilesInDomain(class_loader,
                                       dex_files,
                                       // Some buildbots set /system to be the runtime module root
                                       LocationIsOnRuntimeModule(system_location_path.c_str())
...
TEST_F(HiddenApiTest, DexDomain_SystemDir_MultiDex) {
  ...
  ASSERT_TRUE(CheckAllDexFilesInDomain(class_loader,
                                       dex_files,
                                       // Some buildbots set /system to be the runtime module root
                                       LocationIsOnRuntimeModule(system_multi_location_path.c_str())
                                          ? hiddenapi::Domain::kCorePlatform
                                          : hiddenapi::Domain::kApplication,
                                       &error_msg)) << error_msg;
