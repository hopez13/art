...
class IndirectReferenceTable {
 public:
  ...
  // Constructs an unitialized indirect reference table. Use `Initialize()` to initialize it.
  explicit IndirectReferenceTable(IndirectRefKind kind, ResizableCapacity resizable);
