...
template <bool is_range>
static inline bool MethodHandleInvoke0(Thread* self,
                                       ShadowFrame& shadow_frame,
                                       Handle<mirror::MethodHandle> method_handle,
                                       Handle<mirror::MethodType> callsite_type,
                                       const uint32_t (&args)[Instruction::kMaxVarArgRegs],
...
template <bool is_range>
static inline bool MethodHandleInvokeExact0(Thread* self,
                                            ShadowFrame& shadow_frame,
                                            Handle<mirror::MethodHandle> method_handle,
                                            Handle<mirror::MethodType> callsite_type,
                                            const uint32_t (&args)[Instruction::kMaxVarArgRegs],
...
inline bool MethodHandleInvoke(Thread* self,
  ...
  if (UNLIKELY(callsite_type->IsExactMatch(method_handle->GetMethodType()))) {
    ...
    return MethodHandleInvokeExact0<is_range>(self,
                                              shadow_frame,
                                              method_handle,
                                              callsite_type,
                                              args,
    ...
    return MethodHandleInvoke0<is_range>(self,
                                         shadow_frame,
                                         method_handle,
                                         callsite_type,
                                         args,
