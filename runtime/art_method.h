...
class ArtMethod FINAL {
 public:
  ...
  bool IsAnnotatedWithFastNative(bool lookup_in_resolved_boot_classes = false);
  ...
  bool IsAnnotatedWithCriticalNative(bool lookup_in_resolved_boot_classes = false);
