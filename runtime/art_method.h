...
class ArtMethod FINAL {
 public:
  ...
  // As imgdiag does not support mixing instruction sets (e.g., using imgdiag32 to
  // inspect 64-bit images, etc.), we can go beneath the accessors directly to
  // the class members.
  ...
  void VisitMembers(VisitorFunc& visitor) {
    ...
    visitor(this, &ptr_sized_fields_.entry_point_from_quick_compiled_code_,
