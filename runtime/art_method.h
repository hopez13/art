...
class ArtMethod final {
 public:
  ...
  static bool IsCriticalNative(uint32_t access_flags [[maybe_unused]]) {
#ifdef ART_USE_RESTRICTED_MODE
    // Return false to treat all critical native methods as normal native methods instead, i.e: will
    // use the generic JNI trampoline instead.
