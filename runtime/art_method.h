...
class ArtMethod final {
 public:
  ...
  // it isn't equal to GetDexFile->IsCompactDexFile().
  void SetCodeItem(const dex::CodeItem* code_item, bool is_compact_dex_code_item) REQUIRES_SHARED(Locks::mutator_lock_);
