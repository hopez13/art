...
//     // Ensure klass has a ClassExt
//     // TODO This can be delayed until we know if one is needed.
//     // TODO Preallocate the map arrays (we will free/shorten them as needed later).
//     klass->EnsureExtDataPresent(self);

//     self->TransitionFromRunnableToSuspended(old_state);

//     // Stop all threads.
//     // TODO Do this manually for lock tracking reasons.
