...
#undef ERROR_CASE
 ...
 private:
  static jvmtiError GetTransformationData(ArtJvmTiEnv* env,
    ...
    *name = hs_klass->GetName()->ToModifiedUtf8();
  ...
  static jvmtiError MoveTransformedFileIntoRuntime(ArtJvmTiEnv* env,
    ...
    CHECK(new_dex_file.get() != nullptr) << "Unable to load dex file! " << error_msg;
    {
      ...
      art::ArtField* dex_file_cookie_field =
      ...
      art::Handle<art::mirror::Object> dex_file_obj(
          hs.NewHandle(FindDalvikSystemDexFileForClass(jni_env, klass)));
      ...
      art::Handle<art::mirror::LongArray> art_dex_array(
          hs.NewHandle(dex_file_cookie_field->GetObject(dex_file_obj.Get())->AsLongArray()));
      art::Handle<art::mirror::LongArray> new_art_dex_array(
          hs.NewHandle(InsertDexFileIntoArray(self, new_dex_file.get(), art_dex_array)));
      ...
      InvalidateExistingMethods(self, klass, new_dex_file.get());
      ...
      // TODO MASSIVE: don't do this goto error thing;
      threads->ResumeAll();
    }
    return OK;
  }
  ...
  static void InvalidateExistingMethods(art::Thread* self,
    ...
    art::Handle<art::mirror::DexCache> cache(
        hs.NewHandle(AllocateDexCache(self, *dex_file, runtime->GetLinearAlloc())));
  ...
  static art::mirror::Object* FindDalvikSystemDexFileForClass(
      JNIEnv* jni_env, art::Handle<art::mirror::Class>& klass) {
    ...
    art::ArtField* dex_path_list_element_field =
        class_linker->FindClass(self, dex_path_list_name, null_loader)
          ->FindDeclaredInstanceField("dexElements", dex_path_list_element_name);
    ...
    art::Handle<art::mirror::Object> path_list(
        hs.NewHandle(path_list_field->GetObject(loader_class.Get())));
    CHECK(path_list.Get() != nullptr);
    CHECK(!self->IsExceptionPending());
    art::Handle<art::mirror::ObjectArray<art::mirror::Object>> dex_elements_list(
        hs.NewHandle(reinterpret_cast<art::mirror::ObjectArray<art::mirror::Object>*>(
    ...
    for (size_t i = 0; i < num_elements; i++) {
      current_element.Assign(dex_elements_list->GetWithoutChecks(i));
...
const jvmtiInterface_1 gJvmtiInterface = {
  ...
  reinterpret_cast<void*>(JvmtiFunctions::RetransformClassesWithHook),
  // nullptr,  // reserved1
