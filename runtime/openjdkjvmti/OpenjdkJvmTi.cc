...
class JvmtiFunctions {
 ...
 public:
  ...
  static jvmtiError GetTag(jvmtiEnv* env, jobject object, jlong* tag_ptr) {
    ...
    art::mirror::Object* obj = soa.Decode<art::mirror::Object*>(object);
    if (!gObjectTagTable.GetTag(obj, tag_ptr)) {
      *tag_ptr = 0;
    }
  ...
  static jvmtiError SetTag(jvmtiEnv* env, jobject object, jlong tag) {
    ...
    art::mirror::Object* obj = soa.Decode<art::mirror::Object*>(object);
    if (tag == 0) {
      gObjectTagTable.Remove(obj, /* tag* */ nullptr);
    } else {
      gObjectTagTable.Add(obj, tag);
    }
