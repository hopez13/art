...
void Redefiner::RestoreObsoleteMethodMaps(RedefinitionDataHolder& holder) {
  for (RedefinitionDataIter data = holder.begin(); data != holder.end(); ++data) {
    data.GetRedefinition().RestoreObsoleteMethodMaps(&data);
  }
}
...
jvmtiError Redefiner::Run() {
  ...
  RestoreObsoleteMethodMaps(holder);
...
// obsolete methods).
void Redefiner::ClassRedefinition::RestoreObsoleteMethodMaps(const RedefinitionDataIter* cur_data) {
