...
class ClassLoaderHelper {
 public:
  ...
  // Finds the java.lang.DexFile object that is associated with the given ClassLoader. Each of these
  ...
  static art::mirror::Object* FindSourceDexFileObject(art::Thread* self,
                                                      art::Handle<art::mirror::ClassLoader> loader)
      REQUIRES_SHARED(art::Locks::mutator_lock_);

  static art::mirror::LongArray* AllocateNewDexFileCookie(
    art::Thread* self,
    art::Handle<art::mirror::Object> java_dex_file,
    const art::DexFile* new_dex_file)
      REQUIRES_SHARED(art::Locks::mutator_lock_);
