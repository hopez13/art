...
struct ArtJvmTiEnv : public jvmtiEnv {
  ...
  // TODO It might be good to emulate the RI and only let one jvmtiEnv ever have the watch caps so
  // we can record this on the field directly.
  ...
  bool access_watch_all_fields;
  bool modify_watch_all_fields;
