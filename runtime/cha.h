 ...
 * will devirtualize the virtual call for method A into a direct call, and
 ...
 * status need to be invalidated. Method entrypoint will be updated as a
 * result. Method A can later be recompiled with less aggressive assumptions.
 *
 ...
 *
 * A cha_lock_ needs to be taken for updating single-implementation status,
...
class ClassHierarchyAnalysis {
 public:
  ...
  // Remove from cha_dependency_map_ all entries that contains any method header
  // in method_headers.
