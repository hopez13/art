...
class Transaction final {
 public:
  ...
  // used to copy old data to a newly allocated array, and for `filled-new-array/-range`.
 ...
 private:
  ...
  mirror::Class* root_;
  mirror::Object* last_allocated_object_;  // To reduce the number of kept records.
