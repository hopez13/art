...
static constexpr uint32_t kAccHiddenField =           0x0020;  // field
static constexpr uint32_t kAccHiddenMethod =          0x0020;  // method (not native)
static constexpr uint32_t kAccVolatile =              0x0040;  // field
static constexpr uint32_t kAccBridge =                0x0040;  // method (1.5)
static constexpr uint32_t kAccHiddenClass =           0x0040;  // class,, ic
...
static constexpr uint32_t kAccHiddenNativeMethod =    0x0200;  // method (only native)
