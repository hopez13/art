...
struct SubtypeCheckInfo {
  ...
  static SubtypeCheckInfo Infuse(SubtypeCheckBits compressed_value, size_t depth) {
    SubtypeCheckInfo io;
    io.depth_ = depth;
  ...
  SubtypeCheckInfo NewForChild(bool assign_next) {
    ...
    auto OverwriteNextValueFromParent = [&](/*inout*/SubtypeCheckInfo* child, BitStringChar value) {
      if (HasNext()) {
