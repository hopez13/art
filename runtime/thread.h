...
class Thread {
 public:
  ...
  // thread notices the suspension request. This will return true if the closure was added and
  // will (eventually) be executed. It returns false otherwise.
  //
 ...
 public:
  ...
  // TODO: Make this work as described here. Client code currently just looks at the thread
  // flags directly to determine whether we should suspend, so this call is currently
  // unnecessary.
  void TriggerSuspend() {
