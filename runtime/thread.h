...
class Thread {
 ...
 public:
  ...
  Mutex* GetInstrumentationInstallIdMutex() const LOCK_RETURNED(instrumentation_install_id_mutex_) {
    return instrumentation_install_id_mutex_;
  }
  uint64_t GetInstrumentationInstallId() const REQUIRES(instrumentation_install_id_mutex_) {
    return instrumentation_install_id_;
  }
  void IncrementInstrumentationInstallId() REQUIRES(instrumentation_install_id_mutex_) {
    ++instrumentation_install_id_;
  }
 ...
 private:
  ...
  Mutex* instrumentation_install_id_mutex_ BOTTOM_MUTEX_ACQUIRED_AFTER;
  uint64_t instrumentation_install_id_ GUARDED_BY(instrumentation_install_id_mutex_);
