...
class Thread {
 ...
 private:
  ...
  // Mutex used to guard accesses to custom_tls_. We use this to allow the TLS of other threads to
  // be read (the reader must hold the ThreadListLock or have some other way of ensuring the thread
