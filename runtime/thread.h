...
class Thread {
 public:
  ...
  // Find catch block and prepare the long jump context to jump to appropriate exception handle
  // afterwards.
  void QuickDeliverException() REQUIRES_SHARED(Locks::mutator_lock_);
