...
class Thread {
 public:
  ...
  // thread notices the request, normally as a result of executing a suspend point check. This
  // returns true if the closure was added and will (eventually) be executed. It returns false
  // otherwise.
  //
