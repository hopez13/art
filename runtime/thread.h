...
class Thread {
 public:
  ...
  // it, the calling thread shall run the flip function. If successful, notify other
  // threads that may have tried to do that concurrently. After this function returns,
  // the `ThreadFlag::kPendingFlipFunction` is cleared but another thread may still
