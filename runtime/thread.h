...
class Thread {
 public:
  ...
  // Try to run the thread flip function. If successful, notify other threads that
  // may have tried to do that concurrently. After this function returns, the
  ...
  void TryToRunFlipFunction(Thread* self) REQUIRES_SHARED(Locks::mutator_lock_);
