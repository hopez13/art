...
void Instrumentation::PushInstrumentationStackFrame(Thread* self, mirror::Object* this_object,
  ...
  if (!interpreter_entry) {
    MethodEnterEvent(self, thiz.Get(), method, 0);
    if (self->IsExceptionPending()) {
      MethodUnwindEvent(self, thiz.Get(), method, 0);
      return;
    }
  }
  ...
  instrumentation::InstrumentationStackFrame instrumentation_frame(thiz.Get(), method, lr,
