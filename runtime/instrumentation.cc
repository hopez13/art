...
void Instrumentation::UpdateNativeMethodsCodeToJitCode(ArtMethod* method, const void* quick_code) {
  // We don't do any read barrier in this code, as the JIT might call this method on a soon-to-be
  // deleted ArtMethod. Updating the entrypoint is OK though, as the ArtMethod is still in memory.
