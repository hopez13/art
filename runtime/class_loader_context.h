...
class ClassLoaderContext {
 public:
  ...
  // If the context is empty, the method's default is to create a single PathClassLoader with the
  ...
  // Return true if the format matches, or false otherwise. If the return is true, the out
 ...
 private:
  ...
  const char* GetClassLoaderTypeName(ClassLoaderType type) const;
