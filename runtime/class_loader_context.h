...
class ClassLoaderContext {
 public:
  ...
  //
  // For example: if the context was build from the spec
  ...
  //
  // The spec represents a class loader chain with the natural interpretation with respect to the
  // parents: ClassLoader1 has ClassLoader2 as parent which has ClassLoader3 as a parent and so on.
