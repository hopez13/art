...
class Runtime {
 public:
  ...
  void EnableHiddenApiAccessChecks(bool value) {
    hidden_api_access_checks_ = value;
  }

  bool AreHiddenApiAccessChecksEnabled() const {
    return hidden_api_access_checks_;
  }
 ...
 private:
  ...
  bool hidden_api_access_checks_;
