...
class Runtime {
 public:
  ...
  void SetDedupHiddenApiWarnings(bool value) {
    dedup_hidden_api_warnings_ = value;
  }

  bool ShouldDedupHiddenApiWarnings() {
    return dedup_hidden_api_warnings_;
  }
 ...
 private:
  ...
  bool dedup_hidden_api_warnings_;
