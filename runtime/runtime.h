...
class Runtime {
 public:
  ...
  enum class RuntimeDebugState {
    ...
    kJavaDebuggable,
    // The runtime was started as a debuggable runtime. This allows us to support extended set of
    // debug features (for ex: redefinition). We never transition out of this state.
