...
class Runtime {
 public:
  ...
  //
  // This must be called whever there is significant event that
  // forces us to use different interpreter (e.g. debugger is attached).
  //
  ...
  // it make it possible to DCHECK that thread local flag is correct.
