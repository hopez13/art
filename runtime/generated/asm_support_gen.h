...
DEFINE_CHECK_EQ(static_cast<int32_t>(RESOLVE_STRING_DEX_CACHE_TWO_MULTIPLE), (static_cast<int32_t>(art::WhichPowerOf2(sizeof(art::mirror::StringDexCachePair)))))
#define RESOLVED_STRING_DEX_CACHE_SIZE 1023
DEFINE_CHECK_EQ(static_cast<int32_t>(RESOLVED_STRING_DEX_CACHE_SIZE), (static_cast<int32_t>(art::mirror::DexCache::kDexCacheStringCacheSize - 1)))
