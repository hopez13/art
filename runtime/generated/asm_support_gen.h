...
#define OBJECT_INT_LENGTH 0x20
DEFINE_CHECK_EQ(static_cast<uint32_t>(OBJECT_INT_LENGTH), (static_cast<uint32_t>(32)))
#define OBJECT_ZERO 0
DEFINE_CHECK_EQ(static_cast<uint32_t>(OBJECT_ZERO), (static_cast<uint32_t>(0)))
