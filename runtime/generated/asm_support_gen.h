...
#define STRING_DEX_CACHE_ELEMENT_SHIFT 3
DEFINE_CHECK_EQ(static_cast<int32_t>(STRING_DEX_CACHE_ELEMENT_SHIFT), (static_cast<int32_t>(art::WhichPowerOf2(sizeof(art::mirror::StringDexCachePair)))))
...
#define STRING_DEX_CACHE_LEAST_SIG_BIT_MINUS_ONE 10
DEFINE_CHECK_EQ(static_cast<int32_t>(STRING_DEX_CACHE_LEAST_SIG_BIT_MINUS_ONE), (static_cast<int32_t>(art::LeastSignificantBit(art::mirror::DexCache::kDexCacheStringCacheSize))))
