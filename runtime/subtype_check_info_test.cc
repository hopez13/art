...
struct SubtypeCheckInfoTest : public ::testing::Test {
 protected:
  ...
  static SubtypeCheckInfo MakeSubtypeCheckInfoInfused(BitString bs = {},
    ...
    return SubtypeCheckInfo::Infuse(iod, depth);
  }
...
TEST_F(SubtypeCheckInfoTest, NewForRoot) {
  SubtypeCheckInfo io = SubtypeCheckInfo::NewForRoot();
...
TEST_F(SubtypeCheckInfoTest, CopyCleared) {
  SubtypeCheckInfo root = SubtypeCheckInfo::NewForRoot();
  EXPECT_EQ(MakeBitStringChar(1u), root.GetNext());

  SubtypeCheckInfo childC = root.NewForChild(/*assign*/true);
  ...
  SubtypeCheckInfo cleared_copy = childC.CopyCleared();
  ...
  SubtypeCheckInfo cleared_copy_value = SubtypeCheckInfo::Infuse(SubtypeCheckBits{}, /*depth*/1u);
...
TEST_F(SubtypeCheckInfoTest, NewForChild) {
  ...
  SubtypeCheckInfo childA = root.NewForChild(/*assign*/false);
  ...
  SubtypeCheckInfo childB = root.NewForChild(/*assign*/false);
...

  {
    ...
    SubtypeCheckInfo child_of_deep = latest_child.NewForChild(/*assign*/true);
    ...
    SubtypeCheckInfo child_of_deep_2 = child_of_deep.NewForChild(/*assign*/true);
...

  {
    ...
    while (true) {
      ...
      SubtypeCheckInfo child = root.NewForChild(/*assign*/true);
    ...
    SubtypeCheckInfo child = root.NewForChild(/*assign*/false);
    ...
    SubtypeCheckInfo child_of = root.NewForChild(/*assign*/true);
    ...
    SubtypeCheckInfo child_of2 = child_of.NewForChild(/*assign*/true);
