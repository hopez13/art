...
#ifndef ART_RUNTIME_INSTANCEOF_AND_STATUS_H_
#define ART_RUNTIME_INSTANCEOF_AND_STATUS_H_

#include "base/bit_struct.h"
#include "base/bit_utils.h"
#include "class_status.h"
#include "instanceof_bitstring.h"
 ...
 * MSB                                                LSB
 */
BITSTRUCT_DEFINE_START(InstanceOfData, /*size*/ BitString::BitStructSizeOf() + 1u)
  BitStructUint</*lsb*/0, /*width*/1> overflow_;
  BitStructField<BitString, /*lsb*/1> bitstring_;
BITSTRUCT_DEFINE_END(InstanceOfData);
 ...
 * Invariants:
 *
 *  AddressOf(ClassStatus) == AddressOf(InstanceOfAndStatus)
 *  sizeof(InstanceOfAndStatus) == 32
 *
...
BITSTRUCT_DEFINE_START(InstanceOfAndStatusNew, BitSizeOf<BitString::StorageType>())
  BitStructField<ClassStatus, /*lsb*/0, /*width*/kClassStatusBitSize> status_;
  BitStructField<InstanceOfData, /*lsb*/kClassStatusBitSize> instance_of_;
  BitStructInt</*lsb*/0, /*width*/BitSizeOf<BitString::StorageType>()> int32_alias_;
BITSTRUCT_DEFINE_END(InstanceOfAndStatusNew);

// Use the spare alignment from "ClassStatus" to store all the new InstanceOf data.
static_assert(sizeof(InstanceOfAndStatusNew) == sizeof(uint32_t),
              "All of InstanceOf+ClassStatus should fit into 4 bytes");

// TODO: rename to InstanceOfAndStatus.

}  // namespace art

#endif  // ART_RUNTIME_INSTANCEOF_AND_STATUS_H_
