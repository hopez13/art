...
#ifndef ART_RUNTIME_STREAM_ERROR_DELAYING_OUTPUT_STREAM_H_
#define ART_RUNTIME_STREAM_ERROR_DELAYING_OUTPUT_STREAM_H_
...
#endif  // ART_RUNTIME_STREAM_ERROR_DELAYING_OUTPUT_STREAM_H_
