...
CompatFramework::CompatFramework() : reported_compat_changes_lock_("reported compat changes lock") {}
...
void CompatFramework::ReportChange(uint64_t change_id, ChangeState state) {
  WriterMutexLock mu(Thread::Current(), reported_compat_changes_lock_);
