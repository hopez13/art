...
void Thread::InstallImplicitProtection() {
  ...
  //
  // Accesses too far below the current SP might cause a SIGSEGV (at least on x86 with newer
  // kernels). We thus have to move the stack pointer. We do this portably by using a recursive
  // function with a large stack frame size.
