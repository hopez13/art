...
void Thread::CreateNativeThread(JNIEnv* env, jobject java_peer, size_t stack_size, bool is_daemon) {
  ...
  if (VLOG_IS_ON(threads)) {
    ...
    ObjPtr<mirror::String> java_name =
        f->GetObject<mirror::String>(soa.Decode<mirror::Object>(java_peer));
...
mirror::String* Thread::GetThreadName(const ScopedObjectAccessAlreadyRunnable& soa) const {
  ...
  return f->GetObject<mirror::String>(tlsPtr_.opeer).Decode();
}
  ...
  if (gAborting == 0 && self != nullptr && thread != nullptr && thread->tlsPtr_.opeer != nullptr) {
    ...
    if (thread_group != nullptr) {
      ...
      ObjPtr<mirror::String> group_name_string =
          group_name_field->GetObject<mirror::String>(thread_group);
