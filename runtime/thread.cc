...
void Thread::QuickDeliverException(bool skip_method_exit_cb) {
  ...
  if (exception == GetDeoptimizationException()) {
    ...
    ClearException();
    artDeoptimize(this, skip_method_exit_cb);
    UNREACHABLE();
  }
  ...
  exception_handler.FindCatch(exception, skip_method_exit_cb);
