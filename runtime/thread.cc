...
extern "C" __attribute__((weak)) void *__hwasan_tag_pointer(const volatile void *p, unsigned char tag);
...
#pragma GCC diagnostic ignored "-Wframe-larger-than="
    ...
    __attribute__((no_sanitize("memtag"))) static void Touch(uintptr_t target) {
      ...
      uintptr_t addr = reinterpret_cast<uintptr_t>(__hwasan_tag_pointer ? __hwasan_tag_pointer(space, 0) : space);
