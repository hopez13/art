...
void Thread::HandleUncaughtExceptions() {
  ...
  ObjPtr<mirror::Object> peer = tlsPtr_.opeer;
  WellKnownClasses::java_lang_Thread_dispatchUncaughtException->InvokeVirtual<'V', 'L'>(
      self, peer, exception);
...
void Thread::RemoveFromThreadGroup() {
  ...
  if (group != nullptr) {
    WellKnownClasses::java_lang_ThreadGroup_removeThread->InvokeVirtual<'V', 'L'>(
