...
Thread::DumpOrder Thread::DumpJavaStack(std::ostream& os,
  ...
  dumper.WalkStack();
  return IsJitSensitiveThread() ? DumpOrder::kMain :  // The main/UI thread is marked with this flag.
      dumper.num_blocked ? DumpOrder::kBlocked :
      dumper.num_locked ? DumpOrder::kLocked : DumpOrder::kDefault;
}
