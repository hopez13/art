...
static void SetNativePeer(JNIEnv* env, jobject java_peer, Thread* thread) {
  ...
  SetNativePeer(soa.Decode<mirror::Object>(java_peer), thread);
}
...
void Thread::CreatePeer(const char* name, bool as_daemon, jobject thread_group) {
  ...
  ScopedObjectAccess soa(self);
  SetNativePeer(soa.Decode<mirror::Object>(peer.get()), self);
...
void Thread::Destroy() {
  ...
  if (tlsPtr_.opeer != nullptr) {
    ...
    // this.nativePeer = 0;
    SetNativePeer(tlsPtr_.opeer, nullptr);
