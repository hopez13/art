...
const int32_t kPermitAvailable = 0; // Incrementing consumes the permit
const int32_t kNoPermit = 1; // Incrementing marks as waiter waiting
const int32_t kNoPermitWaiterWaiting = 2;
