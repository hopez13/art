...
static void ReportInvalidJNINativeMethod(const ScopedObjectAccess& soa, mirror::Class* c,
    ...
    REQUIRES_SHARED(Locks::mutator_lock_) {
  LOG_S(return_errors ? ::android::base::ERROR : ::android::base::FATAL)
...
#define SET_STATIC_PRIMITIVE_FIELD(fn, value) \
  ...
  static jint RegisterNativeMethods(JNIEnv* env, jclass java_class, const JNINativeMethod* methods,
    ...
    for (jint i = 0; i < method_count; ++i) {
      ...
      if (m == nullptr) {
        LOG_S(return_errors ? ::android::base::ERROR : ::android::base::FATAL_WITHOUT_ABORT)
        ...
        c->DumpClass(
            ART_LOG_STREAM_S(return_errors ? ::android::base::ERROR : ::android::base::FATAL),
  ...
  static void ReleasePrimitiveArray(ScopedObjectAccess& soa, mirror::Array* array,
    ...
    if (is_copy) {
      ...
      if (mode != JNI_ABORT) {
        ...
        soa.Self()->DumpJavaStack(ART_LOG_STREAM(WARNING));
      }
    }
    if (mode != JNI_COMMIT) {
      if (is_copy) {
