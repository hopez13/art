...
static void ReportInvalidJNINativeMethod(const ScopedObjectAccess& soa, mirror::Class* c,
    ...
    REQUIRES_SHARED(Locks::mutator_lock_) {
  LOGS(return_errors ? ::android::base::ERROR : ::android::base::FATAL)
...
#define SET_STATIC_PRIMITIVE_FIELD(fn, value) \
  ...
  static jint RegisterNativeMethods(JNIEnv* env, jclass java_class, const JNINativeMethod* methods,
    ...
    for (jint i = 0; i < method_count; ++i) {
      ...
      if (m == nullptr) {
        LOGS(return_errors ? ::android::base::ERROR : ::android::base::FATAL_WITHOUT_ABORT)
        ...
        c->DumpClass(
            ART_LOGS_STREAM(return_errors ? ::android::base::ERROR : ::android::base::FATAL),
