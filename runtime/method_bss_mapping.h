...
struct MethodBssMappingEntryComparator {
  bool operator()(const MethodBssMappingEntry& lhs, const MethodBssMappingEntry& rhs) const {
    return lhs.method_index < rhs.method_index;
  }
};
