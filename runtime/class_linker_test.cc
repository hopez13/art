...
TEST_F(ClassLinkerTest, Interfaces) {
  ...
  ArtMethod* Ii = I->FindDirectOrVirtualMethod("i", void_sig, kRuntimePointerSize);
  ArtMethod* Jj1 = J->FindDirectOrVirtualMethod("j1", void_sig, kRuntimePointerSize);
  ArtMethod* Jj2 = J->FindDirectOrVirtualMethod("j2", void_sig, kRuntimePointerSize);
  ...
  ArtMethod* Ai = A->FindDirectOrVirtualMethod("i", void_sig, kRuntimePointerSize);
  ArtMethod* Aj1 = A->FindDirectOrVirtualMethod("j1", void_sig, kRuntimePointerSize);
  ArtMethod* Aj2 = A->FindDirectOrVirtualMethod("j2", void_sig, kRuntimePointerSize);
