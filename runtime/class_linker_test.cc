...
TEST_F(ClassLinkerTest, StaticFields) {
  ...
  ArtMethod* clinit = statics->FindInstanceMethod("<clinit>", "()V", kRuntimePointerSize);
...
TEST_F(ClassLinkerTest, Interfaces) {
  ...
  ArtMethod* Ii = I->FindInstanceMethod("i", void_sig, kRuntimePointerSize);
  ArtMethod* Jj1 = J->FindInstanceMethod("j1", void_sig, kRuntimePointerSize);
  ArtMethod* Jj2 = J->FindInstanceMethod("j2", void_sig, kRuntimePointerSize);
  ...
  ArtMethod* Ai = A->FindInstanceMethod("i", void_sig, kRuntimePointerSize);
  ArtMethod* Aj1 = A->FindInstanceMethod("j1", void_sig, kRuntimePointerSize);
  ArtMethod* Aj2 = A->FindInstanceMethod("j2", void_sig, kRuntimePointerSize);
...
TEST_F(ClassLinkerTest, ResolveVerifyAndClinit) {
  ...
  ArtMethod* getS0 =
      klass->FindInstanceMethod("getS0", "()Ljava/lang/Object;", kRuntimePointerSize);
...
TEST_F(ClassLinkerMethodHandlesTest, TestResolveMethodTypes) {
  ...
  ArtMethod* method1 = method_types->FindInstanceMethod(
      "method1",
  ...
  ArtMethod* method2 = method_types->FindInstanceMethod(
      "method2",
