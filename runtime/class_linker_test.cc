...
TEST_F(ClassLinkerMethodHandlesTest, TestResolveMethodTypes) {
  ...
  Handle<mirror::MethodType> method1_type = hs.NewHandle(
      class_linker_->ResolveMethodType(soa.Self(), method1_id.proto_idx_, dex_cache, class_loader, false));
  ...
  Handle<mirror::MethodType> method2_type = hs.NewHandle(
      class_linker_->ResolveMethodType(soa.Self(), method2_id.proto_idx_, dex_cache, class_loader, false));
...
TEST_F(ClassLinkerMethodHandlesTest, TestResolveMethodTypesCachedCallOverridesNonCachedInstance) {
  ...
  Handle<mirror::MethodType> method1_type_cached = hs.NewHandle(
      class_linker_->ResolveMethodType(soa.Self(), method1_id.proto_idx_, dex_cache, class_loader, true));
