...
struct MockClass {
  ...
  bool CasFieldWeakSequentiallyConsistent32(art::MemberOffset offset, int32_t old_value, int32_t new_value)
      REQUIRES_SHARED(Locks::mutator_lock_) {
    UNUSED(offset);
...
struct MockSubtypeCheck {
  ...
  friend std::ostream& operator<<(std::ostream& os, const MockSubtypeCheck& tree) NO_THREAD_SAFETY_ANALYSIS {
