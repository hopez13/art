...
//
// For immune space objects, we rely on graying dirty objects in the FlipCallback pause
// (we try to gray them just before flipping thread roots but the FlipCallback has to re-scan
