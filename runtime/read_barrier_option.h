...
//      - constant reference field known to point to an object in the non-moving space, or
//      - constant reference fields in a chain leading to one of the above purposes;
