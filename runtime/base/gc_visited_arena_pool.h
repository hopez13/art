...
class GcVisitedArenaPool final : public ArenaPool {
 ...
 private:
  ...
  // List of arenas which are free but are not to be used.
  Arena* unusable_arenas_;
  size_t bytes_allocated_;
  // Use memfd_create rather than anonymous mapping so that userfaultfd GC can
  // use shmem features.
  int fd_;
