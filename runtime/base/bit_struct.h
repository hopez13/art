...
//   // Definition example
//   union Example {
//     DefineBitStructSize<10> _;  // This needs to go first.
//     BitStructUint<0, 2> u2;     // Every union field must be a BitStruct[*].
//     BitStructInt<2, 7>  i7;
...
struct DefineBitStructSize {
  static constexpr size_t BitStructSizeOf() { return kSize; }  // Allow nestings.
 private:
  typename detail::MinimumTypeUnsignedHelper<kSize>::type _;
};
