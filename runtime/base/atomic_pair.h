...
namespace art {
  ...
  template <typename IntType>
  ALWAYS_INLINE static inline AtomicPair<IntType> AtomicPairLoadRelaxed(
...
// llvm does not implement 16-byte atomic operations on x86-64.
  ...
  ALWAYS_INLINE static inline AtomicPair<uint64_t> AtomicPairLoadRelaxed(
