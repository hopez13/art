...
struct CustomBitStruct {
  ...
  CustomBitStruct(int8_t data) : data(data) {}
...
//static_assert(sizeof(TestBitStruct) == sizeof(uint8_t), "BitStructs#TestSize");
...
union MixedSizeBitStruct {
  DefineBitStructSize<32> _;
