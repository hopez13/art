...
#define ART_LOG_STREAM(severity) ART_LOGS_STREAM(::android::base::severity)
#define ART_LOGS_STREAM(severity) \
  (WOULD_LOGS(severity) ? LOGS_STREAM(severity) : ::art::LoggingDummyMessage().GetStream())
