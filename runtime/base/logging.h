...
// Make libbase's LogSeverity easier available.
...
#define ART_LOG_STREAM(severity) ART_LOG_STREAM_S(::android::base::severity)
#define ART_LOG_STREAM_S(severity) \
  (WOULD_LOG_SEVERITY(severity) ? LOG_STREAM_S(severity) : ::art::LoggingDummyMessage().GetStream())
