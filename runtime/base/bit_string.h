...
#ifndef ART_RUNTIME_BASE_BITSTRING_H_
#define ART_RUNTIME_BASE_BITSTRING_H_
...
/**
 * A BitChar is a light-weight wrapper to read/write a single character
 ...
 *                    // Padded with trailing 0s to fit the entire word.
 *  MaxBitstringLen   := N+1
...
#endif  // ART_RUNTIME_BASE_BITSTRING_H_
