...
class LOCKABLE Mutex : public BaseMutex {
 public:
  ...
  // Returns true if acquires exclusive access, false otherwise.  check argument specifies whether
  // lock level checking should be performed.  Should be defaulted unless if we are using
