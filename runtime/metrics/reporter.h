...
class MetricsReporter {
 ...
 private:
  ...
  // Whether or not we should wait for startup before reporting for the the first time.
  bool ShouldReportAtStartup() const;

  // Whether or not we should report at a predefined period (either because we still
  ...
  // Must be called only if ShouldReportAtPeriod() is true.
