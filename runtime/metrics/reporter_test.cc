 ...
 protected:
  ...
  void SetupReporter(const char* period_spec,
    ...
    if (period_spec != nullptr) {
      std::string error;
      config.sample_rate_percentage = sample_rate;
...
TEST_F(MetricsReporterTest, SampleRateDisable) {
  SetupReporter("1", /*session_id=*/ 1, /*sample_rate=*/ 0);
...
TEST_F(MetricsReporterTest, SampleRateDisable24) {
  SetupReporter("1", /*session_id=*/ 125, /*sample_rate=*/ 24);
...
TEST_F(MetricsReporterTest, SampleRateEnable50) {
  SetupReporter("1", /*session_id=*/ 125, /*sample_rate=*/ 50);
...
TEST_F(MetricsReporterTest, SampleRateEnableAll) {
  SetupReporter("1", /*session_id=*/ 1099, /*sample_rate=*/ 100);
