 ...
 public:
  void VerifyOptimizationStatus(OatFileAssistant* assistant,
    ...
    assistant->GetOptimizationStatus(
        &compilation_filter2, &compilation_reason2, &odex_status2);
...
TEST_F(OatFileAssistantTest, DexNoOat) {
  ...
  VerifyOptimizationStatus(
      &oat_file_assistant, dex_location, "run-from-apk", "unknown", "out-of-date");
}
...
TEST_F(OatFileAssistantTest, OdexUpToDate) {
  ...
  VerifyOptimizationStatus(
      &oat_file_assistant, dex_location, CompilerFilter::kSpeed, "install", "up-to-date");
}
...
TEST_F(OatFileAssistantTest, OatUpToDate) {
  ...
  VerifyOptimizationStatus(
      &oat_file_assistant, dex_location, CompilerFilter::kSpeed, "unknown", "up-to-date");
}
...
TEST_F(OatFileAssistantTest, OatDexOutOfDate) {
  ...
  VerifyOptimizationStatus(
      &oat_file_assistant, dex_location, "run-from-apk-fallback", "unknown", "out-of-date-app");
}
...
TEST_F(OatFileAssistantTest, OatImageOutOfDate) {
  ...
  VerifyOptimizationStatus(
      &oat_file_assistant, dex_location, "run-from-apk-fallback", "unknown", "out-of-date-boot");
}
