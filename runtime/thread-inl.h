...
inline void Thread::TransitionToSuspendedAndRunCheckpoints(ThreadState new_state) {
  ...
  do {
    ...
    StateAndFlags new_state_and_flags(new_state, old_state_and_flags.Flags());
...
inline ThreadState Thread::TransitionFromSuspendedToRunnable() {
  ...
  do {
    ...
    old_state_and_flags = tls32_.state_and_flags;
    ...
    if (LIKELY(old_state_and_flags.Flags() == ThreadFlag::kNoFlags)) {
      ...
      StateAndFlags new_state_and_flags(ThreadState::kRunnable, old_state_and_flags.Flags());
