...
#define DEX_INSTRUCTION_LIST(V) \
  ...
  V(0xFA, INVOKE_POLYMORPHIC, "invoke-polymorphic", k45cc, kIndexMethodAndProtoRef, kContinue | kThrow | kInvoke | kSignaturePolymorphic, kVerifyRegBMethod | kVerifyVarArgNonZero | kExperimental) \
  V(0xFB, INVOKE_POLYMORPHIC_RANGE, "invoke-polymorphic/range", k4rcc, kIndexMethodAndProtoRef, kContinue | kThrow | kInvoke | kSignaturePolymorphic, kVerifyRegBMethod | kVerifyVarArgRangeNonZero | kExperimental) \
