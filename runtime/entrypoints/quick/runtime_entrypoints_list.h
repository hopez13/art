...
// All C++ quick entrypoints, i.e: C++ entrypoint functions called from quick assembly code. Format
// is name, attribute, return type, argument types.
#define RUNTIME_ENTRYPOINT_LIST(V) \
  V(artDeliverPendingExceptionFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,              \
      Thread* self)                                                                               \
  V(artInvokeObsoleteMethod, REQUIRES_SHARED(Locks::mutator_lock_), uint64_t,                     \
      ArtMethod* method,                                                                          \
      Thread* self)                                                                               \
  V(artDeliverExceptionFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,                     \
      mirror::Throwable* exception,                                                               \
      Thread* self)                                                                               \
  V(artThrowNullPointerExceptionFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,            \
      Thread* self)                                                                               \
  V(artThrowNullPointerExceptionFromSignal, REQUIRES_SHARED(Locks::mutator_lock_), void,          \
      uintptr_t addr,                                                                             \
      Thread* self)                                                                               \
  V(artThrowDivZeroFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,                         \
      Thread* self)                                                                               \
  V(artThrowArrayBoundsFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,                     \
      int index,                                                                                  \
      int length,                                                                                 \
      Thread* self)                                                                               \
  V(artThrowStringBoundsFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,                    \
      int index,                                                                                  \
      int length,                                                                                 \
      Thread* self)                                                                               \
  V(artThrowStackOverflowFromCode, REQUIRES_SHARED(Locks::mutator_lock_), void,                   \
      Thread* self)                                                                               \
  V(artThrowClassCastExceptionForObject, REQUIRES_SHARED(Locks::mutator_lock_), void,             \
      mirror::Object* obj,                                                                        \
      mirror::Class* dest_type,                                                                   \
      Thread* self)                                                                               \
  V(artThrowArrayStoreException, REQUIRES_SHARED(Locks::mutator_lock_), void,                     \
      mirror::Object* array,                                                                      \
      mirror::Object* value,                                                                      \
      Thread* self)                                                                               \
                                                                                                  \
  V(artDeoptimizeIfNeeded, REQUIRES_SHARED(Locks::mutator_lock_), int,                            \
      ...
      uintptr_t result,                                                                           \
      bool is_ref)                                                                                \
  V(artTestSuspendFromCode, REQUIRES_SHARED(Locks::mutator_lock_), int,                           \
      Thread* self)                                                                               \
  V(artImplicitSuspendFromCode, REQUIRES_SHARED(Locks::mutator_lock_), int,                       \
      Thread* self)                                                                               \
  ...
  V(artQuickProxyInvokeHandler, REQUIRES_SHARED(Locks::mutator_lock_), uint64_t,                  \
      ...
      Thread* self,                                                                               \
      ArtMethod** sp)                                                                             \
  V(artInstrumentationMethodEntryFromCode, REQUIRES_SHARED(Locks::mutator_lock_), const void*,    \
      ArtMethod* method,                                                                          \
      mirror::Object* this_object,                                                                \
      Thread* self,                                                                               \
      ArtMethod** sp)                                                                             \
  V(artInstrumentationMethodExitFromCode, REQUIRES_SHARED(Locks::mutator_lock_), TwoWordReturn,   \
      Thread* self,                                                                               \
      ArtMethod** sp,                                                                             \
      uint64_t* gpr_result,                                                                       \
      uint64_t* fpr_result)                                                                       \
  ...
  V(artJniMethodEntryHook, REQUIRES_SHARED(Locks::mutator_lock_), void,                           \
      Thread* self)                                                                               \
  V(artMethodEntryHook, REQUIRES_SHARED(Locks::mutator_lock_), int,                               \
      ArtMethod* method,                                                                          \
      Thread* self,                                                                               \
      ArtMethod** sp ATTRIBUTE_UNUSED)                                                            \
  V(artMethodExitHook, REQUIRES_SHARED(Locks::mutator_lock_), int,                                \
      Thread* self,                                                                               \
      ArtMethod** sp,                                                                             \
      uint64_t* gpr_result,                                                                       \
      uint64_t* fpr_result,                                                                       \
  ...
  V(artResolveStringFromCode, REQUIRES_SHARED(Locks::mutator_lock_), mirror::String*,             \
      int32_t string_idx, Thread* self)                                                           \
                                                                                                  \
  V(artDeoptimize, REQUIRES_SHARED(Locks::mutator_lock_), void,                                   \
      Thread* self)                                                                               \
  V(artDeoptimizeFromCompiledCode, REQUIRES_SHARED(Locks::mutator_lock_), void,                   \
  ...
  V(artJniMethodStart, UNLOCK_FUNCTION(Locks::mutator_lock_) HOT_ATTR, void,                      \
      Thread* self)                                                                               \
  V(artJniUnlockObject, REQUIRES_SHARED(Locks::mutator_lock_) HOT_ATTR, void,                     \
  ...
  ART_GET_FIELD_FROM_CODE_DECL(V, 32, size_t, uint32_t)                                           \
