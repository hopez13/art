...
class QuickArgumentVisitorBase {
 ...
 public:
  ...
  static uint32_t GetCallingDexPc(ArtMethod** sp) REQUIRES_SHARED(Locks::mutator_lock_) {
    ...
    uintptr_t outer_pc = QuickArgumentVisitorBase::GetCallingPc(sp);
  ...
  QuickArgumentVisitorBase(ArtMethod** sp, bool is_static, const char* shorty,
...
class QuickArgumentFrameInfoARM : public QuickArgumentVisitorBase<QuickArgumentFrameInfoARM> {
 public:
  ...
  QuickArgumentFrameInfoARM(ArtMethod** sp,
                            ...
                            const char* shorty,
                            uint32_t shorty_len) REQUIRES_SHARED(Locks::mutator_lock_)
      : QuickArgumentVisitorBase(sp, is_static, shorty, shorty_len) {}
};
