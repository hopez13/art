...
#define CHECK_FRAME_SIZE(isa)                                                        \
  ...
  CheckFrameSize(isa,                                                                \
                 ...
                 GetCalleeSaveFrameSize(isa, CalleeSaveType::kSaveEverythingForSuspendCheck))
...
TEST_F(QuickTrampolineEntrypointsTest, ReturnPC) {
  ...
  CheckPCOffset(kRuntimeISA, CalleeSaveType::kSaveEverythingForSuspendCheck,
                GetCalleeSaveReturnPcOffset(kRuntimeISA, CalleeSaveType::kSaveEverythingForSuspendCheck));
}
