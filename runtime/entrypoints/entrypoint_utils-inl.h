...
// Resolve method by following virtual/interface indirections if applicable.
// Will throw null-pointer exception the if the object is null.
template<InvokeType type, bool access_check>
ALWAYS_INLINE ArtMethod* ResolveIndirectMethod(uint32_t method_idx,
...
inline ArtMethod* FindMethodFromCode(uint32_t method_idx,
  ...
  return ResolveIndirectMethod<type, access_check>(
