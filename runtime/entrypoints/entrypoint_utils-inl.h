...
inline ArtMethod* GetResolvedMethod(ArtMethod* outer_method,
  ...
  // Note: We do not need the read barrier for the dex cache as all the operations below
  // operate on native (non-moveable) data and constants (num_resolved_methods_).
