...
class InstrumentationStackPopper {
 public:
  ...
  bool PopFramesTo(uint8_t* stack_pointer, /*in-out*/MutableHandle<mirror::Throwable>& exception)
      REQUIRES_SHARED(Locks::mutator_lock_);
...
class Instrumentation {
 public:
  ...
  uintptr_t PopFramesForDeoptimization(Thread* self, uint8_t* stack_pointer) const
      REQUIRES_SHARED(Locks::mutator_lock_);
