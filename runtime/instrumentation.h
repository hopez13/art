...
class Instrumentation {
 ...
 private:
  ...
  // this check.
  //
  // For JITed code for non-native methods we already have a stack slot reserved for deoptiming on
  // demand and we use that stack slot to check if the caller needs a deoptimization. JITed code
