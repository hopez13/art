...
class Instrumentation {
 public:
  ...
  // This is used by:
  //  - the debugger to cause a deoptimization of the thread's stack (for
  ...
  // should_deopt indicates whether the frames need to deoptimize or not.
  void InstrumentThreadStack(Thread* thread, bool should_deopt) REQUIRES(Locks::mutator_lock_);
