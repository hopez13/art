...
class Instrumentation {
 public:
  ...
  // This is used by the debugger to cause a deoptimization of the thread's stack (for
  // example, after updating local variables) or to call method entry / exit hooks.
