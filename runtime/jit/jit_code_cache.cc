  ...
  uint8_t* memory = nullptr;
  {
    ...
    WaitForPotentialCollectionToComplete(self);
    {
      ...
      if (writable_ptr != code_ptr) {
        ...
        // indexed and tagged.
        //
        // In the two mappings case, flushing the RX version after the
        // RW version is just invalidating cachelines in the
        // instruction cache. This is necessary as the instruction
        // cache will often have a different set of cache lines
        // present and because the JIT code cache can start a new
        // function at any boundary within a cache-line.
