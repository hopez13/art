...
JitCodeCache* JitCodeCache::Create(size_t initial_capacity,
  ...
  int memmap_flags_prot_data = kProtData;
  int memmap_flags_prot_code = used_only_for_profile_data ? kProtData : kProtCode;
  int memmap_flags_prot_code_update = used_only_for_profile_data ? kProtData : kProtAll;
...
JitCodeCache::JitCodeCache(MemMap* code_map,
                           ...
                           int memmap_flags_prot_data,
                           int memmap_flags_prot_code,
                           int memmap_flags_prot_code_update)
    : lock_("Jit code cache", kJitCodeCacheLock),
      ...
      memmap_flags_prot_data_(memmap_flags_prot_data),
      memmap_flags_prot_code_(memmap_flags_prot_code),
      memmap_flags_prot_code_update_(memmap_flags_prot_code_update) {
...
class ScopedCodeCacheWrite : ScopedTrace {
 public:
  explicit ScopedCodeCacheWrite(JitCodeCache* code_cache)
    ...
    CheckedCall(
        ...
        code_cache_->memmap_flags_prot_code_update_);
  }
 ...
 private:
  const JitCodeCache* code_cache_;
