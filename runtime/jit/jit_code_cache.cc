...
void JitCodeCache::FreeAllMethodHeaders(
  ...
  // Do this after removing CHA dependents before the memory can be reused.
  FreeCode(method_headers);
}
...
void JitCodeCache::FreeCode(const std::unordered_set<OatQuickMethodHeader*>& method_headers) {
  MutexLock mu(Thread::Current(), lock_);
  ScopedCodeCacheWrite scc(code_map_.get());
