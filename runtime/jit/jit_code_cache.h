...
class JitCodeCache {
 ...
 private:
  ...
  // Mapping flags for the data section.
  const int memmap_flags_prot_data_;
  // Mapping flags for the code section.
  const int memmap_flags_prot_code_;
  // Mapping flags for the code section during an update.
  const int memmap_flags_prot_code_update_;
