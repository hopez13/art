...
class ProfileCompilationInfo {
 ...
 private:
  ...
  const uint32_t kProfileSizeWarningThreshholdInBytes = 500000U;
  const uint32_t kProfileSizeErrorThreshholdInBytes = 1000000U;
  ...
  // and Z_DATA_ERROR if stream ended prematurely or the stream has extra data.
