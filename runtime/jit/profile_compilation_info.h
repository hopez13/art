...
class ProfileCompilationInfo {
 public:
  ...
  //  - OfflineProfileMehodInfo#dex_references vector (public use)
 ...
 private:
  ...
  // Add all classes from the given cache to the the profile.
  ...
  // Read individual elements form the profile line header.
  ...
  // Encodes the inline cache into the given buffer.
