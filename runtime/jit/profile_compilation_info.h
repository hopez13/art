...
class ProfileCompilationInfo {
 public:
  ...
  struct DexPcData {
    ...
    // Not all runtime types can be encoded in the profile. For example is the receiver
    // type is in a dex files which is not tracked for profiling its type cannot be
