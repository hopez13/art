...
bool ProfileCompilationInfo::Save(int fd) {
  ...
  int ret = WriteBuffer(fd, kProfileMagic, sizeof(kProfileMagic));
  ret &= WriteBuffer(fd, kProfileVersion, sizeof(kProfileVersion));
  ...
  ret &= WriteBuffer(fd, buffer.data(), buffer.size());
  ...
  ret &= WriteBuffer(fd, buffer.data(), buffer.size());
  ret &= WriteBuffer(fd, compressed_buffer.get(), output_size);
