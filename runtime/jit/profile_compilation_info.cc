...
// return an unique pointer to a ProfileCompilationInfo upon success.
...
ProfileCompilationInfo::ProfileLoadSatus ProfileCompilationInfo::LoadInternal(
  ...
  // Clear the existing profile before starting to load.
  // If the user needs to merge data they should use MergeWith().
  ClearProfile();
