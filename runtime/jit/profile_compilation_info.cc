...
// profile_compilation_info object.
 ...
 *        num_method_ids1,dex_location2,number_of_classes2,methods_region_size,
 *        dex_location_checksum2, num_method_ids2
...
ProfileCompilationInfo::ProfileLoadSatus ProfileCompilationInfo::LoadInternal(
  ...
  RemapProfileIndex(profile_line_headers, &dex_profile_index_remap);
...
bool ProfileCompilationInfo::MergeWith(int fd, bool merge_classes) {
  std::string error;
