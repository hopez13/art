...
// We need to pass it as argument to be able to call it from runtime.
using PackElfFileForJITFunction = std::function<std::vector<uint8_t>(
    ArrayRef<JITCodeEntry*> elf_files,
