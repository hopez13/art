...
// Takes writable address so that we get better compile-time checks.
void JitMemoryRegion::FreeData(uint8_t* writable_data) {
  DCHECK(GetWritableDataMapping()->HasAddress(writable_data));
