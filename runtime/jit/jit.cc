...
void Jit::MethodEntered(Thread* thread, ArtMethod* method) {
  ...
  // jit_code_cache that the method is actually being used. We need to do the search of the
  // code-cache here since at the point where tracing is turned off the locks we have make it
  // impossible to safely find the method's compiled code to reset the entrypoint. Instead we do it
  // here.
