...
void Jit::MethodEntered(Thread* thread, ArtMethod* method) {
  ...
  // instead of interpreting the method. We check for the instrumentation entrypoint since if that
  // is there we are using the SavedEntryPoint for a different purpose and cannot replace the
  // entrypoint with it.
