...
class ScopedCompilation {
 ...
 private:
  ...
  bool is_already_being_compiled_;
};
...
class JitCompileTask final : public Task {
 public:
  ...
  JitCompileTask(ArtMethod* method,
    ...
    DCHECK(!sc.IsAlreadyBeingCompiled());
  }
...
bool Jit::CompileMethod(ArtMethod* method,
                        ...
                        bool prejit) {
  ScopedCompilation sc(this, method, compilation_kind);
  // TODO: we should wait if it is being compiled.
  if (sc.IsAlreadyBeingCompiled()) {
    return false;
  }
