...
// Abstracts accesses to the instruction fields of code items for CompactDex and StandardDexFile.
class CodeItemInstructionsAccessor {
 public:
  ALWAYS_INLINE CodeItemInstructionsAccessor(const DexFile* dex_file,
                                             const DexFile::CodeItem* code_item);

  ALWAYS_INLINE explicit CodeItemInstructionsAccessor(ArtMethod* method);
  ...
  ALWAYS_INLINE static CodeItemInstructionsAccessor CreateNullable(ArtMethod* method)
      REQUIRES_SHARED(Locks::mutator_lock_);

 protected:
  CodeItemInstructionsAccessor() = default;
...
// Abstracts accesses to code item fields other than debug info for CompactDex and StandardDexFile.
class CodeItemDataAccessor : public CodeItemInstructionsAccessor {
 public:
