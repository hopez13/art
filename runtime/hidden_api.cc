...
static bool AreEnforcementPoliciesCompatible(EnforcementPolicy oat_policy,
  ...
  LOG(ERROR) << "OAT_COMPATIBLE runtime_enforcing=" << runtime_enforcing << ", oat_enforcing=" << oat_enforcing;
