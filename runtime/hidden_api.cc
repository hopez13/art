...
// conditionally blocked and blocked. This can be set to true for developer preview / beta builds,
// but should be false for public release builds.
...
bool ShouldDenyAccessToMemberImpl(T* member, ApiList api_list, AccessMethod access_method) {
  ...
  if (member_signature.DoesPrefixMatchAny(runtime->GetHiddenApiExemptions())) {
    ...
    // Exemptions effectively adds new members to the sdk.
