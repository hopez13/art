...
bool FaultManager::HandleSigbusFault(int sig, siginfo_t* info, void* context [[maybe_unused]]) {
...
bool JavaStackTraceHandler::Action(int sig [[maybe_unused]], siginfo_t* siginfo, void* context) {
