...
class DexInstructionsHelper {
 public:
  ALWAYS_INLINE explicit DexInstructionsHelper(const DexFile* dex_file,
                                               const DexFile::CodeItem* code_item);
  ALWAYS_INLINE explicit DexInstructionsHelper(ArtMethod* method);
