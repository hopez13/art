...
void Runtime::InitNonZygoteOrPostFork(
  ...
  if (metrics_reporter_ != nullptr) {
    ...
    auto metrics_config = metrics::ReportingConfig::FromFlags(is_system_server);

    metrics_reporter_->ReloadConfig(std::move(metrics_config));
...
void Runtime::InitMetrics() {
  ...
  metrics_reporter_ = metrics::MetricsReporter::Create(std::move(metrics_config), this);
}
