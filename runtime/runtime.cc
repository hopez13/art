...
bool Runtime::Init(RuntimeArgumentMap&& runtime_options_in) {
  ...
  boot_class_path_art_fds_ = runtime_options.ReleaseOrDefault(Opt::BootClassPathArtFds);
  ...
  CHECK(boot_class_path_art_fds_.empty() || boot_class_path_art_fds_.size() == boot_class_path_fds_.size());
  CHECK(boot_class_path_vdex_fds_.empty() || boot_class_path_vdex_fds_.size() == boot_class_path_fds_.size());
  CHECK(boot_class_path_oat_fds_.empty() || boot_class_path_oat_fds_.size() == boot_class_path_fds_.size());
