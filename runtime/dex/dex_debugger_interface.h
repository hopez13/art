...
#ifndef ART_RUNTIME_DEX_DEX_DEBUGGER_INTERFACE_H_
#define ART_RUNTIME_DEX_DEX_DEBUGGER_INTERFACE_H_
...
DexFileDebugEntry* RegiterDexFileForNative(const void* dexfile);
...
#endif  // ART_RUNTIME_DEX_DEX_DEBUGGER_INTERFACE_H_
