...
template<class MirrorType>
inline ObjPtr<MirrorType> ArtField::GetObject(ObjPtr<mirror::Object> object) {
...
template <bool kExactOffset>
inline ArtField* ArtField::FindStaticFieldWithOffset(ObjPtr<mirror::Class> klass, uint32_t field_offset) {
  DCHECK(klass != nullptr);
