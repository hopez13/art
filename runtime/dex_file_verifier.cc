...
bool DexFileVerifier::CheckInterProtoIdItem() {
  ...
  if (UNLIKELY(!IsValidOrNoTypeId(item->return_type_idx_, item->pad_))) {
...
bool DexFileVerifier::CheckInterClassDefItem() {
  ...
  if (UNLIKELY(!IsValidTypeId(item->class_idx_, item->pad1_))) {
  ...
  if (UNLIKELY(!IsValidOrNoTypeId(item->superclass_idx_, item->pad2_))) {
