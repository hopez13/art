...
class TraceWriter {
 ...
 private:
  ...
  // Buffer to store trace data before flushing this to file. In streaming mode,
  // we flush this data to file every time. In non-streaming mode, this data is
  // flushed at the end of tracing.
