...
static void JNICALL VMInitCallback(jvmtiEnv *jenv ATTRIBUTE_UNUSED, JNIEnv* jni_env, jthread thread ATTRIBUTE_UNUSED) {
...
extern "C" JNIEXPORT jint JNICALL Agent_OnLoad(JavaVM* vm,
  ...
  // Setup jvmti_env and set the capabilities
