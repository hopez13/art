...
// Returns true and sets `filename` if `location` is on framework or I18N module, false otherwise.
...
// /system/framework (i.e. $ANDROID_ROOT/framework) or in the non-updatable I18n module.
// Returns image location if `dex_location` is on framework or I18N module, empty string otherwise.
