...
// If the given location is /apex/<apexname>/..., return apexname. Otherwise return an empty string.
// Note that the result is a view into full_path and is valid only as long as it is.
