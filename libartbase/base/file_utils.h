...
// /system/framework (i.e. $ANDROID_ROOT/framework) or /apex (assuming the apex is not updatable).
// Returns the Oat filename if `location` is valid, empty string otherwise.
...
// /system/framework (i.e. $ANDROID_ROOT/framework) or /apex (assuming the apex is not updatable).
// Returns the Odex filename if `location` is valid, empty string otherwise.
...
// /system/framework (i.e. $ANDROID_ROOT/framework) or /apex (assuming the apex is not updatable).
// Returns image location if `dex_location` is valid, empty string otherwise.
