...
class FdFile : public RandomAccessFile {
 public:
  ...
  // On Linux, we only support copies that will append regions to the file, and we require the
  // output file descriptor to be aligned with the filesystem blocksize (see comments in
  // implementation).
