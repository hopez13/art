...
class ZipLeftIter {
 public:
  ...
  using value_type = typename std::pair<typename IterLeft::value_type, typename IterRight::value_type>;
  using difference_type = std::ptrdiff_t;
  using pointer = typename std::pair<typename IterLeft::value_type, typename IterRight::value_type>*;
  using reference = typename std::pair<typename IterLeft::value_type, typename IterRight::value_type>&;
