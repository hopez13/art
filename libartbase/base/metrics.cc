...
void StreamBackend::BeginHistogram(DatumId histogram_type,
                                   size_t /*num_buckets*/,
                                   int64_t /*low_value_*/,
                                   int64_t /*high_value*/) {
...
void StreamBackend::ReportHistogramBucket(size_t index, uint32_t value) {
  os_ << "  Bucket " << index << ": " << value << "\n";
}

void StreamBackend::EndHistogram() {}
