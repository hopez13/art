...
class MemMap {
 public:
  ...
  // Release ownership of pages at the beginning of the mapping. The mapping must be
  // an anonymous reservation mapping, owning entire pages. The `byte_count`  must not
  // exceed the size of this reservation and it shall be rounded up to entire pages.
  void ReleasePages(size_t byte_count);
