...
class MemMap {
 public:
  ...
  // Request an aligned anonymous region. We can't ask for a MAP_SHARED
  // (anonymous or otherwise) mapping to be aligned as in that case file
  // offset is involved and could make the starting offset to be out of
  // sync with another mapping of the same file.
