...
class ApiList {
 private:
  ...
  static constexpr uint32_t kMaxSdkVersions[] {
    /* whitelist */ kSdkVersionMax,
    /* greylist */ kSdkVersionMax,
    /* blacklist */ kSdkVersionMin,
    /* blacklist-max-o */ kSdkVersionO_MR1,
    /* blacklist-max-p */ kSdkVersionP_MR1,
  };
 ...
 public:
  ...
  uint32_t GetMaxAllowedSdkVersion() const { return kMaxSdkVersions[GetIntValue()]; }
