...
//
// Values greater than kVarintMax could be encoded as a seperate list referred
...
//
// In other cases the value is recorded just follwing the size encoding. This is
