...
#define ART_COUNTERS(COUNTER)                       \
  ...
  COUNTER(OnDeviceRecompilationSuccess)             \
  COUNTER(OnDeviceRecompilationTimeLimitExceed)     \
  COUNTER(OnDeviceRecompilationInsufficientSpace)   \
  COUNTER(OnDeviceRecompilationFailedBootClasspath) \
  COUNTER(OnDeviceRecompilationFailedSystemServer)  \
  COUNTER(OnDeviceRecompilationUnexpectedError)     \
...
#define ART_HISTOGRAMS(HISTOGRAM)                    \
  ...
  HISTOGRAM(OnDeviceRecompilationTime, 15, 0, 60'000'000) \
