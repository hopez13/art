...
#define ART_VALUE_METRICS(METRIC)                         \
  ...
  METRIC(JitMethodCompileTotalTimeDelta, MetricsCounter)  \
  METRIC(JitMethodCompileCountDelta, MetricsCounter)      \
  METRIC(ClassVerificationTotalTimeDelta, MetricsCounter) \
  METRIC(ClassVerificationCountDelta, MetricsCounter)     \
  METRIC(ClassLoadingTotalTimeDelta, MetricsCounter)      \
  METRIC(TotalBytesAllocatedDelta, MetricsCounter)
