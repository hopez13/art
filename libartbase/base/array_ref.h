...
class ArrayRef {
 public:
  ...
  template <typename U,
            size_t size,
            typename = typename std::enable_if_t<std::is_same_v<T, const U>>>
  ...
  template <typename Vector,
            typename = typename std::enable_if_t<
                std::is_same_v<typename Vector::value_type, value_type>>>
  ...
  template <typename Vector,
            typename = typename std::enable_if_t<
                std::is_same_v<typename std::add_const_t<typename Vector::value_type>, value_type>>>
  ...
  template <typename U>
  typename std::enable_if_t<std::is_same_v<T, const U>, ArrayRef>&
