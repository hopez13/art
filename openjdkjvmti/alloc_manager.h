...
class JvmtiAllocationListener : public art::gc::AllocationListener {
 public:
  ...
  void PreOjectAllocated(art::Thread* self,
...
class AllocationManager {
 public:
  ...
  void PauseAllocations(art::Thread* self)
      REQUIRES_SHARED(art::Locks::mutator_lock_);
  void ResumeAllocations(art::Thread* self)
      REQUIRES_SHARED(art::Locks::mutator_lock_);
 ...
 private:
  void PauseForAllocation(art::Thread* self) REQUIRES_SHARED(art::Locks::mutator_lock_);
