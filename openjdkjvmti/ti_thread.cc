...
jvmtiError ThreadUtil::GetCurrentThread(jvmtiEnv* env [[maybe_unused]], jthread* thread_ptr) {
  art::Thread* self = art::Thread::Current();
...
jvmtiError ThreadUtil::GetThreadState(jvmtiEnv* env [[maybe_unused]],
                                      jthread thread,
...
jvmtiError ThreadUtil::SuspendThread(jvmtiEnv* env [[maybe_unused]], jthread thread) {
  art::Thread* self = art::Thread::Current();
...
jvmtiError ThreadUtil::ResumeThread(jvmtiEnv* env [[maybe_unused]], jthread thread) {
  if (thread == nullptr) {
    return ERR(NULL_POINTER);
  }
  art::Thread* self = art::Thread::Current();
...
jvmtiError ThreadUtil::StopThread(jvmtiEnv* env [[maybe_unused]],
                                  jthread thread,
                                  jobject exception) {
  art::Thread* self = art::Thread::Current();
  art::ScopedObjectAccess soa(self);
...
jvmtiError ThreadUtil::InterruptThread(jvmtiEnv* env [[maybe_unused]], jthread thread) {
  art::Thread* self = art::Thread::Current();
  art::ScopedObjectAccess soa(self);
  art::MutexLock tll_mu(self, *art::Locks::thread_list_lock_);
  art::Thread* target = nullptr;
