...
// Remove the error-catching define temporarially as we define the actual implementation.
#pragma push_macro("ScopedNoUserCodeSuspension")
#undef ScopedNoUserCodeSuspension
...
// Restore it to cover this file too.
#pragma pop_macro("ScopedNoUserCodeSuspension")
