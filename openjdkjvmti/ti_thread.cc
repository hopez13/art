        ? context_class_loader_->GetObject(peer)                                         ? nullptr    REQUIRES(art::Locks::thread_list_lock_, art::Locks::user_code_suspension_lock_  art::MutexLock tscl_mu(art::Thread::Current(), *art::Locks::thread_suspend_count_lock_);
