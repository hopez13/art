...
jvmtiError FieldUtil::GetFieldDeclaringClass(jvmtiEnv* env [[maybe_unused]],
                                             jclass klass,
                                             jfieldID field,
...
jvmtiError FieldUtil::GetFieldModifiers(jvmtiEnv* env [[maybe_unused]],
                                        jclass klass,
                                        jfieldID field,
                                        jint* modifiers_ptr) {
  if (klass == nullptr) {
...
jvmtiError FieldUtil::IsFieldSynthetic(jvmtiEnv* env [[maybe_unused]],
                                       jclass klass,
                                       jfieldID field,
