...
bool VisitorFalse(art::ObjPtr<art::mirror::Object> obj [[maybe_unused]],
                  art::ObjPtr<art::mirror::Class> klass [[maybe_unused]],
                  art::ArtField& field [[maybe_unused]],
                  size_t field_index [[maybe_unused]],
                  UserData* user_data [[maybe_unused]]) {
  return false;
}
...
struct DumpVisitor {
  static bool Callback(art::ObjPtr<art::mirror::Object> obj [[maybe_unused]],
                       art::ObjPtr<art::mirror::Class> klass [[maybe_unused]],
                       art::ArtField& field,
                       size_t field_index,
...
jvmtiError HeapUtil::IterateThroughHeap(jvmtiEnv* env,
                                        ...
                                        const jvmtiHeapCallbacks* callbacks,
                                        const void* user_data) {
  auto JvmtiIterateHeap = [](art::mirror::Object* obj [[maybe_unused]],
 ...
 private:
  ...
  void VisitObject(art::mirror::Object* obj)
    ...
    auto report_instance_field =
        [&](art::ObjPtr<art::mirror::Object> src,
            art::ObjPtr<art::mirror::Class> obj_klass [[maybe_unused]],
            art::ArtField& field,
            size_t field_index,
            void* user_data [[maybe_unused]]) REQUIRES_SHARED(art::Locks::mutator_lock_)
            REQUIRES(!*tag_table_->GetAllowDisallowLock()) {
  ...
  void VisitClass(art::mirror::Class* klass)
    ...
    auto report_static_field =
        [&](art::ObjPtr<art::mirror::Object> obj [[maybe_unused]],
...
jvmtiError HeapUtil::ForceGarbageCollection(jvmtiEnv* env [[maybe_unused]]) {
      ...
      [&](art::mirror::Object* ref) REQUIRES_SHARED(art::Locks::mutator_lock_) {
        ...
        class ResizeReferenceVisitor {
         public:
          ...
          void operator()(art::ObjPtr<art::mirror::Class> klass [[maybe_unused]],
