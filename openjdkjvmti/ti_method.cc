...
class GetLocalVariableClosure : public CommonLocalVariableClosure {
 ...
 private:
  art::Primitive::Type type_;
  jvalue* val_;
  // The GcRoot is used to convert a mirror::Object to a jobject when the mirror::Object comes from
  // another thread. There should be no suspension between this closure being run and the GetResult
  // call that reads this GcRoot.
