...
jvmtiError MonitorUtil::CreateRawMonitor(jvmtiEnv* env [[maybe_unused]],
                                         const char* name,
...
jvmtiError MonitorUtil::DestroyRawMonitor(jvmtiEnv* env [[maybe_unused]], jrawMonitorID id) {
  if (id == nullptr) {
...
jvmtiError MonitorUtil::RawMonitorEnterNoSuspend(jvmtiEnv* env [[maybe_unused]], jrawMonitorID id) {
  if (id == nullptr) {
    return ERR(INVALID_MONITOR);
  }
...
jvmtiError MonitorUtil::RawMonitorEnter(jvmtiEnv* env [[maybe_unused]], jrawMonitorID id) {
  if (id == nullptr) {
    return ERR(INVALID_MONITOR);
  }
...
jvmtiError MonitorUtil::RawMonitorExit(jvmtiEnv* env [[maybe_unused]], jrawMonitorID id) {
  if (id == nullptr) {
    return ERR(INVALID_MONITOR);
  }
...
jvmtiError MonitorUtil::RawMonitorWait(jvmtiEnv* env [[maybe_unused]],
                                       jrawMonitorID id,
                                       jlong millis) {
  if (id == nullptr) {
    return ERR(INVALID_MONITOR);
...
jvmtiError MonitorUtil::RawMonitorNotify(jvmtiEnv* env [[maybe_unused]], jrawMonitorID id) {
  if (id == nullptr) {
    return ERR(INVALID_MONITOR);
  }
...
jvmtiError MonitorUtil::RawMonitorNotifyAll(jvmtiEnv* env [[maybe_unused]], jrawMonitorID id) {
  if (id == nullptr) {
    return ERR(INVALID_MONITOR);
  }
...
jvmtiError MonitorUtil::GetCurrentContendedMonitor(jvmtiEnv* env [[maybe_unused]],
                                                   jthread thread,
                                                   jobject* monitor) {
  if (monitor == nullptr) {
    return ERR(NULL_POINTER);
