#include "ti_logging.h"#include "ti_redefine.h"#include "ti_stack.hnamespace openjdkjvmti // These should never be null.DeoptManager* gDeoptManager;    // Allow UNATTACHED_THREAD since we don't really care about that for this function      return err;    return AllocUtil::Deallocate(env, mem);
  }
