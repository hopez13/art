...
class DeoptManager {
 ...
 private:
  ...
  // Disables intrinsics and purges the jit code cache if needed. Returns true if intrinsics were
  // disabled and false if the state has not changed.
  bool MaybeDisableIntrinsics(bool do_disable)
