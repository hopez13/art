...
class ClassDefinitionPauser : public art::ClassLoadCallback {
 public:
  ...
  void ClassLoad(art::Handle<art::mirror::Class> klass [[maybe_unused]]) override {}
  void ClassPrepare(art::Handle<art::mirror::Class> klass1 [[maybe_unused]],
                    art::Handle<art::mirror::Class> klass2 [[maybe_unused]]) override {}
