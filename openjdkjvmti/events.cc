...
void EventHandler::SetupTraceListener(JvmtiMethodTraceListener* listener,
  ...
  // Need to skip this if its the breakpoint/single-step listener though since those events share
  // the same underlying event. We need to give them their own deopt request though.
