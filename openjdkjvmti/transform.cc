...
template
void Transformer::CallClassFileLoadHooksSingleClass<ArtJvmtiEvent::kClassFileLoadHookNonRetransformable>(
    EventHandler* event_handler, art::Thread* self, /*in-out*/ArtClassDefinition* def);
template
void Transformer::CallClassFileLoadHooksSingleClass<ArtJvmtiEvent::kClassFileLoadHookRetransformable>(
    EventHandler* event_handler, art::Thread* self, /*in-out*/ArtClassDefinition* def);
template
void Transformer::CallClassFileLoadHooksSingleClass<ArtJvmtiEvent::kStructuralDexFileLoadHook>(
    EventHandler* event_handler, art::Thread* self, /*in-out*/ArtClassDefinition* def);
...
void Transformer::CallClassFileLoadHooks(
    art::Thread* self,
  ...
  if (kType == RedefinitionType::kNormal) {
    ...
    for (ArtClassDefinition& def : *definitions) {
      CallClassFileLoadHooksSingleClass<ArtJvmtiEvent::kClassFileLoadHookRetransformable>(gEventHandler, self, &def);
    }
  } else {
    ...
    // behaviour.
    for (ArtClassDefinition& def : *definitions) {
      CallClassFileLoadHooksSingleClass<ArtJvmtiEvent::kStructuralDexFileLoadHook>(gEventHandler, self, &def);
    }
    for (ArtClassDefinition& def : *definitions) {
      CallClassFileLoadHooksSingleClass<ArtJvmtiEvent::kClassFileLoadHookRetransformable>(gEventHandler, self, &def);
    }
