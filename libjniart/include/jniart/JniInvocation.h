...
#ifndef ART_LIBJNIART_INCLUDE_JNIART_JNIINVOCATION_H_
#define ART_LIBJNIART_INCLUDE_JNIART_JNIINVOCATION_H_

#include "libjniart_api.h"
...
#endif  // ART_LIBJNIART_INCLUDE_JNIART_JNIINVOCATION_H_
