...
from bisection_search.common import GetJackClassPath
from bisection_search.common import RetCode
from bisection_search.common import RunCommand
...
class DexFuzzTester(object):
  ...
  def RunDexFuzz(self):
    ...
    day = 60 * 60 * 24
    if RunCommand(cmd, out='dexfuzzout.txt', err='dexfuzzerr.txt',
                  timeout=day) != RetCode.SUCCESS:
      raise FatalError('Unexpected error while running DexFuzz')
...
def main():
  ...
  parser.add_argument('--num_inputs', default=100,
