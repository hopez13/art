...
class DexMember {
 public:
  ...
  inline bool IsVirtualMethod() const {
    return IsMethod() && !GetMethod().IsStaticOrDirect();
  }
...
class Hierarchy FINAL {
 ...
 private:
  ...
  void BuildClassHierarchy() {
    ...
    class_path_.ForEachDexClass([this](const DexClass& klass) {
...
class HiddenApi FINAL {
 ...
 private:
  ...
  void EncodeAccessFlags() {
    ...
    boot_class_path.ForEachDexMember([&api_list](const DexMember& boot_member) {
  ...
  void ListApi() {
    ...
    boot_class_path.ForEachDexMember([&boot_members](const DexMember& boot_member) {
    ...
    stub_class_path.ForEachDexMember(
        [&boot_hierarchy, &boot_members, &unresolved](const DexMember& stub_member) {
