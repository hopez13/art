...
TEST_F(HiddenApiTest, InstanceFieldDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxO(), GetIFieldHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, StaticFieldDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxO(), GetSFieldHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, InstanceMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxO(), GetIMethodHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, StaticMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxO(), GetSMethodHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, InstanceNativeMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxO(), GetINMethodHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, StaticNativeMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxO(), GetSNMethodHiddenFlags(*dex_file));
}
