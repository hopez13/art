...
TEST_F(HiddenApiTest, InstanceFieldDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxOMR1(), GetIFieldHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, StaticFieldDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxOMR1(), GetSFieldHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, InstanceMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxOMR1(), GetIMethodHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, StaticMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxOMR1(), GetSMethodHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, InstanceNativeMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxOMR1(), GetINMethodHiddenFlags(*dex_file));
}
...
TEST_F(HiddenApiTest, StaticNativeMethodDarkGreylistMatch) {
  ...
  auto dex_file = RunHiddenApi(light_greylist, dark_greylist, blacklist, {}, &dex);
  ASSERT_NE(dex_file.get(), nullptr);
  ASSERT_EQ(hiddenapi::ApiList::BlacklistMaxOMR1(), GetSNMethodHiddenFlags(*dex_file));
}
