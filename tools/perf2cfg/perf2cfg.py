...
Example:
    ./perf2cfg.py --cfg bench.cfg --perf-data perf.data
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        perf2cfg.py [-h|--help] --cfg CFG --perf-data PERF_DATA [PERF_DATA ...]
    ...
    args.events = args.events.split(',') if args.events else []
