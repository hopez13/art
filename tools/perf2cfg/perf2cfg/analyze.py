...
# This path will need to be updated on directory hierarchy changes in either
# platform/art or platform/system/extras
SCRIPTS_PATH = (
    pathlib.Path(__file__).parent /
    pathlib.Path('../../../../system/extras/simpleperf/scripts/')).resolve()
sys.path.append(str(SCRIPTS_PATH))

# Disable import-error as simpleperf_report_lib is not in pylint's `sys.path`,
# and wrong-import-position as we need to edit `sys.path` before importing the
# module
# pylint: disable=import-error,wrong-import-position
import simpleperf_report_lib
