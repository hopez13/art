...
#
# This script creates the final boot image profile (suitable to include in the platfrom build).
...
#
# It is strongly recomended that you make use of extensive critical user journeys flows in order
