...
if [[ "$#" -lt 5 ]]; then
  ...
  echo "Example: $0 output-dir device/google_car/bramble_car/preloaded-classes-wear boot.zip frameworks/base/config/preloaded-classes-denylist android1.prof android2.prof"
  echo "         $0 output-dir device/google_car/bramble_car/preloaded-classes-wear boot.zip frameworks/base/config/preloaded-classes-denylist android.prof --profman-arg --upgrade-startup-to-hot=true"
