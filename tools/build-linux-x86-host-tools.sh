...
# Script should always be run from the root of the android tree
...
prebuilts/build-tools/linux-x86/bin/soong_zip -o ${DIST_DIR}/host_binaries.zip -j ${HOST_BINARIES[*]/#/-f }
