...
public abstract class Mutation {
   ...
   * @return the serialized string representation of field(s) of mutation.
   */
  public abstract String getString();
  /**
   * Deserializes the strings back to the field(s) of mutation,
   * a string array as its argument. The string contains the individual
   * elements which were previously returned by getstring() method. elements[0] stores
   * the class name and elements[1] stores mutable code index which are predefined in
   * MutationSerializer.java. Users can deserialize the string representation in
   * elements[2] and so forth.
   * @param elements string array which contains serialized representations of
   * the field(s) of the mutation.
   */
