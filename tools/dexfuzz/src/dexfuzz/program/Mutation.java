...
public abstract class Mutation {
   ...
   * given a string array as its argument. The string contains the individual
   * elements which were previously constructed by getstring() method. elements[0] stores
