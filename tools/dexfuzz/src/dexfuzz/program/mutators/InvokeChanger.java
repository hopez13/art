...
public class InvokeChanger extends CodeMutator {
  ...
  static final Opcode[] INVOKE_LIST = {
  ...
  static final Opcode[] INVOKE_RANGE_LIST = {
  ...
  protected void applyMutation(Mutation uncastMutation) {
    ...
    Opcode newOpcode = getModifiedOpcode(invokeInsn);
  ...
  private Opcode getModifiedOpcode(MInsn mInsn) {
