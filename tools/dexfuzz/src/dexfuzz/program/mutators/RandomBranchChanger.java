...
public class RandomBranchChanger extends IfBranchChanger {
  ...
  private static final Opcode[] EQUALITY_CMP_OP_LIST = {Opcode.IF_EQ, Opcode.IF_NE,
      Opcode.IF_LT, Opcode.IF_GT, Opcode.IF_LE, Opcode.IF_GE} ;

  private static final Opcode[] ZERO_CMP_OP_LIST = {Opcode.IF_EQZ, Opcode.IF_NEZ,
  ...
  protected Opcode getModifiedOpcode(MInsn mInsn) {
    ...
    } else if (isZeroComparator(opcode)) {
