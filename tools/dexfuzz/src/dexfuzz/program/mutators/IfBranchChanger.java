...
/**
 * It mutates the comparison operators of the if statements by either 
 * changing them to their opposite comparison operators or to any random
 * comparison operator which is acceptable in the given condition.
 */
public abstract class IfBranchChanger extends CodeMutator {
  ...
  /**
   * Get a different if branch comparison operator.
   */
  protected abstract Opcode getModifiedOpcode(MInsn mInsn);

  /**
   * Get the tag of the mutation that was fired.
   * @return Tag of the type of Mutation used
   */
