 ...
 * statement by taking in a random instruction, checking whether
 * it is an if statement and, if so, changing the comparison
 * operator. The inheriting classes implement the change condition.
 * For example, by choosing the opposite comparison operator or 
 * by choosing a random comparison operator.
 */
