...
public class IfEqBranchChanger extends CodeMutator {
  /**
  ...
  public IfEqBranchChanger() { }

  public IfEqBranchChanger(Random rng, MutationStats stats, List<Mutation> mutations) {
