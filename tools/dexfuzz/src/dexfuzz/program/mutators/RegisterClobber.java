...
public class RegisterClobber extends CodeMutator{
  ...
  protected void applyMutation(Mutation uncastMutation) {
    ...
    // Insert any number between 0-100
    ...
    for (int i = 0; i <= totalRegUsed; i++) {
      ...
      newInsn.insn.vregB = randNum;
      mutatableCode.insertInstructionAt(newInsn, mutation.regClobberIdx);
    }

    Log.info("Assigned a value of " + randNum + " at " + mutation.regClobberIdx);
