...
VeriClass z_(Primitive::Type::kPrimBoolean, 0, nullptr);
VeriClass b_(Primitive::Type::kPrimByte, 0, nullptr);
VeriClass c_(Primitive::Type::kPrimChar, 0, nullptr);
VeriClass s_(Primitive::Type::kPrimShort, 0, nullptr);
VeriClass i_(Primitive::Type::kPrimInt, 0, nullptr);
VeriClass f_(Primitive::Type::kPrimFloat, 0, nullptr);
VeriClass d_(Primitive::Type::kPrimDouble, 0, nullptr);
VeriClass j_(Primitive::Type::kPrimLong, 0, nullptr);
VeriClass v_(Primitive::Type::kPrimVoid, 0, nullptr);
