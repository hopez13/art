...
void FlowAnalysisCollector::AnalyzeFieldSet(const Instruction& instruction [[maybe_unused]]) {
...
void FlowAnalysisSubstitutor::AnalyzeFieldSet(const Instruction& instruction [[maybe_unused]]) {
