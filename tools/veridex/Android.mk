...
$(system_stub_dex): $(TOPDIR)prebuilts/sdk/current/system/android.jar | $(ZIP2ZIP) $(DX)
...
$(oahl_stub_dex): $(TOPDIR)prebuilts/sdk/current/public/org.apache.http.legacy.jar | $(ZIP2ZIP) $(DX)
	$(transform-classes-d8.jar-to-dex)
