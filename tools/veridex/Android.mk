...
$(VERIDEX_FILES_PATH) : $(SOONG_ZIP) $(VERIDEX_FILES) $(app_compat_lists) $(HOST_OUT_EXECUTABLES)/veridex $(system_stub_dex) $(oahl_stub_dex)
	$(hide) $(SOONG_ZIP) -o $(PRIVATE_SYSTEM_STUBS_ZIP) -C $(dir $(system_stub_dex)) -f $(dir $(system_stub_dex))/classes*.dex
	$(hide) $(SOONG_ZIP) -o $(PRIVATE_OAHL_STUBS_ZIP) -C $(dir $(oahl_stub_dex)) -f $(dir $(oahl_stub_dex))/classes*.dex
