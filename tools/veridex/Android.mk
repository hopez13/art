...
# Local definition of full path of appcompat.sh. Using $(LOCAL_PATH) in the $(VERIDEX_FILES_PATH)
# rule does not work.
VERIDEX_FILES := $(LOCAL_PATH)/appcompat.sh

$(VERIDEX_FILES_PATH) : $(SOONG_ZIP)
	$(hide) $(SOONG_ZIP) -o $@ -C art/tools/veridex -f $(VERIDEX_FILES) \
                             -C $(dir $(lastword $(app_compat_lists))) $(addprefix -f , $(app_compat_lists)) \
                             -C $(HOST_OUT_EXECUTABLES) -f $(HOST_OUT_EXECUTABLES)/veridex

sdk: $(VERIDEX_FILES_PATH)
