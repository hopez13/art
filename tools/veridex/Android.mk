...
$(system_stub_dex): $(call resolve-prebuilt-android-path,system_current) | $(ZIP2ZIP) $(DX)
...
$(oahl_stub_dex): $(call get-sdk-dir,current)/org.apache.http.legacy.jar | $(ZIP2ZIP) $(DX)
	$(transform-classes-d8.jar-to-dex)
