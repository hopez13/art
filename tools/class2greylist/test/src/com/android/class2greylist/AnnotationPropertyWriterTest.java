...
public class AnnotationPropertyWriterTest {
    ...
    @Test
    public void testExportPropertiesEscapeCommas() {
        String signature = "foo";
        Map<String, String> annotationProperties = ImmutableMap.of(
                "prop", "val1, val2, val3"
        );
    ...
    public void testExportPropertiesEscapeQuotes() {
        String signature = "foo";
        Map<String, String> annotationProperties = ImmutableMap.of(
                // This | will be escaped, because the whole element will need to be quoted.
        ...
        String output = mByteArrayOutputStream.toString();
        String expected = "prop1,prop2,signature\n"
                + "|val1 , val2 || val3|,val1 | val2 | val3,foo\n";
        assertThat(output).isEqualTo(expected);
    }
}
