...
public class ApiComponentsTest extends AnnotationHandlerTestBase {
    ...
    private final StringCursor.ErrorReporter mErrorReporter = (error) -> fail(
            "Unexpected failure: " + error);

    @Test
    public void testGetApiComponentsPackageFromSignature() {
        ApiComponents api = ApiComponents.fromDexSignature(METHOD_SIGNATURE_WITHOUT_PARAMS,
                mErrorReporter);
    ...
    public void testGetApiComponentsFromSignature() {
        ApiComponents api = ApiComponents.fromDexSignature(METHOD_SIGNATURE_WITH_PARAMS,
                mErrorReporter);
    ...
    public void testGetApiComponentsFromFieldLink() {
        ApiComponents api = ApiComponents.fromLinkTag(LINK, FIELD_SIGNATURE, mErrorReporter);
        assertThat(api.getPackageName()).isEqualTo("a.b");
        assertThat(api.getClassName()).isEqualTo("C");
        assertThat(api.getMemberName()).isEqualTo("foo");
    }
