...
public class ApiResolverTest extends AnnotationHandlerTestBase {
    ...
    public void testFindPublicAlternativeFailDueToMultipleParameterTypes()
        ...
        thrown.expect(new TypeSafeMatcher<AlternativeNotFoundError>() {
            @Override
            protected boolean matchesSafely(AlternativeNotFoundError e) {
                assertThat(e.type).isEqualTo(
                        AlternativeNotFoundError.AlternativeType.MULTIPLE_METHOD_ALTERNATIVES_FOUND);
                try {
                ...
                } catch (SignatureSyntaxError signatureSyntaxError) {
                    fail("Could not parse signatures");
                }
                return true;
            }
    ...
    public void testFindPublicAlternativeFailNoAlternative()
        ...
        thrown.expect(new TypeSafeMatcher<AlternativeNotFoundError>() {
            ...
            protected boolean matchesSafely(AlternativeNotFoundError e) {
                assertThat(e.type).isEqualTo(
                        AlternativeNotFoundError.AlternativeType.METHOD_ALTERNATIVE_NOT_FOUND);
                return true;
            }
    ...
    public void testNoPublicClassAlternatives()
        ...
        thrown.expect(new TypeSafeMatcher<AlternativeNotFoundError>() {
            ...
            protected boolean matchesSafely(AlternativeNotFoundError e) {
                assertThat(e.type).isEqualTo(
                        AlternativeNotFoundError.AlternativeType.NO_ALTERNATIVE_SPECIFIED);
                return true;
            }
