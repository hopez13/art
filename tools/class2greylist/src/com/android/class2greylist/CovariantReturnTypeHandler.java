 ...
 * entries from them.
 *
 * A whitelist entry is generated with the same descriptor as the original
 * method, but with the return type replaced with than specified by the
 * {@link #RETURN_TYPE} property.
 *
 * Methods are also validate against the public API list, to assert that the
 * annotated method is already a public API.
 */
