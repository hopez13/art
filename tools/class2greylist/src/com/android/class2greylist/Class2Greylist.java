...
public class Class2Greylist {
     ...
     */
    private void addRepeatedAnnotationHandlers(
        Builder<String, AnnotationHandler> builder,
        String annotationName, String containerAnnotationName,
        AnnotationHandler handler) {
        builder.put(annotationName, handler);
        builder.put(containerAnnotationName, new RepeatedAnnotationHandler(annotationName, handler));
    }
