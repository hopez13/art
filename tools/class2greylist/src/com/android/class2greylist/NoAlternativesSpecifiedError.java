...
public class NoAlternativesSpecifiedError extends AlternativeNotFoundError {
    ...
    public String toString() {
        return "Hidden API has a public alternative annotation field, but no "
                + "concrete explanations. Please provide either a reference to an SDK method "
                + "using javadoc "
                + "syntax, e.g. {@link foo.bar.Baz#bat}, or a small code snippet if the "
                + "alternative is "
                + "part of a support library or third party library, e.g. "
