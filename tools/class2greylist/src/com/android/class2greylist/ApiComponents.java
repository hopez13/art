...
public class ApiComponents {
    ...
    public String toString() {
        if (mToString == null) {
            ...
            sb.append("(");
            sb.append(mMethodParameterTypes);
            sb.append(")");
    ...
    public static ApiComponents fromDexSignature(String signature,
            StringCursor.ErrorReporter errorReporter) {
        String packageName = "";
        String className = "";
        String memberName = "";
        String methodParameterTypes = "";
        StringCursor sc = new StringCursor(signature, errorReporter);
    ...
    public static ApiComponents fromLinkTag(String linkTag, String contextSignature,
            StringCursor.ErrorReporter errorReporter) {
        ApiComponents contextAlternative = fromDexSignature(contextSignature, errorReporter);
