...
public class ApiComponents {
    ...
    private ApiComponents(String packageName, String className, String memberName,
        ...
        if (!Strings.isNullOrEmpty(mPackageName)) {
        ...
        if (!Strings.isNullOrEmpty(methodParameterTypes)) {
            sb.append("(");
    ...
    public static ApiComponents fromDexSignature(String signature) {
        ...
        String memberName = "";
        String methodParameterTypes = "";
        StringCursor sc = new StringCursor(signature, error -> {
    ...
    public static ApiComponents fromLinkTag(String linkTag, String contextSignature,
        ...
        StringCursor sc = new StringCursor(linkTag, context::reportError);
        String packageName = "";
        String className = "";
        String memberName = "";
        String methodParameterTypes = "";
