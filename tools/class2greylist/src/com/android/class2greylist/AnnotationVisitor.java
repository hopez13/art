...
public class AnnotationVisitor extends EmptyVisitor {
    ...
    public AnnotationVisitor(
            JavaClass clazz, String annotation, Set<String> publicApis, Status s) {
        this(clazz, annotation, sig -> publicApis.contains(sig), s);
    }

    @VisibleForTesting
    public AnnotationVisitor(JavaClass clazz, String annotation, Predicate<Member> memberFilter, Status s) {
        mClass = clazz;
