...
public class AnnotationVisitor extends EmptyVisitor {
                ...
                for (ElementValuePair property : a.getElementValuePairs()) {
                    switch (property.getNameString()) {
                        case EXPECTED_SIGNATURE:
                            ...
                            break;
                        case MAX_TARGET_SDK:
                            maxTargetSdk = verifyAndGetMaxTargetSdk(property, definingClass, member);
                            break;
                    }
                }
    ...
    private Integer verifyAndGetMaxTargetSdk(ElementValuePair property, JavaClass definingClass, FieldOrMethod member) {
