...
class BitmapHandler implements HttpHandler {
  ...
  public void handle(HttpExchange exchange) throws IOException {
    try {
      ...
      if (info != null) {
        BufferedImage image = bufferedImageForBitmap(info);
  ...
  private static BufferedImage bufferedImageForBitmap(BitmapInfo info) {
    ...
    image.setRGB(0, 0, info.width, info.height, abgr, 0, info.width);
    return image;
  }
}
