...
public class Value {
  ...
  /**
   * Construct a value from a generic Java Object. The Object must either be a
   * boxed Java primitive type or a subclass of AhatInstance.
   */
  Value(Object object) {
    // TODO: Check that the Object has the right type.
    mObject = object;
    if (object == null) {
