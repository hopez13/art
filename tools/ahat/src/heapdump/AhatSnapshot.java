...
public class AhatSnapshot {
  ...
  public static AhatSnapshot fromHprof(File hprof) throws IOException {
    return fromDataBuffer(new MemoryMappedFileBuffer(hprof));
  }

  /**
   * Create an AhatSnapshot from an in-memory data buffer.
   */
  public static AhatSnapshot fromDataBuffer(DataBuffer buffer) throws IOException {
    AhatSnapshot snapshot = new AhatSnapshot(buffer);
   ...
   */
  private AhatSnapshot(DataBuffer buffer) throws IOException {
