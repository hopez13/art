...
public class DominatorsComputation {
  ...
  public interface Node {
    /**
     * Associates the given dominator state with this node.
     * Subsequent calls to
     ...
     * This method will be called at most once for each node reachable from
     * the root node of the dominators computation.
     *
