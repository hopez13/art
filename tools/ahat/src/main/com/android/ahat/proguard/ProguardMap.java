...
public class ProguardMap {
  ...
  private static class FrameData {
    ...
    public final TreeMap<Integer, LineNumber> lineNumbers = new TreeMap<>();
  ...
  private static class LineNumber {
    ...
    public final int obfuscatedLineStart;
    public final int obfuscatedLineEnd;
    public final int clearLineStart;
  }
