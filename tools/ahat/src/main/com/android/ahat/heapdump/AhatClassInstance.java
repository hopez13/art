...
public class AhatClassInstance extends AhatInstance {
   ...
   * read.
   */
  public Integer getIntField(String fieldName, Integer def) {
    Value value = getField(fieldName);
   ...
   * be read.
   */
  public Long getLongField(String fieldName, Long def) {
    Value value = getField(fieldName);
   ...
   * AhatArrayInstance.
   */
  public AhatArrayInstance getArrayField(String fieldName) {
  ...
  @Override public AhatInstance getAssociatedBitmapInstance() {
    return isBitmapInstance() ? this : null;
  }
