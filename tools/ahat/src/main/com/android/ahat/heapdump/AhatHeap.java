 ...
 * heap from the heap dump.
 * Standard Java heap dumps have a single heap, called the "default"
 * heap. Android heap dumps distinguish among "zygote", "image", and "app"
 * heaps. There will be a single instance of AhatHeap for each different heap
 * in the heap dump.
 */
