...
/**
 * A Java instance from a parsed heap dump.
 * It is the base class used for all kinds of Java instances, including normal
 * Java objects, class objects, and arrays.
 */
public abstract class AhatInstance implements Diffable<AhatInstance>,
  ...
  /**
   * Returns the total number of bytes retained by this object.
   * The returned size includes the shallow size of this object and the size
   * of all objects directly or indirectly retained by this object.
   *
   ...
   * An object is strongly reachable if there exists a path of (strong)
   * references from some root object to this object.
   *
   ...
   * An object is weakly reachable if it is not strongly reachable but there
   * still exists a path of references from some root object to this object.
   * Because the object is not strongly reachable, any such path must contain
   * a SoftReference, WeakReference, PhantomReference, or FinalizerReference
   * somewhere along it.
   * <p>
   ...
   * An object is completely unreachable if there is no path to the object
   * from some root object, neither through strong nor
   * soft/weak/phantom/finalizer references.
   *
  ...
  /**
   * Returns a list of objects with soft/weak/phantom/finalizer references to this object.
   *
  ...
  /**
   * Returns the value of a field of this instance.
   ...
   * Returns null if the field value is null, of primitive type, or if the
   * field couldn't be read. There is no way using this method to distinguish
   * between a reference field with value null and an invalid field.
   *
  ...
  /**
   * Returns the dex location associated with this object.
   * Only applies to instances of dalvik.system.DexCache.
   * If this is an instance of DexCache, returns the dex location for that dex
  ...
  /**
   * Returns the string associated with this instance.
   * Applies to instances of java.lang.String, char[], and in some cases
   * byte[]. Returns null if this object cannot be interpreted as a string.
   *
   * @return the string associated with this instance
  ...
  /**
   * Returns the bitmap pixel data associated with this given instance.
   ...
   * The first element of the returned path is a GC root object. This instance
   * is included as the last element of the path with an empty field
   * description.
   * <p>
