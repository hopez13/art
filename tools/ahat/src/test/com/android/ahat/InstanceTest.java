...
public class InstanceTest {
  ...
  @Test
  public void binderProxyAnnotation() throws IOException {
    TestDump dump = TestDump.getTestDump();
    AhatInstance obj = dump.getDumpedAhatInstance("binderProxy");
    assertEquals("DumpedStuff$IDumpedManager", obj.getBinderInterface());
  }
}
