...
static void CbClassFileLoadHook(jvmtiEnv* jvmti,
                                ...
                                jclass classBeingRedefined [[maybe_unused]],
                                jobject loader [[maybe_unused]],
                                const char* name,
                                jobject protectionDomain [[maybe_unused]],
                                jint classDataLen,
...
static void AgentMain(jvmtiEnv* jvmti, JNIEnv* jni, void* arg [[maybe_unused]]) {
  AgentInfo* ai = GetAgentInfo(jvmti);
...
static void CbVmInit(jvmtiEnv* jvmti, JNIEnv* env, jthread thr [[maybe_unused]]) {
