...
#define FOR_ALL_SUPPORTED_EVENTS(jni_fun, non_jni_fun)          \
...
FOR_ALL_SUPPORTED_EVENTS(GET_EVENT, GET_EVENT)
#undef GET_EVENT
};

#define GENERATE_EMPTY_FUNCTION(name, number, args, argnames) \
    static void JNICALL empty ## name  args { Unused argnames ; }
FOR_ALL_SUPPORTED_EVENTS(GENERATE_EMPTY_FUNCTION, GENERATE_EMPTY_FUNCTION)
...
#define CREATE_EMPTY_EVENT_CALLBACKS(name, num, args, argnames) \
    .name = empty ## name,
  FOR_ALL_SUPPORTED_EVENTS(CREATE_EMPTY_EVENT_CALLBACKS, CREATE_EMPTY_EVENT_CALLBACKS)
...
FOR_ALL_SUPPORTED_EVENTS(GENERATE_LOG_FUNCTION_JNI, GENERATE_LOG_FUNCTION_NO_JNI)
...
#define CREATE_LOG_EVENT_CALLBACK(name, num, args, argnames) \
    .name = log ## name,
  FOR_ALL_SUPPORTED_EVENTS(CREATE_LOG_EVENT_CALLBACK, CREATE_LOG_EVENT_CALLBACK)
...
#define CHECK_NAME(name, event, args, argnames) \
  ...
  FOR_ALL_SUPPORTED_EVENTS(CHECK_NAME, CHECK_NAME);
