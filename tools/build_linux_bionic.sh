...
find $out_dir/ -maxdepth 1 -mindepth 1 -not -name soong -not -name host -not -name target | xargs -I '{}' rm -rf '{}'
find $out_dir/soong/ -maxdepth 1 -mindepth 1 -not -name .intermediates -not -name host -not -name target | xargs -I '{}' rm -rf '{}'
