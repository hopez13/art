...
>    `adb shell am start-activity --attach-agent /data/local/tmp/libtifast.so=MonitorWait,ClassPrepare com.antonioleiva.bandhookkotlin/.ui.screens.main.MainActivity`
