...
ART_TEST_ON_LINUX=true . "$(dirname $0)/buildbot-utils.sh"
...
(
    ...
    if [[ "$TARGET_ARCH" = "riscv64" ]]; then
        ...
        #mkdir tmp && cd tmp
        #wget http://security.ubuntu.com/ubuntu/pool/main/u/u-boot/u-boot-qemu_2022.01+dfsg-2ubuntu2.3_all.deb
        #7z x u-boot-qemu_2022.01+dfsg-2ubuntu2.3_all.deb && zstd -d data.tar.zst && tar -xf data.tar
        #mv usr/lib/u-boot/qemu-riscv64_smode/uboot.elf ..
        #cd .. && rm -rf tmp
        ...
        #mkdir tmp && cd tmp
        #wget http://security.ubuntu.com/ubuntu/pool/main/o/opensbi/opensbi_1.1-0ubuntu0.22.04.1_all.deb
        #7z x opensbi_1.1-0ubuntu0.22.04.1_all.deb && zstd -d data.tar.zst && tar -xf data.tar
        #mv usr/lib/riscv64-linux-gnu/opensbi/generic/fw_jump.elf ..
        #cd .. && rm -rf tmp
        ...
        #mkdir tmp && cd tmp
        #wget http://security.ubuntu.com/ubuntu/pool/main/e/edk2/qemu-efi-aarch64_2022.02-3ubuntu0.22.04.1_all.deb
        #7z x qemu-efi-aarch64_2022.02-3ubuntu0.22.04.1_all.deb && zstd -d data.tar.zst && tar -xf data.tar
