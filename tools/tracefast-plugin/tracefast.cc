...
class Tracer final : public art::instrumentation::InstrumentationListener {
 public:
  ...
  void MethodEntered(art::Thread* thread [[maybe_unused]],
                     art::ArtMethod* method [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void MethodExited(art::Thread* thread [[maybe_unused]],
                    art::ArtMethod* method [[maybe_unused]],
                    art::instrumentation::OptionalFrame frame [[maybe_unused]],
                    art::MutableHandle<art::mirror::Object>& return_value [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void MethodExited(art::Thread* thread [[maybe_unused]],
                    art::ArtMethod* method [[maybe_unused]],
                    art::instrumentation::OptionalFrame frame [[maybe_unused]],
                    art::JValue& return_value [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void MethodUnwind(art::Thread* thread [[maybe_unused]],
                    art::ArtMethod* method [[maybe_unused]],
                    uint32_t dex_pc [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void DexPcMoved(art::Thread* thread [[maybe_unused]],
                  art::Handle<art::mirror::Object> this_object [[maybe_unused]],
                  art::ArtMethod* method [[maybe_unused]],
                  uint32_t new_dex_pc [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void FieldRead(art::Thread* thread [[maybe_unused]],
                 art::Handle<art::mirror::Object> this_object [[maybe_unused]],
                 art::ArtMethod* method [[maybe_unused]],
                 uint32_t dex_pc [[maybe_unused]],
                 art::ArtField* field [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void FieldWritten(art::Thread* thread [[maybe_unused]],
                    art::Handle<art::mirror::Object> this_object [[maybe_unused]],
                    art::ArtMethod* method [[maybe_unused]],
                    uint32_t dex_pc [[maybe_unused]],
                    art::ArtField* field [[maybe_unused]],
                    art::Handle<art::mirror::Object> field_value [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}
  ...
  void FieldWritten(art::Thread* thread [[maybe_unused]],
                    ...
                    uint32_t dex_pc [[maybe_unused]],
                    art::ArtField* field [[maybe_unused]],
                    const art::JValue& field_value [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void ExceptionThrown(art::Thread* thread [[maybe_unused]],
                       art::Handle<art::mirror::Throwable> exception_object
                       [[maybe_unused]]) override REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void ExceptionHandled(art::Thread* self [[maybe_unused]],
                        art::Handle<art::mirror::Throwable> throwable [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void Branch(art::Thread* thread [[maybe_unused]],
              art::ArtMethod* method [[maybe_unused]],
              uint32_t dex_pc [[maybe_unused]],
              int32_t dex_pc_offset [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}

  void WatchedFramePop(art::Thread* thread [[maybe_unused]],
                       const art::ShadowFrame& frame [[maybe_unused]]) override
      REQUIRES_SHARED(art::Locks::mutator_lock_) {}
