...
OdrMetricsRecord OdrMetrics::ToRecord() const {
  ...
  if (primary_bcp_dex2oat_result_.has_value()) {
    ExecResult primary_bcp_result = primary_bcp_dex2oat_result_.value();
    record.primary_bcp_dex2oat_result_status = primary_bcp_result.status;
    record.primary_bcp_dex2oat_result_exit_code = primary_bcp_result.exit_code;
    record.primary_bcp_dex2oat_result_signal = primary_bcp_result.signal;
  } else {
    record.primary_bcp_dex2oat_result_status = -1;  // EXEC_RESULT_STATUS_NOT_RUN in atoms.proto
  ...
  if (secondary_bcp_dex2oat_result_.has_value()) {
    ExecResult secondary_bcp_result = secondary_bcp_dex2oat_result_.value();
    record.secondary_bcp_dex2oat_result_status = secondary_bcp_result.status;
    record.secondary_bcp_dex2oat_result_exit_code = secondary_bcp_result.exit_code;
    record.secondary_bcp_dex2oat_result_signal = secondary_bcp_result.signal;
  } else {
    record.secondary_bcp_dex2oat_result_status = -1;  // EXEC_RESULT_STATUS_NOT_RUN in atoms.proto
  ...
  if (system_server_dex2oat_result_.has_value()) {
    ...
    record.system_server_dex2oat_result_status = -1;  // EXEC_RESULT_STATUS_NOT_RUN in atoms.proto
