...
// stats/atoms/art/odrefresh_extension_atoms.proto for primary boot classpath.
int32_t TranslatePrimaryCompilationType(int32_t art_metrics_compilation_type) {
  switch (static_cast<OdrMetrics::BcpCompilationType>(art_metrics_compilation_type)) {
    case OdrMetrics::BcpCompilationType::kUnknown:
      return metrics::statsd::
          ODREFRESH_REPORTED__PRIMARY_BCP_COMPILATION_TYPE__BCP_COMPILATION_TYPE_UNKNOWN;
    case OdrMetrics::BcpCompilationType::kPrimaryAndMainline:
      return metrics::statsd::
          ODREFRESH_REPORTED__PRIMARY_BCP_COMPILATION_TYPE__BCP_COMPILATION_TYPE_PRIMARY_AND_MAINLINE;
    case OdrMetrics::BcpCompilationType::kMainline:
      return metrics::statsd::
          ODREFRESH_REPORTED__PRIMARY_BCP_COMPILATION_TYPE__BCP_COMPILATION_TYPE_MAINLINE;
  }
}

// Convert bare value from art::metrics::BcpCompilationType to value defined in
// stats/atoms/art/odrefresh_extension_atoms.proto for secondary boot classpath.
int32_t TranslateSecondaryCompilationType(int32_t art_metrics_compilation_type) {
  switch (static_cast<OdrMetrics::BcpCompilationType>(art_metrics_compilation_type)) {
    case OdrMetrics::BcpCompilationType::kUnknown:
      return metrics::statsd::
          ODREFRESH_REPORTED__SECONDARY_BCP_COMPILATION_TYPE__BCP_COMPILATION_TYPE_UNKNOWN;
    case OdrMetrics::BcpCompilationType::kPrimaryAndMainline:
      return metrics::statsd::
          ODREFRESH_REPORTED__SECONDARY_BCP_COMPILATION_TYPE__BCP_COMPILATION_TYPE_PRIMARY_AND_MAINLINE;
    case OdrMetrics::BcpCompilationType::kMainline:
      return metrics::statsd::
          ODREFRESH_REPORTED__SECONDARY_BCP_COMPILATION_TYPE__BCP_COMPILATION_TYPE_MAINLINE;
  }
}
...
bool ReadValues(const char* metrics_file,
  ...
  record->primary_bcp_compilation_type =
      TranslatePrimaryCompilationType(record->primary_bcp_compilation_type);
  ...
  record->secondary_bcp_compilation_type =
      TranslateSecondaryCompilationType(record->secondary_bcp_compilation_type);
