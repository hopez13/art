...
// stats/atoms/art/odrefresh_extension_atoms.proto.
int32_t TranslateCompilationType(int32_t art_metrics_compilation_type, bool primary) {
...
bool ReadValues(const char* metrics_file,
  ...
  record->primary_bcp_compilation_type =
      TranslateCompilationType(record->primary_bcp_compilation_type, true);
  ...
  record->secondary_bcp_compilation_type =
      TranslateCompilationType(record->secondary_bcp_compilation_type, false);
