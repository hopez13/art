...
class OdrConfig final {
 ...
 public:
  ...
  bool UseCompilationOs() const { return !cid_.empty(); }
  std::string GetCompilationOsAddress() const { return cid_; }
  ...
  void SetCompilationOsAddress(const std::string& cid) { cid_ = cid; }
