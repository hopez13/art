 ...
 public:
  ...
  std::vector<InstructionSet> GetBootExtensionIsas() const {
    ...
    switch (zygote_kind_) {
      ...
      case ZygoteKind::kZygote64_32:
        LOG_FATAL_IF(isa64 == InstructionSet::kNone, "64-bit boot extensions are not supported.");
        return {isa32, isa64};
  ...
  InstructionSet GetSystemServerIsa() const {
    ...
    switch (zygote_kind_) {
      ...
      case ZygoteKind::kZygote64_32:
      case ZygoteKind::kZygote64:
        LOG_FATAL_IF(isa64 == InstructionSet::kNone, "64-bit system-server are not supported.");
        return isa64;
    }
  }
  ...
  std::pair<InstructionSet, InstructionSet> GetPotentialInstructionSets() const {
    switch (isa_) {
      case art::InstructionSet::kArm:
        return std::make_pair(art::InstructionSet::kArm, art::InstructionSet::kNone);
      ...
      case art::InstructionSet::kX86:
        return std::make_pair(art::InstructionSet::kX86, art::InstructionSet::kNone);
