...
class OdrMetricsRecordTest : public CommonArtTest {
 protected:
  void WriteFile() {
    ...
    ofs << "<stage_reached>286397204</stage_reached>", ofs << status_;
    ...
    ofs << primaryBcpDex2OatResult_;
    ofs << secondaryBcpDex2OatResult_;
    ofs << systemServerDex2OatResult_;
    ofs << "</odrefresh_metrics>";
...
TEST_F(OdrMetricsRecordTest, ExpectedElementNotFound) {
  metricsVersion_ = "<not_valid_metric>25</not_valid_metric>";
  WriteFile();
...
TEST_F(OdrMetricsRecordTest, ExpectedAttributeNotFound) {
  // Missing "status".
  primaryBcpDex2OatResult_ = R"(<primary_bcp_dex2oat_result exit-code="17" signal="18" />)";
  WriteFile();
...
TEST_F(OdrMetricsRecordTest, UnexpectedOdrefreshMetricsVersion) {
  metricsVersion_ = "<odrefresh_metrics_version>0</odrefresh_metrics_version>";
  WriteFile();
