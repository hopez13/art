...
struct OdrMetricsRecord {
  ...
  OdrMetricsRecord() :
    odrefresh_metrics_version(0),
    art_apex_version(0),
    trigger(0),
    stage_reached(0),
    status(0),
    cache_space_free_start_mib(0),
    cache_space_free_end_mib(0),
    primary_bcp_compilation_millis(0),
    secondary_bcp_compilation_millis(0),
    system_server_compilation_millis(0),
