...
class OnDeviceRefresh final {
 ...
 private:
  ...
  static std::string GetBootImagePathWithoutIsa();

  std::string GetBootExtensionImagePathWithoutIsa(bool on_system) const;

  std::string GetBootExtensionImagePath(bool on_system, const InstructionSet isa) const;
