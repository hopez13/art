...
//
// NB if odrefresh crashes, then the caller shouldthe caller should not sign any artifacts and
// should any remove unsigned artifacts under /data/misc/apexdata/com.android.art/system/framework.
//
enum ExitCode {
  ...
  // Compilation failed. Artifacts under /data/misc/apexdata/com.android.art/system/framework
  // will be valid. This may happen, for example, if compilation of boot extensions succeeds, but
  // the compilation of the system_server jars fails due to lack of storage space.
