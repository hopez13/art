...
//
// NB if odrefresh crashes the caller should not sign any artifacts and should any remove unsigned
// artifacts remaining under /data/misc/apexdata/com.android.art/system/framework.
//
enum ExitCode {
