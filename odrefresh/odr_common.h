...
// Returns true if there is no need to refresh existing artifacts on this device. See
// `OnDeviceRefresh::RefreshExistingArtifacts` for more details. Takes a string got from
