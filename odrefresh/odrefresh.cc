 ...
 public:
  ...
  WARN_UNUSED bool CheckSystemServerArtifactsAreUpToDate(
    ...
    if (std::all_of(apex_info_list.begin(),
      ...
      // Currently, the check will never pass because we don't have artifacts on /system for APEX
      // jars.
      ...
      LOG(INFO) << "Incomplete system server artifacts on /system. Checking cache." << error_msg;
    }
