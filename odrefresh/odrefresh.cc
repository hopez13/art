...
void AddDex2OatCommonOptions(/*inout*/ std::vector<std::string>& args) {
  ...
  // dex2oat reads some system properties from cache-info.xml generated by dex2oat.
  args.emplace_back("--runtime-arg");
  args.emplace_back("-Xdalvikcachedir:" + GetApexDataDalvikCacheDirectory(InstructionSet::kNone));
}
