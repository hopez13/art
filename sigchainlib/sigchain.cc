...
void SignalChain::Handler(int signo, siginfo_t* siginfo, void* ucontext_raw) {
  ...
  // android_handle_signal returning true), then we should return from this handler and let the app
  // continue.
  //
  ...
  // logic.
  if (android_handle_signal && android_handle_signal(signo, siginfo, ucontext_raw)) {
    return;
  }
