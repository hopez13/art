...
class OatDumpTest : public CommonRuntimeTest {
 protected:
  ...
  bool GenerateAppOdexFile(Flavor flavor,
    ...
    std::vector<std::string> exec_argv = { dex2oat_path };
    exec_argv.push_back("--runtime-arg");
    exec_argv.push_back("-Xms64m");
    exec_argv.push_back("--runtime-arg");
    exec_argv.push_back("-Xmx512m");
    exec_argv.push_back("--runtime-arg");
    exec_argv.push_back("-Xnorelocate");
    ...
    exec_argv.push_back("--compiler-filter=speed");
