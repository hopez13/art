...
int32_t DexLayout::LayoutCodeItems(std::vector<dex_ir::ClassData*>& new_class_data_order) {
  ...
  int32_t diff = VisitCodeItems(new_class_data_order, visited_code_items, code_item_offset, true);
  diff += VisitCodeItems(new_class_data_order, visited_code_items, code_item_offset, false);
