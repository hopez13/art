...
static void DisplayDexStatistics(size_t start,
  ...
  // Print the summary.
  std::cout << StringPrintf("%-*s resident   total      %% of   %% of",
                            section_header_width, kSectionHeader)
            << std::endl;
  std::cout << StringPrintf("%-*s pages      pages      sect.  total", section_header_width, "")
            << std::endl;
  for (size_t i = sections.size(); i > 0; --i) {
    ...
    std::cout << StringPrintf("%-*s %-10zd %-10zd %-6.2f %-.2f",
  ...
  std::cout << StringPrintf("%-*s %-10zd %-10zd        %-6.2f",
                            section_header_width,
                            "GRAND TOTAL",
