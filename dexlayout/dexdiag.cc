...
static void DisplayDexStatistics(size_t start,
  ...
  std::cout << "Section name               resident   total      % of   % of" << std::endl;
  std::cout << "                           pages      pages      sect.  total" << std::endl;
  for (size_t i = sections.size(); i > 0; --i) {
    ...
    std::cout << StringPrintf("%-26s %-10zd %-10zd %-6.2f %-.2f",
