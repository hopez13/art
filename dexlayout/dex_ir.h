...
class CodeFixups {
 public:
  ...
  std::vector<TypeId*>* TypeIds() { return &type_ids_; }
  std::vector<StringId*>* StringIds() { return &string_ids_; }
  std::vector<MethodId*>* MethodIds() { return &method_ids_; }
  std::vector<FieldId*>* FieldIds() { return &field_ids_; }
