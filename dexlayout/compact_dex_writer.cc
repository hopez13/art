...
uint32_t CompactDexWriter::WriteCodeItem(dex_ir::CodeItem* code_item,
  ...
  // Don't write the fake instruction array at the end.
...
void CompactDexWriter::WriteMemMap() {
  ...
  // TODO: Change the debug info order to minimize the size of the offset table. Currently, sorting
  // by dex method index produces the best result.
