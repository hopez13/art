...
// TODO Make this read from a property or something.
static constexpr char kJdwpAgentName[] = "libjdwp.so";
...
class AdbConnectionState {
 ...
 private:
  ...
  // True if the dt_fd_forward transport has the socket. If so we don't do anything to it or the adb
  // connection until it goes away.
