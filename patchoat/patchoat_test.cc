...
TEST_F(PatchoatTest, RelFileSufficientToUnpatch) {
  ...
  // This test doesn't work when heap poisoning because some of the references
  // are negated. b/72117833 is tracking the effort the have patchoat and it's
  // tests support heap poisoning.
