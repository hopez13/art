...
class DisassemblerRiscv64::Printer {
 ...
 private:
  ...
  static uint32_t Uimm2ToOffset10(uint32_t uimm2) { return (uimm2 >> 1) | (uimm2 & 0x1u) << 1; }

  static uint32_t Uimm2ToOffset1(uint32_t uimm2) { return (uimm2 & 0x1u) << 1; }
      ...
      switch (funct3) {
        ...
        case 0b100u: {
          ...
          switch (funct2) {
            ...
            case 0b10:
              os_ << "c.andi " << XRegName(GetRs1Short16(insn16)) << Decode16Imm6<int32_t>(insn16);
              break;
            case 0b11: {
