...
class DisassemblerRiscv64::Printer {
 ...
 private:
  ...
  static const char* DecodeRVVMemMnemonic(const uint32_t insn32, const char*& rs2, bool is_load);
...
const char* DisassemblerRiscv64::Printer::DecodeRVVMemMnemonic(const uint32_t insn32,
  ...
  switch (mop) {
    case MemAddressMode::kUnitStride: {
      ...
      switch (umop) {
        case 0b00000:  // Vector Unit-Stride
          static constexpr const char* const VUS_Mnemonics[8][4] = {
          ...
          return VUS_Mnemonics[enum_cast<uint32_t>(nf)][width_index];
        case 0b01000: {  // Vector Whole Register Load
          static constexpr const char* const VWH_Mnemonics[][4] = {
          ...
          return VWH_Mnemonics[enum_cast<uint32_t>(nf)][width_index];
        }
        ...
        case 0b10000:  // Vector Unit-Stride Fault-Only-First Load
          static constexpr const char* const VUSFFL_Mnemonics[8][4] = {
          ...
          return is_load ? VUSFFL_Mnemonics[enum_cast<uint32_t>(nf)][width_index] : nullptr;
        default:  // Unknown
          return nullptr;
      }
    }
    case MemAddressMode::kIndexedUnordered: {
      static constexpr const char* const VIU_Mnemonics[8][4] = {
      ...
      return VIU_Mnemonics[enum_cast<uint32_t>(nf)][width_index];
    }
    case MemAddressMode::kStrided: {
      static constexpr const char* const VS_Mnemonics[8][4] = {
      ...
      return VS_Mnemonics[enum_cast<uint32_t>(nf)][width_index];
    }
    case MemAddressMode::kIndexedOrdered: {
      static constexpr const char* const VIO_Mnemonics[8][4] = {
      ...
      rs2 = VRegName(GetRs2(insn32));
      return VIO_Mnemonics[enum_cast<uint32_t>(nf)][width_index];
    }
  }
}

static constexpr const char* const fpMemMnemonics[] = {
  nullptr, "h", "w", "d"
...
void DisassemblerRiscv64::Printer::Print32FLoad(uint32_t insn32) {
  ...
  const char* mnemonic = fpMemMnemonics[funct3];
  const char* prefix = "f";
  if (mnemonic == nullptr) {
    // Vector Loads
    prefix = "v";
    mnemonic = DecodeRVVMemMnemonic(insn32, rs2, /*is_load=*/true);
...
void DisassemblerRiscv64::Printer::Print32FStore(uint32_t insn32) {
  ...
  if (mnemonic == nullptr) {
    ...
    const char* rs2 = nullptr;
    prefix = "v";
    mnemonic = DecodeRVVMemMnemonic(insn32, rs2, /*is_load=*/false);
...
void DisassemblerRiscv64::Printer::AppendVType(uint32_t vtype) {
  ...
  if ((vsew_v & 0x4U) == 0u) {
    if (lmul_v != 0b100) {
      ...
      const char* vsew = vsews[vsew_v & 0x3];
...
static void MaybeSwapOperands(uint32_t funct6, const char* &rs1, const char* &rs2) {
...
void DisassemblerRiscv64::Printer::Print32RVVOp(uint32_t insn32) {
  ...
  switch (via) {
    case VAIEncodings::kOpIVV: {  // 1, vv, R VVV
      static constexpr const char* const OPIVVOpcodes[64] = {
    ...
    case VAIEncodings::kOpIVI: {  // 3, vi, RVV VIV
      ...
      if (funct6 == 0b010111) {
        ...
        static const char* const vmvnrOpcodes[8] = {
            "vmv1r.v", "vmv2r.v", nullptr, "vmv4r.v",
            nullptr,   nullptr,   nullptr, "vmv8r.v",
        };
        if (IsUint<3>(rs1V)) {
          opcode = vmvnrOpcodes[rs1V];
        }
      } else {
    ...
    case VAIEncodings::kOpFVV: {  // 6, vv, R
      switch (funct6) {
        ...
        case VFUNARY0: {
          static const char* const VFUNARY0Opcodes[32] = {
        ...
        default: {
          static const char* const OPFVVOpcodes[64] = {
              ...
              nullptr,       nullptr,         nullptr,      "<vfmerge/vfmv>",
