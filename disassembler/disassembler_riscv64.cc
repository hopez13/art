...
static const uint32_t VWXUNARY0 = 0b010000;
static const uint32_t VRXUNARY0 = 0b010000;
static const uint32_t VXUNARY0 = 0b010010;
static const uint32_t VMUNARY0 = 0b010100;

static const uint32_t VWFUNARY0 = 0b010000;
static const uint32_t VRFUNARY0 = 0b010000;
static const uint32_t VFUNARY0 = 0b010010;
static const uint32_t VFUNARY1 = 0b010011;
    ...
    case VAIEncodings::kOpCFG: {  // vector ALU control instructions
      if ((insn32 >> 31) != 0u) {
        if (((insn32 >> 30) & 0x1U) != 0u) {  // vsetivli
          ...
          if ((Decode32UImm7(insn32) & 0x40u) != 0u) {  // should be zeros
