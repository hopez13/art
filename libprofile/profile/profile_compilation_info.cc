...
bool ProfileCompilationInfo::Save(int fd) {
  ...
  for (size_t i = 0; i != section_index; ++i) {
    section_infos_buffer.WriteUintAndAdvance(enum_cast<uint32_t>(section_infos[i].GetType()));
    section_infos_buffer.WriteUintAndAdvance(section_infos[i].GetFileOffset());
    section_infos_buffer.WriteUintAndAdvance(section_infos[i].GetFileSize());
    section_infos_buffer.WriteUintAndAdvance(section_infos[i].GetInflatedSize());
  }
