...
static inline std::string_view GetProfileDexFileBaseKeyView(std::string_view dex_location) {
...
std::string ProfileCompilationInfo::GetProfileDexFileBaseKey(const std::string& dex_location) {
  ...
  std::string_view base_key = GetProfileDexFileBaseKeyView(dex_location);
  return std::string(base_key.data(), base_key.size());
}

static inline std::string_view GetBaseKeyViewFromAugmentedKey(std::string_view profile_key) {
...
std::string ProfileCompilationInfo::GetBaseKeyFromAugmentedKey(
  ...
  // Note: Conversions between std::string and std::string_view.
  std::string_view augumented_key = GetBaseKeyViewFromAugmentedKey(profile_key);
  return std::string(augumented_key.data(), augumented_key.size());
}
