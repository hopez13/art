...
void ProfileCompilationInfo::WriteProfileIndex(std::vector<uint8_t>* buffer, ProfileIndexType value) const {
  if (IsForBootImage()) {
...
bool ProfileCompilationInfo::ReadProfileIndex(SafeBuffer& safe_buffer, ProfileIndexType* value) const {
  if (IsForBootImage()) {
