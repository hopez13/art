 ...
 public:
  void SetUp() override {
    ...
    dex1_checksum_missmatch =
        BuildDex("location1", /*location_checksum=*/ 12, "LUnique1;", /*num_method_ids=*/ 101);
    dex1_renamed =
        BuildDex("location1-renamed", /*location_checksum=*/ 1, "LUnique1;", /*num_method_ids=*/ 101);
    dex2_renamed =
        BuildDex("location2-renamed", /*location_checksum=*/ 2, "LUnique2;", /*num_method_ids=*/ 102);
  }
...
TEST_F(ProfileCompilationInfoTest, SaveMaxMethods) {
  ...
  const DexFile* dex_max1 = BuildDex(
      "location-max1", /*location_checksum=*/ 5, "LUniqueMax1;", kMaxMethodIds, kMaxClassIds);
  const DexFile* dex_max2 = BuildDex(
      "location-max2", /*location_checksum=*/ 6, "LUniqueMax2;", kMaxMethodIds, kMaxClassIds);
