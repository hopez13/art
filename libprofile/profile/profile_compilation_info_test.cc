...
TEST_F(ProfileCompilationInfoTest, FilteredLoadingWithClasses) {
  ...
  const DexFile* dex1_1000 = BuildDex(
      "location1_1000", /* checksum= */ 7, "LC1_1000;", kMaxMethodIds, /* num_class_ids = */ 1000u);
  const DexFile* dex2_1000 = BuildDex(
      "location2_1000", /* checksum= */ 8, "LC2_1000;", kMaxMethodIds, /* num_class_ids = */ 1000u);
