...
#define __ masm_->
 ...
 public:
  ...
  void Emit_art_quick_alloc_object_rosalloc(mirror::Object* (*func)(mirror::Class*, art::Thread*)) {
    ...
    __ add(x4, xSELF, x3);
    __ lsr(x4, x4, (ROSALLOC_BRACKET_QUANTUM_SIZE_SHIFT - POINTER_SIZE_SHIFT));
...
#error "Class pointer needs to overwrite next pointer."
  ...
  // Emit_POISON_HEAP_REF(w0);
    ...
    __ str(w3, MemOperand(x1));
    __ add(w3, w3, COMPRESSED_REFERENCE_SIZE);
  ...
  void Emit_art_quick_resolve_type() {
    ...
    Emit_SETUP_SAVE_EVERYTHING_FRAME(RUNTIME_SAVE_EVERYTHING_FOR_CLINIT_METHOD_OFFSET);    //@ save everything in case of GC
    __ mov(x1, xSELF);                  //@ pass Thread::Current
    Emit_Call(artResolveTypeFromCode);               //@ (uint32_t index, Thread*)
