...
public class Main {
  ...
  public static void simpleTest() {
    ...
    try {
      ...
      // On RI, the NDCFE has no cause, the badClinit is the cause.
  ...
  public static void hierarchyTest() {
    ...
    try {
      ...
      // On RI, the NDCFE has no cause. On ART, the badClinit is the cause.
      if (ncdfe.getCause() == badClinit || ncdfe.getCause() == null) {
        System.out.println("Caught NoClassDefFoundError.");
      } else {
        ncdfe.printStackTrace();
...
// BadSuper first, BadSub is initialized successfully while BadSub is "initializing" and
// remains initialized when the BadSuper's class initializer throws.
