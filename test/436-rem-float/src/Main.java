...
public class Main {
    ...
    private static void remDouble() {
        ...
        expectApproxEquals(
                Double.MIN_NORMAL, $opt$Rem(Double.MIN_NORMAL, Double.NEGATIVE_INFINITY));
        expectApproxEquals(
                Double.MIN_NORMAL, $opt$Rem(Double.MIN_NORMAL, Double.POSITIVE_INFINITY));
    ...
    static float $opt$Rem(float a, float b) { return a % b; }

    static float $opt$RemConst(float a) { return a % 4F; }

    static double $opt$Rem(double a, double b) { return a % b; }

    static double $opt$RemConst(double a) { return a % 4D; }
