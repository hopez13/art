...
class TestLibraryPathClassifier : public art::hiddenapi::JniLibraryPathClassifier {
 public:
  virtual std::optional<art::hiddenapi::SharedObjectKind> Classify(const char* so_path) {
...
extern "C" JNIEXPORT void JNICALL Java_Main_treatAsRuntimeLibrary(JNIEnv* env,
                                                                  jclass /*klass*/,
                                                                  jstring library_name) {
  InstallLibraryPathClassifier(env, library_name, art::hiddenapi::SharedObjectKind::kArtRuntime);
}

extern "C" JNIEXPORT void JNICALL Java_Main_treatAsApexLibrary(JNIEnv* env,
                                                               jclass /*klass*/,
                                                               jstring library_name) {
  InstallLibraryPathClassifier(env, library_name, art::hiddenapi::SharedObjectKind::kApexModule);
}
