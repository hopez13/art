...
public class Main {
  ...
  private static void doTest(DexDomain parentDomain, DexDomain childDomain,
    ...
    final MethodHandle nativeLibraryLoadHooks[] = {
        OTHER_LIBRARY_LOAD_HOOK,  // Passes
        APEX_LIBRARY_LOAD_HOOK,   // Fails
        RUNTIME_LIBRARY_LOAD_HOOK, // Fails
    };
  ...
  private static final MethodHandle APEX_LIBRARY_LOAD_HOOK =
      getLoadLibraryHook("treatAsApexLibrary");
  private static final MethodHandle RUNTIME_LIBRARY_LOAD_HOOK =
      getLoadLibraryHook("treatAsRuntimeLibrary");
  ...
  public static native void treatAsRuntimeLibrary(String library);
  public static native void treatAsApexLibrary(String library);
