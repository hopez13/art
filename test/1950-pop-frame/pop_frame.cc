...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_setupSuspendSingleStepAt(JNIEnv* env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_clearSuspendSingleStepFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_setupSuspendExceptionEvent(JNIEnv* env,
                                                          jclass klass ATTRIBUTE_UNUSED,
                                                          jobject method,
                                                          jboolean is_catch,
                                                          jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_clearSuspendExceptionEvent(JNIEnv* env,
                                                          jclass klass ATTRIBUTE_UNUSED,
                                                          jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_setupSuspendMethodEvent(JNIEnv* env,
                                                       jclass klass ATTRIBUTE_UNUSED,
                                                       jobject method,
                                                       jboolean enter,
                                                       jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_clearSuspendMethodEvent(JNIEnv* env,
                                                       jclass klass ATTRIBUTE_UNUSED,
                                                       jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_setupFieldSuspendFor(JNIEnv* env,
                                                    jclass klass ATTRIBUTE_UNUSED,
                                                    jclass target_klass,
                                                    jobject field,
                                                    jboolean access,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1950_clearFieldSuspendFor(JNIEnv* env,
                                                    jclass klass ATTRIBUTE_UNUSED,
                                                    jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
