...
public class Main {
    ...
    public static int p(float arg) { return (arg > 5.0f) ? 0 : -1; }
    ...
    // X86 and X86_64 generate at use site the ArrayLength, meaning only the BoundsCheck will have
    // environment uses.
    ...
    /// CHECK-DAG:                    ArrayLength                                                               liveness:18
    /// CHECK-DAG:                    BoundsCheck           env:[[<<Const1>>,<<IntArg>>,<<RefArg>>,<<Array>>]]  liveness:20
    public static void testBoundsCheck(int x, Object y, int[] a) { a[1] = x; }
