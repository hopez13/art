...
class Main {
    ...
    int noThrow(Main nonNullA, Main nonNullB, Main nonNullC) {
    ...
    int checkThrow(
            Main nonNullA, Main nonNullB, Main nonNullC, Main nullA, Main nullB, Main nullC) {
        // "this" check should be eliminated on both IGET/IPUT
        ifoo++;
    ...
    static void throwImplicitAIOBE(int[] array, int index) { array[index] = 0; }
    ...
    static int throwImplicitDivZero(int x, int y) { return x / y; }
