...
public class UnifiedRealVsFpTest {
  ...
  private static void checkFunctionsAt(double x) {
    ...
    final double other = getRandomDouble();
    ...
    if (x != 0.0) {
      ...
      assertTrue(
          "div " + other + ": " + x,
          Double.isInfinite(other / x) || ulpError(other / x, otherAsUr.divide(xAsUr)) == 0);
    }
