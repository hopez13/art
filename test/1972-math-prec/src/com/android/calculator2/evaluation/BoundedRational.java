...
public class BoundedRational {
  ...
  private static final int EXTRACT_SQUARE_MAX_LEN = 2000;
  ...
  public BoundedRational[] extractSquare() {
    ...
    final BoundedRational r = positiveDen().reduce();
    BigInteger[] numResult = extractSquare(r.numerator.abs());
    final BigInteger[] denResult = extractSquare(r.denominator);
    if (r.numerator.signum() < 0) {
