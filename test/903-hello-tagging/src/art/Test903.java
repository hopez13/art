...
public class Test903 {
    ...
    private static void testGetTaggedObjectsRun(
            ArrayList<Object> l, long[] searchTags, boolean returnObjects, boolean returnTags) {
    ...
    private static native Object[] getTaggedObjects(
            long[] searchTags, boolean returnObjects, boolean returnTags);
