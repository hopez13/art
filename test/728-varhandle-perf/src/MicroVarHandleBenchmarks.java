...
class VarHandleCompareAndSetArrayElementIntBenchmark extends MicroBenchmark {
  static final int ELEMENT_VALUE = 42;

  int[] array = { ELEMENT_VALUE };
  VarHandle vh;

  VarHandleCompareAndSetArrayElementIntBenchmark() throws Throwable {
    vh = MethodHandles.arrayElementVarHandle(int[].class);
  }

  @Override
  public void setup() {
    boolean result = (boolean) vh.compareAndSet(array, 0, ELEMENT_VALUE, ELEMENT_VALUE);
    if (!result) {
      throw new RuntimeException("vh.compareAndSet() failed");
    }
  }

  @Override
  public void run() {
    int newValue = ELEMENT_VALUE;
    boolean result;
    for (int pass = 0; pass < 100; ++pass) {
      result = (boolean) vh.compareAndSet(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (boolean) vh.compareAndSet(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (boolean) vh.compareAndSet(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (boolean) vh.compareAndSet(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (boolean) vh.compareAndSet(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
...
class VarHandleCompareAndSetArrayElementStringBenchmark extends MicroBenchmark {
  static final String ELEMENT_VALUE = "foo";

  String[] array = { ELEMENT_VALUE };
  VarHandle vh;

  VarHandleCompareAndSetArrayElementStringBenchmark() throws Throwable {
    vh = MethodHandles.arrayElementVarHandle(String[].class);
  }
...
class VarHandleCompareAndExchangeArrayElementIntBenchmark extends MicroBenchmark {
  static final int ELEMENT_VALUE = 42;

  int[] array = { ELEMENT_VALUE };
  VarHandle vh;

  VarHandleCompareAndExchangeArrayElementIntBenchmark() throws Throwable {
    vh = MethodHandles.arrayElementVarHandle(int[].class);
  }

  @Override
  public void setup() {
    int result = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE);
    if (result != ELEMENT_VALUE) {
      throw new RuntimeException("vh.compareAndExchange() returned " + result);
    }
  }
  ...
  public void run() {
    ...
    int result;
    for (int pass = 0; pass < 100; ++pass) {
      result = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
...
class VarHandleCompareAndExchangeArrayElementStringBenchmark extends MicroBenchmark {
  static final String ELEMENT_VALUE = "foo";

  String[] array = { ELEMENT_VALUE };
  VarHandle vh;

  VarHandleCompareAndExchangeArrayElementStringBenchmark() throws Throwable {
    vh = MethodHandles.arrayElementVarHandle(String[].class);
  }

  @Override
  public void setup() {
    String result = (String) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE);
    if (result != ELEMENT_VALUE) {
      throw new RuntimeException("vh.compareAndExchange() returned " + result);
    }
  }
  ...
  public void run() {
    ...
    String result;
    for (int pass = 0; pass < 100; ++pass) {
      result = (String) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (String) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (String) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (String) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
      result = (String) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE); // OP
...
class VarHandleCompareAndSetByteArrayViewIntBenchmark extends MicroBenchmark {
  static final int ELEMENT_VALUE = 42;
  ...
  VarHandleCompareAndSetByteArrayViewIntBenchmark() throws Throwable {
    vh = MethodHandles.byteArrayViewVarHandle(int[].class, ByteOrder.LITTLE_ENDIAN);
  }
...
class VarHandleCompareAndExchangeByteArrayViewIntBenchmark extends MicroBenchmark {
  static final int ELEMENT_VALUE = 42;
  ...
  VarHandleCompareAndExchangeByteArrayViewIntBenchmark() throws Throwable {
    vh = MethodHandles.byteArrayViewVarHandle(int[].class, ByteOrder.LITTLE_ENDIAN);
  }

  @Override
  public void setup() {
    int value = (int) vh.compareAndExchange(array, 0, ELEMENT_VALUE, ELEMENT_VALUE);
    if (value != ELEMENT_VALUE) {
      throw new RuntimeException("vh.compareAndExchange() returned " + value);
    }
  }
...
class VarHandleCompareAndSetByteArrayViewBigEndianIntBenchmark extends MicroBenchmark {
  static final int ELEMENT_VALUE = 42;
  ...
  VarHandleCompareAndSetByteArrayViewBigEndianIntBenchmark() throws Throwable {
    vh = MethodHandles.byteArrayViewVarHandle(int[].class, ByteOrder.BIG_ENDIAN);
  }
...
class VarHandleCompareAndExchangeByteArrayViewBigEndianIntBenchmark extends MicroBenchmark {
  static final int ELEMENT_VALUE = 42;
  ...
  VarHandleCompareAndExchangeByteArrayViewBigEndianIntBenchmark() throws Throwable {
    vh = MethodHandles.byteArrayViewVarHandle(int[].class, ByteOrder.BIG_ENDIAN);
  }
...
class MicroVarHandleBenchmarks {
  ...
  private static void initialize() throws Throwable {
    benchmarks = new MicroBenchmark[] {
      ...
      new VarHandleCompareAndSetArrayElementIntBenchmark(),
      new VarHandleCompareAndSetArrayElementStringBenchmark(),
      new VarHandleCompareAndExchangeArrayElementIntBenchmark(),
      new VarHandleCompareAndExchangeArrayElementStringBenchmark(),

      // Byte array views LE.
      new VarHandleGetByteArrayViewIntBenchmark(),
      new VarHandleSetByteArrayViewIntBenchmark(),
      new VarHandleCompareAndSetByteArrayViewIntBenchmark(),
      new VarHandleCompareAndExchangeByteArrayViewIntBenchmark(),

      // Byte array views BE.
      new VarHandleGetByteArrayViewBigEndianIntBenchmark(),
      new VarHandleSetByteArrayViewBigEndianIntBenchmark(),
      new VarHandleCompareAndSetByteArrayViewBigEndianIntBenchmark(),
      new VarHandleCompareAndExchangeByteArrayViewBigEndianIntBenchmark(),
