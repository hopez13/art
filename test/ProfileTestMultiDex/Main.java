...
class TestInline {
    public int inlineMonomorphic(Super s) { return s.getValue(); }

    public int inlinePolymorphic(Super s) { return s.getValue(); }

    public int inlineMegamorphic(Super s) { return s.getValue(); }

    public int inlineMissingTypes(Super s) { return s.getValue(); }

    public int noInlineCache(Super s) { return s.getValue(); }
    ...
    public int noInlineCacheMulti(Super s, Secret sec) { return s.getValue() + sec.getIdentity(); }
}

class TestInlineSubtype extends TestInline {
    public void foobar() { this.inlineMonomorphic(new SubA()); }
}
