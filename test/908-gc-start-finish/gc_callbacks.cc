...
extern "C" JNIEXPORT jint JNICALL Java_art_Test908_getGcStarts(JNIEnv* env [[maybe_unused]],
                                                               jclass klass [[maybe_unused]]) {
...
extern "C" JNIEXPORT jint JNICALL Java_art_Test908_getGcFinishes(JNIEnv* env [[maybe_unused]],
                                                                 jclass klass [[maybe_unused]]) {
