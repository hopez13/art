...
public class Main {
    ...
    private static void stackOverflowTestSub0() { stackOverflowTestSub0(); }
    ...
    private static void stackOverflowTestSub10(double pad1, double pad2, double pad3, double pad4,
            double pad5, double pad6, double pad7, double pad8, double pad9, double pad10) {
    ...
    private static void foo(double pad1, double pad2, double pad3) { bar(pad1, pad2, pad3); }

    private static void bar(double pad1, double pad2, double pad3) { baz(pad1, pad2, pad3); }

    private static void baz(double pad1, double pad2, double pad3) { qux(pad1, pad2, pad3); }

    private static void qux(double pad1, double pad2, double pad3) { foo(pad1, pad2, pad3); }
}
