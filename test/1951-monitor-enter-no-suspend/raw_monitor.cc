...
extern "C" JNIEXPORT void JNICALL Java_art_Test1951_otherThreadStart(JNIEnv* env, jclass) {
  ...
  progress = true;
  jvmtiError err = jvmti_env->RawMonitorExit(jvmti_env, mon);
}

extern "C" JNIEXPORT void JNICALL Java_art_Test1951_waitForStart(JNIEnv* env, jclass) {
  while (!started) {}
}

extern "C" JNIEXPORT void JNICALL Java_art_Test1951_otherThreadResume(JNIEnv* env, jclass) {
  resumed = true;
}

extern "C" JNIEXPORT jboolean JNICALL Java_art_Test1951_otherThreadProgressed(JNIEnv* env, jclass) {
  return progress;
}
