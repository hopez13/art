...
public class Main {
    ...
    public static void GetHandles() throws Throwable {
        ...
        get_total_cnt =
                lookup.findStaticGetter(AbstractCollection.class, "TOTAL_COUNT", Integer.TYPE);
    }
    ...
    public static void PrintListAndData(AbstractCollection<String> c) throws Throwable {
        if (PRINT_COUNT) {
            System.out.println("List is: " + c + " count = " + getcnt.invoke(c)
                    + " TOTAL_COUNT = " + get_total_cnt.invoke());
        } else {
            System.out.println("List is: " + c);
        }
    }
    public static void main(String[] args) throws Throwable {
        AbstractCollection<String> l1 =
                (AbstractCollection<String>) Arrays.asList("a", "b", "c", "d");
    ...
    public static void CheckEQ(Object a, int b) { CheckEQ(((Integer) a).intValue(), b); }
