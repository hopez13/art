...
public class Test1979 {
    ...
    public static void doTest() throws Exception {
        ...
        Thread t = new Thread(() -> {
            try {
                // We don't want to read these in the same method here to ensure that no reference
                // to Transform is active on this thread at the time the redefinition occurs. To
                // accomplish this just run the code in a different method, which is good enough.
                ((TRunnable) () -> {
                ...
                cdl.countDown();
                continueLatch.await();
                // Now that redefinition has occurred without this frame having any references to
                // the Transform class we want to make sure we have the correct offsets.
