...
public class Main {
    ...
    public static int InlineParameter(int a) { return returnParameter(a); }
    ...
    public static long InlineWideParameter(long a) { return returnWideParameter(a); }
    ...
    public static Object InlineReferenceParameter(Object o) { return returnReferenceParameter(o); }
    ...
    public static int InlineInt() { return returnInt(); }
    ...
    public static long InlineWide() { return returnWide(); }
    ...
    public static int InlineAdd() { return returnAdd(3, 5); }
    ...
    public static int InlineFieldAccess() { return incCounter(); }
    ...
    private static int returnAbs(int i) { return Math.abs(i); }
    ...
    public static int InlinedIntrinsicsAreStillIntrinsic() { return returnAbs(-1); }

    private static void returnVoid() { return; }

    private static void returnVoidWithOneParameter(int a) { return; }

    private static int returnParameter(int a) { return a; }

    private static long returnWideParameter(long a) { return a; }

    private static Object returnReferenceParameter(Object o) { return o; }

    private static int returnInt() { return 4; }

    private static long returnWide() { return 8L; }

    private static int returnAdd(int a, int b) { return a + b; }

    private static int returnSub(int a, int b) { return a - b; }

    private static int counter = 42;

    private static int incCounter() { return ++counter; }
