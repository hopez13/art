...
class MyInvocationHandler implements InvocationHandler {
    ...
    public MyInvocationHandler(Proxied proxied) { this.proxied = proxied; }
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        new Thread() {
            public void run() {
                Runnable proxy = (Runnable) Proxy.newProxyInstance(Proxied.class.getClassLoader(),
                        new Class[] {Runnable.class}, new MyInvocationHandler(new Proxied()));
                proxy.run();
            }
        }.start();
