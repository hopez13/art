...
public class Main {
    ...
    public static void testValueOfArg() throws Exception {
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                try {
                    ...
                    // Let the main thread know that everythin is set up.
        ...
        // This may use an invalid IntegerValueOfInfo (because of seeing the `alt_cache` which is
        // not in the boot image) when asked to emit code after using a valid info (using `cache`)
