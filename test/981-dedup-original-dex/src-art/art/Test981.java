...
public class Test981 {
    ...
    static class Transform2 {
        public void sayHi() { System.out.println("hello2"); }
    }
    ...
    private static void assertSame(Object a, Object b) throws Exception {
        if (a != b) {
            throw new AssertionError("'" + (a != null ? a.toString() : "null")
                    + "' is not the same as "
    ...
    public static void doTest() throws Exception {
        // Make sure both of these are loaded prior to transformations being added so they have the
        // same original dex files.
        ...
        Redefinition.addCommonTransformationResult(
                "art/Test981$Transform", new byte[0], DEX_BYTES_1);
        Redefinition.addCommonTransformationResult(
                "art/Test981$Transform2", new byte[0], DEX_BYTES_2);
        ...
        assertSame(
                getOriginalDexFile(t1.getClass()).getClass(), Class.forName("java.lang.DexCache"));
        ...
        Class<?> transform3Class = new InMemoryDexClassLoader(
                ByteBuffer.wrap(DEX_BYTES_3_INITIAL), Test981.class.getClassLoader())
                                           .loadClass("Transform3");
