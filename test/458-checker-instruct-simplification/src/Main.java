...
public class Main {
  ...
  /// CHECK-START: byte Main.$noinline$redundantAndShortToByteShift9(short) instruction_simplifier (before)
  /// CHECK-DAG:                       And

  /// CHECK-START: byte Main.$noinline$redundantAndShortToByteShift9(short) instruction_simplifier (after)
  /// CHECK-DAG:                       And
  public static byte $noinline$redundantAndShortToByteShift9(short value) {
  ...
  /// CHECK-START: byte Main.$noinline$redundantAndShortToByteShift9(short) instruction_simplifier (after)
  /// CHECK-DAG:                       And
  public static byte $noinline$redundantAndShortToByteShift10(short value) {
  ...
  public static void main(String[] args) throws Exception {
    ...
    assertIntEquals(0x37, $noinline$redundantAndShortToByteShift9((short) 0x6f45));
    assertIntEquals(127, $noinline$redundantAndShortToByteShift9((short) 0xff45));
    assertIntEquals(127, $noinline$redundantAndShortToByteShift10((short) 0xffff));
