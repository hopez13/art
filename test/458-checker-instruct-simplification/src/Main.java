...
public class Main {
  ...
  /// CHECK:     <<Const24:i\d+>> IntConstant 24
  /// CHECK:     <<Shl:i\d+>>     Shl [<<Param>>,<<Const24>>]
  /// CHECK:     <<UShr:i\d+>>    Shr [<<Shl>>,<<Const24>>]
  /// CHECK:     <<Return:v\d+>>  Return [<<UShr>>]
  ...
  /// CHECK:     <<Const16:i\d+>> IntConstant 16
  /// CHECK:     <<Shl:i\d+>>     Shl [<<Param>>,<<Const16>>]
  /// CHECK:     <<UShr:i\d+>>    Shr [<<Shl>>,<<Const16>>]
  /// CHECK:     <<Return:v\d+>>  Return [<<UShr>>]
  ...
  /// CHECK-START: int Main.$noinline$testShortToUnsignedShortToInt(short) instruction_simplifier (before)
  /// CHECK:     <<Param:s\d+>>   ParameterValue
  /// CHECK:     <<Const24:i\d+>> IntConstant 24
  /// CHECK:     <<Shl:i\d+>>     Shl [<<Param>>,<<Const24>>]
  /// CHECK:     <<UShr:i\d+>>    UShr [<<Shl>>,<<Const24>>]
  ...
  /// CHECK-START: int Main.$noinline$testShortToUnsignedShortToInt(short) instruction_simplifier (after)
  /// CHECK:     <<Param:s\d+>>   ParameterValue
  /// CHECK-NOT:                  Shl
  /// CHECK-NOT:                  UShr
  /// CHECK:     <<Conv:a\d+>>    TypeConversion [<<Param>>]
  /// CHECK:     <<Return:v\d+>>  Return [<<Conv>>]
  private static int $noinline$testShortToUnsignedShortToInt(short arg) {
    return arg << 24 >>> 24;
  }
  ...
  /// CHECK-START: int Main.$noinline$testShortToSignedShortToInt(short) instruction_simplifier (before)
  /// CHECK:     <<Param:s\d+>>   ParameterValue
  /// CHECK:     <<Const24:i\d+>> IntConstant 24
  /// CHECK:     <<Shl:i\d+>>     Shl [<<Param>>,<<Const24>>]
  /// CHECK:     <<Shr:i\d+>>     Shr [<<Shl>>,<<Const24>>]
  ...
  /// CHECK-START: int Main.$noinline$testShortToSignedShortToInt(short) instruction_simplifier (after)
  /// CHECK:     <<Param:s\d+>>   ParameterValue
  /// CHECK-NOT:                  Shl
  /// CHECK-NOT:                  Shr
  /// CHECK:     <<Conv:b\d+>>    TypeConversion [<<Param>>]
  /// CHECK:     <<Return:v\d+>>  Return [<<Conv>>]
  private static int $noinline$testShortToSignedShortToInt(short arg) {
    return arg << 24 >> 24;
  }

  // Check shift amounts > 32
  ...
  public static void main(String[] args) throws Exception {
    ...
    assertIntEquals(0xbb, $noinline$testShortToUnsignedShortToInt((short) 0xaabb));

    assertIntEquals(0xffffffbb, $noinline$testCharToSignedByteToInt((char) 0xaabb));
    assertIntEquals(0xffffffbb, $noinline$testShortToSignedShortToInt((short) 0xaabb));
    assertIntEquals(0x0b, $noinline$testCharToSignedByteToInt((char) 0xaa0b));
    assertIntEquals(0x0b, $noinline$testShortToSignedShortToInt((short) 0xaa0b));

    assertIntEquals(0xccdd, $noinline$testUnsignedPromotionWithHugeShiftAmount(0xaabbccdd));
