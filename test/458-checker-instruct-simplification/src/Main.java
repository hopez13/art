...
public class Main {
  ...
  //
  // That will led to crash as InstructionSimplifier removes implicit type conversions and
  // during visiting one expects that its inputs has been already simplified.
  //
  ...
  //
  // T itself doesn't matter, the only important thing that M -> T is explicit.
  //
  // We check cases when shifts corresponds to the following implicit type conversions:
  //   byte -> byte
  //   byte -> short
