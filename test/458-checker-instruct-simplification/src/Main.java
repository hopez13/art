...
public class Main {
    ...
    public static long $noinline$Add0(long arg) { return 0 + arg; }
    ...
    public static int $noinline$AddAddSubAddConst(int arg) { return arg + 1 + 2 - 3 + 4; }
    ...
    public static int $noinline$AndAllOnes(int arg) { return arg & -1; }
    ...
    public static int $noinline$UShr28And15(int arg) { return (arg >>> 28) & 15; }
    ...
    public static long $noinline$UShr60And15(long arg) { return (arg >>> 60) & 15; }
    ...
    public static int $noinline$UShr28And7(int arg) { return (arg >>> 28) & 7; }
    ...
    public static long $noinline$UShr60And7(long arg) { return (arg >>> 60) & 7; }
    ...
    public static int $noinline$Shr24And255(int arg) { return (arg >> 24) & 255; }
    ...
    public static int $noinline$Shr25And127(int arg) { return (arg >> 25) & 127; }
    ...
    public static long $noinline$Shr56And255(long arg) { return (arg >> 56) & 255; }
    ...
    public static long $noinline$Shr57And127(long arg) { return (arg >> 57) & 127; }
    ...
    public static int $noinline$Shr24And127(int arg) { return (arg >> 24) & 127; }
    ...
    public static long $noinline$Shr56And127(long arg) { return (arg >> 56) & 127; }
    ...
    public static int $noinline$DivN1(int arg) { return arg / -1; }
    ...
    public static long $noinline$Mul1(long arg) { return arg * 1; }
    ...
    public static int $noinline$MulN1(int arg) { return arg * -1; }
    ...
    public static long $noinline$MulPowerOfTwo128(long arg) { return arg * 128; }
    ...
    public static long $noinline$MulMulMulConst(long arg) { return 10 * arg * 11 * 12; }
    ...
    public static int $noinline$Or0(int arg) { return arg | 0; }
    ...
    public static long $noinline$OrSame(long arg) { return arg | arg; }
    ...
    public static int $noinline$Shl0(int arg) { return arg << 0; }
    ...
    public static long $noinline$Shr0(long arg) { return arg >> 0; }
    ...
    public static long $noinline$Shr64(long arg) { return arg >> 64; }
    ...
    public static long $noinline$Sub0(long arg) { return arg - 0; }
    ...
    public static int $noinline$SubAliasNeg(int arg) { return 0 - arg; }
    ...
    public static int $noinline$SubAddConst1(int arg) { return 5 - arg + 6; }
    ...
    public static long $noinline$SubSubConst(long arg) { return 17 - (18 - arg); }
    ...
    public static int $noinline$Xor0(int arg) { return arg ^ 0; }
    ...
    public static int $noinline$AddNegs1(int arg1, int arg2) { return -arg1 + -arg2; }
    ...
    public static long $noinline$AddNeg1(long arg1, long arg2) { return -arg1 + arg2; }
    ...
    public static int $noinline$NegSub1(int arg1, int arg2) { return -(arg1 - arg2); }
    ...
    public static int $noinline$SubNeg1(int arg1, int arg2) { return -arg1 - arg2; }
    ...
    public static int $inline$ReturnArg(int arg) { return arg; }
    ...
    public static float $noinline$Div2(float arg) { return arg / 2.0f; }
    ...
    /// CHECK-START: double Main.$noinline$Div2(double) instruction_simplifier (after)
    /// CHECK-NOT:                        Div
    public static double $noinline$Div2(double arg) { return arg / 2.0; }
    ...
    public static float $noinline$DivMP25(float arg) { return arg / -0.25f; }
    ...
    public static int $noinline$mulPow2Plus1(int arg) { return arg * 9; }
    ...
    public static long $noinline$mulPow2Minus1(long arg) { return arg * 31; }
    ...
    public static int $noinline$shortToLongToInt(short value) {
        // Integral conversion followed by non-widening integral conversion, use implicit
        // conversion.
    ...
    public static long $noinline$intShr28And15L(int value) { return (value >> 28) & 15L; }
    ...
    public static byte $noinline$longAnd0xffToByte(long value) { return (byte) (value & 0xff); }
    ...
    public static int $noinline$intReverseCondition(int i) { return (42 > i) ? 13 : 54; }
    ...
    public static int $noinline$intUnnecessaryShiftModifications(int value, int shift) {
        int c128 = 128;
        return (value << (shift | 32)) + (value >> (shift ^ 64)) + (value >>> (shift + 96))
    ...
    public static int $noinline$intNecessaryShiftModifications(int value, int shift) {
        int c129 = 129;
        return (value << (shift | 33)) + (value >> (shift ^ 65)) + (value >>> (shift + 97))
    ...
    /// CHECK-NOT:                        And
    /// CHECK-NOT:                        TypeConversion
    public static int $noinline$getUint8FromStaticByteField() { return staticByteField & 0xff; }
    ...
    /// CHECK-NOT:                        And
    /// CHECK-NOT:                        TypeConversion
    public static int $noinline$getUint8FromByteArray(byte[] a) { return a[0] & 0xff; }
    ...
    /// CHECK-NOT:                        And
    /// CHECK-NOT:                        TypeConversion
    public static int $noinline$getUint16FromShortArray(short[] a) { return a[0] & 0xffff; }
    ...
    /// CHECK-NOT:                        And
    /// CHECK-NOT:                        TypeConversion
    public static int $noinline$getInt16FromStaticCharField() { return (short) staticCharField; }
    ...
    /// CHECK-NOT:                        And
    /// CHECK-NOT:                        TypeConversion
    public static int $noinline$getInt16FromCharArray(char[] a) { return (short) a[0]; }
    ...
    public static int $inline$toByte(int value) { return (byte) value; }
    ...
    public static int $noinline$getStaticCharFieldAnd0xff() { return staticCharField & 0xff; }
    ...
    /// CHECK-DAG:                        Return [<<Conv>>]
    public static int $noinline$intAnd0xffToChar(int value) { return (char) (value & 0xff); }
    ...
    // CHECK-DAG:      <<And:i\d+>>      And [<<Arg>>,<<Const511>>]
    // CHECK-DAG:                        Return [<<And>>]
    public static int $noinline$intAnd0x1ffToChar(int value) { return (char) (value & 0x1ff); }
    ...
    /// CHECK-DAG:      <<Arg:b\d+>>      ParameterValue
    /// CHECK-DAG:                        Return [<<Arg>>]
    public static int $noinline$bug68142795Byte(byte b) { return (byte) (0xff & (b & 0xff)); }
    ...
    public static int $noinline$emptyStringIndexOf(int ch) { return "".indexOf(ch); }
    ...
    /// CHECK-DAG:                        Return [<<Select>>]
    public static int $noinline$singleCharStringIndexOf(int ch) { return "x".indexOf(ch); }
    ...
    public static byte $noinline$redundantAndShortToByteShift9NotRedundant(short value) {
        // Byte and Short operands for bitwise operations (e.g. &,>>) are promoted to Int32 prior to
        // operation. Negative operands will be sign extended accordingly: (short: 0xff45) --> (int:
        // 0xffffff45) & fe00 will clear bits [31:16]. For negative 'value', this will clear sign
        // bits. Without the AND, the right shift will move the sign extended ones into the result
        // instead of zeros. Therefore AND is not redundant and should not be removed.
    ...
    public static void main(String[] args) throws Exception {
        ...
        Method $noinline$bug68142795Short =
                smaliTests2.getMethod("$noinline$bug68142795Short", short.class);
        Method $noinline$bug68142795Boolean =
                smaliTests2.getMethod("$noinline$bug68142795Boolean", boolean.class);
        ...
        assertIntEquals(
                Short.MAX_VALUE, $noinline$floatToIntToShort((float) (Short.MIN_VALUE - 1)));
        assertIntEquals(
                Short.MIN_VALUE, $noinline$floatToIntToShort((float) (Short.MAX_VALUE + 1)));
        ...
        assertDoubleEquals(
                (double) Short.MAX_VALUE, $noinline$shortAnd0xffffToShortToDouble(Short.MAX_VALUE));
        assertDoubleEquals(
                (double) Short.MIN_VALUE, $noinline$shortAnd0xffffToShortToDouble(Short.MIN_VALUE));
        ...
        assertLongEquals(
                0xaf37bc048d159e24L, $noinline$longSmallerShiftMasking(0xabcdef0123456789L, 2));
        ...
        assertIntEquals(
                0xfffd5e7c, $noinline$otherUseOfUnnecessaryShiftMasking(0xabcdef01, 13 + 512));
        ...
        assertIntEquals(
                (short) 0x8000, (int) $noinline$bug68142795Short.invoke(null, (short) 0x8000));
