...
public class Test1981 {
  ...
  public static void doTest() throws Exception {
    try {
      ...
      System.out.println("Setting BAZ to 'foo' with new mh.");
      lookup.findStaticSetter(Transform.class, "BAZ", Object.class).invoke("foo");
      System.out.println("Post set with new mh: " + Transform.staticToString());

      System.out.println("Setting FOO to 'Transform.class' with old mh.");
