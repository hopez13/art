...
public class Test1968 {
    ...
    public static final class OveriddenReturnValue {
        ...
        public String toString() {
            String stackTrace = PRINT_STACK_TRACE
    ...
    private static String safeDumpStackTrace(StackTraceElement st[], String prefix) {
        ...
        for (StackTraceElement e : st) {
            os.println(prefix + e.getClassName() + "." + e.getMethodName() + "("
    ...
    public Thread mkThread(Runnable r) {
        ...
        t.setUncaughtExceptionHandler((thr, e) -> {
            System.out.println("Uncaught exception in thread " + thr + " - "
    ...
    public abstract static class AbstractTestObject implements TestRunnable {
        ...
        public AbstractTestObject() { resultObject = null; }

        public Object getReturnValue() { return resultObject; }
    ...
    public static class IntContainer {
        ...
        public IntContainer(int i) { value = i; }

        public String toString() { return "IntContainer { value: " + value + " }"; }
    }
    ...
    public static class ExceptionCatchTestObject extends AbstractTestObject implements Runnable {
        ...
        public Object doThrow() { throw new TestError(); }
    ...
    public static class ExceptionThrowFarTestObject implements TestRunnable {
        ...
        public Object callingFunction() { return calledFunction(); }
    ...
    public static class ExceptionThrowTestObject implements TestRunnable {
        ...
        public Object getReturnValue() { return result; }
    ...
    public static class StaticMethodObject implements TestRunnable {
        ...
        public void run() { result = calledFunction(() -> new IntContainer(++cnt)); }

        public String toString() { return "StaticMethodObject { cnt: " + cnt + " }"; }
    }
    ...
    public static class BadForceVoidObject implements TestRunnable {
        ...
        public String toString() { return "BadForceVoidObject { cnt: " + cnt + " }"; }
    }

    public static class BadForceIntObject implements TestRunnable {
        public int cnt = 0;
        public int result = 0;
        public Object getReturnValue() { return Integer.valueOf(result); }
        public void run() { result = incrCnt(); }
        public int incrCnt() {
            ++cnt; // line +0
            // We set a breakpoint here and try to force-early-return.
            int res = cnt; // line +2
        ...
        public String toString() { return "BadForceIntObject { cnt: " + cnt + " }"; }
    }

    public static void run() throws Exception { new Test1968((x) -> {}).runTests(); }

    public Test1968(Consumer<TestRunnable> preTest) { this.preTest = preTest; }
    ...
    public void runTests() throws Exception {
        ...
        runTestOn(StandardTestObject::new,
                (thr)
        ...
        // Add a breakpoint on the second line after the start of the function Annoyingly r8
        // generally has the first instruction (a monitor enter) not be marked as being on any line
        // but javac has it marked as being on the first line of the function. Just use the second
        // entry on the line-number table to get the breakpoint. This should be good for both.
        ...
        runTestOn(SynchronizedFunctionTestObject::new,
                (thr)
        ...
        runTestOn(FieldBasedTestObject::new,
                (thr)
        ...
        runTestOn(()
                ...
                (thr)
                        -> setupSuspendMethodEvent(
                                exceptionOnceCalledMethod, /* enter */ false, thr),
                SuspendEvents::clearSuspendMethodEvent);
        ...
        runTestOn(ExceptionCatchTestObject::new,
                (thr)
        ...
        runTestOn(NativeCalledObject::new, SuspendEvents::setupWaitForNativeCall,
        ...
        runTestOn(NativeCallerObject::new,
                (thr)
                        -> setupSuspendMethodEvent(nativeCallerMethod, /* enter */ false, thr),
                SuspendEvents::clearSuspendMethodEvent);

        System.out.println("Test stopped in a static method");
        final Method staticCalledMethod =
                StaticMethodObject.class.getDeclaredMethod("calledFunction", Supplier.class);
        final int staticFunctionLine = Breakpoint.locationToLine(staticCalledMethod, 0) + 2;
        final long staticFunctionLoc =
                Breakpoint.lineToLocation(staticCalledMethod, staticFunctionLine);
        runTestOn(StaticMethodObject::new,
                (thr)
                        -> setupSuspendBreakpointFor(staticCalledMethod, staticFunctionLoc, thr),
                SuspendEvents::clearSuspendMethodEvent);
        ...
        runTestOn(BadForceVoidObject::new,
                (thr)
                        -> setupSuspendBreakpointFor(voidFunction, voidLoc, thr),
                SuspendEvents::clearSuspendMethodEvent);
        ...
        runTestOn(BadForceIntObject::new,
                (thr)
                        -> setupSuspendBreakpointFor(intFunction, intLoc, thr),
                SuspendEvents::clearSuspendMethodEvent);
    }
}
