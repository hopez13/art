...
public class Main {
    public static void main(String[] args) {
        ...
        try {
             ...
             * then throws IllegalAccessError on JVM (both invokes). For the invoke-virtual,
             * the IAE is thrown in line with the method resolution specification as the
             * private Test7Base.foo() is found before the inherited Test7Interface.foo().
             * However, the invoke-interface is rather puzzling because the method resolution
             ...
             *
             * Files:
             *   src/Test8User2.java         - calls invoke-static Test8Derived.foo()V.
             *   src/Test8Derived.java       - defines static foo()V, not used in the test.
             *   src2/Test8User.java         - calls invoke-virtual Test8Derived.foo()V.
             *   src2/Test8Base.java         - does not define foo()V, not used in the test.
             *   src2/Test8Derived.java      - defines non-static foo()V.
             *   src3/Test8Base.java         - defines static foo()V.
             */
             ...
             *
             * Files:
             *   src/Test9User2.java         - calls invoke-virtual Test8Derived.foo()V.
             *   src/Test9Derived.java       - defines non-static foo()V, not used in the test.
             *   src2/Test9User.java         - calls invoke-static Test8Derived.foo()V.
             *   src2/Test9Base.java         - does not define foo()V, not used in the test.
             *   src2/Test9Derived.java      - defines static foo()V.
             *   src3/Test9Base.java         - defines non-static foo()V.
             */
