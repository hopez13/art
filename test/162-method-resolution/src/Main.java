...
public class Main {
     ...
     * with every other class. Then we delete "clone" from Test10Interface only. As there is a method
     * with the same signature declared in `java.lang.Object`, ART throws ICCE. For some reason
     * RI throws NSME even though 13.4.12 is not applicable due to the superclass declaring a method
     * with the same signature and the applicable section 13.4.7 does not specify what exception
     * should be thrown (but ICCE is a reasonable choice).
     *
     * Files:
