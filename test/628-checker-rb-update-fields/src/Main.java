...
public class Main {
  ...
  /*
   * Check graph before pre-emptive update of object fields and Baker read barrier removal.
   */
  ...
  /*
   * Check graph after pre-emptive update of object fields and Baker read barrier removal.
   */
   ...
   * instructions (on two different objects) are not removed.
   */
