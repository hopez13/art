...
public class Test1924 {
    public static void handleFramePop(Executable m, boolean exception, long location) {
        System.out.println(m + " pop. Line=" + Breakpoint.locationToLine(m, location)
                + " exception:" + exception);
    }
    ...
    public static void doRecurTestWith(final int times, int watch_frame) throws Exception {
        ...
        Thread target = new Thread(null,
                ()
                    ...
                    try {
                        ...
                        System.out.println("Caught exception " + e + " while running recurTimes("
                                + times + ")");
                    }
                },
        ...
        if (target_frame != null) {
            ...
            System.out.println("Unable to find stack frame for " + watch_frame + " depth of "
    ...
    public static void run() throws Exception {
        ...
        FramePop.enableFramePopEvent(Test1924.class,
