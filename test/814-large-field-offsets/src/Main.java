...
public class Main {
  ...
  static void check(NullPointerException npe, int firstLine) {
    ...
    checkElement(trace[1], "Main", "main", "Main.java", 171);
  }
  ...
  public static void test() {
    ...
    try {
      System.out.println(((Main) null).objectField);
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 3);

    try {
      System.out.println(((Main) null).intField);
    } catch (NullPointerException e) {
      npe = e;
    }
    ...
    try {
      System.out.println(((Main) null).wideField);
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 7);
    ...
    try {
      System.out.println(((Main) null).volatileObjectField);
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 7);
    ...
    try {
      System.out.println(((Main) null).volatileIntField);
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 7);
    ...
    try {
      System.out.println(((Main) null).volatileWideField);
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 7);
    ...
    try {
      ((Main) null).volatileObjectField = null;
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 7);
    ...
    try {
      ((Main) null).volatileWideField = 42L;
    } catch (NullPointerException e) {
      npe = e;
    }
    check(npe, thisLine += 7);
