...
public class Main {
    ...
    public static int inlineMonomorphicSubA(Super a) { return a.getValue(); }
    ...
    /// CHECK-NOT:                            Deoptimize
    public static int inlinePolymophicSubASubB(Super a) { return a.getValue(); }
    ...
    /// CHECK-NOT:                            Deoptimize
    public static int inlinePolymophicCrossDexSubASubC(Super a) { return a.getValue(); }
    ...
    /// CHECK:       InvokeVirtual method_name:Super.getValue
    public static int inlineMegamorphic(Super a) { return a.getValue(); }
    ...
    /// CHECK:       InvokeVirtual method_name:Super.getValue
    public static int inlineMissingTypes(Super a) { return a.getValue(); }
    ...
    /// CHECK:       InvokeVirtual method_name:Super.getValue
    public static int noInlineCache(Super a) { return a.getValue(); }

    // We shouldn't inline `someSubclassesThrow` since we are trying a monomorphic inline and it
    // always throws for SubA. However, we shouldn't mark it as `always_throws` since we
    // speculatively tried to inline and other subclasses (e.g. SubB) can call
    // noInlineSomeSubclassesThrow and they don't throw.
