...
public class Test1928 {
    ...
    private static void PrintStack() {
        ...
        for (StackTrace.StackFrameData e : StackTrace.GetStackTrace(Thread.currentThread())) {
            if (Objects.equals(
                        e.method.getDeclaringClass().getPackage(), Test1928.class.getPackage())) {
    ...
    public static void run() throws Exception {
        // Set up
        Exceptions.setupExceptionTracing(Test1928.class, TestException.class,
                Test1928.class.getDeclaredMethod("ExceptionEvent", Thread.class, Executable.class,
