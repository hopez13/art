...
public class Main {
  ...
  // the graph and eliminate the `TryBoundary` instructions. It does so in `after_gvn` and nit
  // `initial` since it requires the VisitIf optimization which happens later in the graph.
