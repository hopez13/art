...
public class Main {
    ...
    private static void test(ClassLoader loader, boolean expectedHasVdexFile,
            boolean expectedBackedByOat, boolean invokeMethod) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        test(singleLoader(), /*hasVdex*/ featureEnabled, /*backedByOat*/ false,
                /*invokeMethod*/ true);
