...
public class Main {
    ...
    public static int add3(int a) { return 1 + a + 2; }

    public static long add3(long a) { return 1l + a + 2l; }

    public static float add3(float a) { return 1f + a + 2f; }

    public static double add3(double a) { return 1d + a + 2d; }
    ...
    public static void assertEqual(float a, float b) {
        boolean aproxEquals = (a > b) ? ((a - b) < 0.0001f) : ((b - a) < 0.0001f);
        if (!aproxEquals) {
            throw new RuntimeException("Expected: " + a + " Found: " + b);
        }
    }
    ...
    public static void assertEqual(double a, double b) {
        boolean aproxEquals = (a > b) ? ((a - b) < 0.0001d) : ((b - a) < 0.0001d);
        if (!aproxEquals) {
            throw new RuntimeException("Expected: " + a + " Found: " + b);
        }
    }
