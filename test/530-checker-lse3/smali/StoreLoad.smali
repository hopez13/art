...
## CHECK-START: int StoreLoad.test(int) load_store_analysis (before)
## CHECK-NOT:                     TypeConversion

## CHECK-START: int StoreLoad.test(int) load_store_analysis (after)
## CHECK:                         TypeConversion

## CHECK-START: int StoreLoad.test(int) load_store_elimination (before)
## CHECK-DAG:     <<Arg:i\d+>>    ParameterValue
## CHECK-DAG:     <<Conv:b\d+>>   TypeConversion [<<Arg>>]
## CHECK-DAG:                     StaticFieldSet [{{l\d+}},<<Conv>>] field_name:StoreLoad.byteField
## CHECK-DAG:     <<Val:b\d+>>    StaticFieldGet [{{l\d+}}] field_name:StoreLoad.byteField
## CHECK-DAG:                     Return [<<Val>>]
