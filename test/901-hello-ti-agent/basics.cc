...
static void JNICALL VMStartCallback(jvmtiEnv *jenv, JNIEnv* jni_env [[maybe_unused]]) {
...
extern "C" JNIEXPORT void JNICALL Java_art_Test901_setVerboseFlag(
    JNIEnv* env, jclass Main_klass [[maybe_unused]], jint iflag, jboolean val) {
...
extern "C" JNIEXPORT jstring JNICALL Java_art_Test901_getErrorName(
    JNIEnv* env, jclass Main_klass [[maybe_unused]], jint error) {
  char* name;
