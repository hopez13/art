...
public class Test1919 {
  ...
  public static void run() throws Exception {
    ...
    // has otherwise completed successfully. This has only been observed on the chrome buildbots and
    // I haven't had any luck reproing it. I assume it has something to do with racing between the
    // DetachCurrentThread and shutdown but I'm not sure. Since the runtime normally never shuts
    // down anyway for now I'll just ensure everything gets cleaned up early to prevent the problem
    // from showing up.
    testing_thread.join();
