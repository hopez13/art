...
public class Test1925 {
    ...
    public static void doRecurTestWith(final int times, int watch_frame) throws Exception {
        ...
        final Runnable safepoint = () -> {
            ...
            int cnt = 0;
            for (StackTrace.StackFrameData frame :
                    StackTrace.GetStackTrace(Thread.currentThread())) {
        ...
        try {
            ...
            System.out.println(
                    "Caught exception " + e + " while running recurTimes(" + times + ")");
        }
    }

    public static void run() throws Exception {
        FramePop.enableFramePopEvent(Test1925.class,
