...
public class Test1988 {
  ...
  public static void doTest() {
    Transform1.sayHi();
    Transform2.sayHi();
    System.out.println("Redefining both to use each other.");
    Redefinition.doCommonMultiStructuralClassRedefinition(
        new Class[] { Transform1.class, Transform2.class },
        new byte[][] { T1_BYTES, T2_BYTES });
    Transform1.sayHi();
    Transform2.sayHi();
  }
}
