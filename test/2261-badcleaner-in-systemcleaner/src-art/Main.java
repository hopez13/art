...
public class Main {
    ...
    private static void registerBadCleaner(CountDownLatch finalizerWait) {
        Object obj = new Object();
        SystemCleaner.cleaner().register(obj, () -> neverEndingCleanup(finalizerWait));
    ...
    private static void neverEndingCleanup(CountDownLatch finalizerWait) {
