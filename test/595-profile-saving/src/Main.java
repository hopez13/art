...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Method appMethod = Main.class.getDeclaredMethod(
                    "testAddMethodToProfile", File.class, Method.class);
            ...
            // We never expect System.console to be executed before Main.main gets invoked,
            // and therefore it should never be in a profile.
