...
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      // We nexver expect System.console to be executed before Main.main gets invoked, and therefore
  ...
  static void testMethodNotInProfile(File file, Method m) {
    ...
    // Verify that the profile was saved and contains the method.
    if (presentInProfile(file.getPath(), m)) {
      throw new RuntimeException("Dit not expect method " + m + " to be in the profile");
    }
  }
