...
public class Main {
    public final static int INTERFACE_DEFINED_BITS = 0x0001 | // public, may be set.
    ...
    public final static int CLASS_DEFINED_BITS = 0x0001 | // public, may be set.
            0x0002 | // private, may be flagged by inner class.
            0x0004 | // protected, may be flagged by inner class.
            0x0008 | // static, may be flagged by inner class.
    ...
    public final static int FIELD_DEFINED_BITS = 0x0001 | // public
            0x0002 | // private
            0x0004 | // protected
            0x0008 | // static
            0x0010 | // final
    ...
    public final static int METHOD_DEFINED_BITS = 0x0001 | // public
            0x0002 | // private
            0x0004 | // protected
            0x0008 | // static
            0x0010 | // final
    ...
    private static void check(String className) throws Exception {
        ...
        if (className.equals("Inf")) {
            ...
            if ((clazz.getModifiers() & undefinedBits) != 0) {
                System.out.println(
                        "Clazz.getModifiers(): " + Integer.toBinaryString(clazz.getModifiers()));
                System.out.println(
                        "INTERFACE_DEF_BITS: " + Integer.toBinaryString(INTERFACE_DEFINED_BITS));
        ...
        for (java.lang.reflect.Method m : clazz.getDeclaredMethods()) {
            ...
            if ((m.getModifiers() & undefinedBits) != 0) {
                ...
                System.out.println(
                        "METHOD_DEF_BITS: " + Integer.toBinaryString(METHOD_DEFINED_BITS));
