...
public class Main {
  ...
  public static void testTryFinally() throws Throwable {
    ...
    assertEquals("cleanup t:null result:<target arg1:string arg2:12> arg1:string arg2:12", returnVal);
    ...
    assertEquals("cleanup t:msg result:null arg1:string arg2:12", returnVal);
    returnVal = (String) adapterThrowing.invokeExact(12L, "msg");
    assertEquals("cleanup t:msg result:null arg1:string arg2:12", returnVal);
  }
  ...
  public static String testTryFinally_cleanup(Throwable t, String result, String arg1, long arg2) {
    System.out.println("cleanup: " + t + ", " + result + ", " + arg1 + ", " + arg2);
    return String.format("cleanup t:%s result:%s arg1:%s arg2:%d", t, result, arg1, arg2);
  }

  public static String testTryFinally_cleanup_nonMatchingTrailingArgs(Throwable t, String result, String arg1, double arg2) {
    System.out.println("cleanup: " + t + ", " + result + ", " + arg1 + ", " + arg2);
    return String.format("cleanup t:%s result:%s arg1:%s arg2:%.2f", t, result, arg1, arg2);
  }
  ...
  public static String testTryFinally_cleanup_lessArgsThanTarget(Throwable t, String result, String arg1) {
    System.out.println("cleanup: " + t + ", " + result + ", " + arg1);
    return String.format("cleanup t:%s result:%s arg1:%s", t, result, arg1);
  }
