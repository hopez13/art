...
public class Main {
    ...
    public static int $opt$noinline$mulPlusOne(int acc, int var) { return acc * (var + 1); }
    ...
    /// CHECK-NOT:                        MultiplyAccumulate
    public static long $opt$noinline$mulMinusOne(long acc, long var) { return acc * (1 - var); }
    ...
    public static int $opt$noinline$mulNeg(int left, int right) { return -(left * right); }
    ...
    public static long $opt$noinline$mulNeg(long left, long right) { return -(left * right); }
