...
public class Main {
    ...
    public static char $noinline$inlineMonomorphic(CharSequence cs) { return cs.charAt(0); }
    ...
    public static char $noinline$inlinePolymorphic(CharSequence cs) { return cs.charAt(0); }
    ...
    public static boolean $noinline$stringEquals(Object obj) { return obj.equals("def"); }
