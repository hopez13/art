...
public class Main {
  ...
  /// CHECK-NOT:   InvokeVirtual method_name:java.lang.StringBuilder.charAt
  ...
  public static void test() {
    ...
    if ($noinline$inlinePolymorphic(strBuilder) != 'x') {
      throw new Error("Expected x");
    }
  ...
  static StringBuilder strBuilder = new StringBuilder("xyz");
