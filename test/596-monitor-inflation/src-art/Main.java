...
public class Main {
    public static void main(String[] args) {
        ...
        // Since monitor deflation is delayed significantly, we believe that even with an
        // intervening GC, monitors should remain inflated.  We allow some slop for unrelated
        // concurrent runtime actions.
