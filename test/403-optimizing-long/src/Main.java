...
public class Main {
    ...
    static long $opt$MakeCallsWithLongs1() {
        ...
        return $opt$ReturnLong() + $opt$TakeOneLong1(1) + $opt$TakeOneLong2(0, 2)
                + $opt$TakeOneLong3(0, 0, 3)
                + $opt$TakeOneLong4(0, 0, 0, 4)
                // Test invoke-range.
    ...
    static long $opt$ReturnLong() { return 42; }

    static long $opt$TakeOneLong1(long l) { return l; }

    static long $opt$TakeOneLong2(int a, long l) { return l; }

    static long $opt$TakeOneLong3(int a, int b, long l) { return l; }

    static long $opt$TakeOneLong4(int a, int b, int c, long l) { return l; }

    static long $opt$TakeOneLong5(int a, int b, int c, int d, long l) { return l; }

    static long $opt$AddTwoLongs(long a, long b) { return a + b; }

    static long $opt$AddThreeLongs(long a, long b, long c) { return a + b + c; }

    static long $opt$SubTwoLongs(long a, long b) { return a - b; }
}
