...
//    -permitbasedwait:X .. frequency of PermitBasedWait (double)
...
public class Main implements Runnable {
    ...
    private final static class PermitBasedWait extends Operation {
        private final static int SLEEP_TIME = 100;

        private final Semaphore semaphore;

        public PermitBasedWait(Semaphore semaphore) {
    ...
    private final static Map<Operation, Double> createDefaultFrequencyMap(Object lock,
        ...
        frequencyMap.put(new PermitBasedWait(semaphore), 0.05);    // 10/200
    ...
    private static Map<Operation, Double> updateFrequencyMap(Map<Operation, Double> in,
        ...
        } else if (split[0].equals("-permitbasedwait")) {
            op = new PermitBasedWait(semaphore);
        } else {
