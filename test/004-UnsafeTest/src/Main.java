...
public class Main {
    ...
    private static void testGetAndPutAndCAS(Unsafe unsafe) throws NoSuchFieldException {
        ...
        if (!unsafe.compareAndSwapObject(t, objectOffset, t, t)) {
            System.out.println(
                    "Unexpectedly not succeeding compareAndSwapObject(t, objectOffset, t, t)");
        }
        // Exercise sun.misc.Unsafe.compareAndSwapObject using the same
    ...
    private static void testGetAndPutVolatile(Unsafe unsafe) throws NoSuchFieldException {
        ...
        check(unsafe.getIntVolatile(tv, volatileIntOffset), 0,
        ...
        check(unsafe.getIntVolatile(tv, volatileIntOffset), intValue,
        ...
        check(unsafe.getLongVolatile(tv, volatileLongOffset), 0,
        ...
        check(unsafe.getLongVolatile(tv, volatileLongOffset), longValue,
        ...
        check(unsafe.getObjectVolatile(tv, volatileObjectOffset), null,
        ...
        check(unsafe.getObjectVolatile(tv, volatileObjectOffset), objectValue,
