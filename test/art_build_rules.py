...
def build_run_test(
  ...
  RBE_image = ("docker://gcr.io/androidbuild-re-dockerimage/android-build-remoteexec-image@sha256:"
               "582efb38f0c229ea39952fff9e132ccbe183e14869b39888010dacf56b360d62,Pool=java16")
    ...
    def rbe_wrap(args, inputs=set()):
      with tempfile.NamedTemporaryFile(mode="w+t", dir=RBE_exec_root) as input_list:
        ...
        return run(RBE_rewrapper, [
          "--platform=container-image=" + RBE_image,
