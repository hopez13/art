...
public class Main {
    ...
    static void and(boolean x) {
        for (int i = 0; i < 128; i++) a[i] &= x; // NOTE: bitwise and, not the common &&
    }
    ...
    static void or(boolean x) {
        for (int i = 0; i < 128; i++) a[i] |= x; // NOTE: bitwise or, not the common ||
    }
    ...
    static void xor(boolean x) {
        for (int i = 0; i < 128; i++) a[i] ^= x; // NOTE: bitwise xor
    }
