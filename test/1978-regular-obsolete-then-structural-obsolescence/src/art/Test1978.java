...
public class Test1978 {
    ...
    //   }
    // }
    private static final byte[] NON_STRUCTURAL_DEX_BYTES = Base64.getDecoder().decode(
    ...
    //   }
    // }
    private static final byte[] STRUCTURAL_DEX_BYTES = Base64.getDecoder().decode(
        ...
        Transform.sayHi(
                ...
                () -> {
                    ...
                    Redefinition.doCommonStructuralClassRedefinition(
                            Transform.class, STRUCTURAL_DEX_BYTES);
                });
        Transform.sayHi(()
                                -> { System.out.println("Not doing anything here - op1"); },
                () -> { System.out.println("Not doing anything here - op2"); });
