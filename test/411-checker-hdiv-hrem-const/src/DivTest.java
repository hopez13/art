...
public class DivTest {
  ...
  // into one 'asr'.
  //
  /// CHECK-START-ARM64: java.lang.Integer DivTest.$noinline$IntDivBy18(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #34
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  private static Integer $noinline$IntDivBy18(int v) {
    int r = v / 18;
    return r;
  }
  ...
  // into one 'asr'.
  //
  /// CHECK-START-ARM64: java.lang.Integer DivTest.$noinline$IntDivByMinus18(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #34
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  private static Integer $noinline$IntDivByMinus18(int v) {
    int r = v / -18;
    return r;
  }
  ...
  //
  /// CHECK-START-ARM64: java.lang.Integer DivTest.$noinline$IntDivBy7(int) disassembly (after)
  /// CHECK:                 lsr x{{\d+}}, x{{\d+}}, #32
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}
  /// CHECK-NEXT:            asr w{{\d+}}, w{{\d+}}, #2
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  private static Integer $noinline$IntDivBy7(int v) {
    int r = v / 7;
    return r;
  }
  ...
  //
  /// CHECK-START-ARM64: java.lang.Integer DivTest.$noinline$IntDivByMinus7(int) disassembly (after)
  /// CHECK:                 lsr x{{\d+}}, x{{\d+}}, #32
  /// CHECK-NEXT:            sub w{{\d+}}, w{{\d+}}, w{{\d+}}
  /// CHECK-NEXT:            asr w{{\d+}}, w{{\d+}}, #2
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  private static Integer $noinline$IntDivByMinus7(int v) {
    int r = v / -7;
    return r;
  }
  ...
  //
  /// CHECK-START-ARM64: java.lang.Integer DivTest.$noinline$IntDivBy6(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #32
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  private static Integer $noinline$IntDivBy6(int v) {
    int r = v / 6;
    return r;
  }
  ...
  // 32 bits can be used as well.
  //
  /// CHECK-START-ARM64: java.lang.Integer DivTest.$noinline$IntDivByMinus6(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #32
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  private static Integer $noinline$IntDivByMinus6(int v) {
    int r = v / -6;
    return r;
  }
  ...
  /// CHECK-START-ARM64: java.lang.Long DivTest.$noinline$LongDivBy18(long) disassembly (after)
  ...
  /// CHECK-START-ARM64: java.lang.Long DivTest.$noinline$LongDivByMinus18(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
  ...
  /// CHECK-START-ARM64: java.lang.Long DivTest.$noinline$LongDivBy7(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  ...
  /// CHECK-START-ARM64: java.lang.Long DivTest.$noinline$LongDivByMinus7(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            asr x{{\d+}}, x{{\d+}}, #1
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
  ...
  /// CHECK-START-ARM64: java.lang.Long DivTest.$noinline$LongDivBy6(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
  ...
  /// CHECK-START-ARM64: java.lang.Long DivTest.$noinline$LongDivByMinus6(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
