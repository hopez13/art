...
public class RemTest {
  ...
  // into one 'asr'.
  //
  /// CHECK-START-ARM64: java.lang.Integer RemTest.$noinline$IntRemBy18(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #34
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  /// CHECK-NEXT:            mov w{{\d+}}, #0x12
  /// CHECK-NEXT:            msub w{{\d+}}, w{{\d+}}, w{{\d+}}, w{{\d+}}
  private static Integer $noinline$IntRemBy18(int v) {
    int r = v % 18;
    return r;
  }
  ...
  // into one 'asr'.
  //
  /// CHECK-START-ARM64: java.lang.Integer RemTest.$noinline$IntRemByMinus18(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #34
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  /// CHECK-NEXT:            mov w{{\d+}}, #0xffffffee
  /// CHECK-NEXT:            msub w{{\d+}}, w{{\d+}}, w{{\d+}}, w{{\d+}}
  private static Integer $noinline$IntRemByMinus18(int v) {
    int r = v % -18;
    return r;
  }
  ...
  //
  /// CHECK-START-ARM64: java.lang.Integer RemTest.$noinline$IntRemBy7(int) disassembly (after)
  ...
  /// CHECK-NEXT:            msub w{{\d+}}, w{{\d+}}, w{{\d+}}, w{{\d+}}
  private static Integer $noinline$IntRemBy7(int v) {
    int r = v % 7;
    return r;
  }
  ...
  //
  /// CHECK-START-ARM64: java.lang.Integer RemTest.$noinline$IntRemByMinus7(int) disassembly (after)
  /// CHECK:                 lsr x{{\d+}}, x{{\d+}}, #32
  ...
  /// CHECK-NEXT:            msub w{{\d+}}, w{{\d+}}, w{{\d+}}, w{{\d+}}
  private static Integer $noinline$IntRemByMinus7(int v) {
    int r = v % -7;
    return r;
  }
  ...
  //
  /// CHECK-START-ARM64: java.lang.Integer RemTest.$noinline$IntRemBy6(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #32
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  /// CHECK-NEXT:            mov w{{\d+}}, #0x6
  /// CHECK-NEXT:            msub w{{\d+}}, w{{\d+}}, w{{\d+}}, w{{\d+}}
  private static Integer $noinline$IntRemBy6(int v) {
    int r = v % 6;
    return r;
  }
  ...
  // 32 bits can be used as well.
  //
  /// CHECK-START-ARM64: java.lang.Integer RemTest.$noinline$IntRemByMinus6(int) disassembly (after)
  /// CHECK:                 asr x{{\d+}}, x{{\d+}}, #32
  /// CHECK-NEXT:            add w{{\d+}}, w{{\d+}}, w{{\d+}}, lsr #31
  /// CHECK-NEXT:            mov w{{\d+}}, #0xfffffffa
  /// CHECK-NEXT:            msub w{{\d+}}, w{{\d+}}, w{{\d+}}, w{{\d+}}
  private static Integer $noinline$IntRemByMinus6(int v) {
    int r = v % -6;
    return r;
  }
  ...
  /// CHECK-START-ARM64: java.lang.Long RemTest.$noinline$LongRemBy18(long) disassembly (after)
  ...
  /// CHECK-START-ARM64: java.lang.Long RemTest.$noinline$LongRemByMinus18(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
  ...
  /// CHECK-START-ARM64: java.lang.Long RemTest.$noinline$LongRemBy7(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  ...
  /// CHECK-START-ARM64: java.lang.Long RemTest.$noinline$LongRemByMinus7(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            asr x{{\d+}}, x{{\d+}}, #1
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
  ...
  /// CHECK-START-ARM64: java.lang.Long RemTest.$noinline$LongRemBy6(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
  ...
  /// CHECK-START-ARM64: java.lang.Long RemTest.$noinline$LongRemByMinus6(long) disassembly (after)
  /// CHECK:                 smulh x{{\d+}}, x{{\d+}}, x{{\d+}}
  /// CHECK-NEXT:            add x{{\d+}}, x{{\d+}}, x{{\d+}}, lsr #63
