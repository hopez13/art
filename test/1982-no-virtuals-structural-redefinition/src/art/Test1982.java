...
public class Test1982 {
    ...
    public static class SuperTransform {
        ...
        public SuperTransform(int id) { this.id = id; }
    ...
    public static class Transform extends SuperTransform {
        ...
        public Transform(int id) { super(id); }
    ...
    public static class SubTransform extends Transform {
        public SubTransform(int id) { super(id); }
    ...
    public static void doTest() throws Exception {
        ...
        readReflective("Reading with reflection on subtransform instance.",
                SubTransform.class.getFields(), t2);
        ...
        readReflective("Reading with reflection after redefinition.",
                Transform.class.getDeclaredFields(), null);
        readReflective("Reading with reflection after redefinition on subtransform instance.",
                SubTransform.class.getFields(), t2);
        ...
        System.out.println("Creating new transform from t1 class = "
