...
interface Itf {
    ...
    public default void m() throws Exception { throw new Exception("Don't inline me"); }
...
public class Main implements Itf, Itf2 {
    ...
    public static void $noinline$doCallDefault() throws Exception { itf.m(); }

    public static void $noinline$doCallDefaultConflict() throws Exception { itf.mConflict(); }

    public static void $noinline$doCallDefaultConflictItf3() throws Exception { itf3.mConflict(); }

    public static void $noinline$doCallDefaultConflictItf4() throws Exception { itf4.mConflict(); }
