...
class Super implements Interface {
    ...
    public void $noinline$f() { throw new RuntimeException(); }

    public int $inline$h(boolean cond) {
        Super obj = (cond ? this : null);
        return obj.$noinline$hashCode();
    }
    public int $noinline$hashCode() { return hashCode(); }
}

class SubclassA extends Super {
    public void $noinline$f() { throw new RuntimeException(); }

    public String $noinline$h() { throw new RuntimeException(); }

    void $noinline$g() { throw new RuntimeException(); }
}
...
public class Main {
    ...
    /// CHECK:         CheckCast
    public void testSimpleKeep(Super s) { ((SubclassA) s).$noinline$f(); }
    ...
    private SubclassC get() { return genericC.get(); }

    private Final getFinal() { return genericFinal.get(); }
    ...
    private Super getSuper() { return new SubclassA(); }
    ...
    public String checkcastPreserveNullCheck(Object a) { return ((SubclassA) a).toString(); }
    ...
    private Main getNull() { return null; }
    ...
    public static int $inline$hashCode(Super obj) { return obj.hashCode(); }
