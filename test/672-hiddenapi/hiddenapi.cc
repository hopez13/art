...
extern "C" JNIEXPORT void JNICALL Java_Main_appendToBootClassLoader(
    JNIEnv* env, jclass Main_klass ATTRIBUTE_UNUSED, jstring jpath) {
  ...
  if (!DexFileLoader::Open(
        path, path, /* verify */ true, /* verify_checksum */ true, &error_msg, &dex_files)) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_JNI_canDiscoverField(JNIEnv* env,
    jclass thisClass ATTRIBUTE_UNUSED, jclass klass, jstring name, jboolean is_static) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_JNI_canDiscoverMethod(JNIEnv* env,
    jclass thisClass ATTRIBUTE_UNUSED, jclass klass, jstring name, jboolean is_static) {
  ScopedUtfChars utf_name(env, name);
...
extern "C" JNIEXPORT jboolean JNICALL Java_JNI_canDiscoverConstructor(JNIEnv* env,
    jclass thisClass ATTRIBUTE_UNUSED, jclass klass, jstring args) {
