...
public class JNI {
  ...
  public static native boolean canInvokeMethod(Class<?> klass, String name, boolean isStatic);
  public static native boolean canInvokeConstructor(Class<?> klass, String signature);
}
