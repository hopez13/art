...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    // the child dex file should not be able to access the parent.
  ...
  private static final String DEX_PARENT =
      new File(System.getenv("DEX_LOCATION"), "672-hiddenapi.jar").getAbsolutePath();
  private static final String DEX_PARENT_BOOT =
      new File(System.getenv("DEX_LOCATION"), "672-hiddenapi-boot.jar").getAbsolutePath();
  private static final String DEX_CHILD =
      new File(System.getenv("DEX_LOCATION"), "672-hiddenapi-ex.jar").getAbsolutePath();
