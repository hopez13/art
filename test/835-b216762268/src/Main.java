...
public class Main {
    ...
    public static void main(String[] strArr) {
      System.out.println("verySimpleTest: " + $noinline$verySimpleTest());
      System.out.println("simpleTest: " + $noinline$simpleTest());
      System.out.println("mainTest: " + $noinline$mainTest());
    }
}
