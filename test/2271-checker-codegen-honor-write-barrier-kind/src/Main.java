...
public class Main {
    ...
    // (which is incorrect). arr[1] write barrier depends on arr[0]'s write barrier. The disappeared
    // BoundType in prepare_for_register_allocation shouldn't remove the setting of the dirty bit
    // for arr[0].
