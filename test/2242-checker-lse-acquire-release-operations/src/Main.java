...
public class Main {
    public static void main(String[] args) {
        ...
        assertEquals(
                3, $noinline$testVolatileLoadDifferentFields(new TestClass(), new TestClass()));
        assertEquals(3,
                $noinline$testVolatileLoadDifferentFieldsBlocking(
        ...
        assertEquals(
                2, $noinline$testVolatileLoadSetAndMergeValuesBlocking(new TestClass(), false));
        ...
        assertEquals(
                2, $noinline$testVolatileLoadInlineMethodWithSynchronizedScope(new TestClass()));

        // Volatile stores - Different fields shouldn't alias.
        assertEquals(
                3, $noinline$testVolatileStoreDifferentFields(new TestClass(), new TestClass()));
        assertEquals(3,
                $noinline$testVolatileStoreDifferentFieldsBlocking(
                        new TestClass(), new TestClass()));
        ...
        assertEquals(
                1, $noinline$testVolatileStoreSetAndMergeValuesNotBlocking(new TestClass(), true));
        assertEquals(
        ...
        assertEquals(2,
                $noinline$testVolatileStoreRedundantStoreRemovedSynchronization(new TestClass()));
        ...
        assertEquals(
                2, $noinline$testVolatileStoreInlineMethodWithSynchronizedScope(new TestClass()));
        ...
        assertEquals(
                2, $noinline$testMonitorOperationRedundantStoreBlockingOnlyLoad(new TestClass()));
        ...
        assertEquals(
                1, $noinline$testMonitorOperationSetAndMergeValuesBlocking(new TestClass(), true));
        assertEquals(
        ...
        assertEquals(2,
                $noinline$testMonitorOperationRedundantStoreRemovedSynchronization(
                        new TestClass()));
        ...
        assertEquals(2,
                $noinline$testMonitorOperationInlineMethodWithSynchronizedScope(new TestClass()));
    }
    ...
    static int $noinline$testMonitorOperationDifferentFieldsBlocking(
            TestClass obj1, TestClass obj2) {
        obj1.i = 1;
        obj2.j = 2;
        synchronized (classForSync) {
