...
public class Main {
  ...
  static int $noinline$testVolatileLoadDifferentFieldsRemovedSynchronization(TestClass obj1, TestClass obj2) {
    Main m = new Main();
  ...
  static int $noinline$testVolatileLoadSetAndMergeValuesRemovedSynchronization(TestClass obj, boolean b) {
    Main m = new Main();
  ...
  static int $noinline$testVolatileStoreDifferentFieldsRemovedSynchronization(TestClass obj1, TestClass obj2) {
    Main m = new Main();
  ...
  static int $noinline$testVolatileStoreSetAndMergeValuesRemovedSynchronization(TestClass obj, boolean b) {
    Main m = new Main();
