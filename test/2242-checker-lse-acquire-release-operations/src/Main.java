...
public class Main {
    public static void main(String[] args) {
        ...
        assertEquals(
                $noinline$testVolatileLoadDifferentFields(new TestClass(), new TestClass()), 3);
        assertEquals(
        ...
        assertEquals(
                $noinline$testVolatileLoadSetAndMergeValuesBlocking(new TestClass(), false), 2);

        // Volatile stores - Different fields shouldn't alias.
        assertEquals(
                $noinline$testVolatileStoreDifferentFields(new TestClass(), new TestClass()), 3);
        assertEquals($noinline$testVolatileStoreDifferentFieldsBlocking(
        ...
        assertEquals(
                $noinline$testVolatileStoreSetAndMergeValuesNotBlocking(new TestClass(), true), 1);
        assertEquals(
                $noinline$testVolatileStoreSetAndMergeValuesNotBlocking(new TestClass(), false), 2);
