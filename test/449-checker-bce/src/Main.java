...
public class Main {
    ...
    static void runAllConstantIndices() {
        ...
        if (a6[0] != 0 || a6[1] != 1 || a6[2] != 1 || a6[3] != 1 || a6[4] != 1 || a6[5] != 11) {
        ...
        if (!caught || a6[0] != 6 || a6[1] != 6 || a6[2] != 6 || a6[3] != 6 || a6[4] != 1
                || a6[5] != 11) {
        ...
        if (a6[0] != 7 || a6[1] != 7 || a6[2] != 7 || a6[3] != 7 || a6[4] != 1 || a6[5] != 11) {
            System.out.println("constant indices 2c failed!");
        }
        ...
        if (a6[0] != 7 || a6[1] != 7 || a6[2] != 7 || a6[3] != 111 || a6[4] != 111 || a6[5] != 11) {
            System.out.println("constant indices 6 failed!");
        }

        constantIndexing7(a6, 1);
        if (a6[0] != 7 || a6[1] != 10 || a6[2] != 20 || a6[3] != 30 || a6[4] != 40 || a6[5] != 11) {
        ...
        if (!caught || a6[0] != 7 || a6[1] != 10 || a6[2] != 20 || a6[3] != 30 || a6[4] != 40
                || a6[5] != 10) {
            System.out.println("constant indices 7 failed!");
        }

        constantIndexing8(a6, 1);
        if (a6[0] != 100 || a6[1] != 200 || a6[2] != 300 || a6[3] != 400 || a6[4] != 40
                || a6[5] != 10) {
        ...
        if (a6[0] != 0 || a6[1] != 1 || a6[2] != 2 || a6[3] != 3 || a6[4] != 40 || a6[5] != 10) {
            System.out.println("constant indices 9 failed!");
        }

        constantIndexing10(a6, 0);
        if (a6[0] != 1 || a6[1] != 2 || a6[2] != 3 || a6[3] != 4 || a6[4] != 40 || a6[5] != 10) {
    ...
    static int foo() {
        try {
            ...
            assertIsManaged(); // This is to ensure that single-frame deoptimization works.
                               // Will need to be updated if $opt$noinline$constantIndexing2 is
                               // inlined.
            try {
                // This will cause AIOOBE.
    ...
    public static void main(String[] args) {
        ...
        if (!compiledWithOptimizing() || !hasOatFile() || runtimeIsSoftFail() || isInterpreted()) {
