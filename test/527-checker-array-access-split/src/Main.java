...
public class Main {
    ...
    public static int constantIndexGet(int array[]) { return array[1]; }
    ...
    public static void constantIndexSet(int array[]) { array[1] = 2; }
    ...
    /// CHECK-NOT:                                IntermediateAddress
    /// CHECK:                                    ArraySet [<<Address>>,<<Index>>,<<Add>>]
    public static void getSet(int array[], int index) { array[index] = array[index] + 1; }
    ...
    private int testIntAddressObjDisasm(Integer[] obj, int x) { return obj[x] + obj[x + 1]; }
