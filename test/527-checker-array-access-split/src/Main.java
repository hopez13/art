...
public class Main {
  ...
  /// CHECK: <<Array:l\d+>>         NullCheck [<<Parameter>>]
  /// CHECK: <<IntAddr1:i\d+>>      IntermediateAddress [<<Array>>,<<Const12>>]
  /// CHECK:                        ArrayGet [<<IntAddr1>>,{{i\d+}}]
  /// CHECK: <<IntAddr2:i\d+>>      IntermediateAddress [<<Array>>,<<Const12>>]
  /// CHECK:                        ArrayGet [<<IntAddr2>>,{{i\d+}}]
  /// CHECK:                        ArraySet [<<Array>>,{{i\d+}},{{l\d+}}]
  /// CHECK: <<IntAddr3:i\d+>>      IntermediateAddress [<<Array>>,<<Const12>>]
