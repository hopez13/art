...
public class Main {
    ...
    /// CHECK-START: int Main.$noinline$testDoubleDiamondSameValue(boolean, boolean) select_generator (after)
    /// CHECK-NOT: Select
    private static int $noinline$testDoubleDiamondSameValue(
            boolean bool_param_1, boolean bool_param_2) {
        int return_value;
        if (bool_param_1) {
            return_value = 10;
        } else {
    ...
    // Check that we generate a select for a double diamond pattern, with a different value in the
    // outer branch.
    ...
    private static int $noinline$testDoubleDiamondSameValueButNotAllOuter(
            boolean bool_param_1, boolean bool_param_2) {
        int return_value;
        if (bool_param_1) {
            return_value = 10;
    ...
    /// CHECK-DAG:                    Return [<<Select2>>]
    private static int $noinline$testDoubleDiamondSameValueButNotAllInner(
            boolean bool_param_1, boolean bool_param_2) {
        int return_value;
        if (bool_param_1) {
            return_value = 20;
    ...
    /// CHECK-DAG:   <<Select2:i\d+>> Select [<<Select>>,<<Const10>>,<<Bool1>>]
    /// CHECK-DAG:                    Return [<<Select2>>]
    private static int $noinline$testDoubleDiamondDifferentValue(
            boolean bool_param_1, boolean bool_param_2) {
        int return_value;
        if (bool_param_1) {
            return_value = 10;
    ...
    /// CHECK:       Return
    /// CHECK-NOT:   Return
    private static int $noinline$testDoubleDiamondSameValueWithReturn(
            boolean bool_param_1, boolean bool_param_2) {
        if (bool_param_1) {
            return 10;
        } else {
    ...
    // Note that we have 2 returns instead of 3 as the two `return 20;` get merged into one before
    // `select_generator`.
    /// CHECK-START: int Main.$noinline$testDoubleDiamondSameValueButNotAllOuterWithReturn(boolean, boolean) select_generator (before)
    /// CHECK:                    Return
    /// CHECK:                    Return
    ...
    /// CHECK-DAG:                    Return [<<Select2>>]
    private static int $noinline$testDoubleDiamondSameValueButNotAllOuterWithReturn(
            boolean bool_param_1, boolean bool_param_2) {
        if (bool_param_1) {
            return 10;
        } else {
    ...
    /// CHECK-DAG:   <<Select2:i\d+>> Select [<<Select>>,<<Const20>>,<<Bool1>>]
    /// CHECK-DAG:                    Return [<<Select2>>]
    private static int $noinline$testDoubleDiamondSameValueButNotAllInnerWithReturn(
            boolean bool_param_1, boolean bool_param_2) {
        if (bool_param_1) {
            return 20;
        } else {
    ...
    /// CHECK-DAG:   <<Select2:i\d+>> Select [<<Select>>,<<Const10>>,<<Bool1>>]
    /// CHECK-DAG:                    Return [<<Select2>>]
    private static int $noinline$testDoubleDiamondDifferentValueWithReturn(
            boolean bool_param_1, boolean bool_param_2) {
        if (bool_param_1) {
            return 10;
        } else {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        assertEquals(
                20, $noinline$testDoubleDiamondSameValueButNotAllOuterWithReturn(false, false));
        assertEquals(
                20, $noinline$testDoubleDiamondSameValueButNotAllInnerWithReturn(false, false));
