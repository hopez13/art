...
public class Main {
    ...
    public static void main(String[] args) throws Throwable {
      targetMethodThrowsException();
      mhIsCalledWithWrongTypes();
      // mh();
    }

    private static void targetMethodThrowsException() throws Throwable {
      for (int i = 0; i < 2; ++i) {
        try {
    ...
    private static void mhIsCalledWithWrongTypes() throws Throwable {
      for (int i = 0; i < 2; ++i) {
        try {
    ...
    static {
        try {
            ...
            INTERFACE_DEFAULT_METHOD = MethodHandles.lookup()
                      .findVirtual(A.class, "defaultMethod", MethodType.methodType(void.class));
        } catch (Exception e) {
