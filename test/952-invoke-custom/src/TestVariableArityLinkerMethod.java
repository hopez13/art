...
public class TestVariableArityLinkerMethod extends TestBase {
    ...
    private static CallSite bsmWithStringArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, String... arityArgs) throws Throwable {
    ...
    @CalledByIndy(
            bootstrapMethod = @BootstrapMethod(enclosingType = TestVariableArityLinkerMethod.class,
            ...
            constantArgumentsForBootstrapMethod =
            {
                ...
                , @Constant(stringValue = "Aalborg"), @Constant(stringValue = "Aalto")
            })
    private static void
    methodA() {
    ...
    private static CallSite bsmWithIntAndStringArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, int extraInt, String... extraArityArgs) throws Throwable {
        printBsmArgs("bsmWithIntAndStringArray", lookup, methodName, methodType, extraInt,
                extraArityArgs);
        MethodHandle mh = lookup.findStatic(lookup.lookupClass(), methodName, methodType);
        return new ConstantCallSite(mh);
    }
    ...
    @CalledByIndy(
            ...
            constantArgumentsForBootstrapMethod =
            {
                ...
                , @Constant(stringValue = "zoo"), @Constant(stringValue = "zoogene"),
    ...
    private static CallSite bsmWithLongAndIntArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, long extraArg, int... arityArgs) throws Throwable {
    ...
    @CalledByIndy(
            ...
            constantArgumentsForBootstrapMethod =
            {
                ...
                , @Constant(intValue = +1), @Constant(intValue = -1), @Constant(intValue = +2),
                        @Constant(intValue = -2)
            })
    private static void
    methodG() {
    ...
    private static CallSite bsmWithFloatAndLongArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, float extraArg, long... arityArgs) throws Throwable {
        printBsmArgs(
    ...
    @CalledByIndy(
            ...
            constantArgumentsForBootstrapMethod =
            {
                ...
                , @Constant(longValue = 999999999999l), @Constant(longValue = -8888888888888l)
            })
    private static void
    methodH() {
    ...
    private static CallSite bsmWithClassAndFloatArray(MethodHandles.Lookup lookup,
            String methodName, MethodType methodType, Class<?> extraArg, float... arityArgs)
            throws Throwable {
        printBsmArgs(
    ...
    @CalledByIndy(
            bootstrapMethod = @BootstrapMethod(enclosingType = TestVariableArityLinkerMethod.class,
                    ...
                    parameterTypes = {MethodHandles.Lookup.class, String.class, MethodType.class,
                            Class.class, float[].class}),
            fieldOrMethodName = "methodI",
            constantArgumentsForBootstrapMethod =
            {
                @Constant(classValue = Throwable.class)
                , @Constant(floatValue = Float.MAX_VALUE), @Constant(floatValue = Float.MIN_VALUE),
    ...
    private static CallSite bsmWithDoubleArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, double... arityArgs) throws Throwable {
    ...
    @CalledByIndy(
            ...
            constantArgumentsForBootstrapMethod =
            {
                ...
                , @Constant(doubleValue = Double.MIN_VALUE), @Constant(doubleValue = Math.E),
    ...
    private static CallSite bsmWithClassArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, Class... arityArgs) throws Throwable {
    ...
    @CalledByIndy(
            ...
            constantArgumentsForBootstrapMethod =
            {
                ...
                , @Constant(classValue = MethodHandles.class), @Constant(classValue = Arrays.class)
            })
    private static void
    methodK() {
    ...
    @CalledByIndy(
            ...
            {
                @Constant(intValue = 103)
                , @Constant(stringValue = "A"), @Constant(stringValue = "B"),
    ...
    private static CallSite bsmWithWiderArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, long[] extraArgs) throws Throwable {
    ...
    private static CallSite bsmWithBoxedArray(MethodHandles.Lookup lookup, String methodName,
            MethodType methodType, Integer[] extraArgs) throws Throwable {
