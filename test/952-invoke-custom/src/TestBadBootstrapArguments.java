...
public class TestBadBootstrapArguments extends TestBase {
    ...
    private static CallSite bsmDJ(MethodHandles.Lookup lookup,
                                  String methodName,
                                  MethodType methodType,
                                  double extraArg0,
                                  long extraArg1) throws Throwable {
    ...
    private static CallSite bsmDoubleLong(MethodHandles.Lookup lookup,
                                          String methodName,
                                          MethodType methodType,
                                          Double extraArg0,
                                          Long extraArg1) throws Throwable {
