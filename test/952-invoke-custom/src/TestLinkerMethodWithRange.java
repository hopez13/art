...
public class TestLinkerMethodWithRange extends TestBase {
    @CalledByIndy(
            bootstrapMethod = @BootstrapMethod(enclosingType = TestLinkerMethodWithRange.class,
    ...
    @SuppressWarnings("unused")
    private static CallSite primLinkerMethod(MethodHandles.Lookup caller, String name,
        ...
        MethodHandle mh_add = caller.findStatic(TestLinkerMethodWithRange.class, name, methodType);
    ...
    @CalledByIndy(bootstrapMethod = @BootstrapMethod(
                          enclosingType = TestLinkerMethodWithRange.class, name = "refLinkerMethod",
                          parameterTypes =
                                  {
            ...
            fieldOrMethodName = "_multiply", returnType = Integer.class,
            parameterTypes = {Double.class, Double.class, Double.class, Double.class, Double.class,
                    Double.class},
            constantArgumentsForBootstrapMethod = {})

    private static Double
    multiply(Double a, Double b, Double c, Double d, Double e, Double f) {
        assertNotReached();
        return 0.0;
    }
