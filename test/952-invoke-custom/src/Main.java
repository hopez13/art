...
public class Main {
  ...
  private static void Test004() throws Throwable {
    ...
    // expected values.
    byte[] base64Data = TestData004.BASE64_DEX_FILE.getBytes();
  ...
  private static void Test006() throws Throwable {
    // This is a concurrency test that attempts to run invoke-custom on the same
    // call site.
    byte[] base64Data = TestData006.BASE64_DEX_FILE.getBytes();
    Base64.Decoder decoder = Base64.getDecoder();
    ByteBuffer dexBuffer = ByteBuffer.wrap(decoder.decode(base64Data));
