...
public class Main {
  ...
  private static final long kBigLong = 739287620162442240L;
  ...
  public static void test_Long_divideUnsigned() {
    ...
    Assert.assertEquals(Long.divideUnsigned(kBigLong, kBigLong), 1L);
    Assert.assertEquals(Long.divideUnsigned(kBigLong, 1L), kBigLong);
    Assert.assertEquals(Long.divideUnsigned(kBigLong, 1024L), 721960566564885L);
    Assert.assertEquals(Long.divideUnsigned(kBigLong, 0x1FFFFFFFFL), 86064406L);
