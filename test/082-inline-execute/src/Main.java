...
public class Main {
    ...
    // Break up the charAt tests. The optimizing compiler doesn't optimize methods with try-catch
    // yet, so we need to separate out the tests that are expected to throw exception
    ...
    private static int testNullIndex(String strNull, int c) { return strNull.indexOf(c); }
    ...
    public static void test_Math_multiplyHigh() {
        ...
        Assert.assertEquals(
                Math.multiplyHigh(Long.MAX_VALUE, Long.MAX_VALUE), 4611686018427387903L);
    }
    ...
    public static void test_StrictMath_min_I() {
        ...
        Assert.assertEquals(
                StrictMath.min(Integer.MIN_VALUE, Integer.MAX_VALUE), Integer.MIN_VALUE);
    }
    ...
    public static void test_StrictMath_max_I() {
        ...
        Assert.assertEquals(
                StrictMath.max(Integer.MIN_VALUE, Integer.MAX_VALUE), Integer.MAX_VALUE);
    }
    ...
    public static void test_StrictMath_ceil() {
        ...
        Assert.assertEquals(
                StrictMath.ceil(Double.POSITIVE_INFINITY), Double.POSITIVE_INFINITY, 0.0);
        Assert.assertEquals(
                StrictMath.ceil(Double.NEGATIVE_INFINITY), Double.NEGATIVE_INFINITY, 0.0);
    }
    ...
    public static void test_StrictMath_floor() {
        ...
        Assert.assertEquals(
                StrictMath.floor(Double.POSITIVE_INFINITY), Double.POSITIVE_INFINITY, 0.0);
        Assert.assertEquals(
                StrictMath.floor(Double.NEGATIVE_INFINITY), Double.NEGATIVE_INFINITY, 0.0);
    }
    ...
    public static void test_StrictMath_rint() {
        ...
        Assert.assertEquals(
                StrictMath.rint(Double.POSITIVE_INFINITY), Double.POSITIVE_INFINITY, 0.0);
        Assert.assertEquals(
                StrictMath.rint(Double.NEGATIVE_INFINITY), Double.NEGATIVE_INFINITY, 0.0);
    }
    ...
    public static void test_StrictMath_round_D() {
        ...
        Assert.assertEquals(
                StrictMath.round(-4503599627370495.0d), -4503599627370495l); // -(2^52 - 1)
        Assert.assertEquals(
                StrictMath.round(-4503599627370495.5d), -4503599627370495l); // -(2^52 - 0.5)
        Assert.assertEquals(StrictMath.round(-4503599627370496.0d), -4503599627370496l); // -2^52
        Assert.assertEquals(StrictMath.round(9007199254740991.0d), 9007199254740991l); // 2^53 - 1
        Assert.assertEquals(
                StrictMath.round(-9007199254740991.0d), -9007199254740991l); // -(2^53 - 1)
    ...
    public static void test_Double_doubleToRawLongBits() {
        ...
        Assert.assertEquals(
                Double.doubleToRawLongBits(Double.POSITIVE_INFINITY), 0x7ff0000000000000L);
        Assert.assertEquals(
                Double.doubleToRawLongBits(Double.NEGATIVE_INFINITY), 0xfff0000000000000L);
    }
    ...
    private static long test_Long_reverse_b22324327(long l1, long l2) {
        ...
        // Include everything in the result, so things are kept live. Try to be a little bit clever
        // to avoid things being folded somewhere.
    ...
    public static void test_Integer_numberOfLeadingZeros() {
        ...
        Assert.assertEquals(
                Integer.numberOfLeadingZeros($noinline$return_int_zero()), Integer.SIZE);
    ...
    public static void initSupportMethodsForPeekPoke() throws Exception {
        ...
        new_non_movable_array =
                vm_runtime.getDeclaredMethod("newNonMovableArray", Class.class, Integer.TYPE);
    ...
    public static void test_Memory_peekShort() throws Exception {
        ...
        Assert.assertEquals(
                (short) peek_short.invoke(null, address, false), 0x1213); // Aligned read
        Assert.assertEquals(
                (short) peek_short.invoke(null, address + 1, false), 0x1112); // Unaligned read
    }
    ...
    public static void test_Integer_numberOfTrailingZeros() {
        ...
        for (int i = 0; i < Integer.SIZE; i++) {
            Assert.assertEquals(
                    Integer.numberOfTrailingZeros(0x80000000 >> i), Integer.SIZE - 1 - i);
            Assert.assertEquals(Integer.numberOfTrailingZeros((0x80000000 >> i) | 0x80000000),
                    Integer.SIZE - 1 - i);
    ...
    public static void test_Long_numberOfTrailingZeros() {
        ...
        for (int i = 0; i < Long.SIZE; i++) {
            Assert.assertEquals(
                    Long.numberOfTrailingZeros(0x8000000000000000L >> i), Long.SIZE - 1 - i);
            Assert.assertEquals(
    ...
    public static void test_Integer_rotateRight() throws Exception {
        ...
        for (int i = 0; i < Integer.SIZE; i++) {
            Assert.assertEquals(Integer.rotateRight(0xBBAAAADD, i),
    ...
    public static void test_Long_rotateRight() throws Exception {
        ...
        for (int i = 0; i < Long.SIZE; i++) {
            Assert.assertEquals(Long.rotateRight(0xBBAAAADDFF0000DDL, i),
    ...
    public static void test_Integer_rotateRightLeft() throws Exception {
        for (int i = 0; i < Integer.SIZE * 2; i++) {
            Assert.assertEquals(
                    Integer.rotateLeft(0xBBAAAADD, i), Integer.rotateRight(0xBBAAAADD, -i));
            Assert.assertEquals(
                    Integer.rotateLeft(0xBBAAAADD, -i), Integer.rotateRight(0xBBAAAADD, i));
        }
    }
