...
class Main {
    ...
    public static void testMethodReflection() throws Exception {
        ...
        m = Main.class.getDeclaredMethod("ZBCDFIJSV", boolean.class, byte.class, char.class,
                double.class, float.class, int.class, long.class, short.class);
        System.out.println(Arrays.toString(m.getParameterTypes()));
        show(m.invoke(null, true, (byte) 0, '1', 2, 3, 4, 5, (short) 6));

        m = Main.class.getDeclaredMethod("ZBCDLFIJSV", boolean.class, byte.class, char.class,
                double.class, String.class, float.class, int.class, long.class, short.class);
        System.out.println(Arrays.toString(m.getParameterTypes()));
    ...
    private static void thrower() { throw new ArithmeticException("surprise!"); }
    ...
    private static void IV(int i) { System.out.println(i); }

    private static void IIV(int i, int j) { System.out.println(i + " " + j); }
    ...
    private static void ZBCDFIJSV(
            boolean z, byte b, char c, double d, float f, int i, long l, short s) {
        System.out.println(z + " " + b + " " + c + " " + d + " " + f + " " + i + " " + l + " " + s);
    }

    private static void ZBCDLFIJSV(
            boolean z, byte b, char c, double d, String string, float f, int i, long l, short s) {
        System.out.println(z + " " + b + " " + c + " " + d + " "
                + " " + string + " " + f + " " + i + " " + l + " " + s);
    }
...
class ReflectNewInstanceDuringClinit {
    ...
    public ReflectNewInstanceDuringClinit() { intField = 42; }
