...
public class Main {
    ...
    /// CHECK-NOT:      UShr
    /// CHECK-NOT:      Shl
    public static int ror_int_constant_c_c(int value) { return (value >>> 2) | (value << 30); }
    ...
    /// CHECK-NOT:      UShr
    /// CHECK-NOT:      Shl
    public static int ror_int_constant_c_c_0(int value) { return (value >>> 2) | (value << 62); }
    ...
    /// CHECK-NOT:      UShr
    /// CHECK-NOT:      Shl
    public static long ror_long_constant_c_c(long value) { return (value >>> 2) | (value << 62); }

    /// CHECK-START: long Main.ror_long_constant_c_c_0(long) instruction_simplifier (after)
    /// CHECK-NOT:      Ror
    public static long ror_long_constant_c_c_0(long value) { return (value >>> 2) | (value << 30); }
