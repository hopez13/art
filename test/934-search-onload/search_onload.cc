...
jint OnLoad(JavaVM* vm,
  ...
  std::string dex1 = android::base::StringPrintf("%s/934-search-onload.jar", dex_loc);
  std::string dex2 = android::base::StringPrintf("%s/934-search-onload-ex.jar", dex_loc);
