...
public class Test2031 {
    public static class MyClass {
        public void starting() { System.out.println("Starting up!"); }
        public String toString() { return "This is my object!"; }
    }

    public static void $noinline$doSimulateZygoteFork() { simulateZygoteFork(); }
    ...
    public static void $noinline$startTest(String testdir, final MyClass myObject)
            throws Exception {
