...
public class Main {
    ...
    public static int AndSelfNegated(int arg) { return arg & ~arg; }
    ...
    private static Object getNull() { return null; }
    ...
    public static int And0(int arg) { return arg & 0; }
    ...
    public static long Mul0(long arg) { return arg * 0; }
    ...
    public static int OrAllOnes(int arg) { return arg | -1; }
    ...
    public static long Rem0(long arg) { return 0 % arg; }
    ...
    public static int Rem1(int arg) { return arg % 1; }
    ...
    public static int RemN1(int arg) { return arg % -1; }
    ...
    public static long Rem1(long arg) { return arg % 1; }
    ...
    public static long RemN1(long arg) { return arg % -1; }
    ...
    public static int Shl0(int arg) { return 0 << arg; }
    ...
    public static long Shr0(int arg) { return (long) 0 >> arg; }
    ...
    public static long SubSameLong(long arg) { return arg - arg; }
    ...
    public static int UShr0(int arg) { return 0 >>> arg; }
    ...
    public static int XorSameInt(int arg) { return arg ^ arg; }
    ...
    public static boolean CmpFloatGreaterThanNaN(float arg) { return arg > Float.NaN; }
    ...
    public static boolean CmpDoubleLessThanNaN(double arg) { return arg < Double.NaN; }
    ...
    // Check that don't propagate the value == 3 on `if not true` branch, as the `if true` branch
    // also flows into the same block.
    ...
    // By propagating the boolean we can elimniate some equality comparisons as we already know
    // their result. In turn, we also enable DeadCodeElimination to eliminate more code.
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Floats and doubles we do not optimize (here and below). These methods are here to
        // guarantee that.
    ...
    Main() throws ClassNotFoundException { testCmp = Class.forName("TestCmp"); }
