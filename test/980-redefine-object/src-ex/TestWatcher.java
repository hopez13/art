...
public class TestWatcher {
    ...
    private static void MonitorEnter() { lock.lock(); }
    ...
    public static void NotifyCriticalFailure() { criticalFailure = true; }

    public static void NotifyConstructed(Object o) {
        if (criticalFailure) {
            // Something went very wrong. We are probably trying to report it so don't get in the
            // way.
            return;
        }
        MonitorEnter();
