...
public class Main {
    ...
    public static void doTest(Transform t, TestWatcher w) {
        ...
        try {
            say_hi_method =
                    Transform.class.getDeclaredMethod("sayHi", Runnable.class, Consumer.class);
        } catch (Exception e) {
        ...
        // will set the retry boolean to true if the stack does not have a JIT-compiled sayHi entry.
        // This can only happen if the method gets GC'd.
