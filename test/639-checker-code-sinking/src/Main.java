...
public class Main {
  ...
  /// CHECK-START: void Main.testFieldStores() code_sinking (before)
  ...
  /// CHECK-START: void Main.testFieldStores() code_sinking (after)
  /// CHECK: <<Int42:i\d+>>       IntConstant 42
  /// CHECK-NOT:                  NewInstance
  /// CHECK:                      begin_block
  /// CHECK: <<LoadClass:l\d+>>   LoadClass class_name:Main
  ...
  /// CHECK-NOT:                  begin_block
  /// CHECK:                      Throw
  public static void testFieldStores() {
    Main m = new Main();
    m.intField = 42;
    if (doThrow) {
  ...
  // Make sure code sinking does not crash dead code.
