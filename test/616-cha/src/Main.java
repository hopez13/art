...
class Main1 {
    String getName() { return "Main1"; }

    void printError(String msg) { System.out.println(msg); }
    ...
    int getValue3() { return 3; }
    int getValue4() { return 4; }
    int getValue5() { return 5; }
    int getValue6() { return 6; }
}

class Main2 extends Main1 {
    String getName() { return "Main2"; }
...
public class Main {
    ...
    static long calcValue(Main1 m) {
        return m.getValue1() + m.getValue2() * 2 + m.getValue3() * 3 + m.getValue4() * 4
                + m.getValue5() * 5 + m.getValue6() * 6;
    }
...
class Helper {
    ...
    static Main1 createMain3() { return new Main3(); }
}
