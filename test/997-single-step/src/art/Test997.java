...
public class Test997 {
    ...
    public static void notifySingleStep(Thread thr, Executable e, long loc) {
        ...
        // against both the RI and ART and also to prevent front-end compiler changes from affecting
        // output.
    ...
    public static void resetTest() { LAST_LINE_NUMBER = NO_LAST_LINE_NUMBER; }
