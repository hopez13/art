...
public class Main {
  public static void main(String[] args) {
    ...
    test_Long_doubleUnsignedCompare();
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_BT(int x, int y) {
    int cmp = Integer.compare(x + Integer.MIN_VALUE, y + Integer.MIN_VALUE);
    return $inline$BelowInteger(cmp, 0);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_BE(int x, int y) {
    int cmp = Integer.compare(x + Integer.MIN_VALUE, y + Integer.MIN_VALUE);
    return $inline$BelowOrEqualInteger(cmp, 0);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_AT(int x, int y) {
    int cmp = Integer.compare(x + Integer.MIN_VALUE, y + Integer.MIN_VALUE);
    return $inline$AboveInteger(cmp, 0);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_AE(int x, int y) {
    int cmp = Integer.compare(x + Integer.MIN_VALUE, y + Integer.MIN_VALUE);
    return $inline$AboveOrEqualInteger(cmp, 0);
  }

  public static void test_Integer_doubleUnsignedCompare() {
    // <
    assertEquals($noinline$testDoubleUnsignedCompareInteger_BT(0, 0), false);
    assertEquals($noinline$testDoubleUnsignedCompareInteger_BT(Integer.MIN_VALUE, 0), false);
    assertEquals($noinline$testDoubleUnsignedCompareInteger_BT(0, Integer.MIN_VALUE), false);
    ...
    // >
    assertEquals($noinline$testDoubleUnsignedCompareInteger_AT(0, 0), false);
    assertEquals($noinline$testDoubleUnsignedCompareInteger_AT(Integer.MIN_VALUE, 0), true);
    assertEquals($noinline$testDoubleUnsignedCompareInteger_AT(0, Integer.MIN_VALUE), true);
  ...
  public static boolean $inline$BelowLong(long x, long y) {
    return Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE) < 0;
  }

  public static boolean $noinline$testDoubleUnsignedCompareLong_BT(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$BelowLong((long)cmp, 0L);
  }

  public static boolean $inline$BelowOrEqualLong(long x, long y) {
    return Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE) <= 0;
  }

  public static boolean $noinline$testDoubleUnsignedCompareLong_BE(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$BelowOrEqualLong((long)cmp, 0L);
  }

  public static boolean $inline$AboveLong(long x, long y) {
    return Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE) > 0;
  }

  public static boolean $noinline$testDoubleUnsignedCompareLong_AT(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$AboveLong((long)cmp, 0L);
  }

  public static boolean $inline$AboveOrEqualLong(long x, long y) {
    return Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE) >= 0;
  }

  public static boolean $noinline$testDoubleUnsignedCompareLong_AE(long x, long y) {
    int cmp = Long.compare(x + Long.MIN_VALUE, y + Long.MIN_VALUE);
    return $inline$AboveOrEqualLong((long)cmp, 0L);
  }

  public static void test_Long_doubleUnsignedCompare() {
    // <
    assertEquals($noinline$testDoubleUnsignedCompareLong_BT(0L, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_BT(Long.MIN_VALUE, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_BT(0L, Long.MIN_VALUE), false);

    // <=
    assertEquals($noinline$testDoubleUnsignedCompareLong_BE(0L, 0L), true);
    assertEquals($noinline$testDoubleUnsignedCompareLong_BE(Long.MIN_VALUE, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_BE(0L, Long.MIN_VALUE), false);

    // >
    assertEquals($noinline$testDoubleUnsignedCompareLong_AT(0L, 0L), false);
    assertEquals($noinline$testDoubleUnsignedCompareLong_AT(Long.MIN_VALUE, 0L), true);
    assertEquals($noinline$testDoubleUnsignedCompareLong_AT(0L, Long.MIN_VALUE), true);

    // =>
    assertEquals($noinline$testDoubleUnsignedCompareLong_AE(0L, 0L), true);
    assertEquals($noinline$testDoubleUnsignedCompareLong_AE(Long.MIN_VALUE, 0L), true);
    assertEquals($noinline$testDoubleUnsignedCompareLong_AE(0L, Long.MIN_VALUE), true);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_BT_Xored(int x, int y) {
    int cmp = Integer.compare(x ^ Integer.MIN_VALUE, y ^ Integer.MIN_VALUE);
    return $inline$BelowInteger_Xored(cmp, 0);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_BE_Xored(int x, int y) {
    int cmp = Integer.compare(x ^ Integer.MIN_VALUE, y ^ Integer.MIN_VALUE);
    return $inline$BelowOrEqualInteger_Xored(cmp, 0);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_AT_Xored(int x, int y) {
    int cmp = Integer.compare(x ^ Integer.MIN_VALUE, y ^ Integer.MIN_VALUE);
    return $inline$AboveInteger_Xored(cmp, 0);
  }
  ...
  public static boolean $noinline$testDoubleUnsignedCompareInteger_AE_Xored(int x, int y) {
    int cmp = Integer.compare(x ^ Integer.MIN_VALUE, y ^ Integer.MIN_VALUE);
    return $inline$AboveOrEqualInteger_Xored(cmp, 0);
  }
