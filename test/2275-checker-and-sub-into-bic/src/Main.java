...
public class Main {
    ...
    /// CHECK-START-ARM: void Main.$noinline$copy(int[], int[]) instruction_simplifier_arm (before)
    /// CHECK:     Sub
    /// CHECK:     Sub
    /// CHECK-NOT: Sub
    ...
    /// CHECK-START-ARM: void Main.$noinline$copy(int[], int[]) instruction_simplifier_arm (after)
    /// CHECK-NOT: And
