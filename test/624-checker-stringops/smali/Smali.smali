...
## CHECK-DAG: <<Append2:l\d+>> InvokeVirtual [<<Null2>>,<<String2>>] intrinsic:StringBuilderAppendString
...
## CHECK-DAG: <<Append2:l\d+>> InvokeVirtual [<<Null2>>,<<String2>>] intrinsic:StringBuilderAppendString loop:<<Loop>>
## CHECK-DAG: <<String3:l\d+>> LoadString                                                                loop:<<Loop>>
## CHECK-DAG: <<Null3:l\d+>>   NullCheck     [<<Append2>>]                                               loop:<<Loop>>
## CHECK-DAG: <<Append3:l\d+>> InvokeVirtual [<<Null3>>,<<String3>>] intrinsic:StringBuilderAppendString loop:<<Loop>>
## CHECK-DAG: <<Null4:l\d+>>   NullCheck     [<<New>>]                                                   loop:none
