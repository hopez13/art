...
extern "C" JNIEXPORT jboolean JNICALL Java_Main_runtimeIsSoftFail(JNIEnv* env [[maybe_unused]],
                                                                  jclass cls [[maybe_unused]]) {
  return Runtime::Current()->IsVerificationSoftFail() ? JNI_TRUE : JNI_FALSE;
}

// public static native boolean hasImage();

extern "C" JNIEXPORT jboolean JNICALL Java_Main_hasImage(JNIEnv* env [[maybe_unused]],
                                                         jclass cls [[maybe_unused]]) {
...
extern "C" JNIEXPORT jboolean JNICALL Java_Main_isImageDex2OatEnabled(JNIEnv* env [[maybe_unused]],
                                                                      jclass cls [[maybe_unused]]) {
...
extern "C" JNIEXPORT void JNICALL Java_Main_setAsyncExceptionsThrown(JNIEnv* env [[maybe_unused]],
                                                                     jclass cls [[maybe_unused]]) {
