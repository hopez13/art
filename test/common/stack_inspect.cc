...
extern "C" JNIEXPORT void JNICALL Java_Main_disableStackFrameAsserts(JNIEnv* env [[maybe_unused]],
...
extern "C" JNIEXPORT jboolean JNICALL Java_Main_isInterpretedFunction(
    JNIEnv* env, jclass klass [[maybe_unused]], jobject method, jboolean require_deoptimizable) {
...
extern "C" JNIEXPORT jobject JNICALL Java_Main_getThisOfCaller(
    JNIEnv* env, jclass cls [[maybe_unused]]) {
  ScopedObjectAccess soa(env);
