...
public class Main {
    ...
    public Class<?> willInlineWithReturnValue() { return Main.class; }

    public Class<?> willOnlyInlineForMainWithReturnValue() { return Main.class; }
...
class SubMain extends Main {
    ...
    public Class<?> willInlineWithReturnValue() { return SubMain.class; }

    public Class<?> willOnlyInlineForMainWithReturnValue() { return SubMain.class; }
}

class SubSubMain extends SubMain {
    public Class<?> willInlineWithReturnValue() { return SubSubMain.class; }

    public Class<?> willOnlyInlineForMainWithReturnValue() { return SubSubMain.class; }
}
