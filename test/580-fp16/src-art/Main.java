...
public class Main {
  ...
  public static void main(String args[]) {
    ...
    // where the most significant bit of FP16 mantissa is propagated to float and
    // it doesn't perform SNaN->QNaN conversion.
    ...
    assertEquals(0xff802000, TestFP16ToFloatRawIntBits((short)(0xfc01)));  // SNaN->SNaN
    assertEquals(0xffbfe000, TestFP16ToFloatRawIntBits((short)(0xfdff)));  // SNaN->SNaN
