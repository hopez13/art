...
public class Main {
  ...
  public static boolean $noinline$booleanCondition(boolean in) {
    ...
    // The choice of the following method is arbitrary - the idea is to use a
    // function that is complex enough to never get inlined, thus preventing
    // a transformation of the return value into `false`.
    java.lang.ClassLoader.getSystemResource(Integer.toString(value));
    return value > 127;
  }
