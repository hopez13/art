...
[[ noreturn ]] static void test_sigaction_handler([[maybe_unused]] int sig,
                                                  [[maybe_unused]] siginfo_t* info, [[maybe_unused]]                                                  void* context) {
...
extern "C" bool native_bridge_initAnonymousNamespace([[maybe_unused]] const char* public_ns_sonames,
...
extern "C" bool native_bridge_linkNamespaces([[maybe_unused]] android::native_bridge_namespace_t* from,
...
extern "C" void* native_bridge_loadLibraryExt([[maybe_unused]] const char* libpath,
