...
class Main {
    ...
    native static short shortMethod(short s1, short s2, short s3, short s4, short s5, short s6,
            short s7, short s8, short s9, short s10);
    ...
    native static boolean booleanMethod(boolean b1, boolean b2, boolean b3, boolean b4, boolean b5,
