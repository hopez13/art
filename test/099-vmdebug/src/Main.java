...
public class Main {
    ...
    private static void checkBiggerThan0(int i, int b) throws Exception {
        if (i <= 0) {
            System.out.println("Got zero or smaller  " + i + b);
        }
    }
    ...
    private static void testGetAllocCount() throws Exception {
        ...
        checkBiggerThan0(alloc_objects, 1);
        checkBiggerThan0(alloc_bytes, 2);
        checkBiggerThan0(freed_objects, 3);
        checkBiggerThan0(freed_bytes, 4);
    ...
    private static void testCountInstances() throws Exception {
        ...
        checkBiggerThan0(class_count, 14);
    }
