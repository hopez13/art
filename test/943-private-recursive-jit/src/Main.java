...
public class Main {
    ...
    private static class TestWatcher implements Consumer<String> {
        ...
        public TestWatcher() { sb = new StringBuilder(); }
    ...
    public static void main(String[] args) { doTest(new Transform()); }
    ...
    public static void doTest(Transform t) {
        ...
        // Makes sure the stack is the way we want it for the test and does the redefinition. It
        // will set the retry boolean to true if we need to go around again due to jit code being
        // GCd.
