...
public class Main {
    ...
    static void processFieldValues(
            int field0, int field1, int field2, int field3, int field4, int field5) {
        if (field5 != 127) {
    ...
    static int doit(int pass) {
        ...
        for (;; pass++) {
            setFields(fields);
            processFieldValues(fields[0], fields[1], fields[2], fields[3], fields[4], fields[5]);
            if (pass == 0)
                break;
        }
        return fields[5];
