...
public class Main {
    ...
    public static Object returnNullConstant(Object x) { return null; }

    public static Object InlineNullConstant() { return returnNullConstant(null); }
    ...
    public static int returnIntConstant(int x) { return 42; }

    public static int InlineIntConstant() { return returnIntConstant(42); }
    ...
    public static long returnLongConstant(long x) { return 42L; }

    public static long InlineLongConstant() { return returnLongConstant(42L); }
