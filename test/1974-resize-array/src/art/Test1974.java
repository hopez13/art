...
public class Test1974 {
  ...
  public static void runHashMap() {
    ...
    Supplier<byte[]> get_the_value = () -> map.entrySet().stream().filter((x) -> x.getValue().equals(the_value)).findFirst().get().getKey();
    map.put(new byte[] {1, 2, 3, 4}, the_value);
    map.put(new byte[] {1, 2, 3, 4}, "Other Value");
    map.put(new byte[] {1, 4}, "Third value");
    System.out.println(
        "val is: " + Arrays.toString(get_the_value.get()) + " resize +3");
    System.out.print("Map is: ");
    map.entrySet().stream().sorted((x, y) -> x.getValue().compareTo(y.getValue())).forEach((e) -> {
      System.out.print("(" + Arrays.toString(e.getKey()) + "->" + e.getValue() + "), ");
    });
    System.out.println();
    ResizeArray(get_the_value, 7);
    System.out.println(
        "val is: " + Arrays.toString(get_the_value.get()));
    System.out.print("Map is: ");
    map.entrySet().stream().sorted((x, y) -> x.getValue().compareTo(y.getValue())).forEach((e) -> {
      System.out.print("(" + Arrays.toString(e.getKey()) + "->" + e.getValue() + "), ");
    });
  ...
  public static void runWithJniGlobal() throws Exception {
    ...
    System.out.println("val is: " + Arrays.toString((Object[])ReadJniRef(globalID)) + " resize +5");
  ...
  public static void runWithJniLocals() throws Exception {
    ...
    Consumer<Object> printer = (o) -> System.out.println("val is: " + Arrays.toString((Object[])o));
    Runnable resize = () -> {
