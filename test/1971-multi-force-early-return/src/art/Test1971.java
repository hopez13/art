...
public class Test1971 {
        ...
        public String toString() {
            String stackTrace = PRINT_STACK_TRACE ? ",\n\tstate: " + state + ",\n\tstack:\n"
                            + safeDumpStackTrace(stack, "\t\t") + ",\n\t"
                                                  : "";
            return this.getClass().getName() + " { thread: " + target.getName()
                    + ", creator: " + creator.getName() + stackTrace + " }";
        }
    }
    ...
    public static final class ForcedExit extends ReturnValue {
        public ForcedExit(Thread thr) { super(thr); }
    }

    public static final class NormalExit extends ReturnValue {
        public NormalExit() { super(Thread.currentThread()); }
    }
