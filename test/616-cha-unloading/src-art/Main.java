...
public class Main {
    ...
    private static class CHAUnloaderRetType {
        private CHAUnloaderRetType(
                WeakReference<ClassLoader> cl, AbstractCHATester obj, long methodPtr) {
            this.cl = cl;
            this.obj = obj;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Class<ClassLoader> pathClassLoader =
                (Class<ClassLoader>) Class.forName("dalvik.system.PathClassLoader");
        sConstructor = pathClassLoader.getDeclaredConstructor(
    ...
    private static void testUnload() throws Exception {
        // Load a concrete class, then unload it. Get a deleted ArtMethod to test if it'll be
        // inlined.
    ...
    private static CHAUnloaderRetType setupLoader() throws Exception {
    ...
    private static CHAUnloaderRetType targetMethodForJit(int mode) throws Exception {
    ...
    private static CHAUnloaderRetType doUnloadLoader() throws Exception {
