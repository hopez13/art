...
public class Test993 {
    ...
    public static class TestClass1ext extends TestClass1 {
        public TestClass1ext() { super(); }
        public String toString() { return "TestClass1Ext"; }
        public void breakit() { super.breakit(); }
    }
    ...
    public static class TestClass3 implements Breakable {
        ...
        public void breakit() { Breakable.super.breakit(); }
    }
    ...
    public static class TestClass4 {
        ...
        public void callPrivateMethod() { privateMethod(); }
    ...
    public static class ConstructReflect implements ThrowRunnable {
        Constructor<?> m;
        public ConstructReflect(Constructor<?> m) { this.m = m; }
    ...
    public static void run(boolean test_BCP_private) throws Exception {
        ...
        Breakpoint.startBreakpointWatch(Test993.class,
                Test993.class.getDeclaredMethod(
    ...
    public static void runBCPMethodTests(boolean test_BCP_private) throws Exception {
        ...
        Breakpoint.Manager.BP[] static_breakpoints =
                new Breakpoint.Manager.BP[] {BP(bcp_static_method)};
        ...
        if (test_BCP_private) {
            ...
            Breakpoint.Manager.BP[] private_static_breakpoints =
                    new Breakpoint.Manager.BP[] {BP(bcp_private_static_method)};
            runTestGroups("bcp private static invoke", private_static_invokes,
                    private_static_breakpoints);
        }
        ...
        if (test_BCP_private) {
            ...
            Runnable[] private_invokes = new Runnable[] {
                    ...
                    new InvokeDirect("Duration::toBigDecimalSeconds",
                            () -> { test_duration.multipliedBy(2); }),
            };
            Breakpoint.Manager.BP[] private_breakpoints =
                    new Breakpoint.Manager.BP[] {BP(bcp_private_method)};
        ...
        Runnable[] public_invokes = new Runnable[] {
                ...
                new InvokeDirect(
                        "Optional::isPresent", () -> { Optional.of("test3").isPresent(); }),
        };
        Breakpoint.Manager.BP[] public_breakpoints =
                new Breakpoint.Manager.BP[] {BP(bcp_virtual_method)};
    ...
    public static void runMethodTests() throws Exception {
        ...
        Breakpoint.Manager.BP[] static_breakpoints =
                new Breakpoint.Manager.BP[] {BP(breakpoint_method)};
        ...
        Breakpoint.Manager.BP[] private_static_breakpoints =
                new Breakpoint.Manager.BP[] {BP(private_breakpoint_method)};
        ...
        Breakpoint.Manager.BP[] i_static_breakpoints =
                new Breakpoint.Manager.BP[] {BP(i_breakpoint_method)};
        ...
        Runnable[] tc1_invokes = new Runnable[] {
                ...
                new InvokeDirect("new TestClass1().breakit()", () -> new TestClass1().breakit()),
        };
        Breakpoint.Manager.BP[] tc1_breakpoints = new Breakpoint.Manager.BP[] {BP(breakit_method)};
        ...
        Runnable[] tc1ext_invokes = new Runnable[] {
                ...
                new InvokeDirect(
                        "new TestClass1ext().breakit()", () -> new TestClass1ext().breakit()),
        };
        Breakpoint.Manager.BP[] tc1ext_breakpoints =
                new Breakpoint.Manager.BP[] {BP(breakit_method), BP(breakit_method_tc1ext)};
        ...
        Runnable[] tc2_invokes = new Runnable[] {
                ...
                new InvokeDirect("new TestClass2().breakit()", () -> new TestClass2().breakit()),
        };
        Breakpoint.Manager.BP[] tc2_breakpoints =
                new Breakpoint.Manager.BP[] {BP(breakit_method), BP(breakit_method_tc2)};
        ...
        Runnable[] tc2ext_invokes = new Runnable[] {
                ...
                new InvokeDirect(
                        "new TestClass2ext().breakit())", () -> new TestClass2ext().breakit()),
        };
        ...
        Runnable[] tc3_invokes = new Runnable[] {
                ...
                new InvokeDirect("new TestClass3().breakit())", () -> new TestClass3().breakit()),
        };
        Breakpoint.Manager.BP[] tc3_breakpoints =
                new Breakpoint.Manager.BP[] {BP(breakit_method), BP(breakit_method_tc3)};
        ...
        Runnable[] tc3ext_invokes = new Runnable[] {
                ...
                new InvokeDirect(
                        "new TestClass3ext().breakit())", () -> new TestClass3ext().breakit()),
        };
        ...
        Breakpoint.Manager.BP[] private_instance_breakpoints =
                new Breakpoint.Manager.BP[] {BP(private_method)};
        runTestGroups(
                "private instance invoke", private_instance_invokes, private_instance_breakpoints);
    }

    private static void runTestGroups(
            String name, Runnable[] invokes, Breakpoint.Manager.BP[] breakpoints) throws Exception {
