...
public class Test1900 {
    ...
    private static long doAllocate(long size) { return doAllocate(getDefaultJvmtiEnv(), size); }

    private static native void doDeallocate(long jvmtienv, long ptr);
    private static void doDeallocate(long size) { doDeallocate(getDefaultJvmtiEnv(), size); }
