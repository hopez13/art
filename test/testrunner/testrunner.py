...
def gather_test_info():
  ...
  VARIANT_TYPE['trace'] = {'trace', 'ntrace', 'stream'}
  VARIANT_TYPE['image'] = {'picimage', 'no-image', 'npicimage', 'multinpicimage', 'multipicimage'}
  ...
  VARIANT_TYPE['relocate'] = {'relocate-npatchoat', 'relocate', 'no-relocate'}
  VARIANT_TYPE['jni'] = {'jni', 'forcecopy', 'checkjni'}
  VARIANT_TYPE['address_sizes'] = {'64', '32'}
  VARIANT_TYPE['compiler'] = {'interp-ac', 'interpreter', 'jit', 'optimizing', 'regalloc_gc'}
                          ...
                          for address_size in ADDRESS_SIZES_TARGET[target]:
                            ...
                            if address_size == '64':
                              ...
                              if env.HOST_2ND_ARCH_PREFIX_DEX2OAT_HOST_INSTRUCTION_SET_FEATURES:
                                options_test += ' --instruction-set-features ' + env.HOST_2ND_ARCH_PREFIX_DEX2OAT_HOST_INSTRUCTION_SET_FEATURES
