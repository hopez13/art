...
def parse_option():
  ...
  parser.add_argument('--logcat-invoke', dest='logcat_invoke', action='store',
                      default="adb logcat",
                      help="Command to invoke to get logcat data from device")
  parser.add_argument('--logcat-file', dest='logcat_file', action='store',
                      ...
                      This is only valid during --target tests.""")
...
def main():
  ...
  try:
    # This will send a logcat to locat_file if we have target variants.
