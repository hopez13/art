...
def run_tests():
  ...
  test_art_run_test_dependencies += env_param.HOST_OUT_EXECUTABLES + '/jasmin '
  test_art_run_test_dependencies += env_param.HOST_OUT_EXECUTABLES + '/smali '
  test_art_run_test_dependencies += env_param.HOST_OUT_EXECUTABLES + '/dexmerger '
  test_art_run_test_dependencies += env_param.DX
  return test_art_run_test_dependencies
