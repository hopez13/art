...
ART_HOST_EXECUTABLES = 'dex2oat-host imgdiag-host oatdump-host patchoat-host profman-host dalvikvm-host dexlist-hsot'
...
HOST_2ND_ARCH_PREFIX_DEX2OAT_HOST_INSTRUCTION_SET_FEATURES = env.get(HOST_2ND_ARCH_PREFIX + 'DEX2OAT_HOST_INSTRUCTION_SET_FEATURES')

ART_TEST_QUIET = getEnvBoolean('ART_TEST_QUIET', False)

ART_TEST_ANDROID_ROOT = env.get('ART_TEST_ANDROID_ROOT')

ART_TEST_WITH_STRACE = getEnvBoolean('ART_TEST_DEBUG_GC', False)

ANROID_BUILD_TOP = env.get('ANDROID_BUILD_TOP')
