...
public class Main {
  /// CHECK-START: java.lang.Object Main.$noinline$newObject() prepare_for_register_allocation (before)
  /// CHECK: LoadClass
  /// CHECK: NewInstance
  /// CHECK-START: java.lang.Object Main.$noinline$newObject() prepare_for_register_allocation (after)
  /// CHECK-NOT: LoadClass
  /// CHECK: NewInstance
