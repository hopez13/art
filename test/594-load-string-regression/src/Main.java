...
public class Main {
    ...
    public static int $noinline$test() {
        int r = 0x12345678;
        do {
            // LICM pulls the LoadClass and ClinitCheck out of the loop, leaves NewInstance in the
            // loop.
            Helper h = new Helper();
    ...
    static boolean $inline$shouldContinue() { return false; }
...
class Helper {
    public void $noinline$printString(String s) { System.out.println("String: \"" + s + "\""); }
}
