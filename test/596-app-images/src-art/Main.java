...
class Main {
    ...
    public static void testInternedStrings() throws Exception {
        ...
        assertEquals("Static string on initialized class is matches runtime interned string",
                intern, StaticInternString.intent);
...
class StaticInternString {
    ...
    static public String getIntent() { return intent; }
}
...
class StaticInternString2 {
    ...
    static String getIntent() { return intent; }
}
