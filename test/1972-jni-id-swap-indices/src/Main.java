...
public class Main {
  ...
  public static final class PtrClass {
    public static void doNothingPtr() {}
  }

  public static final class IdxClass {
  ...
  public static void main(String[] args) {
    ...
    long expect_ptr_id = GetId(PtrClass.class, "doNothingPtr");
    ...
    SetToIndexIds();
    System.out.println("JNI Type is: " + GetJniType());
    long expect_idx_id = GetId(IdxClass.class, "doNothingIdx");
    ...
    long again_ptr_id = GetId(PtrClass.class, "doNothingPtr");
