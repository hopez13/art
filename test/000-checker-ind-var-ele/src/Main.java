...
/// CHECK-DAG:               Add                     loop:<<Loop>>
/// CHECK-DAG:               Add                     loop:<<Loop>>
/// CHECK-DAG:               Add [<<Phi2>>,<<Inc3>>] loop:<<Loop>>
/// CHECK-DAG:               Add [<<Phi3>>,<<Inc1>>] loop:<<Loop>>
/// CHECK-DAG:               Add [<<Phi4>>,<<Inc1>>] loop:<<Loop>>
...
/// CHECK-DAG: <<Phi1:d\d+>> Phi [<<Var1>>,<<Sub:d\d+>>]     loop:<<Loop:B\d+>>
/// CHECK-DAG: <<Phi2:d\d+>> Phi [<<Var1>>,<<Add:d\d+>>]     loop:<<Loop>>
/// CHECK-DAG:               Mul                        loop:<<Loop>>
/// CHECK-DAG:               Mul                        loop:<<Loop>>
/// CHECK-DAG: <<Sub>>       Sub                        loop:<<Loop>>
/// CHECK-DAG: <<Add>>       Add [<<Phi2>>,<<Var2>>]    loop:<<Loop>>
