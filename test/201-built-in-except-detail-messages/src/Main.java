...
public class Main {
    ...
    private static void arrayStore() throws Exception {
        try {
            ...
            assertEquals(
                    "java.lang.Exception cannot be stored in an array of type java.lang.String[]",
                    ex.getMessage());
        }
        ...
        try {
            ...
            assertEquals(
                    "source[4] of type java.lang.String cannot be stored in destination array of type java.lang.Integer[]",
                    ex.getMessage());
        }
        ...
        try {
            ...
            assertEquals(
                    "Incompatible types: src=float[], dst=java.lang.Runnable[]", ex.getMessage());
        }
    ...
    private static void classCast() throws Exception {
        ...
        try {
            ...
            assertEquals(
                    "java.lang.Integer cannot be cast to java.lang.Object[][][]", ex.getMessage());
        }
    }
     ...
     */
    private static Object makeInteger() { return new Integer(5); }

    /**
     * Helper for testCastOperatorWithArrays. It's important that
     * the return type is Object.
     */
    private static Object makeArray(Class<?> c) { return Array.newInstance(c, 1); }
    ...
    private static Object returnNullObject() { return null; }

    private static A returnNullA() { return null; }
