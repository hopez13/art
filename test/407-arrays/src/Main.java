...
public class Main extends TestCase {
    public static void main(String[] args) {
        $opt$testReads(new boolean[1], new byte[1], new char[1], new short[1], new int[1],
                new Object[1], new long[1], new float[1], new double[1], 0);
        $opt$testWrites(new boolean[2], new byte[2], new char[2], new short[2], new int[2],
                new Object[2], new long[2], new float[2], new double[2], 1);
    ...
    static void $opt$testReads(boolean[] bools, byte[] bytes, char[] chars, short[] shorts,
            int[] ints, Object[] objects, long[] longs, float[] floats, double[] doubles,
            int index) {
    ...
    public static void $opt$doArrayLoad(boolean[] array, int index) { boolean res = array[index]; }

    public static void $opt$doArrayStore(boolean[] array, int index) { array[index] = false; }
}
