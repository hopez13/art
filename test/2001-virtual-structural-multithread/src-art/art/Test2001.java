...
public class Test2001 {
    ...
    public static class Transform {
        ...
        public Transform() { this.greetingEnglish = "Hello"; }
        public String sayHi() {
     ...
     */
    private static final byte[] SUB_DEX_BYTES = Base64.getDecoder().decode(
    ...
    public static Supplier<String> mkTransform() {
        try {
            return (Supplier<String>) (new InMemoryDexClassLoader(
