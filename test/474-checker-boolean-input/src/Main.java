...
public class Main {
    ...
    public static boolean InlinePhi(int x) { return (x == 42) ? f1 : f2; }

    public static boolean TestPhiAsBoolean(int x) { return InlinePhi(x) != true ? true : false; }
    ...
    public static boolean InlineAnd(boolean x, boolean y) { return x & y; }
    ...
    public static boolean InlineOr(boolean x, boolean y) { return x | y; }
    ...
    public static boolean InlineXor(boolean x, boolean y) { return x ^ y; }
