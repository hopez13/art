...
public class VarHandleUnitTestHelpers {
    public static boolean getBytesAs_boolean(byte[] array, int index,
                                                           ByteOrder order) {
    ...
    public static void setBytesAs_boolean(byte[] array, int index, boolean value,
                                                           ByteOrder order) {
    ...
    public static void setBytesAs_boolean(ByteBuffer buffer, int index, boolean value,
                                             ByteOrder order) {
    ...
    public static void setBytesAs_short(ByteBuffer buffer, int index, short value,
                                        ByteOrder order) {
    ...
    public static void setBytesAs_float(ByteBuffer buffer, int index, float value,
                                        ByteOrder order) {
        buffer.order(order).putFloat(index, value);
    }

    public static void setBytesAs_double(ByteBuffer buffer, int index, double value,
                                         ByteOrder order) {
