...
public abstract class VarHandleUnitTest {
    ...
    // Expected exception
    private Class<?> expectedExceptionClass = null;
    ...
    public final void expectExceptionOfType(Class<?> expectedExceptionClass) {
    ...
    public final void run() {
        ...
        try {
            ...
            if (expectedExceptionClass != null) {
                fail("Expected exception was not raised", expectedExceptionClass.getSimpleName());
            }
    ...
    private void failNotEquals(String message, Object expected, Object actual) {
        errorLog().append(message).append(": ").append(expected).append(" != ").append(actual)
                .append(" in ").append(getSourceInfo()).append('\n');
    }
    ...
    private void fail(String message, String detail) {
        errorLog().append(message).append(": ").append(detail)
                .append(" in ").append(getSourceInfo()).append('\n');
    }

    private void fail(String message, Exception e) {
        errorLog().append(message).append(": ").append(e.toString())
                .append(" in ").append(getSourceInfo(e)).append('\n');
    }
