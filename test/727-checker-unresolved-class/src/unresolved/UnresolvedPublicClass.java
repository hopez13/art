...
public class UnresolvedPublicClass implements BcpExMarker {
    ...
    static void $noinline$testReferrersClass() { Class<?> c = UnresolvedPublicClass.class; }
    ...
    static void $noinline$testInlinedClassDescriptorCompare1() {
        // TODO: Make $inline$ and enable CHECK above when we relax the verifier. b/28313047
        Class<?> c = GetUnresolvedPublicClassFromDifferentDexFile.getOtherClass();
    }
    ...
    static void $noinline$testInlinedClassDescriptorCompare2() {
        ...
        // TODO: Make $inline$ and enable CHECK above when we relax the verifier. b/28313047
        Class<?> c = GetUnresolvedPublicClassFromDifferentDexFile
                             .getOtherClassWithSameDescriptorLength();
    }
