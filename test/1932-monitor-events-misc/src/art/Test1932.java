...
public class Test1932 {
    ...
    public static void run() throws Exception {
        Monitors.setupMonitorEvents(Test1932.class,
                Test1932.class.getDeclaredMethod("handleMonitorEnter", Thread.class, Object.class),
                Test1932.class.getDeclaredMethod(
                        "handleMonitorEntered", Thread.class, Object.class),
                Test1932.class.getDeclaredMethod(
                        "handleMonitorWait", Thread.class, Object.class, Long.TYPE),
                Test1932.class.getDeclaredMethod(
                        "handleMonitorWaited", Thread.class, Object.class, Boolean.TYPE),
                Monitors.NamedLock.class, null);
        ...
        // TODO We keep this here since it works on android but it's not clear it's behavior we want
        // to support long term or at all.
        ...
        testRecursiveMontiorEnteredLock(
                new Monitors.NamedLock("test testRecursiveMontiorEnteredLock"));
    ...
    public static void printLockState(Monitors.NamedLock lk, Object exception, int res) {
        System.out.println("MonitorEnter returned: " + res + "\n"
        ...
        HANDLER = new MonitorHandler() {
            ...
            public void handleMonitorEnter(Thread t, Object l) {
                ...
                try {
                    ...
                    throw new Monitors.TestException(
                            "Exception unlocking monitor in MonitorEnter " + l, e);
                }
    ...
    public static void testNativeLockStateThrowEntered(final Monitors.NamedLock lk)
            throws Exception {
        final Monitors.LockController controller1 = new Monitors.LockController(lk);
        HANDLER = new MonitorHandler() {
            @Override
            ...
            public void handleMonitorEntered(Thread t, Object l) {
                ...
                throw new Monitors.TestException(
                        "throwing exception during monitorEntered of " + l);
            }
        };
        controller1.DoLock();
        controller1.waitForLockToBeHeld();
    ...
    public static void testRecursiveMontiorEnteredLock(final Monitors.NamedLock lk)
            throws Exception {
        ...
        HANDLER = new MonitorHandler() {
            @Override
            public void handleMonitorEntered(Thread thd, Object l) {
                try {
                    System.out.println(
                            "In MonitorEntered usage: " + Monitors.getObjectMonitorUsage(lk));
                    synchronized (lk) {
                        System.out.println(
                                "In MonitorEntered sync: " + Monitors.getObjectMonitorUsage(lk));
                    }
                } catch (Exception e) {
    ...
    public static void testWaitedMonitorEnter(final Monitors.NamedLock lk) throws Exception {
        ...
        HANDLER = new MonitorHandler() {
            @Override
            public void handleMonitorWaited(Thread thd, Object l, boolean timeout) {
                try {
                    // make sure that controller2 has acutally unlocked everything, we can be sent
                    // earlier than that on ART.
                    while (controller2.IsLocked()) {
                    }
                    System.out.println(
                            "In waited monitor usage: " + Monitors.getObjectMonitorUsage(lk));
                    synchronized (lk) {
                        System.out.println("In waited monitor usage sync: "
                                + Monitors.getObjectMonitorUsage(lk));
                    }
                } catch (Exception e) {
                    throw new Monitors.TestException(
                            "error while doing unlock in other thread!", e);
                }
            }
        };
        controller1.DoLock();
    ...
    public static void testWaitMonitorEnter(final Monitors.NamedLock lk) throws Exception {
        ...
        HANDLER = new MonitorHandler() {
            ...
            public void handleMonitorWait(Thread thd, Object l, long timeout) {
                try {
                    System.out.println(
                            "In wait monitor usage: " + Monitors.getObjectMonitorUsage(lk));
                    synchronized (lk) {
                        System.out.println("In wait monitor usage sync: "
                                + Monitors.getObjectMonitorUsage(lk));
                    }
                } catch (Exception e) {
                    throw new Monitors.TestException(
    ...
    public static void testWaitEnterInterleaving(Monitors.NamedLock lk) throws Exception {
        ...
        // We cannot use waitForLockToBeHeld since we could race with the HANDLER
        // waitForLockToBeHeld function.
    ...
    public static void testMonitorInfoInEvents(Monitors.NamedLock lk) throws Exception {
        ...
        HANDLER = new MonitorHandler() {
            @Override
            public void handleMonitorEnter(Thread thd, Object l) {
                System.out.println(
                        "Monitor usage in MonitorEnter: " + Monitors.getObjectMonitorUsage(l));
            }
            @Override
            public void handleMonitorEntered(Thread thd, Object l) {
                System.out.println(
                        "Monitor usage in MonitorEntered: " + Monitors.getObjectMonitorUsage(l));
            }
            @Override
            public void handleMonitorWait(Thread thd, Object l, long timeout) {
                System.out.println(
                        "Monitor usage in MonitorWait: " + Monitors.getObjectMonitorUsage(l));
            }
            @Override
            public void handleMonitorWaited(Thread thd, Object l, boolean timeout) {
                // make sure that controller1 has acutally unlocked everything, we can be sent
                // earlier than that on ART.
                while (controller1.IsLocked()) {
                }
                System.out.println(
                        "Monitor usage in MonitorWaited: " + Monitors.getObjectMonitorUsage(l));
            }
        };
        controller1.DoLock();
        controller1.waitForLockToBeHeld();
    ...
    public static AutoCloseable SuppressContention(Monitors.LockController controller) {
        if (CONTENTION_SUPPRESSED != null) {
            throw new IllegalStateException(
                    "Only one contention suppression is possible at a time.");
        }
