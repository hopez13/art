...
Search
356179: Makefile —   test/Android.run-test.mk ▼
Prev / Next
Patch set:   gitiles →   gitiles
/ Download
 / Preferences
Show 9 common lines		Show 9 common lines
...
# an empty file touched in the intermediate directory.
Show 2 common lines		Show 2 common lines
...
TEST_ART_TARGET_SYNC_DEPS += $(OUT_DIR)/$(ART_TEST_LIST_device_$(TARGET_2ND_ARCH)_libartagent)
+10↑ - Show 99 common lines - +10↓		+10↑ - Show 99 common lines - +10↓
    ifeq ($(2),picimage)
    ifeq ($(2),picimage)
