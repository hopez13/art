...
########################################################################
# The lists of types are not complete and are used for building dependencies.

TARGET_TYPES := host target
COMPILER_TYPES := interpreter optimizing
IMAGE_TYPES := picimage no-image multipicimage npicimage multinpicimage
