...
extern "C" JNIEXPORT void JNICALL Java_Main_waitForVerifier(JNIEnv*, jclass) {
  Runtime::Current()->GetOatFileManager().WaitForVerifyTasks();
}
...
extern "C" JNIEXPORT bool JNICALL Java_Main_hasVdexFile(JNIEnv*,
  ...
  return OatFileAssistant::DexFilesToAnonymousDexLocation(
             OatFileManager::ComputeAnonymousDexLocationChecksum(dex_headers),
             &dex_location) &&
