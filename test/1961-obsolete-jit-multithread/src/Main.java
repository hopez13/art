...
public class Main {
    ...
    public static void main(String[] args) throws Exception { doTest(new Transform()); }
    ...
    private static class TestThread extends Thread {
        ...
        public TestThread(Transform t, TestWatcher w, Consumer<Consumer<String>> do_nothing,
