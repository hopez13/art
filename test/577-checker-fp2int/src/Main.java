...
public class Main {
    ...
    /// CHECK-DAG: Return [<<Result>>]
    private static int f2int(float f) { return Float.floatToIntBits(f); }
    ...
    /// CHECK-DAG: Return [<<Result>>]
    private static long d2long(double d) { return Double.doubleToLongBits(d); }
    ...
    public static void main(String args[]) {
        ...
        // A few NaN numbers.
        float[] fvals = {Float.intBitsToFloat(0x7f800001), Float.intBitsToFloat(0x7fa00000),
        ...
        // A few NaN numbers.
        double[] dvals = {Double.longBitsToDouble(0x7ff0000000000001L),
    ...
    private static void expectEquals32(int expected, int result) {
        if (expected != result) {
            throw new Error("Expected: " + Integer.toHexString(expected)
                    + ", found: " + Integer.toHexString(result));
        }
    }

    private static void expectEquals64(long expected, long result) {
        if (expected != result) {
            throw new Error("Expected: " + Long.toHexString(expected)
                    + ", found: " + Long.toHexString(result));
        }
    }
}
