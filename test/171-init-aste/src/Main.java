...
public class Main {
    // Note: This file is used for the RI, so that we do not need an exclusion in known failures.
    public static void main(String args[]) throws Exception {
        ...
        if (annotatedStackTrace == null || annotatedStackTrace.length == 0) {
            throw new Error("Empty stack trace!");
        }
