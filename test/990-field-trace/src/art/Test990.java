...
public class Test990 {
    // Fields of these classes are accessed/modified differently in the RI and ART so we ignore
    // them.
    ...
    static final class FieldWrite implements Printable {
        ...
        public void Print() {
            System.out.println("MODIFY of " + f + " on object of"
                    ...
                    + method + ". New value: " + initialValue + " (type: " + initialValueType
                    + ")");
        }
    }
    ...
    public static void run() throws Exception {
        ...
        Trace.enableFieldTracing(Test990.class,
                Test990.class.getDeclaredMethod("notifyFieldAccess", Executable.class, Long.TYPE,
                        Class.class, Object.class, Field.class),
                Test990.class.getDeclaredMethod("notifyFieldModify", Executable.class, Long.TYPE,
