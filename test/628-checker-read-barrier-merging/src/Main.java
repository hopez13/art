...
public class Main {
  ...
  /// CHECK-START: boolean Main.testTwoAdjacentFieldGets() gc_optimizer (before)
  ...
  /// CHECK-START: boolean Main.testThreeAdjacentFieldGets() gc_optimizer (before)
  /// CHECK: <<Obj:l\d+>>     ParameterValue
  /// CHECK:                  InstanceFieldGet [<<Obj>>] field_name:Main.o1 generates_own_read_barrier:true
  /// CHECK:                  InstanceFieldGet [<<Obj>>] field_name:Main.o2 generates_own_read_barrier:true
  ...
  /// CHECK-START: boolean Main.testInterleavedFieldGets(Main) gc_optimizer (before)
