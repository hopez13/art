...
public class Test996 {
    // The line we are going to break on. This should be the println in the Transform class. We set
    // a breakpoint here after we have redefined the class.
    ...
    public static void run() throws Exception {
        ...
        Breakpoint.startBreakpointWatch(Test996.class,
