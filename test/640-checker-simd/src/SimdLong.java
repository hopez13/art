...
public class SimdLong {
    ...
    static void shr64() {
        ...
        for (int i = 0; i < 128; i++) a[i] >>>= $opt$inline$IntConstant64(); // 0, since & 63
    }
    ...
    /// CHECK-FI:
    static void shr65() {
        for (int i = 0; i < 128; i++) a[i] >>>= $opt$inline$IntConstant65(); // 1, since & 63
    }
    ...
    static void shrMinus254() {
        for (int i = 0; i < 128; i++) a[i] >>>= $opt$inline$IntConstantMinus254(); // 2, since & 63
    }
