...
public class SimdInt {
    ...
    static void shr32() {
        ...
        for (int i = 0; i < 128; i++) a[i] >>>= $opt$inline$IntConstant32(); // 0, since & 31
    }
    ...
    /// CHECK-FI:
    static void shr33() {
        for (int i = 0; i < 128; i++) a[i] >>>= $opt$inline$IntConstant33(); // 1, since & 31
    }
    ...
    static void shrMinus254() {
        for (int i = 0; i < 128; i++) a[i] >>>= $opt$inline$IntConstantMinus254(); // 2, since & 31
    }
