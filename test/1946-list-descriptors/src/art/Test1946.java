...
public class Test1946 {
  ...
  private static ClassLoader makeClassLoaderFrom(byte[] data, ClassLoader parent) throws Exception {
    return (ClassLoader)Class.forName("dalvik.system.InMemoryDexClassLoader")
                             .getConstructor(ByteBuffer.class, ClassLoader.class)
                             .newInstance(ByteBuffer.wrap(data), parent);
  }
  ...
  private static ClassLoader makeClassLoaderFrom(List<byte[]> data, ClassLoader parent)
    ...
    return (ClassLoader)Class.forName("dalvik.system.InMemoryDexClassLoader")
                             .getConstructor(new ByteBuffer[0].getClass(), ClassLoader.class)
                             .newInstance(bufs.toArray(new ByteBuffer[0]), parent);
  }
