...
public class Main {
    ...
    private static void longToInt() {
        ...
        assertLongEquals(
                1L, $opt$noinline$IntToLong($opt$noinline$LongToInt(4294967297L))); // 2^32 + 1
        assertLongEquals(0L, $opt$noinline$IntToLong($opt$noinline$LongToInt(4294967296L))); // 2^32
        assertLongEquals(
                -1L, $opt$noinline$IntToLong($opt$noinline$LongToInt(4294967295L))); // 2^32 - 1
        assertLongEquals(0L, $opt$noinline$IntToLong($opt$noinline$LongToInt(0L)));
        assertLongEquals(
                1L, $opt$noinline$IntToLong($opt$noinline$LongToInt(-4294967295L))); // -(2^32 - 1)
        assertLongEquals(
                0L, $opt$noinline$IntToLong($opt$noinline$LongToInt(-4294967296L))); // -(2^32)
        assertLongEquals(
                -1, $opt$noinline$IntToLong($opt$noinline$LongToInt(-4294967297L))); // -(2^32 + 1)
    }
    ...
    private static void longToFloat() {
        ...
        assertFloatEquals(-4294967296F, $opt$noinline$LongToFloat(-4294967296L)); // -(2^32)
        assertFloatEquals(140739635871745F,
                $opt$noinline$LongToFloat(140739635871745L)); // 1 + 2^15 + 2^31 + 2^47
        assertFloatEquals(-140739635871745F,
                $opt$noinline$LongToFloat(-140739635871745L)); // -(1 + 2^15 + 2^31 + 2^47)
        assertFloatEquals(
                9223372036854775807F, $opt$noinline$LongToFloat(9223372036854775807L)); // 2^63 - 1
        assertFloatEquals(-9223372036854775807F,
                $opt$noinline$LongToFloat(-9223372036854775807L)); // -(2^63 - 1)
        assertFloatEquals(
                -9223372036854775808F, $opt$noinline$LongToFloat(-9223372036854775808L)); // -(2^63)
    }
    ...
    private static void longToDouble() {
        ...
        assertDoubleEquals(-4294967296D, $opt$noinline$LongToDouble(-4294967296L)); // -(2^32)
        assertDoubleEquals(140739635871745D,
                $opt$noinline$LongToDouble(140739635871745L)); // 1 + 2^15 + 2^31 + 2^47
        assertDoubleEquals(-140739635871745D,
                $opt$noinline$LongToDouble(-140739635871745L)); // -(1 + 2^15 + 2^31 + 2^47)
        assertDoubleEquals(
                9223372036854775807D, $opt$noinline$LongToDouble(9223372036854775807L)); // 2^63 - 1
        assertDoubleEquals(-9223372036854775807D,
                $opt$noinline$LongToDouble(-9223372036854775807L)); // -(2^63 - 1)
        assertDoubleEquals(-9223372036854775808D,
                $opt$noinline$LongToDouble(-9223372036854775808L)); // -(2^63)
    }
    ...
    private static void floatToInt() {
        ...
        assertIntEquals(
                -2147483648, $opt$noinline$FloatToInt(-9223372036854775807F)); // -(2^63 - 1)
    ...
    private static void floatToLong() {
        ...
        assertLongEquals(
                9223372036854775807L, $opt$noinline$FloatToLong(9223372036854775807F)); // 2^63 - 1
        assertLongEquals(-9223372036854775808L,
                $opt$noinline$FloatToLong(-9223372036854775807F)); // -(2^63 - 1)
        assertLongEquals(
                -9223372036854775808L, $opt$noinline$FloatToLong(-9223372036854775808F)); // -(2^63)
        assertLongEquals(9223371487098961920L,
                $opt$noinline$FloatToLong(9223371487098961920F)); // Math.nextAfter(2F^63, 0)
        assertLongEquals(-9223371487098961920L,
                $opt$noinline$FloatToLong(-9223371487098961920F)); // Math.nextAfter(-2F^63, 0)
    ...
    private static void floatToDouble() {
        ...
        assertDoubleEquals(9223372036854775807D,
                $opt$noinline$FloatToDouble(9223372036854775807F)); // 2^63 - 1
        assertDoubleEquals(-9223372036854775807D,
                $opt$noinline$FloatToDouble(-9223372036854775807F)); // -(2^63 - 1)
        assertDoubleEquals(-9223372036854775808D,
                $opt$noinline$FloatToDouble(-9223372036854775808F)); // -(2^63)
        assertDoubleIsNaN($opt$noinline$FloatToDouble(Float.NaN));
        assertDoubleEquals(
                Double.POSITIVE_INFINITY, $opt$noinline$FloatToDouble(Float.POSITIVE_INFINITY));
        assertDoubleEquals(
                Double.NEGATIVE_INFINITY, $opt$noinline$FloatToDouble(Float.NEGATIVE_INFINITY));
    }
    ...
    private static void doubleToInt() {
        ...
        assertIntEquals(
                -2147483648, $opt$noinline$DoubleToInt(-9223372036854775807D)); // -(2^63 - 1)
    ...
    private static void doubleToLong() {
        ...
        assertLongEquals(
                9223372036854775807L, $opt$noinline$DoubleToLong(9223372036854775807D)); // 2^63 - 1
        assertLongEquals(-9223372036854775808L,
                $opt$noinline$DoubleToLong(-9223372036854775807D)); // -(2^63 - 1)
        assertLongEquals(-9223372036854775808L,
                $opt$noinline$DoubleToLong(-9223372036854775808D)); // -(2^63)
        assertLongEquals(0L, $opt$noinline$DoubleToLong(Double.NaN));
        assertLongEquals(9223372036854774784L,
                $opt$noinline$DoubleToLong(9223372036854774784D)); // Math.nextAfter(2D^63, 0)
        assertLongEquals(-9223372036854774784L,
                $opt$noinline$DoubleToLong(-9223372036854774784D)); // Math.nextAfter(-2D^63, 0)
        assertLongEquals(
                9223372036854775807L, $opt$noinline$DoubleToLong(Double.POSITIVE_INFINITY));
        assertLongEquals(
                -9223372036854775808L, $opt$noinline$DoubleToLong(Double.NEGATIVE_INFINITY));
    }
    ...
    private static void doubleToFloat() {
        ...
        assertFloatEquals(9223372036854775807F,
                $opt$noinline$DoubleToFloat(9223372036854775807D)); // 2^63 - 1
        assertFloatEquals(-9223372036854775807F,
                $opt$noinline$DoubleToFloat(-9223372036854775807D)); // -(2^63 - 1)
        assertFloatEquals(-9223372036854775808F,
                $opt$noinline$DoubleToFloat(-9223372036854775808D)); // -(2^63)
        assertFloatIsNaN($opt$noinline$DoubleToFloat(Float.NaN));
        assertFloatEquals(
                Float.POSITIVE_INFINITY, $opt$noinline$DoubleToFloat(Double.POSITIVE_INFINITY));
        assertFloatEquals(
                Float.NEGATIVE_INFINITY, $opt$noinline$DoubleToFloat(Double.NEGATIVE_INFINITY));
    }
