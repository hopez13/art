...
public class Main {
  ...
  /// CHECK-START: void Main.shr64() loop_optimization (before)
  /// CHECK-DAG: <<Phi:i\d+>> Phi                                 loop:<<Loop:B\d+>> outer_loop:none
  /// CHECK-DAG: <<Get:j\d+>> ArrayGet                            loop:<<Loop>>      outer_loop:none
  /// CHECK-DAG:              ArraySet [{{l\d+}},<<Phi>>,<<Get>>] loop:<<Loop>>      outer_loop:none
  //
  ...
  /// CHECK-START: void Main.shr65() loop_optimization (before)
  ...
  /// CHECK-START: void Main.shrMinus254() loop_optimization (before)
  ...
  public static void main(String[] args) {
    ...
    shrMinus254();
    for (int i = 0; i < 128; i++) {
      expectEquals(0x07ffffffffffffffL, a[i], "shr65");
    }
