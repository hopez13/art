...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    assertEqual(0x8888888877777777L,
                $noinline$LongEqNonmatCond_LongVarVar(2L, 3L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
    assertEqual(0xAAAAAAAA55555555L,
                $noinline$LongEqNonmatCond_LongVarVar(2L, 2L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
