...
public class Main {
    ...
    public static int $noinline$BoolCond_IntVarCst(boolean cond, int x) { return cond ? x : 1; }
    ...
    public static int $noinline$BoolCond_IntCstVar(boolean cond, int y) { return cond ? 1 : y; }
    ...
    public static long $noinline$BoolCond_LongVarCst(boolean cond, long x) { return cond ? x : 1L; }
    ...
    public static long $noinline$BoolCond_LongCstVar(boolean cond, long y) { return cond ? 1L : y; }
    ...
    public static float $noinline$FloatGtNonmatCond_FloatVarVar(
    ...
    public static int $noinline$BoolCond_0_m1(boolean cond) { return cond ? 0 : -1; }
    ...
    public static int $noinline$BoolCond_m1_0(boolean cond) { return cond ? -1 : 0; }
    ...
    public static void main(String[] args) {
        ...
        assertEqual(0xAAAAAAAA55555555L,
                $noinline$LongNonmatCond_LongVarVar(
                        3L, 2L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
        assertEqual(0x8888888877777777L,
                $noinline$LongNonmatCond_LongVarVar(
                        2L, 2L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
        assertEqual(0x8888888877777777L,
                $noinline$LongNonmatCond_LongVarVar(
                        2L, 3L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
        assertEqual(0xAAAAAAAA55555555L,
                $noinline$LongNonmatCond_LongVarVar(0x0000000100000000L, 0x00000000FFFFFFFFL,
                        0xAAAAAAAA55555555L, 0x8888888877777777L));
        assertEqual(0x8888888877777777L,
                $noinline$LongNonmatCond_LongVarVar(0x00000000FFFFFFFFL, 0x0000000100000000L,
                        0xAAAAAAAA55555555L, 0x8888888877777777L));

        assertEqual(0x8888888877777777L,
                $noinline$LongEqNonmatCond_LongVarVar(
                        2L, 3L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
        assertEqual(0xAAAAAAAA55555555L,
                $noinline$LongEqNonmatCond_LongVarVar(
                        2L, 2L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
        assertEqual(0x8888888877777777L,
                $noinline$LongEqNonmatCond_LongVarVar(
                        0x10000000000L, 0L, 0xAAAAAAAA55555555L, 0x8888888877777777L));
        ...
        long[] long_inputs = {0L, 1L, -1L, Long.MIN_VALUE, Long.MAX_VALUE, 2L, 0x100000000L,
                0xFFFFFFFF00000000L, -9000L};

        long[] expected_1 = {5L, 7L, 7L, 7L, 7L, 7L, 7L, 7L, 7L};

        for (int i = 0; i < long_inputs.length; i++) {
            assertEqual(
                    expected_1[i], $noinline$LongNonmatCondCst_LongVarVar4(long_inputs[i], 5L, 7L));
        }
        ...
        for (int i = 0; i < long_inputs.length; i++) {
            assertEqual(
                    expected_2[i], $noinline$LongNonmatCondCst_LongVarVar5(long_inputs[i], 5L, 7L));
        }
        ...
        for (int i = 0; i < long_inputs.length; i++) {
            assertEqual(
                    expected_3[i], $noinline$LongNonmatCondCst_LongVarVar6(long_inputs[i], 5L, 7L));
        }
        ...
        for (int i = 0; i < long_inputs.length; i++) {
            assertEqual(
                    expected_4[i], $noinline$LongNonmatCondCst_LongVarVar7(long_inputs[i], 5L, 7L));
        }
