...
public class Main {
    ...
    public static void staticNop() { Second.staticNop(11); }
    ...
    public static void nop(Second s) { s.nop(); }
    ...
    public static long returnArg1(Second s, long value) { return s.returnArg1(value); }
    ...
    public static int staticReturn9() { return Second.staticReturn9(); }
    ...
    public static int return7(Second s) { return s.return7(null); }
    ...
    public static float return42f(Second s) { return s.return42f(); }
    ...
    public static String staticReturnNull() { return Second.staticReturnNull(); }
    ...
    public static Object returnNull(Second s) { return s.returnNull(); }
    ...
    public static int getInt(Second s) { return s.getInstanceIntField(); }
    ...
    public static double getDouble(Second s) { return s.getInstanceDoubleField(22); }
    ...
    public static Object getObject(Second s) { return s.getInstanceObjectField(-1L); }
    ...
    public static int staticGetInt(Second s) { return Second.staticGetInstanceIntField(s); }
    ...
    public static int getStaticInt(Second s) { return s.getStaticIntField(); }
    ...
    public static Object newObject() { return new Object(); }
