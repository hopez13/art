...
public class Main extends UnresolvedSuperClass {
    ...
    static public void callInvokeUnresolvedStatic() { UnresolvedClass.staticMethod(); }
    ...
    static public void callInvokeUnresolvedVirtual(UnresolvedClass c) { c.virtualMethod(); }
    ...
    static public void callInvokeUnresolvedInterface(UnresolvedInterface c) { c.interfaceMethod(); }

    static public void callInvokeUnresolvedSuper(Main c) { c.superMethod(); }

    /// CHECK-START: void Main.superMethod() register (before)
    /// CHECK:        InvokeUnresolved invoke_type:super
    public void superMethod() { super.superMethod(); }
