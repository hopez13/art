...
public class Main extends UnresolvedSuperClass {
  ...
  /// CHECK:        UnresolvedStaticFieldSet field_type:Float
  /// CHECK:        UnresolvedStaticFieldSet field_type:Double
  ...
  /// CHECK:        UnresolvedStaticFieldGet field_type:Float
  /// CHECK:        UnresolvedStaticFieldGet field_type:Double
  ...
  /// CHECK:        UnresolvedInstanceFieldSet field_type:Float
  /// CHECK:        UnresolvedInstanceFieldSet field_type:Double
  ...
  /// CHECK:        UnresolvedInstanceFieldGet field_type:Float
  /// CHECK:        UnresolvedInstanceFieldGet field_type:Double
