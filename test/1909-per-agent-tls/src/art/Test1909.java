...
public class Test1909 {
    public static class ThreadHolder {
        public Thread thr;
        public ThreadHolder(Thread thr) { this.thr = thr; }

        public long getTLS(long jvmtienv) { return Test1909.getTLS(jvmtienv, this.thr); }
        public void setTLS(long jvmtienv, long ptr) { Test1909.setTLS(jvmtienv, this.thr, ptr); }
    }
