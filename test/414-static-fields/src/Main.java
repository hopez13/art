...
public class Main extends TestCase {
    ...
    static int getInt() { return 33; }

    static void $opt$TestThisClassStaticField() { assertEquals(42, staticField); }

    static void $opt$TestOtherClassStaticField() { assertEquals(41, Other.staticField); }
