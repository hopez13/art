...
public abstract class TestCase {
    ...
    public static void assertNotSame(Object expected, Object value) {
        if (expected == value) {
            throw new AssertionError("Objects are the same: " + String.valueOf(expected));
        }
    }
    ...
    public static void assertTrue(boolean condition) { assertTrue("Expected true", condition); }
    ...
    public static void assertFalse(boolean condition) { assertFalse("Expected false", condition); }
    ...
    public static void assertNull(Object object) { assertNull("Expected null", object); }
    ...
    public static void assertNotNull(Object object) { assertNotNull("Expected non-null", object); }
