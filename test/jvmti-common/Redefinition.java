...
public class Redefinition {
    ...
    public static enum Config {
        ...
        private Config(int val) { this.val = val; }
    }

    public static void setTestConfiguration(Config type) { nativeSetTestConfiguration(type.val); }
    ...
    public static void doMultiStructuralClassRedefinition(CommonClassDefinition... defs) {
        ...
        doCommonMultiStructuralClassRedefinition(
                classes.toArray(new Class<?>[ 0 ]), dex_files.toArray(new byte[0][]));
    }
    public static native void doCommonMultiStructuralClassRedefinition(
            Class<?>[] targets, byte[][] dexfiles);
