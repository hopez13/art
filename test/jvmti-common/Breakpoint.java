...
public class Breakpoint {
    public static class Manager {
        public static class BP {
            ...
            public BP(Executable method) { this(method, getStartLocation(method)); }
            ...
            public boolean equals(Object other) {
                return (other instanceof BP) && method.equals(((BP) other).method)
        ...
        public void clearAllBreakpoints() { clearBreakpoints(breaks.toArray(new BP[0])); }
    }

    public static void startBreakpointWatch(
            Class<?> methodClass, Executable breakpointReached, Thread thr) {
     ...
     *
     * If allowRecursive == true then breakpoints will be sent even if one is currently being
     * handled.
     */
    public static native void startBreakpointWatch(
            Class<?> methodClass, Executable breakpointReached, boolean allowRecursive, Thread thr);
    ...
    public static void setBreakpoint(Executable m, LineNumber l) { setBreakpoint(m, l.location); }
