...
public class Test1948 {
    ...
    static {
        try {
            // TestGenerator will add functions that get the base64 string of these functions. When
            // we compile this the functions haven't been generated yet though so just do things
            // this way.
    ...
    public static void run() throws Throwable {
        // NB Because we aren't using desugar we cannot use capturing-lambda or string concat
        // anywhere in this test! Version 9+ javac turns these into invokedynamics using bootstrap
        // methods not currently present in android.
        new TestInvoke().runTest(new Runnable() {
            public void run() {
