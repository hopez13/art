...
public class TestGenerator {
  ...
  // Use d8bin to convert the classBytes into a dex file bytes. We use d8 because it doesn't require
  // setting up a directory structures or matching file names like dx does.
