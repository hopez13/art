...
public class Main {
    ...
    public void $noinline$foo(int in_w1, int in_w2, int in_w3, int in_w4, int in_w5, int in_w6,
            int in_w7, int on_stack_int, long on_stack_long, float in_s0, float in_s1, float in_s2,
            float in_s3, float in_s4, float in_s5, float in_s6, float in_s7, float on_stack_float,
    ...
    public void store_zero_to_static_byte_field() { static_byte_field = 0; }
    ...
    public void store_zero_to_static_char_field() { static_char_field = 0; }
    ...
    public void store_zero_to_static_short_field() { static_short_field = 0; }
    ...
    public void store_zero_to_static_int_field() { static_int_field = 0; }
    ...
    public void store_zero_to_static_long_field() { static_long_field = 0; }
    ...
    public void store_zero_to_static_float_field() { static_float_field = 0.0f; }
    ...
    public void store_zero_to_static_double_field() { static_double_field = 0.0; }
    ...
    public void store_zero_to_volatile_static_byte_field() { volatile_static_byte_field = 0; }
    ...
    public void store_zero_to_volatile_static_char_field() { volatile_static_char_field = 0; }
    ...
    public void store_zero_to_volatile_static_short_field() { volatile_static_short_field = 0; }
    ...
    public void store_zero_to_volatile_static_int_field() { volatile_static_int_field = 0; }
    ...
    public void store_zero_to_volatile_static_long_field() { volatile_static_long_field = 0; }
    ...
    public void store_zero_to_volatile_static_float_field() { volatile_static_float_field = 0.0f; }
    ...
    public void store_zero_to_volatile_static_double_field() { volatile_static_double_field = 0.0; }
    ...
    public void store_zero_to_instance_byte_field() { instance_byte_field = 0; }
    ...
    public void store_zero_to_instance_char_field() { instance_char_field = 0; }
    ...
    public void store_zero_to_instance_short_field() { instance_short_field = 0; }
    ...
    public void store_zero_to_instance_int_field() { instance_int_field = 0; }
    ...
    public void store_zero_to_instance_long_field() { instance_long_field = 0; }
    ...
    public void store_zero_to_instance_float_field() { instance_float_field = 0.0f; }
    ...
    public void store_zero_to_instance_double_field() { instance_double_field = 0.0; }
    ...
    public void store_zero_to_volatile_instance_byte_field() { volatile_instance_byte_field = 0; }
    ...
    public void store_zero_to_volatile_instance_char_field() { volatile_instance_char_field = 0; }
    ...
    public void store_zero_to_volatile_instance_short_field() { volatile_instance_short_field = 0; }
    ...
    public void store_zero_to_volatile_instance_int_field() { volatile_instance_int_field = 0; }
    ...
    public void store_zero_to_volatile_instance_long_field() { volatile_instance_long_field = 0; }
    ...
    public void store_zero_to_array_byte() { array_byte[0] = 0; }
    ...
    public void store_zero_to_array_char() { array_char[0] = 0; }
    ...
    public void store_zero_to_array_short() { array_short[0] = 0; }
    ...
    public void store_zero_to_array_int() { array_int[0] = 0; }
    ...
    public void store_zero_to_array_long() { array_long[0] = 0; }
    ...
    public void store_zero_to_array_float() { array_float[0] = 0.0f; }
    ...
    public void store_zero_to_array_double() { array_double[0] = 0.0; }
