...
public class Test1970 {
    ...
    public static long getOveriddenReturnValue(Thread thr) { return OVERRIDE_ID++; }
    ...
    public abstract static class AbstractTestObject implements TestRunnable {
        ...
        public long getReturnValue() { return resultVal; }
    ...
    public static class ExceptionThrowFarTestObject implements TestRunnable {
        ...
        public long callingFunction() { return calledFunction(); }
    ...
    public static class ExceptionOnceObject extends AbstractTestObject {
        ...
        public long doThrow() { throw new TestError(); }
    ...
    public static class ExceptionThrowTestObject implements TestRunnable {
        ...
        public long getReturnValue() { return result; }
    ...
    public static class StaticMethodObject implements TestRunnable {
        ...
        public void run() { result = calledFunction(() -> (long) ++cnt); }
    ...
    public static class BadForceVoidObject implements TestRunnable {
        public int cnt = 0;
        public long getReturnValue() { return -1; }
    ...
    public static class BadForceObjectObject implements TestRunnable {
        ...
        public long getReturnValue() { return result.longValue(); }
    ...
    public static void run() throws Exception { new Test1970().runTests(); }
    ...
    public void runTests() throws Exception {
        ...
        runTestOn(BadForceObjectObject::new,
                (thr)
                        -> setupSuspendBreakpointFor(objFunction, objLoc, thr),
                SuspendEvents::clearSuspendMethodEvent);
    }
}
