...
public class Main {
  ...
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy18(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy18(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMinus18(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMinus18(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntRemDivBy18(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Rem
  /// CHECK:           Div
  //
  /// CHECK-START: long Main.$noinline$IntRemDivBy18(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy5(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy5(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Shl
  /// CHECK-NEXT:      Add
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMinus5(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMinus5(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy7(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy7(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Shl
  /// CHECK-NEXT:      Sub
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMinus7(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMinus7(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMaxInt(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemByMaxInt(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Shl
  /// CHECK-NEXT:      Sub
  /// CHECK-NEXT:      Sub
  ...
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy18(int, boolean) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRemBy18(int, boolean) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK:           Rem
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRem(int, int) loop_friendly_instruction_simplifier$after_gvn (before)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRem(int, int) loop_friendly_instruction_simplifier$after_gvn (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$IntRemDiv(int, int) loop_friendly_instruction_simplifier$after_gvn (before)
  /// CHECK:           Rem
  /// CHECK-NEXT:      Div
  //
  /// CHECK-START: long Main.$noinline$IntRemDiv(int, int) loop_friendly_instruction_simplifier$after_gvn (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  ...
  //  HDiv with the same inputs as HRem but in another basic block is not reused.
  //
  /// CHECK-START: long Main.$noinline$IntDivRem(int, int, boolean) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$IntDivRem(int, int, boolean) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK:           Rem
  ...
  //
  /// CHECK-START: int Main.$noinline$IntRemBy18InLoop(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div loop:B{{\d+}}
  /// CHECK-NEXT:      Rem loop:B{{\d+}}
  //
  /// CHECK-START: int Main.$noinline$IntRemBy18InLoop(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div loop:B{{\d+}}
  /// CHECK-NEXT:      Rem loop:B{{\d+}}
  //
  ...
  //
  /// CHECK-START: float Main.$noinline$FloatRemBy18(float) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  //
  /// CHECK-START: float Main.$noinline$FloatRemBy18(float) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  ...
  //  FP type HRem is not optimized by the instruction simplifier.
  //
  /// CHECK-START: double Main.$noinline$DoubleRemBy18(double) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  //
  /// CHECK-START: double Main.$noinline$DoubleRemBy18(double) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  ...
  //
  /// CHECK-START: int Main.$noinline$IntRemByIntMin(int) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  //
  /// CHECK-START: int Main.$noinline$IntRemByIntMin(int) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$LongDivRemBy18(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$LongDivRemBy18(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMinus18(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMinus18(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$LongRemDivBy18(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Rem
  /// CHECK:           Div
  //
  /// CHECK-START: long Main.$noinline$LongRemDivBy18(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemBy5(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemBy5(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Shl
  /// CHECK-NEXT:      Add
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMinus5(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMinus5(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemBy7(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemBy7(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Shl
  /// CHECK-NEXT:      Sub
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMinus7(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMinus7(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  //
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMaxLong(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long[] Main.$noinline$LongDivRemByMaxLong(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Shl
  /// CHECK-NEXT:      Sub
  /// CHECK-NEXT:      Sub
  ...
  //  HDiv with the same inputs as HRem but in another basic block is not reused.
  //
  /// CHECK-START: long Main.$noinline$LongDivRemBy18(long, boolean) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$LongDivRemBy18(long, boolean) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK:           Rem
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$LongDivRem(long, long) loop_friendly_instruction_simplifier$after_gvn (before)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  //
  /// CHECK-START: long Main.$noinline$LongDivRem(long, long) loop_friendly_instruction_simplifier$after_gvn (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  ...
  //  If there is HDiv with the same inputs as HRem, it is reused.
  //
  /// CHECK-START: long Main.$noinline$LongRemDiv(long, long) loop_friendly_instruction_simplifier$after_gvn (before)
  /// CHECK:           Rem
  /// CHECK-NEXT:      Div
  //
  /// CHECK-START: long Main.$noinline$LongRemDiv(long, long) loop_friendly_instruction_simplifier$after_gvn (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Mul
  /// CHECK-NEXT:      Sub
  ...
  //  HDiv with the same inputs as HRem but in another basic block is not reused.
  //
  /// CHECK-START: long Main.$noinline$LongDivRem(long, long, boolean) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK:           Rem
  //
  /// CHECK-START: long Main.$noinline$LongDivRem(long, long, boolean) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK:           Rem
  ...
  //  loop analysis/optimizations are done.
  //
  /// CHECK-START: long Main.$noinline$LongRemBy18InLoop(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div loop:B{{\d+}}
  /// CHECK-NEXT:      Rem loop:B{{\d+}}
  //
  /// CHECK-START: long Main.$noinline$LongRemBy18InLoop(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div loop:B{{\d+}}
  /// CHECK-NEXT:      Rem loop:B{{\d+}}
  //
  ...
  //  the case is optimized by the code generator.
  //
  /// CHECK-START: long Main.$noinline$LongRemByLongMin(long) loop_friendly_instruction_simplifier (before)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
  //
  /// CHECK-START: long Main.$noinline$LongRemByLongMin(long) loop_friendly_instruction_simplifier (after)
  /// CHECK:           Div
  /// CHECK-NEXT:      Rem
