...
public class Main {
  ...
  /// CHECK:               asr{{s?}} r{{\d+}}, #2
  /// CHECK-NEXT:          sub{{s?}} r{{\d+}}, r{{\d+}}, r{{\d+}}, asr #31
  /// CHECK:               sub{{s?}} r{{\d+}}, r{{\d+}}, r{{\d+}}, lsl #3
  ...
  /// CHECK:               asr{{s?}}  r{{\d+}}, #29
  /// CHECK-NEXT:          sub{{s?}}  r{{\d+}}, r{{\d+}}, r{{\d+}}, asr #31
  /// CHECK:               sub{{s?}}  r{{\d+}}, r{{\d+}}, r{{\d+}}, lsl #31
  /// CHECK:               add{{s?}}  r{{\d+}}, r{{\d+}}, r{{\d+}}
  ...
  /// CHECK:               blx lr
  //  CHECK:               lsl ip, r{{\d}}, #3
  //  CHECK-NEXT:          orr{{s?}} ip, r{{\d}}, lsr #29
  //  CHECK-NEXT:          sub{{s?}} r{{\d}}, r{{\d}}, r{{\d}}, lsl #3
