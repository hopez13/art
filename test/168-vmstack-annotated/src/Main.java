...
public class Main {
    ...
    private static void testCluster1() throws Exception {
        ...
        // Thread 1.
        {
            ...
            assertEquals(stack1[0][2], o2);    // Blocked on o2.
            assertLocks(stack1[0][1], o3);     // Locked o3.
            assertStackTraceElementStep(stack1[0][0]);

            assertLength(stack1[1], 2);
            assertLocks(stack1[1][1], o1);     // Locked o1.
        ...
        // Thread 2.
        {
            ...
            assertEquals(stack2[0][2], o1);        // Blocked on o1.
            assertLocks(stack2[0][1]);             // Nothing locked.
            assertStackTraceElementStep(stack2[0][0]);

            assertLength(stack2[1], 2);
            assertLocks(stack2[1][1], o4, o2);     // Locked o4, o2.
    ...
    private static void assertLength(Object[] o, int l) {
        if (o.length != l) {
            throw new RuntimeException("Expected " + Arrays.toString(o) + " == " + l);
        }
    }
