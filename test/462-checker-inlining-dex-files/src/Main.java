...
public class Main {
    ...
    public static void inlineEmptyMethod() { OtherDex.emptyMethod(); }
    ...
    public static int inlineReturnIntMethod() { return OtherDex.returnIntMethod(); }
    ...
    public static int inlineOtherDexStatic() { return OtherDex.returnOtherDexStatic(); }
    ...
    public static int inlineMainStatic() { return OtherDex.returnMainStatic(); }
    ...
    public static int dontInlineRecursiveCall() { return OtherDex.recursiveCall(); }
    ...
    public static String inlineReturnString() { return OtherDex.returnString(); }
    ...
    public static Class<?> inlineOtherDexClass() { return OtherDex.returnOtherDexClass(); }
    ...
    public static Class<?> inlineMainClass() { return OtherDex.returnMainClass(); }
    ...
    public static Class<?> getOtherClass() { return Main.class; }
