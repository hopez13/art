...
class Main {
    ...
    public static void foo() {
        ...
        long i = myLongField1; // Will call TrySplitNonPairOrUnalignedPairIntervalAt -> Failing
                               // DCHECK
        ...
        // both low and high interval at the fixed use; therefore the allocation of the high
        // interval would not see the register use, and think the interval can just be spilled and
        // not be put in the active set, even though it is holding a register.
    ...
    public static long $noinline$bar() { return 42; }
