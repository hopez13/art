...
class C0 {
    public static void m(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C5 {
    ...
    public static void mImpl(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C90 {
    ...
    public static void mReport_Factory(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
    public static void mApi(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C105 {
    ...
    public static void m_InMemoryScanner(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
    public static void m_Scanner(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C255 {
    ...
    public static void mFactory(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C457 {
    ...
    public static void mMap(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C577 {
    ...
    public static void mDebug(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
...
class C944 {
    ...
    public static void mManager(Context c, Binder b) { /* Defeat inlining. */
        if (Main.doThrow) {
            throw new Error();
        }
    }
