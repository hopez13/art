...
public class Reflection {
    ...
    public static boolean canDiscoverMethodWithMetaReflection(
            Class<?> klass, String name, boolean hardeningEnabled) {
        try {
    ...
    public static boolean canDiscoverFieldWithMetaReflection(
            Class<?> klass, String name, boolean hardeningEnabled) {
        try {
            setHiddenApiCheckHardening(hardeningEnabled);
    ...
    public static boolean canDiscoverConstructorWithMetaReflection(
        ...
        try {
            ...
            return ((Constructor<?>) metaGetDeclaredConstructor.invoke(klass, (Object) args))
                    != null;
        } catch (NoSuchMethodException | InvocationTargetException | IllegalAccessException ex) {
            return false;
        }
