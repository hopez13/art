...
public class ParentClass {
    ...
    public int callMethodPackageConditionallyBlocked() {
        return methodPackageConditionallyBlocked();
    }
    public int callMethodProtectedConditionallyBlocked() {
        return methodProtectedConditionallyBlocked();
    }
