...
static constexpr uin64_t kHiddenApiCheckHardeningId = 142365358;
...
extern "C" JNIEXPORT void JNICALL Java_Reflection_setHiddenApiCheckHardening(JNIEnv*, jclass, jboolean value) {
