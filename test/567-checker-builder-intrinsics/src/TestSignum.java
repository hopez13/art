...
public class TestSignum {
    ...
    private static int signByte(byte x) { return Integer.signum(x); }
    ...
    private static int signShort(short x) { return Integer.signum(x); }
    ...
    private static int signChar(char x) { return Integer.signum(x); }
    ...
    private static int signInt(int x) { return Integer.signum(x); }
    ...
    private static int signLong(long x) { return Long.signum(x); }
