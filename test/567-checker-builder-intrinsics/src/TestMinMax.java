...
public class TestMinMax {
    ...
    public static int minI(int a) { return Math.min(a, 20); }
    ...
    public static long minL(long a) { return Math.min(a, 20L); }
    ...
    public static int maxI(int a) { return Math.max(a, 20); }
    ...
    public static long maxL(long a) { return Math.max(a, 20L); }
    ...
    /// CHECK:            ret
    public static int minIntConstantZero(int a) { return Math.min(a, 0); }
    ...
    /// CHECK:            ret
    public static int minIntConstantOne(int a) { return Math.min(a, 1); }
    ...
    /// CHECK:            ret
    public static int minIntConstantMinusOne(int a) { return Math.min(a, -1); }
    ...
    /// CHECK:            ret
    public static long minLongConstantZero(long a) { return Math.min(a, 0L); }
    ...
    /// CHECK:            ret
    public static long minLongConstantOne(long a) { return Math.min(a, 1L); }
    ...
    /// CHECK:            ret
    public static long minLongConstantMinusOne(long a) { return Math.min(a, -1L); }
    ...
    /// CHECK:            ret
    public static int maxIntConstantZero(int a) { return Math.max(a, 0); }
    ...
    /// CHECK:            ret
    public static int maxIntConstantOne(int a) { return Math.max(a, 1); }
    ...
    /// CHECK:            ret
    public static int maxIntConstantMinusOne(int a) { return Math.max(a, -1); }
    ...
    /// CHECK:            ret
    public static int maxIntLargeConstant(int a) { return Math.max(a, 8193); }
    ...
    /// CHECK:            ret
    public static long maxLongConstantZero(long a) { return Math.max(a, 0L); }
    ...
    /// CHECK:            ret
    public static long maxLongConstantOne(long a) { return Math.max(a, 1L); }
    ...
    /// CHECK:            ret
    public static long maxLongConstantMinusOne(long a) { return Math.max(a, -1L); }
    ...
    /// CHECK:            ret
    public static long maxLongLargeConstant(long a) { return Math.max(a, 8193L); }
    ...
    /// CHECK-START: int TestMinMax.min1(int, int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int min1(int a, int b) { return a < b ? a : b; }
    ...
    /// CHECK-START: int TestMinMax.min3(int, int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int min3(int a, int b) { return a > b ? b : a; }
    ...
    /// CHECK-START: int TestMinMax.min4(int, int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int min4(int a, int b) { return a >= b ? b : a; }
    ...
    /// CHECK-START: int TestMinMax.min5(short, short) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int min5(short a, short b) { return a >= b ? b : a; }
    ...
    /// CHECK-START: int TestMinMax.min6(byte, byte) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int min6(byte a, byte b) { return a >= b ? b : a; }
    ...
    /// CHECK-START: long TestMinMax.min7(long, long) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static long min7(long a, long b) { return a >= b ? b : a; }
    ...
    /// CHECK-START: int TestMinMax.max1(int, int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int max1(int a, int b) { return a < b ? b : a; }
    ...
    /// CHECK-START: int TestMinMax.max3(int, int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int max3(int a, int b) { return a > b ? a : b; }
    ...
    /// CHECK-START: int TestMinMax.max4(int, int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int max4(int a, int b) { return a >= b ? a : b; }
    ...
    /// CHECK-START: int TestMinMax.max5(short, short) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int max5(short a, short b) { return a >= b ? a : b; }
    ...
    /// CHECK-START: int TestMinMax.max6(byte, byte) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static int max6(byte a, byte b) { return a >= b ? a : b; }
    ...
    /// CHECK-START: long TestMinMax.max7(long, long) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:              Select
    public static long max7(long a, long b) { return a >= b ? a : b; }
    ...
    /// CHECK-START: int TestMinMax.minmax3(int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:               Select
    public static int minmax3(int x) { return (x > 100) ? 100 : ((x < -100) ? -100 : x); }
    ...
    /// CHECK-START: int TestMinMax.minmax4(int) instruction_simplifier$after_gvn (after)
    /// CHECK-NOT:               Select
    public static int minmax4(int x) { return (x < -100) ? -100 : ((x > 100) ? 100 : x); }
