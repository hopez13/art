...
public class TestRotate {
    ...
    public static void testRotateRightLong() {
        ...
        expectEqualsLong(
                0x8000000000000000L, rotateRightLong(0x8000000000000000L, 64)); // overshoot
    ...
    public static void testRotateLeftIntWithByteDistance() {
        ...
        expectEqualsInt(
                0x00000001, rotateLeftIntWithByteDistance(0x00000001, (byte) 32)); // overshoot
    ...
    public static void testRotateRightIntWithByteDistance() {
        ...
        expectEqualsInt(
                0x80000000, rotateRightIntWithByteDistance(0x80000000, (byte) 32)); // overshoot
