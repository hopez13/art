...
public class Main
{
  ...
  public int Count = 5;
  public int arithmeticSeries3(int paramInt)
  {
    if (paramInt == 0) {
      return 1;
    }
    return Count * arithmeticSeries3(paramInt - 1);
  }

  // Current TRE implementation don't support multiple return values in exit successor of
  // IF condition (other than invoke call path). Hence, CFG will be same before & after TRE.
  public int arithmeticSeries4(int paramInt)
  {
    if (paramInt < 2) {
      if (paramInt == 1) {
        return 2;
    ...
    return paramInt * arithmeticSeries4(paramInt - 1);
  }
  ...
  public static void main(String[] args)
  {
    ...
    assertIntEquals(1296002393, obj.arithmeticSeries3(50));
    assertIntEquals(0, obj.arithmeticSeries4(50));
  }
}
