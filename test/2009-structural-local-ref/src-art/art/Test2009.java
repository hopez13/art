...
public class Test2009 {
  ...
  /**
   * base64 encoded class/dex file for package art; public class Transform { public Transform() { }
   * }
   */
  ...
  /**
   * base64 encoded class/dex file for package art; public static class Transform { public String
   * greeting; public static String static_greeting;
   *
   * <p>public Transform() { greeting = "Hello"; } public static String getGreetingStatic() {
   * static_greeting = "static-meth"; return static_greeting; } public String getGreeting() {
   * greeting = "meth"; return greeting; } }
   */
