...
public class Test912 {
  ...
  public static void doTest() throws Exception {
    ...
    try {
      System.out.println(TestForInitFail.placeholder);
  ...
  private static void testClassEvents() throws Exception {
    ...
    Thread placeholderThread = new Thread();
    placeholderThread.start();
  ...
  private static class TestForNonInit {
    public static double placeholder = Math.random();  // So it can't be compile-time initialized.
  }

  @SuppressWarnings("RandomCast")
  private static class TestForInitFail {
    public static int placeholder = ((int)Math.random())/0;  // So it throws when initializing.
  }
