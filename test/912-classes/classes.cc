...
extern "C" JNIEXPORT jboolean JNICALL Java_art_Test912_isModifiableClass(
    JNIEnv* env, jclass Main_klass [[maybe_unused]], jclass klass) {
...
extern "C" JNIEXPORT jobjectArray JNICALL Java_art_Test912_getClassLoaderClasses(
    JNIEnv* env, jclass Main_klass [[maybe_unused]], jobject jclassloader) {
  jint count = 0;
  jclass* classes = nullptr;
...
extern "C" JNIEXPORT void JNICALL Java_art_Test912_enableClassLoadPreparePrintEvents(
    JNIEnv* env, jclass Main_klass [[maybe_unused]], jboolean enable, jthread thread) {
  if (thread != nullptr) {
...
class ClassLoadPrepareEquality {
 public:
  ...
  static void AgentThreadTest(jvmtiEnv* jvmti [[maybe_unused]],
                              JNIEnv* env,
                              jobject* obj_global) {
...
extern "C" JNIEXPORT void JNICALL Java_art_Test912_enableClassLoadPrepareEqualityEvents(
    JNIEnv* env, jclass Main_klass [[maybe_unused]], jboolean b) {
  EnableEvents(env,
               b,
...
extern "C" JNIEXPORT void JNICALL Java_art_Test912_runRecursiveClassPrepareEvents(
    JNIEnv* env, jclass klass [[maybe_unused]], jobject runnable) {
  ...
  EnableEvents(
      ...
      true,
      nullptr,
      [](jvmtiEnv* jenv [[maybe_unused]],
         JNIEnv* jni_env,
         jthread thread [[maybe_unused]],
         jclass klass [[maybe_unused]]) -> void {
