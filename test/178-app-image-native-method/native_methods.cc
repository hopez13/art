...
extern "C" JNIEXPORT jint JNICALL Java_CriticalNativeClinitCheck_nativeMethodVoid() {
  return 42;
}

extern "C" JNIEXPORT jint JNICALL Java_CriticalNativeClinitCheck_nativeMethod(jint i) {
  return i;
}

extern "C" JNIEXPORT jint JNICALL Java_CriticalNativeClinitCheck_nativeMethodWithManyParameters(
    jint i1, jlong l1, jfloat f1, jdouble d1,
    jint i2, jlong l2, jfloat f2, jdouble d2,
    jint i3, jlong l3, jfloat f3, jdouble d3,
    jint i4, jlong l4, jfloat f4, jdouble d4,
