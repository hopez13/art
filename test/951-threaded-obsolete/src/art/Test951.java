...
public class Test951 {
    ...
    public static void run() {
        // Semaphores to let each thread know where the other is. We could use barriers but
        // semaphores mean we don't need to have the worker thread be waiting around.
