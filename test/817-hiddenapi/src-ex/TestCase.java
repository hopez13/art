...
public class TestCase {
  ...
  public static void testUnsupportedAppUsage() {
    // This call should be throws an exception as the only accessible method is unsupportedappusage.
    try {
  ...
  public static void testNative(String library) {
    ...
    // Test that we consistantly return we cannot access a hidden method.
  ...
  public static native boolean testAccessInternal(Class<?> cls, String methodName, String signature);
}
