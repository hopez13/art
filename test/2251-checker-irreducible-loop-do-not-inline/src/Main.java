...
public class Main {
    ...
    // `inner` has a Return -> TryBoundary -> Exit chain, which means that when we inline it we would
    // need to recompute the loop information.
