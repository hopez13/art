...
public class Main {
    public static void main(String[] args) {
        ...
        expectEquals(-73014444553L,
                $opt$TestAgressiveLive1(1L << 32, (1L << 32) + 1, 3L << 32, 4L << 32, 5L << 32,
                        6L << 32, (1L << 32) + 2));
        expectEquals(-124554051632L,
                $opt$TestAgressiveLive2(1L << 32, (1L << 32) + 1, 3L << 32, 4L << 32, 5L << 32,
                        6L << 32, 7L << 32));
    }
    ...
    public static long $opt$TestAgressiveLive1(
    ...
    public static long $opt$TestAgressiveLive2(
            long a, long b, long c, long d, long e, long f, long g) {
        long h = a - b;
        long i = c - d;
        long j = e - f;
