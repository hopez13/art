...
public class Test989 {
    ...
    static MethodTracer currentTracer = new MethodTracer() {
        public void methodEntry(Object o) {
            return;
        }
        public void methodExited(Object o, boolean e, Object r) {
            return;
        }
    };
    ...
    public static void baseNotifyMethodEntry(Object o) { currentTracer.methodEntry(o); }
    ...
    private static void setupTracing() throws Exception {
        Trace.enableMethodTracing(Test989.class,
    ...
    private static void doTest(MethodTracer type, MyRunnable test) throws Exception {
        ...
        try {
            ...
            maybeDisableTracing();
            if (expected == null) {
                System.out.println("Received no exception as expected for "
            ...
            if (expected == null) {
                throw new Error(
                        "Unexpected error occured: " + t + " for " + testDescription(type, test),
                        t);
            } else if (!expected.isInstance(t)) {
                throw new Error("Expected error of type " + expected + " not " + t + " for "
                                + testDescription(type, test),
                        t);
            } else {
                System.out.println(
    ...
    public static interface MyRunnable extends Runnable {
        public default Class<?> expectedThrow() { return null; }
    }
    ...
    public static float returnFloat() { return doGetFloat(); }

    public static double returnDouble() { return doGetDouble(); }

    // Throws an ErrorA.
    public static void throwA() { doThrowA(); }

    public static void doThrowA() { throw new ErrorA("Throwing Error A"); }

    static final class TestObject {
        private int idx;
        public TestObject(int v) { this.idx = v; }
        @Override
    ...
    public static Object mkTestObject() { return new TestObject(counter++); }

    public static void printObject(Object o) { System.out.println("Recieved " + o); }

    // Returns a newly allocated value.
    public static Object returnValue() { return mkTestObject(); }

    public static void acceptValue(Object o) { printObject(o); }

    public static float doGetFloat() { return 1.618f; }

    public static double doGetDouble() { return 3.14159628; }
