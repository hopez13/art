...
namespace art {
namespace Test1960ForceEarlyReturn {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupTest(JNIEnv* env, jclass klass ATTRIBUTE_UNUSED) {
  ...
  jvmtiEventCallbacks cb{
    ...
    .Breakpoint = cbBreakpointHit,
    .SingleStep = cbSingleStep,
    .FieldAccess = cbFieldAccess,
    .FieldModification = cbFieldModification,
    .MethodEntry = cbMethodEntry,
    .MethodExit = cbMethodExit,
    .Exception = cbException,
    .ExceptionCatch = cbExceptionCatch,
    .FramePop = cbFramePop,
    .ClassLoad = cbClassLoadOrPrepare,
    .ClassPrepare = cbClassLoadOrPrepare,
  };
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupSuspendClassEvent(JNIEnv* env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearSuspendClassEvent(JNIEnv* env,
                                                      jclass klass ATTRIBUTE_UNUSED,
                                                      jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupSuspendSingleStepAt(JNIEnv* env,
                                                        jclass klass ATTRIBUTE_UNUSED,
                                                        jobject meth,
                                                        jlocation loc,
                                                        jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearSuspendSingleStepFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupSuspendPopFrameEvent(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jint offset,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearSuspendPopFrameEvent(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupSuspendBreakpointFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jobject meth,
                                                         jlocation loc,
                                                         jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearSuspendBreakpointFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupSuspendExceptionEvent(JNIEnv* env,
                                                          jclass klass ATTRIBUTE_UNUSED,
                                                          jobject method,
                                                          jboolean is_catch,
                                                          jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearSuspendExceptionEvent(JNIEnv* env,
                                                          jclass klass ATTRIBUTE_UNUSED,
                                                          jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupSuspendMethodEvent(JNIEnv* env,
                                                       jclass klass ATTRIBUTE_UNUSED,
                                                       jobject method,
                                                       jboolean enter,
                                                       jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearSuspendMethodEvent(JNIEnv* env,
                                                       jclass klass ATTRIBUTE_UNUSED,
                                                       jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupFieldSuspendFor(JNIEnv* env,
                                                    jclass klass ATTRIBUTE_UNUSED,
                                                    jclass target_klass,
                                                    jobject field,
                                                    jboolean access,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearFieldSuspendFor(JNIEnv* env,
                                                    jclass klass ATTRIBUTE_UNUSED,
                                                    jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_setupWaitForNativeCall(JNIEnv* env,
                                                      jclass klass ATTRIBUTE_UNUSED,
                                                      jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_clearWaitForNativeCall(JNIEnv* env,
                                                      jclass klass ATTRIBUTE_UNUSED,
                                                      jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_waitForSuspendHit(JNIEnv* env,
                                                 jclass klass ATTRIBUTE_UNUSED,
                                                 jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_popFrame(JNIEnv* env,
                                        jclass klass ATTRIBUTE_UNUSED,
                                        jthread thr) {
...
extern "C" JNIEXPORT
jobject JNICALL Java_art_Test1960_00024NativeCalledObject_calledFunction(
  ...
  jclass int_container_klass = env->FindClass("art/Test1960$IntContainer");
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1960_00024NativeCallerObject_run(
    JNIEnv* env, jobject thiz) {
  env->PushLocalFrame(1);
  jclass klass = env->GetObjectClass(thiz);
...
extern "C" JNIEXPORT
jboolean JNICALL Java_art_Test1960_isClassLoaded(JNIEnv* env, jclass, jstring name) {
