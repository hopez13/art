public class Main {
    static void testI1(int p1) { System.out.println(p1); }
    static void testI2(int p1, int p2) { System.out.println(p1 + ", " + p2); }
    static void testI3(int p1, int p2, int p3) { System.out.println(p1 + ", " + p2 + ", " + p3); }
    ...
    static void testI11(int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9,
            int p10, int p11) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", "
                + p7 + ", " + p8 + ", " + p9 + ", " + p10 + ", " + p11);
    }
    static void testI12(int p1, int p2, int p3, int p4, int p5, int p6, int p7, int p8, int p9,
    ...
    static void testB1(boolean p1) { System.out.println(p1); }
    static void testB2(boolean p1, boolean p2) { System.out.println(p1 + ", " + p2); }
    ...
    static void testB7(
            boolean p1, boolean p2, boolean p3, boolean p4, boolean p5, boolean p6, boolean p7) {
        System.out.println(
                p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", " + p7);
    }

    static void testO1(Object p1) { System.out.println(p1); }
    static void testO2(Object p1, Object p2) { System.out.println(p1 + ", " + p2); }
    ...
    static void testIOB1(int p1) { System.out.println(p1); }
    static void testIOB2(int p1, Object p2) { System.out.println(p1 + ", " + p2); }
    ...
    static void testF1(float p1) { System.out.println(p1); }
    static void testF2(float p1, float p2) { System.out.println(p1 + ", " + p2); }
    ...
    static void testF8(
            float p1, float p2, float p3, float p4, float p5, float p6, float p7, float p8) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", "
                + p7 + ", " + p8);
    }
    static void testF9(float p1, float p2, float p3, float p4, float p5, float p6, float p7,
            float p8, float p9) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", "
                + p7 + ", " + p8 + ", " + p9);
    }
    static void testF10(float p1, float p2, float p3, float p4, float p5, float p6, float p7,
    ...
    static void testD3(double p1, double p2, double p3) {
        System.out.println(p1 + ", " + p2 + ", " + p3);
    }
    static void testD4(double p1, double p2, double p3, double p4) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4);
    }
    static void testD5(double p1, double p2, double p3, double p4, double p5) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5);
    }
    static void testD6(double p1, double p2, double p3, double p4, double p5, double p6) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6);
    }
    static void testD7(
    ...
    static void testD8(double p1, double p2, double p3, double p4, double p5, double p6, double p7,
            double p8) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", "
                + p7 + ", " + p8);
    }
    static void testD9(double p1, double p2, double p3, double p4, double p5, double p6, double p7,
            double p8, double p9) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", "
                + p7 + ", " + p8 + ", " + p9);
    }
    static void testD9f(float p0, double p1, double p2, double p3, double p4, double p5, double p6,
            double p7, double p8, double p9) {
        System.out.println(p0 + ", " + p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", "
                + p6 + ", " + p7 + ", " + p8 + ", " + p9);
    }
    static void testD10(double p1, double p2, double p3, double p4, double p5, double p6, double p7,
    ...
    //  static void testL2x(long p1, long p2) { testL2(p1+p2, p2); }  // TODO(64) GenAddLong
    //  64BIT_TEMP
    static void testL2(long p1, long p2) { System.out.println(p1 + ", " + p2); }
    static void testL3(long p1, long p2, long p3) {
        System.out.println(p1 + ", " + p2 + ", " + p3);
    }
    static void testL4(long p1, long p2, long p3, long p4) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4);
    }
    static void testL5(long p1, long p2, long p3, long p4, long p5) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5);
    }
    static void testL6(long p1, long p2, long p3, long p4, long p5, long p6) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6);
    }
    static void testL7(long p1, long p2, long p3, long p4, long p5, long p6, long p7) {
        System.out.println(
                p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", " + p7);
    }
    static void testL8(long p1, long p2, long p3, long p4, long p5, long p6, long p7, long p8) {
        System.out.println(p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", " + p6 + ", "
                + p7 + ", " + p8);
    }
    static void testL9(
    ...
    static void testL9i(int p0, long p1, long p2, long p3, long p4, long p5, long p6, long p7,
            long p8, long p9) {
        System.out.println(p0 + ", " + p1 + ", " + p2 + ", " + p3 + ", " + p4 + ", " + p5 + ", "
                + p6 + ", " + p7 + ", " + p8 + ", " + p9);
    }
    ...
    static void testMore(int i1, double d1, double d2, double d3, double d4, double d5, double d6,
            double d7, double d8, double d9, int i2, int i3, int i4, int i5, int i6) {
        System.out.println(i1 + ", " + d1 + ", " + d2 + ", " + d3 + ", " + d4 + ", " + d5 + ", "
                + d6 + ", " + d7 + ", " + d8 + ", " + d9 + ", " + i2 + ", " + i3 + ", " + i4 + ", "
                + i5 + ", " + i6);
    }

    static void testRefs1(
            Object o1, Object o2, Object o3, Object o4, Object o5, long l1, long l2, long l3) {
    ...
    static public void main(String[] args) throws Exception {
        ...
        testRefs(obj, obj, obj, obj, obj, 0x1122334455667788L, 0x8877665544332211L,
                0x1122334455667788L);
    }
}
