...
public class Main {
    public static void main(String[] args) {
        ...
        // Previously, with java.lang Void being compile-time verified but uninitialized,
        // we would try to initialize java.lang.Void here and the static initializer would
        // indirectly initialize TYPE with the current, i.e. zero-initialized, value of TYPE.
        // The only thing that could prevent the series of calls leading to this was a cache
        // hit in Class.getDexCacheType() which we have prevented by clearing the cache above.
        Class<?> void_class = void.class;
        System.out.println("void.class = " + void_class);
    }
