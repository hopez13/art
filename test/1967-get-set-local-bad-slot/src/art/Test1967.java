...
public class Test1967 {
  ...
  BadSet(final String type, final SetterFunction get, final Object v, final ToIntFunction<Integer> transform) {
  ...
  public static SafepointFunction
  BadGet(final String type, final GetterFunction get, final ToIntFunction<Integer> transform) {
    return new SafepointFunction() {
      public void invoke(Thread t, Method method, Locals.VariableDescription desc, int depth) {
        int real_slot = transform.applyAsInt(desc.slot);
        try {
  ...
  public static void run() throws Exception {
    ...
    final SafepointFunction[] SAFEPOINTS = new SafepointFunction[] {
      ...
      BadSet("Object_at_too_high", Locals::SetLocalVariableObject, "NEW_FOR_SET", (i) -> i + 100),
