...
public class Main {
    ...
    static byte $noinline$getByte() { return byteVal; }

    static short $noinline$getShort() { return shortVal; }

    static char $noinline$getChar() { return charVal; }

    static int $noinline$getInt() { return intVal; }
