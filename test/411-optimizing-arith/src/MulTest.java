...
public class MulTest {
    ...
    private static void mulDouble() {
        ...
        expectEquals(Double.NEGATIVE_INFINITY,
                $opt$Mul(Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY));
        expectEquals(Double.POSITIVE_INFINITY,
                $opt$Mul(Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY));
        expectEquals(Double.POSITIVE_INFINITY,
                $opt$Mul(Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY));
    }

    static int $opt$Mul(int a, int b) { return a * b; }

    static long $opt$Mul(long a, long b) { return a * b; }

    static float $opt$Mul(float a, float b) { return a * b; }

    static double $opt$Mul(double a, double b) { return a * b; }
}
