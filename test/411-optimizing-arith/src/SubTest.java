...
public class SubTest {
    ...
    private static void subFloat() {
        ...
        expectEquals(Float.POSITIVE_INFINITY,
                $opt$Sub(Float.POSITIVE_INFINITY, Float.NEGATIVE_INFINITY));
        expectEquals(Float.NEGATIVE_INFINITY,
                $opt$Sub(Float.NEGATIVE_INFINITY, Float.POSITIVE_INFINITY));
    }
    ...
    private static void subDouble() {
        ...
        expectEquals(Double.POSITIVE_INFINITY,
                $opt$Sub(Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY));
        expectEquals(Double.NEGATIVE_INFINITY,
                $opt$Sub(Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY));
    }

    static int $opt$Sub(int a, int b) { return a - b; }

    static long $opt$Sub(long a, long b) { return a - b; }

    static float $opt$Sub(float a, float b) { return a - b; }

    static double $opt$Sub(double a, double b) { return a - b; }
}
