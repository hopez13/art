...
public class DivTest {
    ...
    static int $opt$Div(int a, int b) { return a / b; }

    static int $opt$DivZero(int a) { return a / 0; }

    // Division by literals != 0 should not generate checks.
    static int $opt$DivConst(int a) { return a / 3; }

    static long $opt$DivConst(long a) { return a / 3L; }

    static long $opt$Div(long a, long b) { return a / b; }

    static long $opt$DivZero(long a) { return a / 0L; }

    static float $opt$Div(float a, float b) { return a / b; }

    static double $opt$Div(double a, double b) { return a / b; }
}
