...
public class RemTest {
    ...
    static int $opt$Rem(int a, int b) { return a % b; }

    static int $opt$RemZero(int a) { return a % 0; }
    ...
    static int $opt$RemConst(int a) { return a % 4; }

    static long $opt$RemConst(long a) { return a % 4L; }

    static long $opt$Rem(long a, long b) { return a % b; }

    static long $opt$RemZero(long a) { return a % 0L; }
