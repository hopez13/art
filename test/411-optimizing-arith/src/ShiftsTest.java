...
public class ShiftsTest {
    ...
    static int $opt$ShlInt(int value, int distance) { return value << distance; }

    static long $opt$ShlLong(long value, int distance) { return value << distance; }

    static int $opt$ShrInt(int value, int distance) { return value >> distance; }

    static long $opt$ShrLong(long value, int distance) { return value >> distance; }

    static int $opt$UShrInt(int value, int distance) { return value >>> distance; }

    static long $opt$UShrLong(long value, int distance) { return value >>> distance; }

    static int $opt$ShlIntConst2(int value) { return value << 2; }

    static long $opt$ShlLongConst2(long value) { return value << 2; }

    static int $opt$ShrIntConst2(int value) { return value >> 2; }

    static long $opt$ShrLongConst2(long value) { return value >> 2; }

    static int $opt$UShrIntConst2(int value) { return value >>> 2; }

    static long $opt$UShrLongConst2(long value) { return value >>> 2; }

    static int $opt$ShlIntConst0(int value) { return value << 0; }

    static long $opt$ShlLongConst0(long value) { return value << 0; }

    static int $opt$ShrIntConst0(int value) { return value >> 0; }

    static long $opt$ShrLongConst0(long value) { return value >> 0; }

    static int $opt$UShrIntConst0(int value) { return value >>> 0; }

    static long $opt$UShrLongConst0(long value) { return value >>> 0; }

    static long $opt$ShlLongConst1(long value) { return value << 1; }

    static long $opt$ShlLongConst32(long value) { return value << 32; }

    static long $opt$ShlLongConst33(long value) { return value << 33; }

    static long $opt$ShlLongConst34(long value) { return value << 34; }

    static long $opt$ShlLongConst35(long value) { return value << 35; }
}
