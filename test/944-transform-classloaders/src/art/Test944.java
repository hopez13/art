...
public class Test944 {
    ...
    private static void checkDexFileInClassLoader(Class<?> klass) throws Exception {
        ...
        //   if (arrayContains(curCookie, dexFilePtr) || arrayContains(curInternalCookie,
        //   dexFilePtr)) {
        //     return;
        //   }
        // }
        ...
        AccessibleObject.setAccessible(
                new AccessibleObject[] {pathListField, elementArrayField, dexFileField,
                        dexFileCookieField, dexFileInternalCookieField},
                true);
        ...
        if (!elementArrayValue.getClass().isArray()
            ...
            throw new Exception(
                    "elementArrayValue is not an " + dexPathListElementClass + " array!");
        }
        // int array_length = elementArrayValue.length;
        ...
        for (int i = 0; i < array_length; i++) {
            ...
            if (arrayContains(curCookie, dexFilePtr)
                    || arrayContains(curInternalCookie, dexFilePtr)) {
                return;
            }
        }
        throw new Exception(
    ...
    // DexFile a class is loaded from. This is plucked out of the internal DexCache object
