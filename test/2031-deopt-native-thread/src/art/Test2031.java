...
public class Test2031 {
  ...
  public static void run(String testdir) throws Exception {
    simulateZygoteFork();
    final MyClass myObject = new MyClass();
    startTest(testdir, myObject);
    System.out.println("What is my object? " + myObject);
  }
  public static void startTest(String testdir, final MyClass myObject) throws Exception {
