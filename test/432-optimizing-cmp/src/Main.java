...
public class Main {
    ...
    static boolean $opt$eq(float a, float b) { return a == b; }

    static boolean $opt$eq(double a, double b) { return a == b; }

    static boolean $opt$lt(long a, long b) { return a < b; }

    static boolean $opt$lt(float a, float b) { return a < b; }

    static boolean $opt$lt(double a, double b) { return a < b; }

    static boolean $opt$gt(long a, long b) { return a > b; }

    static boolean $opt$gt(float a, float b) { return a > b; }

    static boolean $opt$gt(double a, double b) { return a > b; }
