...
public class TestCharShort {
  ...
  /// CHECK-START-{ARM64}: int other.TestCharShort.testDotProdParamSigned(short[], short[], int) loop_optimization (after)
  /// CHECK-DAG:                  VecDotProd type:Int16
  ...
  /// CHECK-START-{ARM64}: int other.TestCharShort.testDotProdParamUnsigned(char[], char[], int) loop_optimization (after)
  ...
  /// CHECK-START: int other.TestCharShort.testDotProdIntParam(short[], short[], int) loop_optimization (after)
