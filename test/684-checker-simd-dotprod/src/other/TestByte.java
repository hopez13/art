...
public class TestByte {
  ...
  /// CHECK-START-{ARM64}: int other.TestByte.testDotProdParamSigned(byte[], byte[], int) loop_optimization (after)
  /// CHECK-DAG:                  VecDotProd type:Int8
  ...
  /// CHECK-START-{ARM64}: int other.TestByte.testDotProdParamUnsigned(byte[], byte[], int) loop_optimization (after)
  ...
  /// CHECK-START: int other.TestByte.testDotProdIntParam(byte[], byte[], int) loop_optimization (after)
