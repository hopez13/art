...
public class Test1939 {
    ...
    public static String SafeToString(Object o) {
        if (o instanceof Method && Proxy.isProxyClass(((Method) o).getDeclaringClass())) {
            // TODO This currently only really works on ART. It would be good if we could make it
            // work for the RI as well.
    ...
    public static Object getProxyObject(final Class... k) {
        return Proxy.newProxyInstance(Test1939.class.getClassLoader(), k, (p, m, a) -> {
