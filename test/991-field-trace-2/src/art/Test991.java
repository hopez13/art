...
public class Test991 {
    ...
    static abstract class FieldTracer {
        public final void notifyFieldAccess(
            ...
            System.out.println("\tACCESS of " + f + " on object of"
                    + " type: " + (target == null ? null : target.getClass()) + " in method "
                    + method);
            handleFieldAccess(method, location, f_klass, target, f);
        }

        public final void notifyFieldModify(Executable method, long location, Class<?> f_klass,
                Object target, Field f, Object value) {
            System.out.println("FieldTracer: " + this.getClass());
            System.out.println("\tMODIFY of " + f + " on object of"
                    + " type: " + (target == null ? null : target.getClass()) + " in method "
                    + method + ". New value: " + value + " (type: " + value.getClass() + ")");
        ...
        public void handleFieldModify(
                Executable m, long l, Class<?> fk, Object t, Field f, Object v) {}
    }
    ...
    static class ModifyDuringReadAndWriteFieldTracer extends FieldTracer {
        ...
        public void handleFieldModify(
                Executable m, long l, Class<?> fk, Object t, Field f, Object v) {
            // NB This is only safe because the agent doesn't send recursive access/modification
            // events up to the java layer here.
    ...
    public static class TestClass1 {
        public int xyz;
        public TestClass1(int xyz) { this.xyz = xyz; }
    }
    ...
    public static class NativeReadWrite implements Consumer<TestClass1> {
        public void accept(TestClass1 t1) { doNativeReadWrite(t1); }
    }
    ...
    public static void run() throws Exception {
        ...
        Trace.enableFieldTracing(Test991.class,
                Test991.class.getDeclaredMethod("notifyFieldAccess", Executable.class, Long.TYPE,
                        Class.class, Object.class, Field.class),
                Test991.class.getDeclaredMethod("notifyFieldModify", Executable.class, Long.TYPE,
                        Class.class, Object.class, Field.class, Object.class),
