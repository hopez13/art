...
public class Main {
    ...
    static void invokeStaticInlined() { ClassWithClinit1.$opt$inline$StaticMethod(); }

    static class ClassWithClinit1 {
        static { System.out.println("Main$ClassWithClinit1's static initializer"); }
    ...
    static void invokeStaticNotInlined() { ClassWithClinit2.$noinline$staticMethod(); }

    static class ClassWithClinit2 {
        static { System.out.println("Main$ClassWithClinit2's static initializer"); }
    ...
    static class ClassWithClinit3Static {
        ...
        static { System.out.println("Main$ClassWithClinit3Static's static initializer"); }
    ...
    static class ClassWithClinit3Instance {
        ...
        static { System.out.println("Main$ClassWithClinit3Instance's static initializer"); }
    ...
    static class ClassWithClinit4Static {
        ...
        static { System.out.println("Main$ClassWithClinit4Static's static initializer"); }
    ...
    static class ClassWithClinit4Instance {
        ...
        static { System.out.println("Main$ClassWithClinit4Instance's static initializer"); }
    ...
    static class ClassWithClinit5 {
        ...
        static { System.out.println("Main$ClassWithClinit5's static initializer"); }
    }

    static class SubClassOfClassWithClinit5 extends ClassWithClinit5 {
        static void invokeStaticInlined() { ClassWithClinit5.$opt$inline$StaticMethod(); }
    }
    ...
    static class SubClassOfClassWithoutClinit5 extends ClassWithoutClinit5 {
        static { System.out.println("Main$SubClassOfClassWithoutClinit5's static initializer"); }

        static void invokeStaticInlined() { ClassWithoutClinit5.$opt$inline$StaticMethod(); }
    }
    ...
    static class ClassWithClinit6 {
        ...
        static { System.out.println("Main$ClassWithClinit6's static initializer"); }
    }

    static class SubClassOfClassWithClinit6 extends ClassWithClinit6 {
        static void invokeStaticNotInlined() { ClassWithClinit6.$noinline$staticMethod(); }
    }
    ...
    static class SubClassOfClassWithoutClinit6 extends ClassWithoutClinit6 {
        static { System.out.println("Main$SubClassOfClassWithoutClinit6's static initializer"); }

        static void invokeStaticNotInlined() { ClassWithoutClinit6.$noinline$staticMethod(); }
    }
    ...
    static class ClassWithClinit7 {
        static { System.out.println("Main$ClassWithClinit7's static initializer"); }

        static void $noinline$someStaticMethod(Iterable<?> it) { it.iterator(); }
    }
    ...
    static class ClassWithClinit8 {
        ...
        static { System.out.println("Main$ClassWithClinit8's static initializer"); }
    ...
    static class ClassWithClinit9 {
        public static int value = 0;
        static { System.out.println("Main$ClassWithClinit9's static initializer"); }
    ...
    static class ClassWithClinit10 {
        public static int value = 0;
        static { System.out.println("Main$ClassWithClinit10's static initializer"); }
    ...
    static class ClassWithClinit11 {
        public static int value = 0;
        static { System.out.println("Main$ClassWithClinit11's static initializer"); }

        static void callInlinedForNull(Iterable<?> it) { inlinedForNull(it); }
    ...
    static class ClassWithClinit12 {
        public static int value = 0;
        static { System.out.println("Main$ClassWithClinit12's static initializer"); }
    ...
    static class ClassWithClinit13 {
        static { System.out.println("Main$ClassWithClinit13's static initializer"); }

        public static void $inline$forwardToGetIterator(Iterable<?> it) {
            $noinline$getIterator(it);
        }

        public static void $noinline$getIterator(Iterable<?> it) { it.iterator(); }
    }
