...
public class Main {
    ...
    private static void testOatFilesUnloaded(Constructor<?> constructor, int pid) throws Exception {
        ...
        String line;
        int count = 0;
        // Stop the JIT to ensure its threads and work queue are keeping classes artifically alive.
        ...
        // GC again to ensure the library loaded for restarting the JIT gets unloaded.
        Runtime.getRuntime().gc();
        System.runFinalization();
    }
