...
public class Main {
    ...
    static class MyThread extends Thread {
        public void run() {
            // This will throw at `callMethodThatThrows` and trigger deoptimization checks which we
            // used to crash on.
            new Inner();
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        t.setUncaughtExceptionHandler((th, e) -> { System.out.println("Caught exception"); });
        t.start();
        t.join();
    }
