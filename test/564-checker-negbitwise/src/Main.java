...
public class Main {
    ...
    public static int $opt$noinline$notAnd(int base, int mask) { return base & ~mask; }
    ...
    public static long $opt$noinline$notOr(long base, long mask) { return base | ~mask; }
    ...
    public static int $opt$noinline$notXor(int base, int mask) { return base ^ ~mask; }
    ...
    public static int $opt$noinline$notAndConstant(int mask) { return 0xf & ~mask; }
    ...
    public static int $opt$noinline$deMorganOr(int a, int b) { return ~a | ~b; }
