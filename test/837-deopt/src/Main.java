...
class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (isDebuggable()) {
            // We do not deoptimize with inline caches when the app is debuggable, so just don't run
            // the test.
            return;
        }
        test1();
    ...
    public String returnValue() { return "Main"; }
...
class SubMain extends Main {
    public String returnValue() { return "SubMain"; }
}
