...
public class Main {
    ...
    static void $opt$noinline$testNeg(int a) {
        assertIntEquals(
                -$noinline$IntShl(a, 8) | -$noinline$intToShort(a), (-(a << 8)) | (-(short) a));
    }
    ...
    public static void $opt$validateExtendCharInt2(int a, char b) {
        ...
        // There is an environment use for `(long)b` and the implicit `(long)a`, preventing the
        // merge.
    ...
    static int $noinline$IntShl(int b, int c) { return b << c; }
    static int $noinline$IntShr(int b, int c) { return b >> c; }
    static int $noinline$IntUshr(int b, int c) { return b >>> c; }
    ...
    static long $noinline$LongShl(long b, long c) { return b << c; }
    static long $noinline$LongShr(long b, long c) { return b >> c; }
    static long $noinline$LongUshr(long b, long c) { return b >>> c; }
    ...
    public static void main(String[] args) {
        ...
        long inputs[] = {-((1L << 7) - 1L), -((1L << 7)), -((1L << 7) + 1L), -((1L << 15) - 1L),
                -((1L << 15)), -((1L << 15) + 1L), -((1L << 16) - 1L), -((1L << 16)),
                -((1L << 16) + 1L), -((1L << 31) - 1L), -((1L << 31)), -((1L << 31) + 1L),
                -((1L << 32) - 1L), -((1L << 32)), -((1L << 32) + 1L), -((1L << 63) - 1L),
                -((1L << 63)), -((1L << 63) + 1L), -42L, -314L, -2718281828L, -0x123456789L,
                -0x987654321L, -1L, -20L, -300L, -4000L, -50000L, -600000L, -7000000L, -80000000L,
                0L, 1L, 20L, 300L, 4000L, 50000L, 600000L, 7000000L, 80000000L, 42L, 314L,
                2718281828L, 0x123456789L, 0x987654321L, (1L << 7) - 1L, (1L << 7), (1L << 7) + 1L,
                (1L << 8) - 1L, (1L << 8), (1L << 8) + 1L, (1L << 15) - 1L, (1L << 15),
                (1L << 15) + 1L, (1L << 16) - 1L, (1L << 16), (1L << 16) + 1L, (1L << 31) - 1L,
                (1L << 31), (1L << 31) + 1L, (1L << 32) - 1L, (1L << 32), (1L << 32) + 1L,
                (1L << 63) - 1L, (1L << 63), (1L << 63) + 1L, Long.MIN_VALUE, Long.MAX_VALUE};
