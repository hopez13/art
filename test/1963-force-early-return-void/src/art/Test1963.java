...
public class Test1963 {
    ...
    for (StackTraceElement e : st) {
      os.println(
          prefix
              ...
              + ")");
      if (e.getClassName().equals("art.Test1963") && e.getMethodName().equals("runTests")) {
  ...
  public Thread mkThread(Runnable r) {
    Thread t = new Thread(r, "Test1963 target thread - " + THREAD_COUNT++);
  ...
  public static class ClassLoadObject implements Runnable {
    ...
    public static final String[] CLASS_NAMES =
        new String[] {
          "Lart/Test1963$ClassLoadObject$TC0;",
          "Lart/Test1963$ClassLoadObject$TC1;",
          "Lart/Test1963$ClassLoadObject$TC2;",
          "Lart/Test1963$ClassLoadObject$TC3;",
          "Lart/Test1963$ClassLoadObject$TC4;",
          "Lart/Test1963$ClassLoadObject$TC5;",
          "Lart/Test1963$ClassLoadObject$TC6;",
          "Lart/Test1963$ClassLoadObject$TC7;",
          "Lart/Test1963$ClassLoadObject$TC8;",
          "Lart/Test1963$ClassLoadObject$TC9;",
        };
  ...
  //   public int cnt = 0;
  //   // TODO Test we can force-early-return from <init> method.
  ...
  public static class StaticMethodObject implements Runnable {
    public int cnt = 0;
  ...
  public static void run(boolean canRunClassLoadTests) throws Exception {
    new Test1963((x) -> {}, canRunClassLoadTests).runTests();
  }

  // Only used by CTS to run without class-load tests.
  public static void run() throws Exception {
    new Test1963((x) -> {}, false).runTests();
  }

  public Test1963(Consumer<Runnable> preTest, boolean canRunClassLoadTests) {
    this.canRunClassLoadTests = canRunClassLoadTests;
    this.preTest = preTest;
  }

  private Consumer<Runnable> preTest;
  ...
  public boolean CanRunClassLoadingTests() {
    ...
    classesPreverified = !isClassLoaded("Lart/Test1963$RCLT1;");
