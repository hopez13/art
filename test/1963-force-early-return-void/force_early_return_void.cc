...
namespace art {
namespace Test1963ForceEarlyReturnVoid {

extern "C" JNIEXPORT
void JNICALL Java_art_Test1963_00024NativeCalledObject_calledFunction(
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1963_00024NativeCallerObject_run(
    JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT
jboolean JNICALL Java_art_Test1963_isClassLoaded(JNIEnv* env, jclass, jstring name) {
