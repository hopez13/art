...
class MyClassNatives {
    ...
    // Normal native
    static native int fooSI(int x);
    // Normal native
    static native int fooSB(byte x);
    // Normal native
    static native int fooSC(char x);
    // Normal native
    static native int fooSS(short x);
    // Normal native
    static native int fooSZ(boolean x);
    // Normal native
    static native int fooSL(Object x);
    // Normal native
    ...
    // Normal native
    static native int fooS7FI(float f1, float f2, float f3, float f4, float f5, float f6, float f7,
        int i1);
    // Normal native
    static native int fooS3F5DI(float f1, float f2, float f3, double d1, double d2, double d3,
        double d4, double d5, int i1);
    // Normal native
    static native int fooS3F6DI(float f1, float f2, float f3, double d1, double d2, double d3,
    ...
    @FastNative
    native int foo3F5D_Fast(float f1, float f2, float f3, double d1, double d2, double d3, double d4,
        double d5);
    @FastNative
    native int foo3F6D_Fast(float f1, float f2, float f3, double d1, double d2, double d3, double d4,
        double d5, double d6);
    @FastNative
    ...
    static native int foo7F_Critical(float f1, float f2, float f3, float f4, float f5, float f6,
        float f7);
    @CriticalNative
    static native int foo3F5D_Critical(float f1, float f2, float f3, double d1, double d2, double d3,
        double d4, double d5);
    @CriticalNative
    static native int foo3F6D_Critical(float f1, float f2, float f3, double d1, double d2, double d3,
