...
extern "C" JNIEXPORT
jstring JNICALL Java_art_Test1957_getLastError(JNIEnv* env, jclass klass [[maybe_unused]]) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1957_clearLastError(JNIEnv* env, jclass klass [[maybe_unused]]) {
