...
public class Test1911 {
    ...
    public static Set<Locals.VariableDescription>[] CONSTRUCTOR_VARIABLES = new Set[] {
            ...
            new HashSet<>(Arrays.asList(new Locals.VariableDescription(8, 6, "q", "I", null, 2),
    ...
    public static Set<Locals.VariableDescription>[] DO_SOMETHING_VARIABLES = new Set[] {
            // RI Local variable table
            new HashSet<>(Arrays.asList(new Locals.VariableDescription(0, 130, "x", "I", null, 1),
                    ...
                    new Locals.VariableDescription(85, 45, "i", "Ljava/util/ArrayList;",
                            "Ljava/util/ArrayList<Ljava/lang/Integer;>;", 4))),
            // ART Local variable table
            new HashSet<>(Arrays.asList(new Locals.VariableDescription(19, 31, "q", "F", null, 6),
                    ...
                    new Locals.VariableDescription(60, 32, "i", "Ljava/util/ArrayList;",
                            "Ljava/util/ArrayList<Ljava/lang/Integer;>;", 2))),
    };
    ...
    public static void CheckLocalVariableTable(
            Executable m, Set<Locals.VariableDescription>[] possible_vars) {
    ...
    public static void run() throws Exception {
        ...
        CheckLocalVariableTable(target.getDeclaredConstructor(Integer.TYPE), CONSTRUCTOR_VARIABLES);
        CheckLocalVariableTable(target.getDeclaredMethod("doNothing", (new Object[0]).getClass()),
                DO_NOTHING_VARIABLES);
        CheckLocalVariableTable(
                target.getDeclaredMethod("doSomething", Integer.TYPE), DO_SOMETHING_VARIABLES);
    }
}
