...
public class AnnotationTest extends AnnotationTestHelpers {
    public static void testAnnotationsByType() {
        ...
        //    In particular it's the order of #getDeclaredAnnotations which is completely
        //    unmentioned. The only requirement for #getAnnotationsByType is to have same ordering
        //    as #getDeclaredAnnotations. (Calendars[] itself has to maintain value() order).
        printAnnotationsByType(
                Calendar.class, UserComplex.class); // Cs(C,C),C collapses into C,C,C.
    ...
    // "annotationUseClass."
    private static <A extends Annotation> void printAnnotationsByType(
        ...
        String msg = "Annotations by type, defined by class " + annotationUseClass.getName()
    ...
    private static <A extends Annotation> void printDeclaredAnnotation(
        ...
        System.out.println("Declared annotations by class " + annotationUseClass + ", annotation "
                + annotationDefClass + ": " + msg);
    }
    ...
    private static <A extends Annotation> void printDeclaredAnnotationsByType(
        ...
        String msg = "Declared annnotations by type, defined by class "
    ...
    private static <A extends Annotation> void printMethodAnnotationsByType(
        ...
        String msg = "Annotations by type, defined by method " + m.getName() + " with annotation "
                + annotationClass.getName() + ": " + asString(annotationsByType);
    ...
    private static <A extends Annotation> void printMethodDeclaredAnnotation(
            Class<A> annotationClass, String methodName, Class<?> annotationUseClass) {
        Method m = null;
        try {
            m = annotationUseClass.getDeclaredMethod(methodName);
    ...
    public static void testMethodDeclaredAnnotationsByType() {
        ...
        printMethodDeclaredAnnotationByType(
                Calendar.class, "singleUser", AnnotationTestFixture.class);
        printMethodDeclaredAnnotationByType(
                Calendars.class, "singleUser", AnnotationTestFixture.class);
        ...
        printMethodDeclaredAnnotationByType(
                Calendar.class, "userComplex", AnnotationTestFixture.class);
        printMethodDeclaredAnnotationByType(
                Calendars.class, "userComplex", AnnotationTestFixture.class);
