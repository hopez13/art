...
public class Main {
    public static class A {
        ...
        public void foo() { System.out.println("foo_A"); }

        public static final Lookup lookup = MethodHandles.lookup();
    }

    public static class B extends A {
        public void foo() { System.out.println("foo_B"); }
    ...
    public static class D {
        private final void privateRyan() { System.out.println("privateRyan_D"); }
    ...
    private interface F {
        public default void sayHi() { System.out.println("F.sayHi()"); }
    }

    public static class G implements F {
        public void sayHi() { System.out.println("G.sayHi()"); }
        public MethodHandles.Lookup getLookup() { return MethodHandles.lookup(); }
    }

    public static class H implements Chatty {
        public void chatter() { System.out.println("H.chatter()"); }
        public MethodHandles.Lookup getLookup() { return MethodHandles.lookup(); }
    }
    ...
    public static void testfindSpecial_invokeSuperBehaviour() throws Throwable {
        ...
        try {
            C.lookup.findSpecial(
                    A.class, "foo", MethodType.methodType(void.class), D.class /* specialCaller */);
        ...
        try {
            B.lookup.findSpecial(A.class /* refC */, "foo", MethodType.methodType(int.class),
                    B.class /* specialCaller */);
            fail();
        } catch (NoSuchMethodException e) {
        }
        // Check constructors
        try {
            B.lookup.findSpecial(A.class /* refC */, "<init>", MethodType.methodType(void.class),
                    B.class /* specialCaller */);
            fail();
        } catch (NoSuchMethodException e) {
        }
    ...
    public static void testfindSpecial_invokeDirectBehaviour() throws Throwable {
        ...
        // itself...
        try {
            D.lookup.findSpecial(
                    D.class, "privateRyan", MethodType.methodType(void.class), C.class);
        ...
        try {
            E.lookup.findSpecial(
                    D.class, "privateRyan", MethodType.methodType(void.class), E.class);
    ...
    public static class BarSuper extends BarAbstractSuper {
        public String superPublicMethod() { return "superPublicMethod"; }

        protected String superProtectedMethod() { return "superProtectedMethod"; }

        public String abstractSuperPublicMethod() { return "abstractSuperPublicMethod"; }

        String superPackageMethod() { return "superPackageMethod"; }
    }
    ...
    public static class BarImpl extends BarSuper implements Bar {
        ...
        public String add(int x, int y) { return Arrays.toString(new int[] {x, y}); }
    ...
    public static void testfindVirtual() throws Throwable {
        ...
        mh = MethodHandles.lookup().findVirtual(
                BarImpl.class, "foo", MethodType.methodType(String.class));
        ...
        try {
            mh = MethodHandles.lookup().findVirtual(
                    BarImpl.class, "foo", MethodType.methodType(void.class));
            fail();
        } catch (NoSuchMethodException e) {
        }
        ...
        try {
            mh = MethodHandles.lookup().findVirtual(BarImpl.class, "add",
        ...
        mh = MethodHandles.lookup().findVirtual(
                BarImpl.class, "bar", MethodType.methodType(String.class));
        str = (String) mh.invoke(new BarImpl());
        if (!"bar".equals(str)) {
        ...
        mh = MethodHandles.lookup().findVirtual(
                Bar.class, "bar", MethodType.methodType(String.class));
        str = (String) mh.invoke(new BarImpl());
        if (!"bar".equals(str)) {
            System.out.println("Unexpected return value for BarImpl#bar: " + str);
        }
        ...
        if (!"abstractSuperPublicMethod".equals(str)) {
            System.out.println(
                    "Unexpected return value for BarImpl#abstractSuperPublicMethod: " + str);
        }

        // We should also be able to lookup public / protected / package methods in
        // the super class, given sufficient access privileges.
        mh = MethodHandles.lookup().findVirtual(
                BarImpl.class, "superPublicMethod", MethodType.methodType(String.class));
        str = (String) mh.invoke(new BarImpl());
        ...
        mh = MethodHandles.lookup().findVirtual(
                BarImpl.class, "superProtectedMethod", MethodType.methodType(String.class));
        str = (String) mh.invoke(new BarImpl());
        ...
        mh = MethodHandles.lookup().findVirtual(
                BarImpl.class, "superPackageMethod", MethodType.methodType(String.class));
        str = (String) mh.invoke(new BarImpl());
        ...
        try {
            MethodHandles.lookup().findVirtual(
                    BarImpl.class, "<init>", MethodType.methodType(void.class));
            fail();
        } catch (NoSuchMethodException e) {
        }
    }
    ...
    public static void testfindStatic() throws Throwable {
        ...
        try {
            MethodHandles.lookup().findStatic(
                    BarImpl.class, "staticMethod", MethodType.methodType(void.class));
            fail();
        } catch (NoSuchMethodException e) {
        }
        try {
            MethodHandles.lookup().findStatic(
                    BarImpl.class, "staticMethod", MethodType.methodType(String.class, int.class));
            fail();
        } catch (NoSuchMethodException e) {
        }
        try {
            MethodHandles.lookup().findStatic(
                    BarImpl.class, "<clinit>", MethodType.methodType(void.class));
            fail();
        } catch (NoSuchMethodException e) {
        }
        try {
    ...
    static class UnreflectTester {
        ...
        // different signature.
        public UnreflectTester(String val, boolean unused) { this(val); }

        private static String privateStaticMethod() { return "privateStaticMethod"; }
        ...
        public String publicVarArgsMethod(String... args) { return "publicVarArgsMethod"; }
    }
    ...
    public static void testUnreflects() throws Throwable {
        ...
        Constructor publicConstructor =
                UnreflectTester.class.getConstructor(String.class, boolean.class);
    ...
    public static CharSequence getSequence() { return "foo"; }
    ...
    public static void testAsType() throws Throwable {
        ...
        MethodHandle asType =
                mh.asType(MethodType.methodType(Object.class, CharSequence.class, String.class));
        ...
        MethodHandle voidMH = MethodHandles.lookup().findStatic(
                I.class, "someVoidMethod", MethodType.methodType(void.class));
        {
        ...
        {
            MethodHandle valueOfMH = MethodHandles.lookup().findStatic(
                    Integer.class, "valueOf", MethodType.methodType(Integer.class, int.class));
        ...
        {
            MethodHandle valueOfMH = MethodHandles.lookup().findStatic(
                    Double.class, "valueOf", MethodType.methodType(Double.class, double.class));
    ...
    public static void testConstructors() throws Throwable {
        MethodHandle mh = MethodHandles.lookup().findConstructor(
                Float.class, MethodType.methodType(void.class, float.class));
        ...
        mh = MethodHandles.lookup().findConstructor(
                Double.class, MethodType.methodType(void.class, String.class));
        ...
        mh = MethodHandles.lookup().findConstructor(
                Double.class, MethodType.methodType(void.class, double.class));
        ...
        try {
            mh = MethodHandles.lookup().findConstructor(
                    int.class, MethodType.methodType(void.class));
        ...
        try {
            mh = MethodHandles.lookup().findConstructor(
                    Readable.class, MethodType.methodType(void.class));
        ...
        // Abstract
        mh = MethodHandles.lookup().findConstructor(
                Process.class, MethodType.methodType(void.class));
        try {
            mh.invoke();
        ...
        // Child class constructor (b/143343351)
        {
            ...
            AbstractList list =
                    (AbstractList) handle.asType(MethodType.methodType(AbstractList.class))
                            .invokeExact();
        }
    }
    ...
    public static void testStringConstructors() throws Throwable {
        ...
        // String(char[], int, int)
        mh = MethodHandles.lookup().findConstructor(String.class,
                MethodType.methodType(void.class, char[].class, int.class, int.class));
        ...
        mh = MethodHandles.lookup().findConstructor(String.class,
                MethodType.methodType(
                        void.class, byte[].class, int.class, int.class, String.class));
        ...
        mh = MethodHandles.lookup().findConstructor(String.class,
                MethodType.methodType(
                        void.class, byte[].class, int.class, int.class, Charset.class));
        ...
        mh = MethodHandles.lookup().findConstructor(
                String.class, MethodType.methodType(void.class, byte[].class, String.class));
    ...
    private static void testReturnValues() throws Throwable {
        ...
        // double
        MethodHandle mhSin = lookup.findStatic(
        ...
        // float
        MethodHandle mhAbsFloat = lookup.findStatic(
        ...
        // long
        MethodHandle mhMaxLong = lookup.findStatic(
                Math.class, "max", MethodType.methodType(long.class, long.class, long.class));
        assertEquals(
        ...
        // ref
        MethodHandle mhShortValueOf = lookup.findStatic(
        ...
        MethodHandle mhCopyOf = lookup.findStatic(
        ...
        // boolean
        MethodHandle mhBooleanValue = lookup.findVirtual(
    ...
    private static void testPrimitiveReturnValueConversions() throws Throwable {
        ...
        mh = MethodHandles.lookup().findStatic(
                System.class, "gc", MethodType.methodType(void.class));
        ...
        // boolean -> Boolean
        mh = MethodHandles.lookup().findStatic(
                Boolean.class, "parseBoolean", MethodType.methodType(boolean.class, String.class));
        ...
        // Boolean -> boolean
        mh = MethodHandles.lookup().findStatic(
                Boolean.class, "valueOf", MethodType.methodType(Boolean.class, boolean.class));
    ...
    public static class VariableArityTester extends BaseVariableArityTester {
        ...
        @Override
        public String update(Float f0, Float... floats) {
            return lastResult = tally(f0, floats);
        }
        public String update(String s0, String... strings) {
            return lastResult = tally(s0, strings);
        }
        ...
        public String arrayMethod(Object[] o) { return Arrays.deepToString(o); }
    ...
    // This method only exists to fool Jack's handling of types. See b/32536744.
    public static Object getAsObject(String[] strings) { return (Object) strings; }
    ...
    public static void testVariableArity() throws Throwable {
        ...
        assertEquals(
                "[false, true]", mh.invoke(vat, Boolean.valueOf(false), Boolean.valueOf(true)));
        try {
        ...
        assertEquals(
                "[0.0, -1.0, 1.0, 0.0]", mh.invoke(vat, new float[] {0.0f, -1.0f, 1.0f, 0.0f}));
        ...
        assertEquals("[0.0, -1.0, 1.0, 0.0]", mh.invoke(vat, new double[] {0.0, -1.0, 1.0, 0.0}));
        ...
        assertEquals("Bongo, [Jerboa, Okapi]", mh.invoke(vat, "Bongo", "Jerboa", "Okapi"));
        ...
        assertEquals("9.99, [0.0, 0.1, 1.1]",
                (String) mh.invoke(vat, Float.valueOf(9.99f),
                        new Float[] {
                                Float.valueOf(0.0f), Float.valueOf(0.1f), Float.valueOf(1.1f)}));
        assertEquals("9.99, [0.0, 0.1, 1.1]",
        ...
        assertEquals("9.99, [0.0, null, 1.1]",
                (String) mh.invokeExact(vat, Float.valueOf(9.99f),
                        new Float[] {Float.valueOf(0.0f), null, Float.valueOf(1.1f)}));
        try {
            assertEquals("9.99, [0.0, 0.1, 1.1]",
        ...
        assertEquals(
                "x, [null, 3.131, 37]", (String) mh.invoke(vat, 'x', null, 3.131, new Integer(37)));
        try {
        ...
        try {
            assertEquals("x, [null, 3.131, bad, 37]",
                    (String) mh.invoke(vat, 'x', (Process) null, 3.131, "bad", new Integer(37)));
            assertTrue(false);
            fail();
        } catch (ClassCastException e) {
        }
        ...
        mh = MethodHandles.lookup().findVirtual(VariableArityTester.class, "arrayMethod",
        ...
        assertEquals("[55, 66, 60]",
                ((VariableArityTester) mh.invoke(new byte[] {(byte) 55, (byte) 66, (byte) 60}))
                        .lastResult());
        assertEquals("[55, 66, 60]",
                ((VariableArityTester) mh.invoke((byte) 55, (byte) 66, (byte) 60)).lastResult());
        try {
            assertEquals("[55, 66, 60]",
                    ((VariableArityTester) mh.invokeExact((byte) 55, (byte) 66, (byte) 60))
                            .lastResult());
            fail();
        } catch (WrongMethodTypeException e) {
        }
        try {
            assertEquals("[3, 3]",
                    ((VariableArityTester) mh.invoke(
                             new Number[] {Byte.valueOf((byte) 3), (byte) 3}))
                            .lastResult());
            fail();
        } catch (WrongMethodTypeException e) {
        }
        ...
        mh = MethodHandles.lookup().findConstructor(VariableArityTester.class,
        ...
        // Constructors - Number
        mh = MethodHandles.lookup().findConstructor(VariableArityTester.class,
                MethodType.methodType(void.class, char.class, Number[].class));
        assertTrue(mh.isVarargsCollector());
        assertFalse(mh.asFixedArity().isVarargsCollector());
        assertEquals("x, []", ((VariableArityTester) mh.invoke('x')).lastResult());
        ...
        try {
            assertEquals("x, [null, 3.131, bad, 37]",
                    ((VariableArityTester) mh.invoke('x', null, 3.131, "bad", new Integer(37)))
                            .lastResult());
            assertTrue(false);
            fail();
        } catch (ClassCastException e) {
        ...
        try {
            assertEquals("x, [null, 3.131, bad, 37]",
                    ((VariableArityTester) mh.invoke(
                             'x', (Process) null, 3.131, "bad", new Integer(37)))
                            .lastResult());
            assertTrue(false);
            fail();
        } catch (ClassCastException e) {
        ...
        mh = MethodHandles.lookup().findStatic(VariableArityTester.class, "tally",
                MethodType.methodType(String.class, Float.class, Float[].class));
        assertTrue(mh.isVarargsCollector());
        assertEquals("9.99, [0.0, 0.1, 1.1]",
                (String) mh.invoke(Float.valueOf(9.99f),
                        new Float[] {
                                Float.valueOf(0.0f), Float.valueOf(0.1f), Float.valueOf(1.1f)}));
        assertEquals("9.99, [0.0, 0.1, 1.1]",
                (String) mh.invoke(Float.valueOf(9.99f), Float.valueOf(0.0f), Float.valueOf(0.1f),
                        Float.valueOf(1.1f)));
        assertEquals("9.99, [0.0, 0.1, 1.1]",
        ...
        mh = VariableArityTester.lookup().findSpecial(BaseVariableArityTester.class, "update",
                MethodType.methodType(String.class, Float.class, Float[].class),
        ...
        mh = MethodHandles.lookup().findStatic(
                VariableArityTester.class, "foo", MethodType.methodType(void.class, int[].class));
    ...
    public static void testVariableArity_MethodHandles_bind() throws Throwable {
        VariableArityTester vat = new VariableArityTester();
        MethodHandle mh = MethodHandles.lookup().bind(
                vat, "update", MethodType.methodType(String.class, boolean[].class));
        assertTrue(mh.isVarargsCollector());
    ...
    public static void testRevealDirect() throws Throwable {
        ...
        MethodHandle handle =
                MethodHandles.lookup().findVirtual(UnreflectTester.class, "publicMethod", type);
        ...
        handle = MethodHandles.lookup().findStatic(
                UnreflectTester.class, "publicStaticMethod", MethodType.methodType(String.class));
        ...
        handle = MethodHandles.lookup().findVirtual(
                UnreflectTester.class, "publicVarArgsMethod", type);
    ...
    public static void testReflectiveCalls() throws Throwable {
        ...
        for (String methodName : methodNames) {
            ...
            MethodHandle instance = MethodHandles.lookup().findVirtual(java.io.PrintStream.class,
    ...
    public static void testInterfaceSpecial() throws Throwable {
        ...
        Consumer<Object> c = (Consumer<Object>) Proxy.newProxyInstance(
                Main.class.getClassLoader(), new Class<?>[] {Consumer.class}, (p, m, a) -> {
                    ...
                    if (m.equals(andThenMethod)) {
                        ...
                        return MethodHandles.lookup()
                                .findSpecial(Consumer.class, m.getName(),
                                        MethodType.methodType(
        ...
        c4.accept("hello");
        Consumer<Object> andthen = (Object o) -> {
            System.out.println("Called and then with " + o);
        };
        Consumer<Object> c5 = (Consumer<Object>) MethodHandles.lookup()
                                      .findSpecial(Consumer.class, andThenMethod.getName(),
                                              MethodType.methodType(andThenMethod.getReturnType(),
        ...
        MethodHandle abstract_target =
                MethodHandles.lookup().findSpecial(Consumer.class, acceptMethod.getName(),
                        MethodType.methodType(
                                acceptMethod.getReturnType(), acceptMethod.getParameterTypes()),
                        c3.getClass());
        try {
    ...
    private static void testFastInvoke() throws Throwable {
        ...
        MethodHandle mh0 = MethodHandles.lookup().findStatic(
