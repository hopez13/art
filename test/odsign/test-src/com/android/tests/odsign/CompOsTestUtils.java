...
public class CompOsTestUtils {
     ...
     */
    public static void runCompilationJobEarlyAndWait(ITestDevice device) throws Exception {
        waitForJobToBeScheduled(device);
    ...
    public static String checksumDirectoryContentPartial(ITestDevice device, String path)
            throws Exception {
    ...
    private static void waitForJobToBeScheduled(ITestDevice device)
            throws Exception {
