...
public class OnDeviceSigningHostTest extends BaseHostJUnit4Test {
    ...
    private Set<String> zygoteArtifacts;
    private Set<String> systemServerArtifacts;
    ...
    public void setUp() throws Exception {
        ...
        zygoteArtifacts = new HashSet<>();
        for (String zygoteName : ZYGOTE_NAMES) {
            zygoteArtifacts.addAll(getZygoteLoadedArtifacts(zygoteName).orElse(new HashSet<>()));
        }
        systemServerArtifacts = getSystemServerLoadedArtifacts();
        bootTimeMs = getDevice().getDeviceDate();
    }
    ...
    public void verifyArtSamegradeUpdateTriggersCompilation() throws Exception {
        ...
        assertArtifactsModifiedAfter(zygoteArtifacts, bootTimeMs);
        assertArtifactsModifiedAfter(systemServerArtifacts, bootTimeMs);
    }
    ...
    public void verifyOtherApexSamegradeUpdateTriggersCompilation() throws Exception {
        ...
        assertArtifactsNotModifiedAfter(zygoteArtifacts, bootTimeMs);
        assertArtifactsModifiedAfter(systemServerArtifacts, bootTimeMs);
    }
    ...
    public void verifyNoCompilationWhenCacheIsGood() throws Exception {
        ...
        assertArtifactsNotModifiedAfter(zygoteArtifacts, bootTimeMs);
        assertArtifactsNotModifiedAfter(systemServerArtifacts, bootTimeMs);
    }
