...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        assertStringEquals(
                smallString.substring(5, 10), stringGetCharsRange(smallString, 5, 10, 0));
        // Substring > 8 characters.
        assertStringEquals(
                smallString.substring(7, 28), stringGetCharsRange(smallString, 7, 28, 0));
        ...
        // Substring < 8 characters.
        assertStringEquals(
                smallString.substring(5, 10), stringGetCharsRange(smallString, 5, 10, 17));
        // Substring > 8 characters.
        assertStringEquals(
                smallString.substring(7, 28), stringGetCharsRange(smallString, 7, 28, 17));
        ...
        try {
            ...
            assertStringContains(
                    "Main.$opt$noinline$stringCharAt", sioob.getStackTrace()[1].toString());
        }
        try {
    ...
    static public int $opt$noinline$getStringLength(String s) { return s.length(); }
    ...
    static public boolean $opt$noinline$isStringEmpty(String s) { return s.isEmpty(); }
    ...
    static public char $opt$noinline$stringCharAt(String s, int pos) { return s.charAt(pos); }
    ...
    public static boolean stringEqualsSame() { return $inline$callStringEquals("obj", "obj"); }
    ...
    public static boolean $inline$callStringEquals(String a, String b) { return a.equals(b); }
    ...
    /// CHECK-NOT:      ldr {{w\d+}}, [{{x\d+}}, #0]
    /// CHECK:          cmp {{w\d+}}, {{w\d+|#.*}}
    public static boolean stringArgumentIsString() { return "foo".equals(myString); }
