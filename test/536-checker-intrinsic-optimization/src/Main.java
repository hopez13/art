...
public class Main {
  ...
  public static String smallFilledString = generateFilledString(100);
  public static String mediumFilledString = generateFilledString(300);
  public static String largeFilledString = generateFilledString(2000);
  ...
  public static String generateFilledString(int length) {
    StringBuilder sb = new StringBuilder();
    for (int i = 0; i < length; i++) {
  ...
  public static void main(String[] args) {
    ...
    // Strings > 8 characters of various lengths.
    assertStringEquals(smallFilledString, stringGetCharsAndBack(smallFilledString));
    assertStringEquals(mediumFilledString, stringGetCharsAndBack(mediumFilledString));
    assertStringEquals(largeFilledString, stringGetCharsAndBack(largeFilledString));

    // Get only a substring:
    // Substring < 8 characters.
    assertStringEquals(smallFilledString.substring(5, 10), stringGetCharsRange(smallFilledString, 5, 10, 0));
    // Substring > 8 characters.
    assertStringEquals(smallFilledString.substring(7, 28), stringGetCharsRange(smallFilledString, 7, 28, 0));

    // Get full string with offset in the char array.
    assertStringEquals(smallFilledString, stringGetCharsAndBackOffset(smallFilledString, 17));

    // Get a substring with an offset in the char array.
    // Substring < 8 characters.
    assertStringEquals(smallFilledString.substring(5, 10), stringGetCharsRange(smallFilledString, 5, 10, 17));
    // Substring > 8 characters.
    assertStringEquals(smallFilledString.substring(7, 28), stringGetCharsRange(smallFilledString, 7, 28, 17));
