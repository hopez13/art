...
public class Transform1975 {
     ...
     *    System.out.println("NEW VALUE REDEFINED_DEX_BYTES: " +
     * Base64.getEncoder().encodeToString(REDEFINED_DEX_BYTES)); System.out.println("NEW VALUE
    ...
    public static void doSomething() { System.out.println("Not doing anything"); }

    public static void readFields() {
        System.out.println("ORIGINAL VALUE CUR_CLASS: " + CUR_CLASS);
        System.out.println("ORIGINAL VALUE REDEFINED_DEX_BYTES: "
