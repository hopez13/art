...
public class Main {
  ...
  /// CHECK-START-{ARM,ARM64}: void Main.testArraySetCheckCastNull(Main$Element[]) prepare_for_register_allocation (before)
  /// CHECK:         <<Array:l\d+>>         ParameterValue
  /// CHECK-DAG:     <<Index:i\d+>>         IntConstant 42
  /// CHECK-DAG:     <<Null:l\d+>>          NullConstant
  /// CHECK-DAG:     <<Class:l\d+>>         LoadClass
  ...
  /// CHECK-START-{ARM,ARM64}: void Main.testArraySetCheckCastNull(Main$Element[]) prepare_for_register_allocation (after)
  /// CHECK:         <<Array:l\d+>>         ParameterValue
  /// CHECK-DAG:     <<Index:i\d+>>         IntConstant 42
  /// CHECK-DAG:     <<Null:l\d+>>          NullConstant
  /// CHECK-DAG:     <<Class:l\d+>>         LoadClass
  ...
  /// CHECK-START-{X86_64,X86}: void Main.testArraySetCheckCastNull(Main$Element[]) prepare_for_register_allocation (before)
  /// CHECK:         <<Array:l\d+>>         ParameterValue
  /// CHECK-DAG:     <<Index:i\d+>>         IntConstant 42
  /// CHECK-DAG:     <<Null:l\d+>>          NullConstant
  /// CHECK-DAG:     <<Class:l\d+>>         LoadClass
  /// CHECK-DAG:     <<CheckedValue:l\d+>>  BoundType [<<Null>>]
  /// CHECK-DAG:     <<CheckedArray:l\d+>>  NullCheck [<<Array>>]
  /// CHECK-DAG:     <<X86CheckedArray:i\d+>> X86BoundsCheck [<<Index>>,<<CheckedArray>>]  
  /// CHECK-DAG:     <<ArraySet:v\d+>>      ArraySet [<<CheckedArray>>,<<X86CheckedArray>>,<<CheckedValue>>] needs_type_check:true

  /// CHECK-START-{X86_64,X86}: void Main.testArraySetCheckCastNull(Main$Element[]) prepare_for_register_allocation (after)
  /// CHECK:         <<Array:l\d+>>         ParameterValue
  /// CHECK-DAG:     <<Index:i\d+>>         IntConstant 42
  /// CHECK-DAG:     <<Null:l\d+>>          NullConstant
  /// CHECK-DAG:     <<Class:l\d+>>         LoadClass
