...
public class Main implements Itf {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Make $noinline$testInvokeVirtual and $noinline$testInvokeInterface hot to get them
        // jitted. We pass Main and Subclass to get polymorphic inlining based on calling the same
        // method.
    ...
    public static Class<?> $noinline$testInvokeInterface(Itf i) { return i.sameInvokeInterface(); }
    ...
    public static Class<?> $noinline$testInvokeVirtual(Main m) { return m.sameInvokeVirtual(); }

    public static void $noinline$testInlineToSameTarget(Main m) { m.increment(); }
...
class OtherSubclass extends Main {
    public Class<?> sameInvokeVirtual() { return OtherSubclass.class; }

    public Class<?> sameInvokeInterface() { return OtherSubclass.class; }

    public Class<?> sameInvokeInterface2() { return null; }
    public Class<?> sameInvokeInterface3() { return null; }
}
