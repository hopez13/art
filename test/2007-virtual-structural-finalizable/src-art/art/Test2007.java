...
public class Test2007 {
    ...
    public static void doTest() throws Exception {
        ...
        // Make sure we don't have any remaining things to finalize, eg obsolete objects or
        // something.
        Runtime.getRuntime().gc();
        System.runFinalization();
    ...
    public static void mktransform() throws Exception { theObject = new Transform(); }
}
