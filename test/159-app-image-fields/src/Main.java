...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            int value = 0;
            try {
                // If the ArtField* is erroneously left in the DexCache, this shall
                // succeed despite the class Derived being unresolved so far.
                // Otherwise, we're correctly throw OOME trying to resolve it.
                value = Derived.value;
