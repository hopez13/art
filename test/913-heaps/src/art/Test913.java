...
public class Test913 {
    public static void run() throws Exception {
        ...
        // Run the follow-references tests on a dedicated thread so we know the specific Thread
        // type.
        Thread t = new Thread() {
            @Override
            public void run() {
    ...
    private static class TestConfig {
        ...
        private void doFollowReferencesTestImpl(A root, int stopAfter, int followSet, Object asRoot,
                Verifier v, String additionalEnabled) {
            String[] lines =
    ...
    public static class Verifier {
        ...
        public static class Node {
            ...
            public Node(String r) { referrer = r; }

            public boolean isRoot() { return referrer.startsWith("root@"); }
        }
        ...
        public void process(String[] lines, String additionalEnabledReferrer, boolean filtered) {
            ...
            // Check for consecutive chunks of referrers. Also ensure roots come first.
            {
                ...
                for (String l : lines) {
                    ...
                    if (currentHead == null) {
                        ...
                        // Ignore 0@0, as it can happen at any time (as it stands for all other
                        // objects).
            ...
            // TODO: What about extra roots? JNI and the interpreter seem to introduce those (though
            // it
            //       isn't clear why a debuggable-AoT test doesn't have the same, at least for
            //       locals). For now, swallow duplicates, and resolve once we have the metadata for
            //       the roots.
            {
            ...
            if (filtered) {
                ...
                // we
                //       cannot verify that output is correct when parts of it are suppressed by
        ...
        public static boolean isRoot(String ref) { return ref.startsWith("root@"); }
