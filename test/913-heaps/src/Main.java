...
public class Main {
  ...
  private static class TestConfig {
    ...
    private void doFollowReferencesTestImpl(A root, int stopAfter, int followSet,
      ...
      if (heapFilter == 0 && klass == null) {
        v.process(lines, additionalEnabled);
      } else {
        // TODO: The verifier doesn't support hidden references at the moment. Until this is
        //       refactored/rewritten, just sort the output and print.
        Arrays.sort(lines);
        for (String l : lines) {
