...
extern "C" JNIEXPORT void JNICALL Java_Main_followReferences(JNIEnv* env ATTRIBUTE_UNUSED,
                                                             jclass klass ATTRIBUTE_UNUSED,
                                                             jint heap_filter,
                                                             jclass klass_filter,
                                                             jobject initial_object,
                                                             jint stop_after,
                                                             jint follow_set) {
  class PrintIterationConfig : public IterationConfig {
   public:
    ...
    void Print(jvmtiHeapReferenceKind reference_kind,
      ...
      printf("%s --(%s)--> %" PRId64 "@%" PRId64 " [size=%" PRId64 ", length=%d]",
             referrer_str.c_str(),
