...
extern "C" JNIEXPORT void JNICALL Java_art_Test913_registerClass(
    JNIEnv* env, jclass klass [[maybe_unused]], jlong tag, jobject obj) {
  ClassData data;
  ...
  class PrintIterationConfig final : public IterationConfig {
   public:
    ...
    jint Handle(jvmtiHeapReferenceKind reference_kind,
                ...
                jlong* referrer_tag_ptr,
                jint length,
                void* user_data [[maybe_unused]]) override {
      jlong tag = *tag_ptr;
...
extern "C" JNIEXPORT jobjectArray JNICALL Java_art_Test913_followReferencesString(
    JNIEnv* env, jclass klass [[maybe_unused]], jobject initial_object) {
  struct FindStringCallbacks {
    static jint JNICALL FollowReferencesCallback(
        jvmtiHeapReferenceKind reference_kind [[maybe_unused]],
        const jvmtiHeapReferenceInfo* reference_info [[maybe_unused]],
        jlong class_tag [[maybe_unused]],
        jlong referrer_class_tag [[maybe_unused]],
        jlong size [[maybe_unused]],
        jlong* tag_ptr [[maybe_unused]],
        jlong* referrer_tag_ptr [[maybe_unused]],
        jint length [[maybe_unused]],
...
static void JNICALL GarbageCollectionFinish(jvmtiEnv* ti_env [[maybe_unused]]) {
  finishes++;
}

static void JNICALL GarbageCollectionStart(jvmtiEnv* ti_env [[maybe_unused]]) {
  starts++;
}
...
extern "C" JNIEXPORT jint JNICALL Java_art_Test913_getGcStarts(JNIEnv* env [[maybe_unused]],
                                                               jclass klass [[maybe_unused]]) {
...
extern "C" JNIEXPORT jint JNICALL Java_art_Test913_getGcFinishes(JNIEnv* env [[maybe_unused]],
                                                                 jclass klass [[maybe_unused]]) {
...
extern "C" JNIEXPORT jint JNICALL Java_art_Test913_getObjectHeapId(
    JNIEnv* env, jclass klass [[maybe_unused]], jlong tag) {
  CHECK(gGetObjectHeapIdFn != nullptr);
  jint heap_id;
...
extern "C" JNIEXPORT jstring JNICALL Java_art_Test913_getHeapName(
    JNIEnv* env, jclass klass [[maybe_unused]], jint heap_id) {
  CHECK(gGetHeapNameFn != nullptr);
  char* heap_name;
...
extern "C" JNIEXPORT void JNICALL Java_art_Test913_checkGetObjectHeapIdInCallback(
    JNIEnv* env, jclass klass [[maybe_unused]], jlong tag, jint heap_id) {
  CHECK(gGetObjectHeapIdFn != nullptr);
  ...
  {
    struct GetObjectHeapIdCallbacks {
      static jint JNICALL HeapIterationCallback(jlong class_tag [[maybe_unused]],
                                                jlong size [[maybe_unused]],
                                                jlong* tag_ptr,
                                                jint length [[maybe_unused]],
                                                void* user_data) {
...
static jint JNICALL HeapIterationExtCallback(jlong class_tag [[maybe_unused]],
                                             jlong size [[maybe_unused]],
                                             jlong* tag_ptr,
                                             jint length [[maybe_unused]],
                                             void* user_data [[maybe_unused]],
