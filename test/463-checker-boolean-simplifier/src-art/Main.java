...
public class Main {
    ...
    public static boolean GreaterThan(int x, int y) { return (x <= y) ? false : true; }
    ...
    public static int SimpleTrueBlock(boolean x, int y) { return x ? y + 42 : 43; }
    ...
    public static int SimpleFalseBlock(boolean x, int y) { return x ? 42 : y + 43; }
    ...
    public static int SimpleBothBlocks(boolean x, int y, int z) { return x ? y + 42 : z + 43; }
    ...
    public int TrueBlockWithTooManyInstructions(boolean x) { return x ? (read_field + 2) : 43; }
    ...
    public int FalseBlockWithTooManyInstructions(boolean x) { return x ? 42 : (read_field + 3); }
    ...
    public int TrueBlockWithSideEffects(boolean x) { return x ? (write_field = 42) : 43; }
    ...
    public int FalseBlockWithSideEffects(boolean x) { return x ? 42 : (write_field = 43); }
