...
public class Main {
    public static void main(String args[]) {
        for (int i = 0; i <= 360; i += 45) {
            ...
            System.out.println(
                    "Math.sin(" + d + ") = " + String.format(Locale.US, "%.12f", Math.sin(d)));

            System.out.println(
                    "Math.sinh(" + d + ") = " + String.format(Locale.US, "%.12f", Math.sinh(d)));
            System.out.println(
                    "Math.asin(" + d + ") = " + String.format(Locale.US, "%.12f", Math.asin(d)));
            System.out.println(
                    "Math.cos(" + d + ") = " + String.format(Locale.US, "%.12f", Math.cos(d)));
            System.out.println(
                    "Math.cosh(" + d + ") = " + String.format(Locale.US, "%.12f", Math.cosh(d)));
            System.out.println(
                    "Math.acos(" + d + ") = " + String.format(Locale.US, "%.12f", Math.acos(d)));
            if ((i + 90) % 180 != 0) {
                System.out.println(
                        "Math.tan(" + d + ") = " + String.format(Locale.US, "%.12f", Math.tan(d)));
            }
            System.out.println(
                    "Math.tanh(" + d + ") = " + String.format(Locale.US, "%.12f", Math.tanh(d)));
            System.out.println(
                    "Math.atan(" + d + ") = " + String.format(Locale.US, "%.12f", Math.atan(d)));
        ...
        for (int j = -3; j <= 3; j++) {
            double e = (double) j;
            System.out.println(
                    "Math.cbrt(" + e + ") = " + String.format(Locale.US, "%.12f", Math.cbrt(e)));
            System.out.println(
                    "Math.log(" + e + ") = " + String.format(Locale.US, "%.12f", Math.log(e)));
            System.out.println(
                    "Math.log10(" + e + ") = " + String.format(Locale.US, "%.12f", Math.log10(e)));
            System.out.println(
                    "Math.log1p(" + e + ") = " + String.format(Locale.US, "%.12f", Math.log1p(e)));
            System.out.println(
                    "Math.exp(" + e + ") = " + String.format(Locale.US, "%.12f", Math.exp(e)));
            System.out.println(
                    "Math.expm1(" + e + ") = " + String.format(Locale.US, "%.12f", Math.expm1(e)));
        ...
        System.out.println(
                "Math.ceil(0.0001) = " + String.format(Locale.US, "%.12f", Math.ceil(0.0001)));
        System.out.println(
                "Math.floor(0.0001) = " + String.format(Locale.US, "%.12f", Math.floor(0.0001)));
        ...
        for (int j = -3; j <= 3; j++) {
            ...
            System.out.println(
                    "StrictMath.pow(" + e + ", " + (e + 1.0) + ") = " + StrictMath.pow(e, e + 1.0));
