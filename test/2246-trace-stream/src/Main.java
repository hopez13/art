...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Main m = new Main();
        Thread t = new Thread(() -> { Main m1 = new Main(); m1.doSomeWork(); }, "TestThread2246");
        try {
    ...
    private void CheckTraceFileFormat(File trace_file) throws Exception {
      ...
      parser.validateTraceHeader(StreamTraceParser.kTraceVersionDualClock);
      ...
      while (has_entries) {
        ...
        switch (header_type) {
          ...
          default:
            ...
            // Ignore events after method tracing was stopped. The code that is executed later could
    ...
    private static class VMDebug {
        ...
        public static void startMethodTracing(String filename, FileDescriptor fd, int bufferSize, int flags,
                boolean samplingEnabled, int intervalUs, boolean streaming) throws Exception {
