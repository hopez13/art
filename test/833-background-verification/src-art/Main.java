...
public class Main {
    public static void main(String[] args) throws Exception {
      UnknownLoader loader = new UnknownLoader();
...
class UnknownLoader extends PathClassLoader {
  static String DEX_FILE = System.getenv("DEX_LOCATION") + "/833-background-verification-ex.jar";
  public UnknownLoader() {
    super(DEX_FILE, Object.class.getClassLoader());
  }
}
