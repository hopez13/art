...
public class Main {
    ...
    /// CHECK: Select
    //
    /// CHECK-START: int Main.mainIndexReturnedN(int) dead_code_elimination$after_loop_opt (after)
    /// CHECK-NOT: Select
    ...
    /// CHECK: Select
    //
    /// CHECK-START: int Main.mainIndexShort1(short) dead_code_elimination$after_loop_opt (after)
    /// CHECK-NOT: Select
    ...
    /// CHECK: Select
    //
    /// CHECK-START: int Main.mainIndexShort2(short) dead_code_elimination$after_loop_opt (after)
    /// CHECK-NOT: Select
