...
public class Test1988 {
    static class Transform1 {
        public static void sayHi() { System.out.println("hello - Transform 1"); }
    }
    static class Transform2 {
        public static void sayHi() { System.out.println("hello - Transform 2"); }
    }
    ...
    public static void doTest() {
        Transform1.sayHi();
        Transform2.sayHi();
        System.out.println("Redefining both " + Transform1.class + " and "
                + Transform2.class + " to use each other.");
