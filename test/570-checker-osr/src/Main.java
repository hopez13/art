...
public class Main {
    ...
    public Main inlineCache() { return new Main(); }

    public Main inlineCache2() { return null; }

    public Main inlineCache3() { return null; }

    public Class<?> returnClass() { return Main.class; }

    public void otherInlineCache() { return; }
    ...
    public static boolean $opt$inline$inlineTrue() { return true; }

    public static boolean $opt$inline$inlineFalse() { return false; }
...
class SubMain extends Main {
    public Class<?> returnClass() { return SubMain.class; }

    public Main inlineCache() { return new SubMain(); }

    public Main inlineCache2() { return new SubMain(); }
