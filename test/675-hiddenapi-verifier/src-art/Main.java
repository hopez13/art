...
public class Main {
  public static void main(String[] args) throws Exception {
    ...
    ClassLoader c2 = new PathClassLoader(DEX_BOOT, ClassLoader.getSystemClassLoader());
    if (!canFindMyClass(c2)) {
      System.out.println("Should not be able find MyClass in boot dex file");
    }
  }
  ...
  private static final String DEX_BOOT =
