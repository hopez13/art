...
public class Secondary {
    public static void main() {
        ...
        System.out.println($noinline$getSecondaryClassWithUnmetDendency().getName());
    }
    ...
    /// CHECK-START: java.lang.Class Secondary.$noinline$getSecondaryClassWithUnmetDendency() builder (after)
    /// CHECK:            LoadClass load_kind:BssEntry in_image:false
    public static Class<?> $noinline$getSecondaryClassWithUnmetDendency() {
        return SecondaryClassWithUnmetDendency.class;
    }
}
...
class SecondaryClassWithUnmetDendency implements PrimaryInterface {}
