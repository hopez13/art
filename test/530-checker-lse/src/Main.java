...
class TestClass {
    static { sTestClassObj = new TestClass(-1, -2); }
    TestClass() {}
...
public class Main {
    ...
    private static int testStoreStore6(TestClass2 obj1, TestClass2 obj2) {
        obj1.i = 81; // Even though the value in `obj1.i` will be overridden below, this store is
                     // needed since obj2.j has a NullCheck and can throw.
        int j = obj2.j;
        obj1.i = 82;
        return j;
    }
    ...
    private static int[] $noinline$returnArg(int[] a) { return a; }
    ...
    private static boolean $noinline$getBoolean(boolean val) { return val; }
    ...
    public static void main(String[] args) {
        ...
        try {
            assertDoubleEquals(
                    Math.PI * Math.PI * Math.PI, testDeoptimize(iarray, darray, Math.PI));
        } catch (Exception e) {
