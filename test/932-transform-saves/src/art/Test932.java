...
public class Test932 {
    // This class is never used so just have it print out a bogus value so we can detect if
    // something goes very wrong.
    static class Transform {
        public void sayHi() { System.out.println("foobar"); }
    }
    ...
    public static void doTest(Transform t) {
        ...
        // TODO REMOVE this theoretically does nothing but it ensures the original-dex-file we have
        // set is one we can return to unaltered.
        ...
        Redefinition.addCommonTransformationResult(
                "art/Test932$Transform", CLASS_BYTES_B, DEX_BYTES_B);
