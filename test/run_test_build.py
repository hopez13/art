...
class BuildTestContext:
  def __init__(self, args, test_dir):
    ...
    self.soong_zip = self.android_build_top / "prebuilts/build-tools/linux-x86/bin/soong_zip"
    self.zipalign = self.android_build_top / "prebuilts/build-tools/linux-x86/bin/zipalign"
