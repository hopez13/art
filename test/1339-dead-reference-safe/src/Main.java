...
public class Main {
    ...
    public static boolean ensureCompiled(Class cls, String methodName)
    ...
    // analysis.
    public static void $noinline$gcAndCheck(
            AtomicInteger counter, int expected, String label, String msg) {
