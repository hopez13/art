...
class A {
    ...
    void m_a$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! A::m_a$$Startup$Poststartup");
    }
    void m_a$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! A::m_a$Hot$Startup$Poststartup");
    }
    ...
    void m_b$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! A::m_b$$Startup$Poststartup");
    }
    void m_b$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! A::m_b$Hot$Startup$Poststartup");
    }
    ...
    void m_c$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! A::m_c$$Startup$Poststartup");
    }
    void m_c$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! A::m_c$Hot$Startup$Poststartup");
    }
}
class B {
    ...
    void m_a$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! B::m_a$$Startup$Poststartup");
    }
    void m_a$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! B::m_a$Hot$Startup$Poststartup");
    }
    ...
    void m_b$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! B::m_b$$Startup$Poststartup");
    }
    void m_b$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! B::m_b$Hot$Startup$Poststartup");
    }
    ...
    void m_c$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! B::m_c$$Startup$Poststartup");
    }
    void m_c$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! B::m_c$Hot$Startup$Poststartup");
    }
}
class C {
    ...
    void m_a$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! C::m_a$$Startup$Poststartup");
    }
    void m_a$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! C::m_a$Hot$Startup$Poststartup");
    }
    ...
    void m_b$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! C::m_b$$Startup$Poststartup");
    }
    void m_b$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! C::m_b$Hot$Startup$Poststartup");
    }
    ...
    void m_c$$Startup$Poststartup() {
        System.out.println("Don't dedupe me! C::m_c$$Startup$Poststartup");
    }
    void m_c$Hot$Startup$Poststartup() {
        System.out.println("Don't dedupe me! C::m_c$Hot$Startup$Poststartup");
    }
}
