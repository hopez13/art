...
METHOD_HOTNESS = [MethodHotness('Hot', 'H', 0x1), MethodHotness('Startup', 'S', 0x2), MethodHotness('Poststartup', 'P', 0x4)]
...
class JavaMethod:
  ...
  def sort_key_name(self):
    ...
    # However a class has no lexicographical order.
    # TODO: figure out how class_def_idx can be forced (maybe its alphabetical by default?).
