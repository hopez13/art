...
public class Main {
    public static void main(String[] args) throws Throwable {
        ...
        c.getMethod("storeInstance", c, Object.class).invoke(null, new Object[]{ c.newInstance(), null });
        ...
        testStoreObject(c.getMethod("storeInstance", c, Object.class), c.newInstance(), new Object());
