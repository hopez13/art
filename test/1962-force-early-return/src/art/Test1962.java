...
public class Test1962 {
    ...
    for (StackTraceElement e : st) {
      os.println(
          prefix
              ...
              + ")");
      if (e.getClassName().equals("art.Test1962") && e.getMethodName().equals("runTests")) {
  ...
  public Thread mkThread(Runnable r) {
    Thread t = new Thread(r, "Test1962 target thread - " + THREAD_COUNT++);
  ...
  public static void run() throws Exception {
    new Test1962((x) -> {}).runTests();
  }

  public Test1962(Consumer<TestRunnable> preTest) {
