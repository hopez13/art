...
namespace art {
namespace Test1962ForceEarlyReturn {

extern "C" JNIEXPORT
jobject JNICALL Java_art_Test1962_00024NativeCalledObject_calledFunction(
  ...
  jclass int_container_klass = env->FindClass("art/Test1962$IntContainer");
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1962_00024NativeCallerObject_run(
    JNIEnv* env, jobject thiz) {
...
extern "C" JNIEXPORT
jboolean JNICALL Java_art_Test1962_isClassLoaded(JNIEnv* env, jclass, jstring name) {
