...
public class Main {
   ...
   * }
   */
  private static final String CLASS_BASE64 =
  ...
  private static final String DEX_BASE64 =
  ...
  private static final byte[] CLASS_BYTES = Base64.getDecoder().decode(CLASS_BASE64.getBytes());
  private static final byte[] DEX_BYTES = Base64.getDecoder().decode(DEX_BASE64.getBytes());
