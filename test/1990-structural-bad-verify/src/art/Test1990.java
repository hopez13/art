...
public class Test1990 {
    static class Transform {
        public static void saySomething() { System.out.println("hello"); }
    }
    ...
    // step the verifier will first check and verify there are no hard-failures in this class. Next
    // it will realize it cannot find the sayGoodbye method on the loaded & resolved Transform
    // class. This is (correctly) recognized as a soft-verification failure but then the verifier
    // decides the rest of the method is dead-code. This means the verifier will not perform any of
    // the soft-failure checks on the rest of the method (since control would never reach there).
    //
    ...
    // 0001d0:                                        |[0001d0]
    // art.Test1990$Transform.saySomething:()V 0001e0: 6200 0000                              |0000:
    // sget-object v0, Ljava/lang/System;.out:Ljava/io/PrintStream; // field@0000 0001e4: 7100 0100
    // 0000                         |0002: invoke-static {},
    // Lart/Test1990$Transform;.sayGoodbye:()Ljava/lang/String; // method@0001 0001ea: 0c01 |0005:
    // move-result-object v1 0001ec: 2202 0700                              |0006: new-instance v2,
    // Ljava/lang/StringBuilder; // type@0007 0001f0: 7010 0500 0200                         |0008:
    // invoke-direct {v2}, Ljava/lang/StringBuilder;.<init>:()V // method@0005 0001f6: 1a03 0100
    // |000b: const-string v3, "I say hello and " // string@0001 0001fa: 6e20 0600 3200 |000d:
    // invoke-virtual {v2, v3},
    // Ljava/lang/StringBuilder;.append:(Ljava/lang/String;)Ljava/lang/StringBuilder; // method@0006
    // 000200: 6e20 0600 1200                         |0010: invoke-virtual {v2, v1},
    // Ljava/lang/StringBuilder;.append:(Ljava/lang/String;)Ljava/lang/StringBuilder; // method@0006
    // 000206: 6e10 0700 0200                         |0013: invoke-virtual {v2},
    // Ljava/lang/StringBuilder;.toString:()Ljava/lang/String; // method@0007 00020c: 0c01 |0016:
    // move-result-object v1 00020e: 6e20 0300 1000                         |0017: invoke-virtual
    // {v0, v1}, Ljava/io/PrintStream;.println:(Ljava/lang/String;)V // method@0003 000214: 0e00
    // |001a: return-void
    //       catches       : (none)
    //       positions     :
    //         0x0000 line=5
