...
public class Main {
    ...
    //       throw new Error("Method redefined away!");
    //     }
    //     public static long parseUnsignedLong(CharSequence s, int beginIndex, int endIndex, int
    ...
    static class FuncCmp implements LongPredicate {
        ...
        public boolean test(long l) { return p.test(l); }
    }
    ...
    static interface LI2IFunction {
        public long applyToLongInt(long a, int b);
    }
    ...
    public static void main(String[] args) { doTest(10000); }
    ...
    public static void doTest(int iters) {
        ...
        FuncCmp[] comps = new FuncCmp[] {
                ...
                l2i("numberOfLeadingZeros", Long::numberOfLeadingZeros,
                        RedefinedLongIntrinsics::numberOfLeadingZeros),
                l2i("numberOfTrailingZeros", Long::numberOfTrailingZeros,
