...
public class Main {
    ...
    private static void testWithArgs() throws Throwable {
    ...
    static class Sums {
        ...
        public int sum(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10) {
        ...
        public long sum(int a1, long a2, int a3) {
          return a1 + a2 + a3;
        }
        ...
        public long sum(int a1, long a2, int a3, long a4, int a5) {
          return a1 + a2 + a3 + a4 + a5;
        }
        ...
        public long sum(int a1, long a2, int a3, long a4, int a5, long a6, int a7) {
          return a1 + a2 + a3 + a4 + a5 + a6 + a7;
        }
        ...
        public long sum(int a1, long a2, int a3, long a4, int a5, long a6, int a7, long a8, int a9, long a10) {
          return a1 + a2 + a3 + a4 + a5 + a6 + a7 + a8 + a9 + a10;
        }
    }
}
