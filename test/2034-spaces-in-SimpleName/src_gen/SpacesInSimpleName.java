...
public class SpacesInSimpleName {
    public static void main(String args[]) throws Exception {
        ...
        MethodVisitor mvMain = cw.visitMethod(Opcodes.ACC_PUBLIC + Opcodes.ACC_STATIC, "main",
                "([Ljava/lang/String;)V", null, null);
        mvMain.visitCode();
        mvMain.visitFieldInsn(
                Opcodes.GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");
        mvMain.visitLdcInsn("Hello, world!");
        mvMain.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "java/io/PrintStream", "println",
        ...
        mvMain.visitEnd();
        MethodVisitor mvSpaces = cw.visitMethod(
