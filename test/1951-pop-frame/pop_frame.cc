...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_setupTest(JNIEnv* env, jclass klass ATTRIBUTE_UNUSED) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_setupSuspendSingleStepAt(JNIEnv* env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_clearSuspendSingleStepFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_setupSuspendBreakpointFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jobject meth,
                                                         jlocation loc,
                                                         jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_clearSuspendBreakpointFor(JNIEnv* env,
                                                         jclass klass ATTRIBUTE_UNUSED,
                                                         jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_setupSuspendExceptionEvent(JNIEnv* env,
                                                          jclass klass ATTRIBUTE_UNUSED,
                                                          jobject method,
                                                          jboolean is_catch,
                                                          jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_clearSuspendExceptionEvent(JNIEnv* env,
                                                          jclass klass ATTRIBUTE_UNUSED,
                                                          jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_setupSuspendMethodEvent(JNIEnv* env,
                                                       jclass klass ATTRIBUTE_UNUSED,
                                                       jobject method,
                                                       jboolean enter,
                                                       jthread thr) {
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_clearSuspendMethodEvent(JNIEnv* env,
                                                       jclass klass ATTRIBUTE_UNUSED,
                                                       jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_setupFieldSuspendFor(JNIEnv* env,
                                                    jclass klass ATTRIBUTE_UNUSED,
                                                    jclass target_klass,
                                                    jobject field,
                                                    jboolean access,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_clearFieldSuspendFor(JNIEnv* env,
                                                    jclass klass ATTRIBUTE_UNUSED,
                                                    jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_waitForSuspendHit(JNIEnv* env,
                                                 jclass klass ATTRIBUTE_UNUSED,
                                                 jthread thr) {
  TestData *data;
  if (JvmtiErrorToException(env,
...
extern "C" JNIEXPORT
void JNICALL Java_art_Test1951_popFrame(JNIEnv* env,
                                        jclass klass ATTRIBUTE_UNUSED,
                                        jthread thr) {
