...
public class Test1951 {
  ...
  public static TestSuspender makeSuspend(final ThreadRunnable setup, final ThreadRunnable clean) {
    return new TestSuspender() {
      ...
      public void waitForSuspend(Thread thr) { Test1951.waitForSuspendHit(thr); }
  ...
  public static void run() throws Exception {
    new Test1951((x)-> {}).runTests();
  }

  public Test1951(Consumer<Object> preTest) {
  ...
  public void runTests() throws Exception {
    ...
    final Method doNothingMethod = Test1951.class.getDeclaredMethod("doNothing");
    ...
    runTestOn(new StandardTestObject(false),
        ...
        Test1951::clearSuspendMethodEvent);
    ...
    runTestOn(new ExceptionThrowTestObject(true),
        ...
        Test1951::clearSuspendExceptionEvent);
