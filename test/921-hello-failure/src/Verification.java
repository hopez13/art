...
class Verification {
  // Jasmin program:
  // TODO This actually returns JVMTI_ERROR_INVALID_CLASS_FORMAT
  //
  ...
  private static final byte[] CLASS_BYTES = Base64.getDecoder().decode(
    ...
    "AAAABSq3AAGxAAAAAAAAAAYADAABAAkAAAAOAAEAAQAAAAIrsAAAAAAAAQAEAAAAAgAL");
  ...
  private static final byte[] DEX_BYTES = Base64.getDecoder().decode(
    "ZGV4CjAzNQCIOyNAJ3DNVPo7/4nl+h7yXm5EZgU9cmgoAgAAcAAAAHhWNBIAAAAAAAAAAJQBAAAI" +
    ...
    "AgEA9AIMAAAAAAAAAAEAAAAAAAAAAQAAAAgAAABwAAAAAgAAAAQAAACQAAAAAwAAAAIAAACgAAAA" +
