...
class MethodChange {
  ...
  private static final byte[] CLASS_BYTES = Base64.getDecoder().decode(
    ...
    "AgAAAAcACAABAAkAAAAdAAEAAQAAAAUqtwABsQAAAAEACgAAAAYAAQAAAAEACQALAAwAAQAJAAAA" +
    "IgADAAEAAAAKuwACWRIDtwAEvwAAAAEACgAAAAYAAQAAAAMAAQANAAAAAgAO");
  private static final byte[] DEX_BYTES = Base64.getDecoder().decode(
    "ZGV4CjAzNQDyWGGNYSnRm5+snyn2r+7nxLUE7JLUwQiQAgAAcAAAAHhWNBIAAAAAAAAAAPwBAAAL" +
    ...
    "AA4AAwABAAIAAADoAQAACQAAACIAAQAbAQUAAABwIAIAEAAnAAAAAQAAAAMABjxpbml0PgALTFRy" +
    ...
    "EmVtaXR0ZXI6IGphY2stNC4yMgAFc2F5SGkAAQAHDgADAQAHDgAAAAIAAICABIgCAQmgAgwAAAAA" +
