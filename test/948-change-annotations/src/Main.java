...
public class Main {
    ...
    private static void printAnnotations(Class<?> transform) {
        System.out.println(
                "Type annotations: " + Arrays.toString(sortedAnno(transform.getAnnotations())));
    ...
    public static void doCommonClassRedefinition(
            Class<?> target, byte[] class_file, byte[] dex_file) {
