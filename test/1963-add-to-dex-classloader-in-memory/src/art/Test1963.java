...
public final class Test1963 {
    ...
    public static void SafePrintCause(Throwable t) {
        ...
        System.out.println(" --- " + t.getClass().getName() + " At " + cause.getClassName() + "."
                + cause.getMethodName() + "(" + cause.getFileName() + ":" + cause.getLineNumber()
                + ")");
    }
    ...
    public static class ExtensibleClassLoader extends ClassLoader {
        ...
        public ExtensibleClassLoader() { super(ExtensibleClassLoader.class.getClassLoader()); }

        public void addSingleClass(byte[] bb) { new_class = bb; }
    ...
    public static ClassLoader getClassLoader() throws Exception {
        if (!IS_ART) {
            ...
            return (ClassLoader) ctor.newInstance(
                    ByteBuffer.wrap(DEX_BYTES), Test1963.class.getClassLoader());
        }
    }
