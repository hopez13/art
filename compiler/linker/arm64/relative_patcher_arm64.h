...
class Arm64RelativePatcher FINAL : public ArmBaseRelativePatcher {
 public:
  ...
  static uint32_t EncodeBakerReadBarrierOffsetData(uint32_t base_reg, uint32_t holder_reg) {
    CheckValidReg(base_reg);
    CheckValidReg(holder_reg);
    return BakerReadBarrierKindField::Encode(BakerReadBarrierKind::kOffset) |
           BakerReadBarrierFirstRegField::Encode(base_reg) |
           BakerReadBarrierSecondRegField::Encode(holder_reg);
  }

  static uint32_t EncodeBakerReadBarrierIndexData(uint32_t base_reg) {
    CheckValidReg(base_reg);
    return BakerReadBarrierKindField::Encode(BakerReadBarrierKind::kIndex) |
           BakerReadBarrierFirstRegField::Encode(base_reg) |
  ...
  static uint32_t EncodeBakerReadBarrierGcRootData(uint32_t root_reg) {
    ...
    return BakerReadBarrierKindField::Encode(BakerReadBarrierKind::kRoot) |
