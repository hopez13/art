...
class Mips64RelativePatcherTest : public RelativePatcherTest {
 ...
 protected:
  ...
  static const uint8_t UnpatchedPcRelativeCallRawCode[];
  ...
  static const ArrayRef<const uint8_t> UnpatchedPcRelativeCallCode;
...
const uint8_t Mips64RelativePatcherTest::UnpatchedPcRelativeRawCode[] = {
    0x34, 0x12, 0x5E, 0xEE,  // auipc s2, high(diff); placeholder = 0x1234
    0x78, 0x56, 0x52, 0x26,  // addiu s2, s2, low(diff); placeholder = 0x5678
};
const uint8_t Mips64RelativePatcherTest::UnpatchedPcRelativeCallRawCode[] = {
    0x34, 0x12, 0x3E, 0xEC,  // auipc at, high(diff); placeholder = 0x1234
    0x78, 0x56, 0x01, 0xF8,  // jialc at, low(diff); placeholder = 0x5678
};
const uint32_t Mips64RelativePatcherTest::LiteralOffset = 0;  // At auipc (where patching starts).
const uint32_t Mips64RelativePatcherTest::AnchorOffset = 0;  // At auipc (where PC+0 points).
const ArrayRef<const uint8_t> Mips64RelativePatcherTest::UnpatchedPcRelativeCode(
    UnpatchedPcRelativeRawCode);
const ArrayRef<const uint8_t> Mips64RelativePatcherTest::UnpatchedPcRelativeCallCode(
    UnpatchedPcRelativeCallRawCode);
...
TEST_F(Mips64RelativePatcherTest, CallOther) {
  LinkerPatch method1_patches[] = {
      LinkerPatch::RelativeCodePatch(LiteralOffset, nullptr, 2u),
  };
  AddCompiledMethod(MethodRef(1u),
                    UnpatchedPcRelativeCallCode,
                    ArrayRef<const LinkerPatch>(method1_patches));
  LinkerPatch method2_patches[] = {
      LinkerPatch::RelativeCodePatch(LiteralOffset, nullptr, 1u),
  };
  ...
  uint32_t diff_after = method2_offset - (method1_offset + AnchorOffset /* PC adjustment */);
  ...
  uint32_t diff_before = method1_offset - (method2_offset + AnchorOffset /* PC adjustment */);
