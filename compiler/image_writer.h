...
class ImageWriter FINAL {
 ...
 private:
  ...
  static void FastFixupAllStringsCallback(mirror::Object* obj, void* arg)
        REQUIRES_SHARED(Locks::mutator_lock_);

  bool IsFastFixupReference(mirror::Object* obj) const REQUIRES_SHARED(Locks::mutator_lock_) {
    return is_fast_fixup_reference_.find(obj) != is_fast_fixup_reference_.end();
  }
