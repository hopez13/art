...
class ImageWriter FINAL {
 public:
  ImageWriter(const CompilerDriver& compiler_driver,
              ...
              std::unordered_set<std::string>* dirty_image_objects);
 ...
 private:
  ...
  enum Bin {
    kBinKnownDirty,               // Known dirty objects from imgdiag
  ...
  // Set of class names of objects known to be dirty in the image.
