...
JitCompiler::JitCompiler() {
  compiler_options_.reset(new CompilerOptions(
      ...
      CompilerOptions::kSchedulerStrength,
      CompilerOptions::kArmIntegerOpLatency,
      CompilerOptions::kArmFloatingPointOpLatency,
      CompilerOptions::kArmDataProcWithShifterOpLatency,
      CompilerOptions::kArmMulIntegerLatency,
      CompilerOptions::kArmMulFloatingPointLatency,
      CompilerOptions::kArmDivIntegerLatency,
      CompilerOptions::kArmDivFloatLatency,
      CompilerOptions::kArmDivDoubleLatency,
      CompilerOptions::kArmTypeConversionFloatingPointIntegerLatency,
      CompilerOptions::kArmMemoryLoadLatency,
      CompilerOptions::kArmMemoryStoreLatency,
      CompilerOptions::kArmMemoryBarrierLatency,
      CompilerOptions::kArmBranchLatency,
      CompilerOptions::kArmCallLatency,
      CompilerOptions::kArmCallInternalLatency,
      CompilerOptions::kArmLoadStringInternalLatency,
      CompilerOptions::kArmNopLatency,
      CompilerOptions::kArmLoadWithBakerReadBarrierLatency,
      CompilerOptions::kArmRuntimeTypeCheckLatency,
