...
void ImageWriter::CalculateNewObjectOffsets() {
  ...
  auto ensure_bin_slots_assigned = [&](mirror::Object* obj) REQUIRES_SHARED(Locks::mutator_lock_) {
  ...
  auto unbin_objects_into_offset = [&](mirror::Object* obj) REQUIRES_SHARED(Locks::mutator_lock_) {
