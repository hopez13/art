...
class OatWriter {
 ...
 private:
  ...
  // string in the dex file with the value comparator for deduplication. The value is the
  // target offset for patching, starting at `bss_start_ + bss_roots_offset_`.
