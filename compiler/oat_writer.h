...
class OatWriter {
 ...
 private:
  ...
  bool WriteDexFiles(OutputStream* out, File* file, bool actually_write);
  bool WriteDexFile(OutputStream* out, File* file, OatDexFile* oat_dex_file, bool actually_write);
