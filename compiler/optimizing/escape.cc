...
void CalculateEscape(HInstruction* reference,
  ...
  *is_singleton_and_not_deopt_visible = true;
  ...
  std::function<bool(HInstruction*)> visitor = [&](HInstruction* escape) -> bool {
...
void CalculateEscape(HInstruction* reference,
                     ...
                     /*out*/ bool* is_singleton_and_not_returned,
                     /*out*/ bool* is_singleton_and_not_deopt_visible) {
  std::function<bool(HInstruction*, HInstruction*)> escape = [&no_escape](HInstruction* reference,
                                                                          HInstruction* user) {
    return (no_escape == nullptr) ? false : no_escape(reference, user);
  };
...
bool DoesNotEscape(HInstruction* reference,
  ...
  return DoesNotEscape(reference, escape);
}
