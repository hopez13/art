...
HInliner::InlineCacheType HInliner::GetInlineCacheType(
  ...
  switch (number_of_types) {
    case 0: return kInlineCacheUninitialized;
    case 1: return kInlineCacheMonomorphic;
    case InlineCache::kIndividualCacheSize: return kInlineCacheMegamorphic;
    default: return kInlineCachePolymorphic;
  }
}
