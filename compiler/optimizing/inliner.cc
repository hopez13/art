...
bool HInliner::CanInlineBody(const HGraph* callee_graph,
  ...
  // TODO(solanes): I think we can do it more narrow, see needs_bss_check and related.
  // if (throws && !IsSameDexFile(*caller_compilation_unit_.GetDexFile(),
  // *resolved_method->GetDexFile())) {
  //   // TODO(solanes): Other stat
  //   LOG_FAIL(stats_, MethodCompilationStat::kNotInlinedAlwaysThrows)
  //       << "Method " << resolved_method->PrettyMethod()
  //       << " could not be inlined because it always throws";
  //   return false;
