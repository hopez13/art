...
bool HInliner::TryBuildAndInline(HInvoke* invoke_instruction,
  ...
  if (method->IsProxyMethod()) {
    VLOG(compiler) << "Method " << ArtMethod::PrettyMethod(method)
  ...
  if (!compiler_driver_->MayInline(method->GetDexFile(),
    ...
    VLOG(compiler) << "Won't inline " << ArtMethod::PrettyMethod(method) << " in "
  ...
  VLOG(compiler) << "Successfully inlined " << ArtMethod::PrettyMethod(method);
