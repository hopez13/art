...
HInliner::InlineCacheType HInliner::ExtractClassesFromOfflineProfile(
  ...
  // the inline cache types. Note that this is optimized to work better for
  // a small number of dex files (less than kIndividualCacheSize); which is
  ...
  // Walk over the classes and resolve them. If we can't find a type we return
