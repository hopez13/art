...
void LocationsBuilderRISCV64::HandleFieldGet(HInstruction* instruction) {
  ...
  bool object_field_get_with_read_barrier =
      (instruction->GetType() == DataType::Type::kReference) && codegen->EmitReadBarrier();
...
void LocationsBuilderRISCV64::VisitLoadClass(HLoadClass* instruction) {
  ...
  const bool requires_read_barrier = !instruction->IsInBootImage() && codegen->EmitReadBarrier();
