 ...
 *
 * A local optimization pass that greedily merges redundant constructor fences
 ...
 * - No Publish(R) must exist for any R in CFS s.t. it's between any CF in CFS.
...
class ConstructorFenceRedundancyElimination : public HOptimization {
 public:
  ...
  static constexpr const char* kPassName = "cfre";
