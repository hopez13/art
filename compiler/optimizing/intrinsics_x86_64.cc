  ...
  if (DataType::IsFloatingPointType(type)) {
    ...
    switch (type) {
      ...
      case DataType::Type::kUint64:
        ...
        break;
      default:
        CHECK(false) << "unexpected type in getAndSet intrinsic";
        UNREACHABLE();
    }
    if (byte_swap) {
      codegen->GetInstructionCodegen()->Bswap(value, type);
...
static void GenerateVarHandleGetAndOp(HInvoke* invoke,
  ...
  switch (get_and_update_op) {
    ...
    case GetAndUpdateOp::kBitwiseXor:
      ...
      break;
    default:
      CHECK(false) <<  "unexpected operation";
      UNREACHABLE();
  }
  ...
  switch (type) {
    ...
    case DataType::Type::kUint64:
      ...
      break;
    default:
      CHECK(false) << "unexpected type in getAndBitwiseOp intrinsic";
      UNREACHABLE();
  }
    ...
    if (byte_swap) {
      ...
      switch (type) {
        ...
        case DataType::Type::kUint64:
          ...
          break;
        default:
          CHECK(false) << "unexpected type in getAndAdd intrinsic";
          UNREACHABLE();
      }
    }
  }
