...
class ReadBarrierSystemArrayCopySlowPathX86_64 : public SlowPathCode {
 public:
  ReadBarrierSystemArrayCopySlowPathX86_64(HInstruction* instruction) : SlowPathCode(instruction) {
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    int32_t entry_point_offset =
        CodeGenerator::GetReadBarrierMarkEntryPointsOffset<kX86_64WordSize>(TMP);
...
void IntrinsicCodeGeneratorX86_64::VisitSystemArrayCopy(HInvoke* invoke) {
  ...
  if (kEmitCompilerReadBarrier && kUseBakerReadBarrier) {
    ...
    __ shrl(CpuRegister(TMP), Immediate(LockWord::kReadBarrierStateShift));
    __ andl(CpuRegister(TMP), Immediate(LockWord::kReadBarrierStateMask));
    static_assert(
    ...
    __ cmpl(CpuRegister(TMP), Immediate(ReadBarrier::gray_ptr_));
    __ j(kEqual, read_barrier_slow_path->GetEntryLabel());
