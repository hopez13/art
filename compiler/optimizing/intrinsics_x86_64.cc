...
void IntrinsicCodeGeneratorX86_64::VisitStringGetCharsNoCheck(HInvoke* invoke) {
  ...
  NearLabel done, compressed_string_comparison;
  ...
  __ j(kLessEqual, &compressed_string_comparison);
  if (srcBegin.IsConstant()) {
  ...
  __ Bind(&compressed_string_comparison);
  if (srcBegin.IsConstant()) {
