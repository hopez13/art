...
void IntrinsicCodeGeneratorX86_64::VisitStringEquals(HInvoke* invoke) {
  ...
  NearLabel string_not_compressed;
...
void IntrinsicCodeGeneratorX86_64::VisitStringGetCharsNoCheck(HInvoke* invoke) {
  ...
  __ leaq(CpuRegister(RSI), CodeGeneratorX86_64::ArrayAddress(obj, srcBegin,
  ...
  __ Bind(&copy_loop);
  __ jrcxz(&done);
  // Use dstBegin as temporary (not used anymore to convert byte from RSI to word).
