...
// return pred-field-get[val_phi, target_phi] => PredFieldGet[val_phi, target_phi]
...
// val_phi = PHI[3,3,10]
// target_phi = PHI[param2, param3, obj2]
// return pred-field-get[val_phi, target_phi] => PredFieldGet[3, target_phi]
...
// return pred-field-get[val_phi, target_phi] => fieldGet[target_phi]
