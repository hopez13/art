...
static void GenUnsafeGet(HInvoke* invoke,
  ...
  switch (type) {
    case Primitive::kPrimLong: {
      ...
      // TODO: must be atomic if volatile.
      if (is_R6) {
        __ Lw(trg_lo, TMP, 0);
        __ Lw(trg_hi, TMP, 4);
      } else {
    ...
    case Primitive::kPrimInt: {
      ...
      // TODO: must be atomic if volatile & unaligned?
      if (is_R6) {
        __ Lw(trg, TMP, 0);
      } else {
        __ Lwr(trg, TMP, 0);
    ...
    case Primitive::kPrimNot: {
      // TODO: what about alignment? Read barrier code expects aligned.
      Register trg = trg_loc.AsRegister<Register>();
...
static void GenUnsafePut(LocationSummary* locations,
  ...
  if ((type == Primitive::kPrimInt) || (type == Primitive::kPrimNot)) {
    ...
    // TODO: must kPrimInt store be atomic if volatile & unaligned?
    // TODO: what about alignment of kPrimNot? Read barrier code expects aligned.
    if (is_R6) {
      __ Sw(value, TMP, 0);
    } else {
      __ Swr(value, TMP, 0);
