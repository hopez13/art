...
class HInstructionBuilder : public ValueObject {
 ...
 private:
  ...
  // Build a HConstructorFence for HNew* instructions. This ensures the happens-before ordering for
  // default-initialization of the object referred to by new_instance.
  void BuildConstructorFenceForNew(HInstruction* new_instance);
