...
TEST(DataType, SizeAgainstPrimitive) {
  ...
  CheckConversion<DataType::Type::kBoolean, Primitive::kPrimBoolean>();
  ...
  CheckConversion<DataType::Type::kFloat, Primitive::kPrimFloat>();
  CheckConversion<DataType::Type::kDouble, Primitive::kPrimDouble>();
