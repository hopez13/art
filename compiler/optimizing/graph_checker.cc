...
void GraphChecker::VisitArraySet(HArraySet* instruction) {
  ...
  CheckWriteBarrier(
      ...
      [](HInstruction* it_instr) { return it_instr->IsArraySet(); },
      [](HInstruction* it_instr) { return it_instr->AsArraySet()->GetWriteBarrierKind(); });
}
...
void GraphChecker::VisitInstanceFieldSet(HInstanceFieldSet* instruction) {
  ...
  CheckWriteBarrier(
      ...
      instruction->GetWriteBarrierKind(),
      instruction->GetValue(),
      [](HInstruction* it_instr) { return it_instr->IsInstanceFieldSet(); },
      [](HInstruction* it_instr) { return it_instr->AsInstanceFieldSet()->GetWriteBarrierKind(); });
}
...
void GraphChecker::VisitStaticFieldSet(HStaticFieldSet* instruction) {
  ...
  CheckWriteBarrier(
      ...
      instruction->GetWriteBarrierKind(),
      instruction->GetValue(),
      [](HInstruction* it_instr) { return it_instr->IsStaticFieldSet(); },
      [](HInstruction* it_instr) { return it_instr->AsStaticFieldSet()->GetWriteBarrierKind(); });
}

void GraphChecker::CheckWriteBarrier(
    HInstruction* instruction,
    DataType::Type type,
    WriteBarrierKind write_barrier_kind,
    HInstruction* value,
    const std::function<bool(HInstruction*)>& instruction_type_cast,
    const std::function<WriteBarrierKind(HInstruction*)>& get_write_barrier_kind) {
  ...
  for (HBackwardInstructionIterator it(instruction); !it.Done(); it.Advance()) {
    if (instruction_type_cast(it.Current()) &&
