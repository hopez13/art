...
class SuperblockCloner : public ValueObject {
 ...
 private:
  ...
  // The induction analysis that the loop optimization uses. If not null, the superblock
  // cloner will update it when it replaces instructions with new instructions.
