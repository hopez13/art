...
void InstructionSimplifierVisitor::VisitIf(HIf* instruction) {
  ...
  // If a condition 'cond' is evaluated in an HIf instruction then in the successors of the this
