...
HBasicBlock* HGraph::TransformLoopForVectorization(HBasicBlock* header, HBasicBlock* body, HBasicBlock* exit) {
  DCHECK(header->IsLoopHeader());
  ...
  suspend_check->CopyEnvironmentFrom(loop->GetSuspendCheck()->GetEnvironment());
