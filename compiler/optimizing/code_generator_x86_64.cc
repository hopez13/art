...
void SetInForReturnValue(HInstruction* instr, LocationSummary* locations, int index) {
  switch (instr->InputAt(index)->GetType()) {
    ...
    case DataType::Type::kInt32:
    case DataType::Type::kInt64:
      locations->SetInAt(index, Location::RegisterLocation(RAX));
      break;
    ...
    default:
      LOG(FATAL) << "Unexpected return type " << instr->InputAt(index)->GetType();
  }
}
