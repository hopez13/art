...
class CompileOptimizedSlowPathX86_64 : public SlowPathCode {
 public:
  CompileOptimizedSlowPathX86_64(uint64_t counter_address)
  ...
  void EmitNativeCode(CodeGenerator* codegen) override {
    ...
    __ movl(Address(CpuRegister(TMP), ProfilingInfo::BaselineHotnessCountOffset().Int32Value()),
            Immediate(ProfilingInfo::GetOptimizeThreshold()));
    __ jmp(GetExitLabel());
  }
