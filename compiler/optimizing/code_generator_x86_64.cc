...
class DivZeroCheckSlowPathX86_64 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_64_codegen->InvokeRuntime(kQuickThrowDivZero,
                                  instruction_,
                                  instruction_->GetDexPc(),
                                  this);
...
class SuspendCheckSlowPathX86_64 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    CodeGeneratorX86_64* x86_64_codegen = down_cast<CodeGeneratorX86_64*>(codegen);
    __ Bind(GetEntryLabel());
    x86_64_codegen->InvokeRuntime(kQuickTestSuspend,
                                  instruction_,
                                  instruction_->GetDexPc(),
                                  this);
...
class BoundsCheckSlowPathX86_64 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_64_codegen->InvokeRuntime(entrypoint,
                                  instruction_,
                                  instruction_->GetDexPc(),
                                  this);
 ...
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    if (instruction_->IsInstanceOf()) {
      x86_64_codegen->InvokeRuntime(kQuickInstanceofNonTrivial,
                                    instruction_,
                                    dex_pc,
                                    this);
      ...
      DCHECK(instruction_->IsCheckCast());
      x86_64_codegen->InvokeRuntime(kQuickCheckCast,
                                    instruction_,
                                    dex_pc,
                                    this);
...
class DeoptimizationSlowPathX86_64 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    __ Bind(GetEntryLabel());
    SaveLiveRegisters(codegen, instruction_->GetLocations());
    x86_64_codegen->InvokeRuntime(kQuickDeoptimize,
                                  instruction_,
                                  instruction_->GetDexPc(),
                                  this);
...
class ArraySetSlowPathX86_64 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    CodeGeneratorX86_64* x86_64_codegen = down_cast<CodeGeneratorX86_64*>(codegen);
    x86_64_codegen->InvokeRuntime(kQuickAputObject,
                                  instruction_,
                                  instruction_->GetDexPc(),
                                  this);
...
void CodeGeneratorX86_64::InvokeRuntime(QuickEntrypointEnum entrypoint,
  ...
  InvokeRuntimeHelper(GetThreadOffset<kX86_64PointerSize>(entrypoint).Int32Value());
...
void CodeGeneratorX86_64::InvokeRuntimeWithoutRecordingPcInfo(int32_t entry_point_offset,
  ...
  InvokeRuntimeHelper(entry_point_offset);
}

void CodeGeneratorX86_64::InvokeRuntimeHelper(int32_t entry_point_offset) {
