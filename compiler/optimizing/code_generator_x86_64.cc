...
Label* CodeGeneratorX86_64::NewTypeBssEntryPatch(HLoadClass* load_class) {
  bss_entry_type_patches_.emplace_back(load_class->GetDexFile(), load_class->GetTypeIndex().index_);
  return &bss_entry_type_patches_.back().label;
}
...
void CodeGeneratorX86_64::EmitLinkerPatches(ArenaVector<LinkerPatch>* linker_patches) {
  ...
  EmitPcRelativeLinkerPatches<LinkerPatch::TypeBssEntryPatch>(bss_entry_type_patches_,
                                                              linker_patches);
...
CodeGeneratorX86_64::CodeGeneratorX86_64(HGraph* graph,
      ...
      : CodeGenerator(graph,
        ...
        bss_entry_type_patches_(graph->GetArena()->Adapter(kArenaAllocCodeGenerator)),
