...
#define STL_FRIENDS(clazz) \
  clazz() : clazz(HInstructionList()) {} \
  friend struct HSTLInstructionIterator<clazz>
...
class HInstructionIterator : public ValueObject {
 ...
 private:
  ...
  STL_FRIENDS(HInstructionIterator);
};
...
class HInstructionIteratorHandleChanges : public ValueObject {
 ...
 private:
  ...
  STL_FRIENDS(HInstructionIteratorHandleChanges);
};
...
class HBackwardInstructionIterator : public ValueObject {
 ...
 private:
  ...
  STL_FRIENDS(HBackwardInstructionIterator);
};
