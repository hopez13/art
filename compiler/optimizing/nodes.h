...
#undef DECLARE_KIND
  ...
  // Move `this` instruction before `cursor`, globally.
  void MoveBefore(HInstruction* cursor);

  // Move `this` instruction after `cursor`, locally.
  void LocalMoveAfter(HInstruction* cursor);
...
#undef INSTRUCTION_TYPE_CHECK
 ...
 protected:
  ...
  void MoveBeforeUnchecked(HInstruction* cursor);
