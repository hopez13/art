...
#undef INSTRUCTION_TYPE_CHECK
 ...
 protected:
  ...
  explicit HInstruction(const HInstruction& other)
    ...
    SetPackedField<InstructionKindField>(other.GetKind());
  }
...
class HTemplateInstruction: public HInstruction {
 public:
  HTemplateInstruction<N>(InstructionKind kind,
                          SideEffects side_effects, uint32_t dex_pc)
...
class HTemplateInstruction<0>: public HInstruction {
 public:
  explicit HTemplateInstruction<0>(InstructionKind kind,
                                   SideEffects side_effects, uint32_t dex_pc)
...
class HExpression : public HTemplateInstruction<N> {
 public:
  ...
  HExpression<N>(InstructionKind kind,
                 DataType::Type type, SideEffects side_effects, uint32_t dex_pc)
 ...
 public:
  ...
  HShouldDeoptimizeFlag(ArenaAllocator* allocator, uint32_t dex_pc)
      : HVariableInputSizeInstruction(kShouldDeoptimizeFlag,
                                      SideEffects::None(), dex_pc, allocator, 0,
                                      kArenaAllocCHA) {
  }
...
class HUnaryOperation : public HExpression<1> {
 public:
  HUnaryOperation(InstructionKind kind, DataType::Type result_type,
...
class HBinaryOperation : public HExpression<2> {
 public:
  HBinaryOperation(InstructionKind kind, DataType::Type result_type,
                   HInstruction* left,
                   HInstruction* right,
...
class HCondition : public HBinaryOperation {
 public:
  HCondition(InstructionKind kind, HInstruction* first, HInstruction* second,
             uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kind, DataType::Type::kBool, first, second,
 ...
 public:
  HNewInstance(HInstruction* cls,
      ...
      : HExpression(kNewInstance,
                    ...
                    SideEffects::CanTriggerGC(), dex_pc),
...
class HNewArray FINAL : public HExpression<2> {
 public:
  HNewArray(HInstruction* cls, HInstruction* length, uint32_t dex_pc)
      : HExpression(kNewArray, DataType::Type::kReference,
                    SideEffects::CanTriggerGC(), dex_pc) {
    SetRawInputAt(0, cls);
...
class HAdd FINAL : public HBinaryOperation {
 public:
  HAdd(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kAdd, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HSub FINAL : public HBinaryOperation {
 public:
  HSub(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kSub, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HMul FINAL : public HBinaryOperation {
 public:
  HMul(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kMul, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HDiv FINAL : public HBinaryOperation {
 public:
  HDiv(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc)
      : HBinaryOperation(kDiv, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HRem FINAL : public HBinaryOperation {
 public:
  HRem(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc)
      : HBinaryOperation(kRem, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HDivZeroCheck FINAL : public HExpression<1> {
 public:
  ...
  HDivZeroCheck(HInstruction* value, uint32_t dex_pc)
      : HExpression(kDivZeroCheck, value->GetType(),
                    SideEffects::CanTriggerGC(), dex_pc) {
    SetRawInputAt(0, value);
  }
...
class HShl FINAL : public HBinaryOperation {
 public:
  HShl(DataType::Type result_type,
       ...
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kShl, result_type, value, distance,
                         SideEffects::None(), dex_pc) {
...
class HShr FINAL : public HBinaryOperation {
 public:
  HShr(DataType::Type result_type,
       ...
       HInstruction* distance,
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kShr, result_type, value, distance,
                         SideEffects::None(), dex_pc) {
    DCHECK_EQ(result_type, DataType::Kind(value->GetType()));
    DCHECK_EQ(DataType::Type::kInt32, DataType::Kind(distance->GetType()));
  }
...
class HUShr FINAL : public HBinaryOperation {
 public:
  HUShr(DataType::Type result_type,
        ...
        HInstruction* distance,
        uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kUShr, result_type, value, distance,
                         SideEffects::None(), dex_pc) {
    DCHECK_EQ(result_type, DataType::Kind(value->GetType()));
    DCHECK_EQ(DataType::Type::kInt32, DataType::Kind(distance->GetType()));
  }
...
class HAnd FINAL : public HBinaryOperation {
 public:
  HAnd(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kAnd, result_type, left, right,
                         SideEffects::None(), dex_pc) {
  }
...
class HOr FINAL : public HBinaryOperation {
 public:
  HOr(DataType::Type result_type,
      ...
      HInstruction* right,
      uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kOr, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HXor FINAL : public HBinaryOperation {
 public:
  HXor(DataType::Type result_type,
       ...
       HInstruction* right,
       uint32_t dex_pc = kNoDexPc)
      : HBinaryOperation(kXor, result_type, left, right, SideEffects::None(),
                         dex_pc) {
  }
...
class HParameterValue FINAL : public HExpression<0> {
 public:
  HParameterValue(const DexFile& dex_file,
                  ...
                  bool is_this = false)
      : HExpression(kParameterValue, parameter_type, SideEffects::None(),
                    kNoDexPc),
        dex_file_(dex_file),
        type_index_(type_index),
        index_(index) {
...
class HNullCheck FINAL : public HExpression<1> {
 public:
  ...
  HNullCheck(HInstruction* value, uint32_t dex_pc)
      : HExpression(kNullCheck, value->GetType(), SideEffects::CanTriggerGC(),
                    dex_pc) {
    SetRawInputAt(0, value);
  }
...
class HArrayLength FINAL : public HExpression<1> {
 public:
  HArrayLength(HInstruction* array, uint32_t dex_pc, bool is_string_length = false)
      : HExpression(kArrayLength, DataType::Type::kInt32, SideEffects::None(),
                    dex_pc) {
...
class HBoundsCheck FINAL : public HExpression<2> {
 public:
  ...
  HBoundsCheck(HInstruction* index,
      ...
      : HExpression(kBoundsCheck, index->GetType(),
                    SideEffects::CanTriggerGC(), dex_pc) {
...
class HSuspendCheck FINAL : public HTemplateInstruction<0> {
 public:
  explicit HSuspendCheck(uint32_t dex_pc = kNoDexPc)
      : HTemplateInstruction(kSuspendCheck, SideEffects::CanTriggerGC(),
                             dex_pc),
                             slow_path_(nullptr) {
  }
...
class HStaticFieldGet FINAL : public HExpression<1> {
 public:
  HStaticFieldGet(HInstruction* cls,
                  ...
                  const DexFile& dex_file,
                  uint32_t dex_pc)
      : HExpression(kStaticFieldGet, field_type,
                    SideEffects::FieldReadOfType(field_type, is_volatile),
                    dex_pc),
        field_info_(field,
                    field_offset,
 ...
 public:
  HStaticFieldSet(HInstruction* cls,
      ...
      : HTemplateInstruction(kStaticFieldSet,
                             SideEffects::FieldWriteOfType(field_type,
                                                           is_volatile),
                             dex_pc),
        field_info_(field,
                    field_offset,
 ...
 public:
  HUnresolvedInstanceFieldGet(HInstruction* obj,
      ...
      : HExpression(kUnresolvedInstanceFieldGet,
                    field_type, SideEffects::AllExceptGCDependency(), dex_pc),
 ...
 public:
  HUnresolvedInstanceFieldSet(HInstruction* obj,
      ...
      : HTemplateInstruction(kUnresolvedInstanceFieldSet,
                             SideEffects::AllExceptGCDependency(), dex_pc),
        field_index_(field_index) {
...
class HUnresolvedStaticFieldGet FINAL : public HExpression<0> {
 public:
  HUnresolvedStaticFieldGet(DataType::Type field_type,
                            uint32_t field_index,
                            uint32_t dex_pc)
      : HExpression(kUnresolvedStaticFieldGet, field_type,
                    SideEffects::AllExceptGCDependency(), dex_pc),
        field_index_(field_index) {
  }
...
class HLoadException FINAL : public HExpression<0> {
 public:
  explicit HLoadException(uint32_t dex_pc = kNoDexPc)
      : HExpression(kLoadException, DataType::Type::kReference,
                    SideEffects::None(), dex_pc) {
  }
...
class HClearException FINAL : public HTemplateInstruction<0> {
 public:
  explicit HClearException(uint32_t dex_pc = kNoDexPc)
      : HTemplateInstruction(kClearException,
                             SideEffects::AllWrites(), dex_pc) {
  }
...
class HInstanceOf FINAL : public HExpression<2> {
 public:
  HInstanceOf(HInstruction* object,
              ...
              uint32_t dex_pc)
      : HExpression(kInstanceOf, DataType::Type::kBool,
...
class HBoundType FINAL : public HExpression<1> {
 public:
  explicit HBoundType(HInstruction* input, uint32_t dex_pc = kNoDexPc)
      : HExpression(kBoundType, DataType::Type::kReference,
                    SideEffects::None(), dex_pc),
...
class HMemoryBarrier FINAL : public HTemplateInstruction<0> {
 public:
  explicit HMemoryBarrier(MemBarrierKind barrier_kind, uint32_t dex_pc = kNoDexPc)
      : HTemplateInstruction(kMemoryBarrier,
...
class HMonitorOperation FINAL : public HTemplateInstruction<1> {
 public:
  ...
  HMonitorOperation(HInstruction* object, OperationKind kind, uint32_t dex_pc)
    : HTemplateInstruction(kMonitorOperation,
          SideEffects::AllExceptGCDependency(),  // Assume write/read on all fields/arrays.
          dex_pc) {
...
class HSelect FINAL : public HExpression<3> {
 public:
  HSelect(HInstruction* condition,
          ...
          uint32_t dex_pc)
      : HExpression(kSelect, HPhi::ToPhiType(true_value->GetType()),
                    SideEffects::None(), dex_pc) {
...
class HIntermediateAddress FINAL : public HExpression<2> {
 public:
  HIntermediateAddress(HInstruction* base_address, HInstruction* offset, uint32_t dex_pc)
      : HExpression(kIntermediateAddress, DataType::Type::kInt32,
