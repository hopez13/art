...
class HGraph : public ArenaObject<kArenaAllocGraph> {
 public:
  HGraph(ArenaAllocator* allocator,
      ...
      : allocator_(allocator),
        ...
        reachability_graph_(allocator->Adapter(kArenaAllocReachabilityGraph)),
 ...
 private:
  ...
  // each blocks_.size() is the reachability of each node.
  ArenaVector<bool> reachability_graph_;
