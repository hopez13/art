...
#undef DECLARE_KIND
  ...
  virtual bool CanDoImplicitNullCheckOn(HInstruction* obj [[maybe_unused]]) const { return false; }
...
#undef INSTRUCTION_TYPE_CAST
  ...
  virtual HInstruction* Clone(ArenaAllocator* arena [[maybe_unused]]) const {
  ...
  virtual bool InstructionDataEquals(const HInstruction* other [[maybe_unused]]) const {
    return false;
  }
...
class HBinaryOperation : public HExpression<2> {
 public:
  ...
  virtual HConstant* Evaluate(HNullConstant* x [[maybe_unused]],
                              HNullConstant* y [[maybe_unused]]) const {
  ...
  virtual HConstant* Evaluate(HLongConstant* x [[maybe_unused]],
                              HIntConstant* y [[maybe_unused]]) const {
...
class HEqual final : public HCondition {
 public:
  ...
  HConstant* Evaluate(HNullConstant* x [[maybe_unused]],
                      HNullConstant* y [[maybe_unused]]) const override {
...
class HCompare final : public HBinaryOperation {
 public:
  ...
  static SideEffects SideEffectsForArchRuntimeCalls(DataType::Type type [[maybe_unused]]) {
...
class HInvokeStaticOrDirect final : public HInvoke {
 public:
  ...
  bool CanDoImplicitNullCheckOn(HInstruction* obj [[maybe_unused]]) const override {
...
class HShl final : public HBinaryOperation {
 public:
  ...
  HConstant* Evaluate(HLongConstant* value [[maybe_unused]],
                      HLongConstant* distance [[maybe_unused]]) const override {
    LOG(FATAL) << DebugName() << " is not defined for the (long, long) case.";
    UNREACHABLE();
  }
  HConstant* Evaluate(HFloatConstant* value [[maybe_unused]],
                      HFloatConstant* distance [[maybe_unused]]) const override {
    LOG(FATAL) << DebugName() << " is not defined for float values";
    UNREACHABLE();
  }
  HConstant* Evaluate(HDoubleConstant* value [[maybe_unused]],
                      HDoubleConstant* distance [[maybe_unused]]) const override {
    LOG(FATAL) << DebugName() << " is not defined for double values";
    UNREACHABLE();
  }
...
class HBooleanNot final : public HUnaryOperation {
 public:
  ...
  HConstant* Evaluate(HLongConstant* x [[maybe_unused]]) const override {
...
class HGraphVisitor : public ValueObject {
 public:
  ...
  virtual void VisitInstruction(HInstruction* instruction [[maybe_unused]]) {}
