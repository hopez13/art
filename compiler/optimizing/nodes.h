...
class HGraph : public ArenaObject<kArenaAllocGraph> {
 public:
  ...
  // phi in the preheader should collate the inputs from the original multiply incoming blocks.
...
class HLoopInformation : public ArenaObject<kArenaAllocLoopInfo> {
 public:
  ...
  // Update blocks population of the loop and all of its outer' ones recursively after the
  ...
  // Reset back edge and blocks-in-loop data.
...
class HBasicBlock : public ArenaObject<kArenaAllocBasicBlock> {
 public:
  ...
  // Register a back edge; if the block was not a loop header before the call associate a newly
