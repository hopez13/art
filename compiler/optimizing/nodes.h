...
#undef INSTRUCTION_TYPE_CAST
  ...
  // Check whether the i-th operand is non-negative.
  bool IsInputNonNegativeAt(size_t i);

  // Check whether the i-th operand is non-negative or the minimum integer value.
  bool IsInputNonNegativeOrMinIntAt(size_t i);
