...
class HConstructorFence FINAL : public HVariableInputSizeInstruction {
 ...
 public:
  ...
  HConstructorFence(HInstruction* fence_object,
    ...
    //
    // In the implementation, this initially starts out as an "all reads" side effect; this an
    // even more conservative approach to the one described above, and prevents all of the
