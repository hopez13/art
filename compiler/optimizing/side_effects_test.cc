...
TEST(SideEffectsTest, DependencesAndNoDependences) {
  ...
  for (DataType::Type type = DataType::Type::kReference;
       ...
       type = static_cast<DataType::Type>(static_cast<uint8_t>(type) + 1)) {
...
TEST(SideEffectsTest, NoDependences) {
  ...
  testNoWriteAndReadDependence(
      ...
      SideEffects::FieldReadOfType(DataType::Type::kDouble, false));
  testNoWriteAndReadDependence(
      SideEffects::ArrayWriteOfType(DataType::Type::kInt32),
      SideEffects::ArrayReadOfType(DataType::Type::kDouble));
...
TEST(SideEffectsTest, SameWidthTypesNoAlias) {
  ...
  testNoWriteAndReadDependence(
      SideEffects::FieldWriteOfType(DataType::Type::kInt32, /* is_volatile */ false),
      SideEffects::FieldReadOfType(DataType::Type::kFloat, /* is_volatile */ false));
  testNoWriteAndReadDependence(
      SideEffects::ArrayWriteOfType(DataType::Type::kInt32),
      SideEffects::ArrayReadOfType(DataType::Type::kFloat));
  // Type L/D.
  testNoWriteAndReadDependence(
      SideEffects::FieldWriteOfType(DataType::Type::kInt64, /* is_volatile */ false),
      SideEffects::FieldReadOfType(DataType::Type::kDouble, /* is_volatile */ false));
  testNoWriteAndReadDependence(
...
TEST(SideEffectsTest, BitStrings) {
  ...
  EXPECT_STREQ(
      "|||||Z||",
      SideEffects::ArrayWriteOfType(DataType::Type::kBoolean).ToString().c_str());
  EXPECT_STREQ(
      "|||||C||",
  ...
  EXPECT_STREQ(
      "||D|||||",
      SideEffects::ArrayReadOfType(DataType::Type::kDouble).ToString().c_str());
  EXPECT_STREQ(
      "||J|||||",
      SideEffects::ArrayReadOfType(DataType::Type::kInt64).ToString().c_str());
  EXPECT_STREQ(
      "||F|||||",
      SideEffects::ArrayReadOfType(DataType::Type::kFloat).ToString().c_str());
  EXPECT_STREQ(
      "||I|||||",
  ...
  s = s.Union(SideEffects::ArrayReadOfType(DataType::Type::kFloat));
  s = s.Union(SideEffects::ArrayReadOfType(DataType::Type::kDouble));
