...
TEST_F(LoadStoreAnalysisTest, ArrayAliasingTest) {
  ...
  HInstruction* arr_set_0 = new (&allocator_) HArraySet(array, c0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_1 = new (&allocator_) HArraySet(array, c1, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_i = new (&allocator_) HArraySet(array, index, c0, DataType::Type::kInt32, 0);

  HVecOperation* v1 = new (&allocator_) HVecReplicateScalar(&allocator_,
                                                            c1,
                                                            DataType::Type::kInt32,
                                                            4);
  HVecOperation* v2 = new (&allocator_) HVecReplicateScalar(&allocator_,
                                                            c1,
                                                            DataType::Type::kInt32,
                                                            2);
  HInstruction* i_add6 = new (&allocator_) HAdd(DataType::Type::kInt32, index, c6);
  HInstruction* i_add8 = new (&allocator_) HAdd(DataType::Type::kInt32, index, c8);

  HInstruction* vstore_0 = new (&allocator_) HVecStore(&allocator_,
                                                       array,
                                                       c0,
                                                       v1,
                                                       DataType::Type::kInt32,
                                                       4,
                                                       0);
  HInstruction* vstore_1 = new (&allocator_) HVecStore(&allocator_,
                                                       array,
                                                       c1,
                                                       v1,
                                                       DataType::Type::kInt32,
                                                       4,
                                                       0);
  HInstruction* vstore_8 = new (&allocator_) HVecStore(&allocator_,
                                                       array,
                                                       c8,
                                                       v1,
                                                       DataType::Type::kInt32,
                                                       4,
                                                       0);
  HInstruction* vstore_i = new (&allocator_) HVecStore(&allocator_,
                                                       array,
                                                       index,
                                                       v1,
                                                       DataType::Type::kInt32,
                                                       4,
                                                       0);
  HInstruction* vstore_i_add6 = new (&allocator_) HVecStore(&allocator_,
                                                            array,
                                                            i_add6,
                                                            v1,
                                                            DataType::Type::kInt32,
                                                            4,
                                                            0);
  HInstruction* vstore_i_add8 = new (&allocator_) HVecStore(&allocator_,
                                                            array,
                                                            i_add8,
                                                            v1,
                                                            DataType::Type::kInt32,
                                                            4,
                                                            0);
  HInstruction* vstore_i_add6_vlen2 = new (&allocator_) HVecStore(&allocator_,
                                                                  array,
                                                                  i_add6,
                                                                  v2,
                                                                  DataType::Type::kInt32,
