...
TEST_F(LoadStoreAnalysisTest, ArrayHeapLocations) {
  ...
  HInstruction* array_get1 = new (GetArena()) HArrayGet(array, c1, DataType::Type::kInt32, 0);
  HInstruction* array_get2 = new (GetArena()) HArrayGet(array, c2, DataType::Type::kInt32, 0);
  HInstruction* array_set1 = new (GetArena()) HArraySet(array, c1, c3, DataType::Type::kInt32, 0);
  HInstruction* array_set2 =
      new (GetArena()) HArraySet(array, index, c3, DataType::Type::kInt32, 0);
...
TEST_F(LoadStoreAnalysisTest, FieldHeapLocations) {
  ...
  HInstruction* c1 = graph_->GetIntConstant(1);
  HInstruction* object = new (GetArena()) HParameterValue(graph_->GetDexFile(),
                                                          dex::TypeIndex(0),
                                                          0,
                                                          DataType::Type::kReference);
  HInstanceFieldSet* set_field10 = new (GetArena()) HInstanceFieldSet(object,
                                                                      c1,
                                                                      nullptr,
                                                                      ...
                                                                      graph_->GetDexFile(),
                                                                      0);
  HInstanceFieldGet* get_field10 = new (GetArena()) HInstanceFieldGet(object,
                                                                      nullptr,
                                                                      DataType::Type::kInt32,
                                                                      MemberOffset(10),
                                                                      false,
                                                                      ...
                                                                      graph_->GetDexFile(),
                                                                      0);
  HInstanceFieldGet* get_field20 = new (GetArena()) HInstanceFieldGet(object,
                                                                      nullptr,
                                                                      DataType::Type::kInt32,
                                                                      MemberOffset(20),
                                                                      false,
...
TEST_F(LoadStoreAnalysisTest, ArrayIndexAliasingTest) {
  ...
  HInstruction* add0 = new (GetArena()) HAdd(DataType::Type::kInt32, index, c0);
  HInstruction* add1 = new (GetArena()) HAdd(DataType::Type::kInt32, index, c1);
  HInstruction* sub0 = new (GetArena()) HSub(DataType::Type::kInt32, index, c0);
  HInstruction* sub1 = new (GetArena()) HSub(DataType::Type::kInt32, index, c1);
  HInstruction* sub_neg1 = new (GetArena()) HSub(DataType::Type::kInt32, index, c_neg1);
  HInstruction* rev_sub1 = new (GetArena()) HSub(DataType::Type::kInt32, c1, index);
  HInstruction* arr_set1 = new (GetArena()) HArraySet(array, c0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set2 = new (GetArena()) HArraySet(array, c1, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set3 = new (GetArena()) HArraySet(array, add0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set4 = new (GetArena()) HArraySet(array, add1, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set5 = new (GetArena()) HArraySet(array, sub0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set6 = new (GetArena()) HArraySet(array, sub1, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set7 =
      new (GetArena()) HArraySet(array, rev_sub1, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set8 =
      new (GetArena()) HArraySet(array, sub_neg1, c0, DataType::Type::kInt32, 0);
...
TEST_F(LoadStoreAnalysisTest, ArrayIndexCalculationOverflowTest) {
  ...
  HInstruction* add_0x80000000 = new (GetArena()) HAdd(
      DataType::Type::kInt32, index, c_0x80000000);
  HInstruction* sub_0x80000000 = new (GetArena()) HSub(
      DataType::Type::kInt32, index, c_0x80000000);
  HInstruction* arr_set_1 = new (GetArena()) HArraySet(
      array, add_0x80000000, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_2 = new (GetArena()) HArraySet(
      array, sub_0x80000000, c0, DataType::Type::kInt32, 0);

  // `index+0x10` and `index-0xFFFFFFF0` array indices MAY alias.
  HInstruction* add_0x10 = new (GetArena()) HAdd(DataType::Type::kInt32, index, c_0x10);
  HInstruction* sub_0xFFFFFFF0 = new (GetArena()) HSub(
      DataType::Type::kInt32, index, c_0xFFFFFFF0);
  HInstruction* arr_set_3 = new (GetArena()) HArraySet(
      array, add_0x10, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_4 = new (GetArena()) HArraySet(
      array, sub_0xFFFFFFF0, c0, DataType::Type::kInt32, 0);

  // `index+0x7FFFFFFF` and `index-0x80000001` array indices MAY alias.
  HInstruction* add_0x7FFFFFFF = new (GetArena()) HAdd(
      DataType::Type::kInt32, index, c_0x7FFFFFFF);
  HInstruction* sub_0x80000001 = new (GetArena()) HSub(
      DataType::Type::kInt32, index, c_0x80000001);
  HInstruction* arr_set_5 = new (GetArena()) HArraySet(
      array, add_0x7FFFFFFF, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_6 = new (GetArena()) HArraySet(
      array, sub_0x80000001, c0, DataType::Type::kInt32, 0);

  // `index+0` and `index-0` array indices MAY alias.
  HInstruction* add_0 = new (GetArena()) HAdd(DataType::Type::kInt32, index, c0);
  HInstruction* sub_0 = new (GetArena()) HSub(DataType::Type::kInt32, index, c0);
  HInstruction* arr_set_7 = new (GetArena()) HArraySet(
      array, add_0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_8 = new (GetArena()) HArraySet(
