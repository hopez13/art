...
TEST_F(LoadStoreAnalysisTest, ArrayHeapLocations) {
  ...
  HInstruction* array_set2 = new (&allocator_) HArraySet(array, index, c3, DataType::Type::kInt32, 0);
...
TEST_F(LoadStoreAnalysisTest, ArrayIndexAliasingTest) {
  ...
  HInstruction* arr_set7 = new (&allocator_) HArraySet(array, rev_sub1, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set8 = new (&allocator_) HArraySet(array, sub_neg1, c0, DataType::Type::kInt32, 0);
...
TEST_F(LoadStoreAnalysisTest, ArrayIndexCalculationOverflowTest) {
  ...
  HInstruction* add_0x80000000 = new (&allocator_) HAdd(DataType::Type::kInt32, index, c_0x80000000);
  HInstruction* sub_0x80000000 = new (&allocator_) HSub(DataType::Type::kInt32, index, c_0x80000000);
  ...
  HInstruction* sub_0xFFFFFFF0 = new (&allocator_) HSub(DataType::Type::kInt32, index, c_0xFFFFFFF0);
  ...
  HInstruction* add_0x7FFFFFFF = new (&allocator_) HAdd(DataType::Type::kInt32, index, c_0x7FFFFFFF);
  HInstruction* sub_0x80000001 = new (&allocator_) HSub(DataType::Type::kInt32, index, c_0x80000001);
  ...
  HInstruction* arr_set_7 = new (&allocator_) HArraySet(array, add_0, c0, DataType::Type::kInt32, 0);
  HInstruction* arr_set_8 = new (&allocator_) HArraySet(array, sub_0, c0, DataType::Type::kInt32, 0);
