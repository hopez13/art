 ...
 public:
  ...
  struct ExcludedCohort {
   public:
    ...
    const std::unordered_set<const HBasicBlock*>& GetEntryBlocks() const {
    ...
    const std::unordered_set<const HBasicBlock*>& GetExitBlocks() const {
      return exit_blocks_;
    }
    // All blocks in the cohort.
    const std::unordered_set<const HBasicBlock*>& GetBlocks() const {
      return blocks_;
    }
