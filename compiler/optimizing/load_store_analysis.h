...
class HeapLocation : public ArenaObject<kArenaAllocLSA> {
 ...
 private:
  ...
  bool has_aliased_locations_;         // has aliased heap locations in the method, due to
                                       // either the reference is aliased or the array
                                       // element is aliased via different index
                                       // names.
