...
static void GenMinMaxFP(LocationSummary* locations,
  ...
  if (type == DataType::Type::kDouble) {
    ...
    DCHECK_EQ(type, DataType::Type::kFloat);
    __ CmpUnS(FTMP, a, b);
    __ Bc1eqz(FTMP, &noNaNs);
...
void IntrinsicCodeGeneratorMIPS64::VisitMathMinDoubleDouble(HInvoke* invoke) {
  GenMinMaxFP(invoke->GetLocations(), /* is_min */ true, DataType::Type::kDouble, GetAssembler());
}
...
void IntrinsicCodeGeneratorMIPS64::VisitMathMinFloatFloat(HInvoke* invoke) {
  GenMinMaxFP(invoke->GetLocations(), /* is_min */ true, DataType::Type::kFloat, GetAssembler());
}
...
void IntrinsicCodeGeneratorMIPS64::VisitMathMaxDoubleDouble(HInvoke* invoke) {
  GenMinMaxFP(invoke->GetLocations(), /* is_min */ false, DataType::Type::kDouble, GetAssembler());
}
...
void IntrinsicCodeGeneratorMIPS64::VisitMathMaxFloatFloat(HInvoke* invoke) {
  GenMinMaxFP(invoke->GetLocations(), /* is_min */ false, DataType::Type::kFloat, GetAssembler());
}
...
static void GenRound(LocationSummary* locations, Mips64Assembler* assembler, DataType::Type type) {
  ...
  DCHECK(type == DataType::Type::kFloat || type == DataType::Type::kDouble);
...
void IntrinsicCodeGeneratorMIPS64::VisitMathRoundFloat(HInvoke* invoke) {
  GenRound(invoke->GetLocations(), GetAssembler(), DataType::Type::kFloat);
}
...
void IntrinsicCodeGeneratorMIPS64::VisitMathRoundDouble(HInvoke* invoke) {
  GenRound(invoke->GetLocations(), GetAssembler(), DataType::Type::kDouble);
}
...
static void CreateFPToFPCallLocations(ArenaAllocator* arena, HInvoke* invoke) {
  ...
  locations->SetOut(calling_convention.GetReturnLocation(DataType::Type::kDouble));
}
