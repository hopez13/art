...
class FieldAccessCallingConventionARM64 : public FieldAccessCallingConvention {
 public:
  ...
  Location GetReturnLocation(DataType::Type type [[maybe_unused]]) const override {
    return helpers::LocationFrom(vixl::aarch64::x0);
  }
  Location GetSetValueLocation(DataType::Type type [[maybe_unused]],
                               bool is_instance) const override {
    return is_instance
        ? helpers::LocationFrom(vixl::aarch64::x2)
        : helpers::LocationFrom(vixl::aarch64::x1);
  }
  Location GetFpuLocation(DataType::Type type [[maybe_unused]]) const override {
...
class CodeGeneratorARM64 : public CodeGenerator {
 public:
  ...
  bool NeedsTwoRegisters(DataType::Type type [[maybe_unused]]) const override { return false; }
