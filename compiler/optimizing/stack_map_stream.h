...
class StackMapStream : public ValueObject {
 public:
  explicit StackMapStream(ScopedArenaAllocator* allocator, InstructionSet instruction_set)
      : allocator_(allocator),
        allocator_adapter_(allocator->Adapter(kArenaAllocStackMapStream)),
        instruction_set_(instruction_set),
        stack_maps_(allocator_adapter_),
        location_catalog_entries_(allocator_adapter_),
        location_catalog_entries_indices_(allocator_adapter_),
        dex_register_locations_(allocator_adapter_),
        inline_infos_(allocator_adapter_),
        stack_masks_(allocator_adapter_),
        register_masks_(allocator_adapter_),
        method_indices_(allocator_adapter_),
        dex_register_entries_(allocator_adapter_),
        stack_mask_max_(-1),
        out_(allocator_adapter_),
        dex_map_hash_to_stack_map_indices_(std::less<uint32_t>(), allocator_adapter_),
        current_entry_(),
 ...
 private:
  ...
  ScopedArenaAllocatorAdapter<void> allocator_adapter_;
