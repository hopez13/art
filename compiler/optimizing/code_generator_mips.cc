    ...
    switch (cond) {
      ...
      case kCondLE:
        if (isR6) {
          ...
          __ Sltiu(AT, lhs_low, 1);
          __ Slt(dst, lhs_high, ZERO);
          __ Movz(dst, AT, lhs_high);
        }
        break;
      case kCondGT:
        __ Or(TMP, lhs_high, lhs_low);
    ...
    switch (cond) {
      ...
      case kCondGE:
        if (isR6) {
          ...
          if (dst == lhs_low) {
            __ LoadConst32(TMP, imm_low);
            __ Slt(dst, lhs_low, TMP);
          }
          __ LoadConst32(TMP, imm_high);
          __ Slt(AT, lhs_high, TMP);
          __ Xor(TMP, lhs_high, TMP);
          if (dst != lhs_low) {
            __ LoadConst32(dst, imm_low);
            __ Sltu(dst, lhs_low, dst);
          }
