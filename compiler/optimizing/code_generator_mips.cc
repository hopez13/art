...
void LocationsBuilderMIPS::VisitDeoptimizationFlag(HDeoptimizationFlag* flag ATTRIBUTE_UNUSED) {
}

void InstructionCodeGeneratorMIPS::VisitDeoptimizationFlag(HDeoptimizationFlag* flag ATTRIBUTE_UNUSED) {
}
