...
static void inline ExcludeIPAndBakerCcEntrypointRegister(UseScratchRegisterScope* temps,
...
static void inline EmitPlaceholderBne(CodeGeneratorARMVIXL* codegen, vixl32::Label* patch_label) {
    ...
    case Primitive::kPrimNot: {
      ...
      if (kEmitCompilerReadBarrier && kUseBakerReadBarrier) {
        ...
        if (index.IsConstant()) {
          ...
          data_offset += Int64ConstantFrom(index) << Primitive::ComponentSizeShift(type);
          Location maybe_temp =
