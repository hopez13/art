...
void LocationsBuilderARMVIXL::VisitTypeConversion(HTypeConversion* conversion) {
  ...
  LocationSummary::CallKind call_kind =
      (((input_type == DataType::Type::kFloat || input_type == DataType::Type::kDouble)
       ...
       || (input_type == DataType::Type::kInt64 && result_type == DataType::Type::kFloat))
...
void LocationsBuilderARMVIXL::HandleFieldSet(
  ...
  bool is_wide = field_type == DataType::Type::kInt64 || field_type == DataType::Type::kDouble;
  ...
  if (needs_write_barrier) {
    ...
    locations->AddTemp(Location::RequiresRegister());
    locations->AddTemp(Location::RequiresRegister());
    if (field_type == DataType::Type::kDouble) {
...
void InstructionCodeGeneratorARMVIXL::HandleFieldSet(HInstruction* instruction,
  ...
  if (field_type != DataType::Type::kInt64 && field_type != DataType::Type::kDouble) {
...
void LocationsBuilderARMVIXL::HandleFieldGet(HInstruction* instruction,
  ...
  bool volatile_for_double = field_info.IsVolatile()
      && (field_info.GetFieldType() == DataType::Type::kDouble)
      && !codegen_->GetInstructionSetFeatures().HasAtomicLdrdAndStrd();
  ...
  bool overlap = (field_info.IsVolatile() && (field_info.GetFieldType() == DataType::Type::kInt64)) ||
      object_field_get_with_read_barrier;
...
void InstructionCodeGeneratorARMVIXL::HandleFieldGet(HInstruction* instruction,
  ...
  if (field_type == DataType::Type::kReference || field_type == DataType::Type::kDouble) {
...
void CodeGeneratorARMVIXL::MoveFromReturnRegister(Location trg, DataType::Type type) {
  ...
  if (type == DataType::Type::kInt64) {
    TODO_VIXL32(FATAL);
  } else if (type == DataType::Type::kDouble) {
    TODO_VIXL32(FATAL);
  } else {
