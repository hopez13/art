...
void IntrinsicCodeGeneratorARM::VisitStringCompareTo(HInvoke* invoke) {
  ...
  __ bic(temp0, temp2, ShifterOperand(0x80000000));
  __ bic(IP, temp1, ShifterOperand(0x80000000));
  // out = length diff.
  ...
  __ eors(temp2, temp2, ShifterOperand(temp1));
  __ b(&different_compression, MI);
  // Store offset of string value in preparation for comparison loop.
  __ mov(temp3, ShifterOperand(value_offset));
