...
class ReadBarrierSystemArrayCopySlowPathARM : public SlowPathCode {
 public:
  ReadBarrierSystemArrayCopySlowPathARM(HInstruction* instruction) : SlowPathCode(instruction) {
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    int32_t entry_point_offset =
        CodeGenerator::GetReadBarrierMarkEntryPointsOffset<kArmWordSize>(IP);
