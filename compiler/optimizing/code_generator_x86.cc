...
class BoundsCheckSlowPathMemoryX86 : public SlowPathCode {
 public:
  explicit BoundsCheckSlowPathMemoryX86(HX86BoundsCheck* instruction)
  ...
  void EmitNativeCode(CodeGenerator* codegen) override {
    ...
    Address array_length(locations->InAt(1).AsRegister<Register>(), len_offset);
...
void LocationsBuilderX86::VisitX86BoundsCheck(HX86BoundsCheck* instruction) {
...
void InstructionCodeGeneratorX86::VisitX86BoundsCheck(HX86BoundsCheck* instruction) {
  LocationSummary* locations = instruction->GetLocations();
  Location index_loc = locations->InAt(0);
