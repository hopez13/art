...
class LoadStringSlowPathX86 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_codegen->InvokeRuntime(kQuickResolveString,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
 ...
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    if (instruction_->IsInstanceOf()) {
      ...
      DCHECK(instruction_->IsCheckCast());
      x86_codegen->InvokeRuntime(kQuickCheckCast,
                                 instruction_,
                                 instruction_->GetDexPc(),
                                 this);
...
class DeoptimizationSlowPathX86 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    __ Bind(GetEntryLabel());
    SaveLiveRegisters(codegen, instruction_->GetLocations());
    x86_codegen->InvokeRuntime(kQuickDeoptimize,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
...
class ArraySetSlowPathX86 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    CodeGeneratorX86* x86_codegen = down_cast<CodeGeneratorX86*>(codegen);
    x86_codegen->InvokeRuntime(kQuickAputObject,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
...
class ReadBarrierForHeapReferenceSlowPathX86 : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    x86_codegen->InvokeRuntime(kQuickReadBarrierSlow,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
    CheckEntrypointTypes<
...
void CodeGeneratorX86::InvokeRuntime(QuickEntrypointEnum entrypoint,
  ...
  InvokeRuntimeHelper(GetThreadOffset<kX86PointerSize>(entrypoint).Int32Value());
...
void CodeGeneratorX86::InvokeRuntimeHelper(int32_t entry_point_offset) {
    ...
    case Primitive::kPrimLong:
      switch (input_type) {
        ...
        case Primitive::kPrimFloat:
          ...
          codegen_->InvokeRuntime(kQuickF2l,
                                  conversion,
                                  conversion->GetDexPc(),
                                  nullptr);
        ...
        case Primitive::kPrimDouble:
          ...
          codegen_->InvokeRuntime(kQuickD2l,
                                  conversion,
                                  conversion->GetDexPc(),
                                  nullptr);
