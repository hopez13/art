...
void LocationsBuilderX86::VisitBitwiseNegatedRight(HBitwiseNegatedRight* instruction) {
  UNUSED(instruction);
  LOG(FATAL) << "Unimplemented";
}

void InstructionCodeGeneratorX86::VisitBitwiseNegatedRight(HBitwiseNegatedRight* instruction) {
  UNUSED(instruction);
  LOG(FATAL) << "Unimplemented";
}
