...
#define OPTIMIZING_INTRINSICS(Name, ...) \
  virtual void Visit##Name(HInvoke* invoke [[maybe_unused]]) {}
#include "intrinsics_list.h"
  INTRINSICS_LIST(OPTIMIZING_INTRINSICS)
#undef INTRINSICS_LIST
#undef OPTIMIZING_INTRINSICS
...
#define UNIMPLEMENTED_INTRINSIC(Arch, Name)                                              \
  void IntrinsicLocationsBuilder##Arch::Visit##Name(HInvoke* invoke [[maybe_unused]]) {} \
  void IntrinsicCodeGenerator##Arch::Visit##Name(HInvoke* invoke [[maybe_unused]]) {}
