...
static void GenHighestOneBit(HInvoke* invoke,
  ...
  if (type == Primitive::kPrimLong) {
    ...
    __ Mov(temp, 1);
    __ Lsl(out_reg_lo, temp, out_reg_lo);
    __ Rbit(out_reg_lo, out_reg_lo);
    __ Lsls(out_reg_hi, temp, out_reg_hi);
    __ Rbit(out_reg_hi, out_reg_hi);
...
static void GenLowestOneBit(HInvoke* invoke,
  ...
  if (type == Primitive::kPrimLong) {
    ...
    __ And(out_reg_lo, temp, in_reg_lo);
