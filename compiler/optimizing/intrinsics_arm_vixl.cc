...
void IntrinsicLocationsBuilderARMVIXL::VisitUnsafePut(HInvoke* invoke) {
  CreateIntIntIntIntToVoid(arena_, features_, DataType::Type::kInt32, /* is_volatile */ false, invoke);
}
...
void IntrinsicLocationsBuilderARMVIXL::VisitUnsafePutVolatile(HInvoke* invoke) {
  CreateIntIntIntIntToVoid(arena_, features_, DataType::Type::kInt32, /* is_volatile */ true, invoke);
}
...
static void CreateFPToFPCallLocations(ArenaAllocator* arena, HInvoke* invoke) {
  ...
  DCHECK_EQ(invoke->InputAt(0)->GetType(), DataType::Type::kDouble);
  DCHECK_EQ(invoke->GetType(), DataType::Type::kDouble);
...
static void CreateFPFPToFPCallLocations(ArenaAllocator* arena, HInvoke* invoke) {
  ...
  DCHECK_EQ(invoke->InputAt(0)->GetType(), DataType::Type::kDouble);
  DCHECK_EQ(invoke->InputAt(1)->GetType(), DataType::Type::kDouble);
  DCHECK_EQ(invoke->GetType(), DataType::Type::kDouble);
