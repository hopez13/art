...
void SchedulingLatencyVisitorARM64::VisitIntermediateAddressIndex(HIntermediateAddressIndex* instr
                                                                  [[maybe_unused]]) {
  // Although the code generated is a simple `add` instruction, we found through empirical results
  // that spacing it from its use in memory accesses was beneficial.
...
void SchedulingLatencyVisitorARM64::VisitVecReplicateScalar(HVecReplicateScalar* instr
                                                            [[maybe_unused]]) {
...
void SchedulingLatencyVisitorARM64::VisitVecCnv(HVecCnv* instr [[maybe_unused]]) {
...
void SchedulingLatencyVisitorARM64::VisitVecAnd(HVecAnd* instr [[maybe_unused]]) {
  last_visited_latency_ = kArm64SIMDIntegerOpLatency;
}

void SchedulingLatencyVisitorARM64::VisitVecAndNot(HVecAndNot* instr [[maybe_unused]]) {
  last_visited_latency_ = kArm64SIMDIntegerOpLatency;
}

void SchedulingLatencyVisitorARM64::VisitVecOr(HVecOr* instr [[maybe_unused]]) {
  last_visited_latency_ = kArm64SIMDIntegerOpLatency;
}

void SchedulingLatencyVisitorARM64::VisitVecXor(HVecXor* instr [[maybe_unused]]) {
  last_visited_latency_ = kArm64SIMDIntegerOpLatency;
}
...
void SchedulingLatencyVisitorARM64::VisitVecMultiplyAccumulate(HVecMultiplyAccumulate* instr
                                                               [[maybe_unused]]) {
  last_visited_latency_ = kArm64SIMDMulIntegerLatency;
}
