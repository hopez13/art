...
class SchedulerTest : public OptimizingUnitTest {
 public:
  ...
  void TestBuildDependencyGraphAndSchedule(HScheduler* scheduler) {
    ...
    HInstruction* array_get1 = new (GetAllocator()) HArrayGet(array, add1, DataType::Type::kInt32, 0);
    HInstruction* array_set1 =
        new (GetAllocator()) HArraySet(array, add1, add2, DataType::Type::kInt32, 0);
    HInstruction* array_get2 = new (GetAllocator()) HArrayGet(array, add1, DataType::Type::kInt32, 0);
  ...
  void TestDependencyGraphOnAliasingArrayAccesses(HScheduler* scheduler) {
    ...
    HInstruction* arr_set_0 = new (GetAllocator()) HArraySet(arr, c0, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_1 = new (GetAllocator()) HArraySet(arr, c1, c0, DataType::Type::kInt32, 0);
