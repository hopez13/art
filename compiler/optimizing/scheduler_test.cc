...
class SchedulerTest : public CommonCompilerTest {
 public:
  ...
  void TestBuildDependencyGraphAndSchedule(HScheduler* scheduler) {
    ...
    HInstruction* array_set1 = new (&allocator_) HArraySet(array, add1, add2, DataType::Type::kInt32, 0);
    HInstruction* array_get2 = new (&allocator_) HArrayGet(array, add1, DataType::Type::kInt32, 0);
    HInstruction* array_set2 = new (&allocator_) HArraySet(array, add1, add2, DataType::Type::kInt32, 0);
  ...
  void TestDependencyGraphOnAliasingArrayAccesses(HScheduler* scheduler) {
    ...
    HInstruction* arr_set_add0 = new (&allocator_) HArraySet(arr, add0, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_add1 = new (&allocator_) HArraySet(arr, add1, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_sub0 = new (&allocator_) HArraySet(arr, sub0, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_sub1 = new (&allocator_) HArraySet(arr, sub1, c0, DataType::Type::kInt32, 0);
