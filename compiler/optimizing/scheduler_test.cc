...
class SchedulerTest : public OptimizingUnitTest {
 public:
  ...
  void TestBuildDependencyGraphAndSchedule(HScheduler* scheduler) {
    ...
    HInstruction* array = new (GetArena()) HParameterValue(graph_->GetDexFile(),
                                                           dex::TypeIndex(0),
                                                           0,
                                                           DataType::Type::kReference);
    HInstruction* c1 = graph_->GetIntConstant(1);
    HInstruction* c2 = graph_->GetIntConstant(10);
    HInstruction* add1 = new (GetArena()) HAdd(DataType::Type::kInt32, c1, c2);
    HInstruction* add2 = new (GetArena()) HAdd(DataType::Type::kInt32, add1, c2);
    HInstruction* mul = new (GetArena()) HMul(DataType::Type::kInt32, add1, add2);
    HInstruction* div_check = new (GetArena()) HDivZeroCheck(add2, 0);
    HInstruction* div = new (GetArena()) HDiv(DataType::Type::kInt32, add1, div_check, 0);
    HInstruction* array_get1 = new (GetArena()) HArrayGet(array, add1, DataType::Type::kInt32, 0);
    HInstruction* array_set1 =
        new (GetArena()) HArraySet(array, add1, add2, DataType::Type::kInt32, 0);
    HInstruction* array_get2 = new (GetArena()) HArrayGet(array, add1, DataType::Type::kInt32, 0);
    ...
    HEnvironment* environment = new (GetArena()) HEnvironment(GetArena(),
                                                              2,
                                                              graph_->GetArtMethod(),
                                                              0,
                                                              div_check);
  ...
  void TestDependencyGraphOnAliasingArrayAccesses(HScheduler* scheduler) {
    ...
    HInstruction* arr = new (GetArena()) HParameterValue(graph_->GetDexFile(),
                                                         dex::TypeIndex(0),
                                                         0,
                                                         DataType::Type::kReference);
    HInstruction* i = new (GetArena()) HParameterValue(graph_->GetDexFile(),
                                                       dex::TypeIndex(1),
                                                       1,
                                                       DataType::Type::kInt32);
    HInstruction* j = new (GetArena()) HParameterValue(graph_->GetDexFile(),
                                                       dex::TypeIndex(1),
                                                       1,
                                                       DataType::Type::kInt32);
    ...
    HInstruction* c1 = graph_->GetIntConstant(1);
    HInstruction* add0 = new (GetArena()) HAdd(DataType::Type::kInt32, i, c0);
    HInstruction* add1 = new (GetArena()) HAdd(DataType::Type::kInt32, i, c1);
    HInstruction* sub0 = new (GetArena()) HSub(DataType::Type::kInt32, i, c0);
    HInstruction* sub1 = new (GetArena()) HSub(DataType::Type::kInt32, i, c1);
    HInstruction* arr_set_0 = new (GetArena()) HArraySet(arr, c0, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_1 = new (GetArena()) HArraySet(arr, c1, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_i = new (GetArena()) HArraySet(arr, i, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_add0 =
        new (GetArena()) HArraySet(arr, add0, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_add1 =
        new (GetArena()) HArraySet(arr, add1, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_sub0 =
        new (GetArena()) HArraySet(arr, sub0, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_sub1 =
        new (GetArena()) HArraySet(arr, sub1, c0, DataType::Type::kInt32, 0);
    HInstruction* arr_set_j = new (GetArena()) HArraySet(arr, j, c0, DataType::Type::kInt32, 0);
