...
void InstructionCodeGeneratorARM64Sve::VisitVecNot(HVecNot* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    case DataType::Type::kBool:  // special case boolean-not
      __ Dup(dst.VnB(), 1);
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Eor(dst.VnB(), dst.VnB(), src.VnB());
      } else {
...
void InstructionCodeGeneratorARM64Sve::VisitVecAdd(HVecAdd* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kInt8:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Add(dst.VnB(), lhs.VnB(), rhs.VnB());
      } else {
    ...
    case DataType::Type::kInt16:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Add(dst.VnH(), lhs.VnH(), rhs.VnH());
      } else {
    ...
    case DataType::Type::kInt32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Add(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kInt64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Add(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
    ...
    case DataType::Type::kFloat32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Fadd(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kFloat64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Fadd(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
...
void InstructionCodeGeneratorARM64Sve::VisitVecSub(HVecSub* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kInt8:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Sub(dst.VnB(), lhs.VnB(), rhs.VnB());
      } else {
    ...
    case DataType::Type::kInt16:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Sub(dst.VnH(), lhs.VnH(), rhs.VnH());
      } else {
    ...
    case DataType::Type::kInt32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Sub(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kInt64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Sub(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
    ...
    case DataType::Type::kFloat32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Fsub(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kFloat64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Fsub(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
...
void InstructionCodeGeneratorARM64Sve::VisitVecMul(HVecMul* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kFloat32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Fmul(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kFloat64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Fmul(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
...
void InstructionCodeGeneratorARM64Sve::VisitVecDiv(HVecDiv* instruction) {
  ...
  // TODO: Consider other options other than StrictNaNPropagation.
  switch (instruction->GetPackedType()) {
    case DataType::Type::kFloat32:
...
void InstructionCodeGeneratorARM64Sve::VisitVecAnd(HVecAnd* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kInt8:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ And(dst.VnB(), lhs.VnB(), rhs.VnB());
      } else {
    ...
    case DataType::Type::kInt16:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ And(dst.VnH(), lhs.VnH(), rhs.VnH());
      } else {
    ...
    case DataType::Type::kFloat32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ And(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kFloat64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ And(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
...
void InstructionCodeGeneratorARM64Sve::VisitVecOr(HVecOr* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kInt8:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Orr(dst.VnB(), lhs.VnB(), rhs.VnB());
      } else {
    ...
    case DataType::Type::kInt16:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Orr(dst.VnH(), lhs.VnH(), rhs.VnH());
      } else {
    ...
    case DataType::Type::kFloat32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Orr(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kFloat64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Orr(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
...
void InstructionCodeGeneratorARM64Sve::VisitVecXor(HVecXor* instruction) {
  ...
  switch (instruction->GetPackedType()) {
    ...
    case DataType::Type::kInt8:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Eor(dst.VnB(), lhs.VnB(), rhs.VnB());
      } else {
    ...
    case DataType::Type::kInt16:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Eor(dst.VnH(), lhs.VnH(), rhs.VnH());
      } else {
    ...
    case DataType::Type::kFloat32:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Eor(dst.VnS(), lhs.VnS(), rhs.VnS());
      } else {
    ...
    case DataType::Type::kFloat64:
      if (CouldUseUnpredicatedVersion(instruction)) {
        __ Eor(dst.VnD(), lhs.VnD(), rhs.VnD());
      } else {
    ...
    case 1u: {
      if (CouldUseUnpredicatedVersion(instruction)) {
        if (instruction->IsZeroExtending()) {
          __ Udot(acc.VnS(), acc.VnS(), left.VnB(), right.VnB());
        } else {
          __ Sdot(acc.VnS(), acc.VnS(), left.VnB(), right.VnB());
        }
      } else {
        ...
        __ Dup(tmp0.VnB(), 0u);
        __ Mov(tmp1, tmp0);
        __ Mov(tmp0.VnB(), p_reg, left.VnB());
        __ Mov(tmp1.VnB(), p_reg, right.VnB());
        if (instruction->IsZeroExtending()) {
...
void LocationsBuilderARM64Sve::VisitVecPredWhile(HVecPredWhile* instruction) {
  ...
  // Instruction doesn't need a core register as out location; this is a hack to workaround
  // absence of support for vector predicates in register allocation.
...
void InstructionCodeGeneratorARM64Sve::SaveRestoreLiveRegistersHelper(LocationSummary* locations,
  ...
  if (codegen_->GetGraph()->HasSIMD()) {
    ...
    GetAssembler()->SaveRestoreZRegisterList(fp_spills, fp_spill_offset, is_save);
    return;
  }

  // Case when we only need to restore D-registers.
  DCHECK(!codegen_->GetGraph()->HasSIMD());
  DCHECK_LE(codegen_->GetSlowPathFPWidth(), kDRegSizeInBytes);
  CPURegList fp_list = CPURegList(CPURegister::kVRegister, kDRegSize, fp_spills);
  if (is_save) {
    __ StoreCPURegList(core_list, MemOperand(base, spill_offset));
    __ StoreCPURegList(fp_list, MemOperand(base, fp_spill_offset));
  } else {
    __ LoadCPURegList(core_list, MemOperand(base, spill_offset));
    __ LoadCPURegList(fp_list, MemOperand(base, fp_spill_offset));
  }
}
