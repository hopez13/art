...
static bool CanBinaryOpAndIndexAlias(const HBinaryOperation* idx1,
  ...
  // TODO: Remove "OrNull".
  if (idx1->AsBinaryOperationOrNull()->GetLeastConstantLeft() != idx2) {
...
static bool CanBinaryOpsAlias(const HBinaryOperation* idx1,
  ...
  // TODO: Remove "OrNull".
  if (idx1->AsBinaryOperationOrNull()->GetLeastConstantLeft() !=
      idx2->AsBinaryOperationOrNull()->GetLeastConstantLeft()) {
