...
/**
 * Replaces multiplications involving basic induction variables
 * with their addition equivalents
 */
class IvStrengthReduction {
 public:
  explicit  IvStrengthReduction(HInductionVarAnalysis* analysis);
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(IvStrengthReduction);
};
