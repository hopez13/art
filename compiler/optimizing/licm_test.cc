...
class LICMTest : public OptimizingUnitTest {
 public:
  ...
  void BuildLoop() {
    ...
    loop_header_->AddInstruction(new (GetArena()) HIf(parameter_));
...
TEST_F(LICMTest, FieldHoisting) {
  ...
  HInstruction* get_field = new (GetArena()) HInstanceFieldGet(parameter_,
                                                               nullptr,
  ...
  HInstruction* set_field = new (GetArena()) HInstanceFieldSet(
...
TEST_F(LICMTest, NoFieldHoisting) {
  ...
  HInstruction* get_field = new (GetArena()) HInstanceFieldGet(parameter_,
                                                               ...
                                                               0);
  loop_body_->InsertInstructionBefore(get_field, loop_body_->GetLastInstruction());
  HInstruction* set_field = new (GetArena()) HInstanceFieldSet(parameter_,
                                                               get_field,
                                                               nullptr,
                                                               DataType::Type::kInt64,
                                                               MemberOffset(10),
...
TEST_F(LICMTest, ArrayHoisting) {
  ...
  HInstruction* get_array = new (GetArena()) HArrayGet(
      parameter_, int_constant_, DataType::Type::kInt32, 0);
  loop_body_->InsertInstructionBefore(get_array, loop_body_->GetLastInstruction());
  HInstruction* set_array = new (GetArena()) HArraySet(
