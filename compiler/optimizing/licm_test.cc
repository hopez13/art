...
TEST_F(LICMTest, ArrayHoisting) {
  ...
  HInstruction* set_array = new (&allocator_) HArraySet(
      parameter_, int_constant_, float_constant_, DataType::Type::kFloat, 0);
...
TEST_F(LICMTest, NoArrayHoisting) {
  ...
  HInstruction* get_array = new (&allocator_) HArrayGet(
      parameter_, int_constant_, DataType::Type::kFloat, 0);
  loop_body_->InsertInstructionBefore(get_array, loop_body_->GetLastInstruction());
  HInstruction* set_array = new (&allocator_) HArraySet(
      parameter_, get_array, float_constant_, DataType::Type::kFloat, 0);
  loop_body_->InsertInstructionBefore(set_array, loop_body_->GetLastInstruction());
