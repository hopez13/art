...
TEST_F(NodesVectorTest, VectorOperationProperties) {
  ...
  EXPECT_EQ(DataType::Type::kDouble, v0->GetType());
  EXPECT_EQ(DataType::Type::kDouble, v1->GetType());
  EXPECT_EQ(DataType::Type::kDouble, v2->GetType());
  EXPECT_EQ(DataType::Type::kDouble, v3->GetType());
  EXPECT_EQ(DataType::Type::kDouble, v4->GetType());
...
TEST_F(NodesVectorTest, VectorAlignmentAndStringCharAtMatterOnLoad) {
  HVecLoad* v0 = new (&allocator_)
      HVecLoad(&allocator_, parameter_, parameter_, DataType::Type::kInt32, 4, /*is_string_char_at*/ false);
  HVecLoad* v1 = new (&allocator_)
      HVecLoad(&allocator_, parameter_, parameter_, DataType::Type::kInt32, 4, /*is_string_char_at*/ false);
  HVecLoad* v2 = new (&allocator_)
      HVecLoad(&allocator_, parameter_, parameter_, DataType::Type::kInt32, 4, /*is_string_char_at*/ true);
...
TEST_F(NodesVectorTest, VectorOperationMattersOnMultiplyAccumulate) {
  ...
  HVecMultiplyAccumulate* v1 = new (&allocator_)
      HVecMultiplyAccumulate(&allocator_, HInstruction::kAdd, v0, v0, v0, DataType::Type::kInt32, 4);
  HVecMultiplyAccumulate* v2 = new (&allocator_)
      HVecMultiplyAccumulate(&allocator_, HInstruction::kSub, v0, v0, v0, DataType::Type::kInt32, 4);
  HVecMultiplyAccumulate* v3 = new (&allocator_)
      HVecMultiplyAccumulate(&allocator_, HInstruction::kAdd, v0, v0, v0, DataType::Type::kInt32, 2);
