...
class TestParallelMoveResolverWithSwap : public ParallelMoveResolverWithSwap {
 public:
  ...
  void SpillScratch(int reg [[maybe_unused]]) override {}
  void RestoreScratch(int reg [[maybe_unused]]) override {}
...
class TestParallelMoveResolverNoSwap : public ParallelMoveResolverNoSwap {
 public:
  ...
  void FreeScratchLocation(Location loc [[maybe_unused]]) override {}
