...
class TREContext {
 public:
  ...
  // return instruction of false path of major IF condition
  HInstruction* false_return_;

  // return instruction of true path of major IF condition
  HInstruction* true_return_;
  ...
  TREContext(): ret_type_(DataType::Type::kLast), if_true_exit_(false),
      ...
      ret_op_(nullptr), false_return_(nullptr), true_return_(nullptr),
      recursive_invoke_map_()  {}
};
