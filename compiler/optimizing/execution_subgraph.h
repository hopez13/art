...
class ExecutionSubgraph : public DeletableArenaObject<kArenaAllocLSA> {
 public:
  ...
  // analysis is desired (eg when being used for instruction scheduling) and
  // when the branching factor in the graph is not too high. The last condition
  // is calculated once and passed down for performance reasons.
