...
#include "nodes.h"
#include "optimizing/execution_subgraph_test.h"
...
// (1) Any block which inevitably leads to a removed block
 ...
 public:
  ...
  class ExcludedCohort : public ArenaObject<kArenaAllocLSA> {
   ...
   public:
    ...
    // NB blocks contained within the cohort are not considered to succeed the
    // cohort (i.e. this function will return false).
    ...
    // NB blocks contained within the cohort are not considered to preceed the
    // cohort (i.e. this function will return false).
