...
class ArenaPoolAndAllocator {
 public:
  ArenaPoolAndAllocator()
      : pool_(), arena_(&pool_), arena_stack_(&pool_), scoped_arena_(&arena_stack_) { }

  ArenaAllocator* GetArena() { return &arena_; }
  ArenaStack* GetArenaStack() { return &arena_stack_; }
  ScopedArenaAllocator* GetScopedArena() { return &scoped_arena_; }

 private:
  ArenaPool pool_;
  ArenaAllocator arena_;
  ArenaStack arena_stack_;
  ScopedArenaAllocator scoped_arena_;
};
...
class OptimizingUnitTest : public CommonCompilerTest {
 protected:
  ...
  ScopedArenaAllocator* GetScopedArena() { return pool_and_allocator_->GetScopedArena(); }
