...
static bool IsContextInBody(HBasicBlock* context, HLoopInformation* loop) {
  DCHECK(loop != nullptr);
...
bool UseFullTripCount(HBasicBlock* context, HLoopInformation* loop, bool is_min) {
  // We're currently classifying trip count only for the exit condition from loop header.
...
bool InductionVarRange::GetInductionRange(HBasicBlock* context,
...
bool InductionVarRange::CanGenerateRange(HBasicBlock* context,
                                         HInstruction* instruction,
                                         /*out*/bool* needs_finite_test,
...
void InductionVarRange::GenerateRange(HBasicBlock* context,
                                      HInstruction* instruction,
                                      HGraph* graph,
                                      HBasicBlock* block,
...
HInstruction* InductionVarRange::GenerateTakenTest(HInstruction* loop_control,
                                                   HGraph* graph,
                                                   HBasicBlock* block) {
  HBasicBlock* context = loop_control->GetBlock();
...
bool InductionVarRange::CanGenerateLastValue(HInstruction* instruction) {
  HBasicBlock* context = instruction->GetBlock();
...
bool InductionVarRange::IsUnitStride(HBasicBlock* context,
                                     HInstruction* instruction,
                                     HGraph* graph,
...
bool InductionVarRange::IsConstant(HBasicBlock* context,
...
bool InductionVarRange::IsWellBehavedTripCount(HBasicBlock* context,
                                               HLoopInformation* loop,
...
bool InductionVarRange::NeedsTripCount(HBasicBlock* context,
                                       HLoopInformation* loop,
                                       HInductionVarAnalysis::InductionInfo* info,
...
InductionVarRange::Value InductionVarRange::GetLinear(HBasicBlock* context,
                                                      HLoopInformation* loop,
                                                      HInductionVarAnalysis::InductionInfo* info,
...
InductionVarRange::Value InductionVarRange::GetPolynomial(
  ...
  if (IsConstant(context, loop, info->op_a->op_a, kExact, &a) &&
    ...
    // Do not simply return `c` as minimum because the trip count may be
    // non-zero if the `context` is after the `loop` (ignoring `is_min`).
...
InductionVarRange::Value InductionVarRange::GetGeometric(HBasicBlock* context,
                                                         HLoopInformation* loop,
                                                         HInductionVarAnalysis::InductionInfo* info,
                                                         HInductionVarAnalysis::InductionInfo* trip,
                                                         bool is_min) const {
...
InductionVarRange::Value InductionVarRange::GetFetch(HBasicBlock* context,
                                                     HLoopInformation* loop,
                                                     HInstruction* instruction,
                                                     HInductionVarAnalysis::InductionInfo* trip,
                                                     bool is_min) const {
...
InductionVarRange::Value InductionVarRange::GetVal(HBasicBlock* context,
                                                   HLoopInformation* loop,
                                                   HInductionVarAnalysis::InductionInfo* info,
                                                   HInductionVarAnalysis::InductionInfo* trip,
                                                   bool is_min) const {
...
InductionVarRange::Value InductionVarRange::GetMul(HBasicBlock* context,
                                                   HLoopInformation* loop,
...
InductionVarRange::Value InductionVarRange::GetDiv(HBasicBlock* context,
                                                   HLoopInformation* loop,
                                                   HInductionVarAnalysis::InductionInfo* info1,
                                                   HInductionVarAnalysis::InductionInfo* info2,
                                                   HInductionVarAnalysis::InductionInfo* trip,
...
bool InductionVarRange::GenerateRangeOrLastValue(HBasicBlock* context,
                                                 HInstruction* instruction,
                                                 bool is_last_value,
                                                 HGraph* graph,
                                                 HBasicBlock* block,
...
bool InductionVarRange::GenerateLastValuePolynomial(HBasicBlock* context,
                                                    HLoopInformation* loop,
                                                    HInductionVarAnalysis::InductionInfo* info,
                                                    HInductionVarAnalysis::InductionInfo* trip,
                                                    HGraph* graph,
...
bool InductionVarRange::GenerateLastValueGeometric(HBasicBlock* context,
                                                   HLoopInformation* loop,
                                                   HInductionVarAnalysis::InductionInfo* info,
                                                   HInductionVarAnalysis::InductionInfo* trip,
                                                   HGraph* graph,
...
bool InductionVarRange::GenerateLastValueWrapAround(HBasicBlock* context,
                                                    HLoopInformation* loop,
                                                    HInductionVarAnalysis::InductionInfo* info,
                                                    HInductionVarAnalysis::InductionInfo* trip,
                                                    HGraph* graph,
...
bool InductionVarRange::GenerateLastValuePeriodic(HBasicBlock* context,
                                                  HLoopInformation* loop,
                                                  HInductionVarAnalysis::InductionInfo* info,
                                                  HInductionVarAnalysis::InductionInfo* trip,
                                                  HGraph* graph,
...
bool InductionVarRange::GenerateCode(HBasicBlock* context,
                                     HLoopInformation* loop,
                                     HInductionVarAnalysis::InductionInfo* info,
                                     HInductionVarAnalysis::InductionInfo* trip,
        ...
        switch (info->operation) {
          ...
          case HInductionVarAnalysis::kTripCountInLoopUnsafe:
            if (UseFullTripCount(context, loop, is_min)) {
              ...
              return GenerateCode(context, loop, info->op_a, trip, graph, block, is_min, result);
            }
            FALLTHROUGH_INTENDED;
          case HInductionVarAnalysis::kTripCountInBody:
          case HInductionVarAnalysis::kTripCountInBodyUnsafe:
