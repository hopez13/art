...
void IntrinsicCodeGeneratorARM64::VisitStringCompareTo(HInvoke* invoke) {
  ...
  if (mirror::kUseStringCompression) {
    ...
    __ Tst(temp1, Operand(1));
    __ Csneg(out, temp4, temp4, ne);
  }
...
void IntrinsicCodeGeneratorARM64::VisitStringEquals(HInvoke* invoke) {
  ...
  temp1 = temp1.X();
  temp2 = temp2.X();
  // Loop to compare strings 4 characters at a time starting at the front of the string.
