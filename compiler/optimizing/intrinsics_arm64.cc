...
void compareOperation(MacroAssembler* masm,
                      const Register out,
                      const VRegister& in0,
                      const VRegister& in1) {
  __ Fcmp(in0, in1);
...
void GenerateFP16Compare(HInvoke* invoke,
  ...
  compareOp(masm, out, half0, half1);
}
...
void IntrinsicCodeGeneratorARM64::VisitFP16Greater(HInvoke* invoke) {
  MacroAssembler* masm = GetVIXLAssembler();
  GenerateFP16Compare(invoke, codegen_, masm, compareOperation<gt>);
}
...
void IntrinsicCodeGeneratorARM64::VisitFP16GreaterEquals(HInvoke* invoke) {
  MacroAssembler* masm = GetVIXLAssembler();
  GenerateFP16Compare(invoke, codegen_, masm, compareOperation<ge>);
}
...
void IntrinsicCodeGeneratorARM64::VisitFP16Less(HInvoke* invoke) {
  MacroAssembler* masm = GetVIXLAssembler();
  GenerateFP16Compare(invoke, codegen_, masm, compareOperation<mi>);
}
...
void IntrinsicCodeGeneratorARM64::VisitFP16LessEquals(HInvoke* invoke) {
  MacroAssembler* masm = GetVIXLAssembler();
  GenerateFP16Compare(invoke, codegen_, masm, compareOperation<ls>);
}
...
void IntrinsicCodeGeneratorARM64::VisitFP16Compare(HInvoke* invoke) {
  MacroAssembler* masm = GetVIXLAssembler();
  auto compareOp = [](MacroAssembler* masm,
                      const Register out,
                      const VRegister& in0,
                      const VRegister& in1) {
    vixl::aarch64::Label end;
