...
#ifndef ART_COMPILER_OPTIMIZING_CODE_GENERATOR_PATCHES_ARM64_H_
#define ART_COMPILER_OPTIMIZING_CODE_GENERATOR_PATCHES_ARM64_H_
 ...
 */
class CodeGeneratorPatchesARM64 {
 public:
  CodeGeneratorPatchesARM64(Arm64Assembler* assembler,
                            CodeGenerationData* code_generation_data,
                            ArenaAllocator* allocator) :
      assembler_(assembler),
      code_generation_data_(code_generation_data),
    ...
    DCHECK(code_generation_data != nullptr);
  }
  ...
  void EmitJitRootPatches(uint8_t* code, const uint8_t* roots_data);
 ...
 private:
  ...
  CodeGenerationData* code_generation_data_;
...
#endif  // ART_COMPILER_OPTIMIZING_CODE_GENERATOR_PATCHES_ARM64_H_
