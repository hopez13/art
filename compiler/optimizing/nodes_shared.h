...
class HMultiplyAccumulate FINAL : public HExpression<3> {
 ...
 protected:
  explicit HMultiplyAccumulate(const HMultiplyAccumulate& other) = default;
...
class HBitwiseNegatedRight FINAL : public HBinaryOperation {
 ...
 protected:
  explicit HBitwiseNegatedRight(const HBitwiseNegatedRight& other) = default;
...
class HIntermediateAddress FINAL : public HExpression<2> {
 ...
 protected:
  explicit HIntermediateAddress(const HIntermediateAddress& other) = default;
};
...
class HIntermediateAddressIndex FINAL : public HExpression<3> {
 ...
 protected:
  explicit HIntermediateAddressIndex(const HIntermediateAddressIndex& other) = default;
};
...
class HDataProcWithShifterOp FINAL : public HExpression<2> {
 ...
 protected:
  explicit HDataProcWithShifterOp(const HDataProcWithShifterOp& other) = default;
