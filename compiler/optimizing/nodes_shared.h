...
// This `#include` is outside the guard becausethis file (`nodes_shared.h`) is included
// in `nodes.h`. Otherwise the order of definitions is wrong (wrt/ methods like AsType).
#include "nodes.h"
