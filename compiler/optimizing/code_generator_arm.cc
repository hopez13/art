 ...
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    if (instruction_->IsInstanceOf()) {
      ...
      DCHECK(instruction_->IsCheckCast());
      arm_codegen->InvokeRuntime(kQuickCheckCast,
                                 instruction_,
                                 instruction_->GetDexPc(),
                                 this);
...
class DeoptimizationSlowPathARM : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    __ Bind(GetEntryLabel());
    SaveLiveRegisters(codegen, instruction_->GetLocations());
    arm_codegen->InvokeRuntime(kQuickDeoptimize,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
...
class ArraySetSlowPathARM : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    CodeGeneratorARM* arm_codegen = down_cast<CodeGeneratorARM*>(codegen);
    arm_codegen->InvokeRuntime(kQuickAputObject,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
...
class ReadBarrierForHeapReferenceSlowPathARM : public SlowPathCode {
 public:
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    arm_codegen->InvokeRuntime(kQuickReadBarrierSlow,
                               instruction_,
                               instruction_->GetDexPc(),
                               this);
    CheckEntrypointTypes<
...
void CodeGeneratorARM::InvokeRuntime(QuickEntrypointEnum entrypoint,
  ...
  InvokeRuntimeHelper(GetThreadOffset<kArmPointerSize>(entrypoint).Int32Value());
...
void CodeGeneratorARM::InvokeRuntimeHelper(int32_t entry_point_offset) {
  ...
  switch (result_type) {
    ...
    case Primitive::kPrimFloat:
      switch (input_type) {
        ...
        case Primitive::kPrimLong:
          // Processing a Dex `long-to-float' instruction.
          codegen_->InvokeRuntime(kQuickL2f,
                                  conversion,
                                  conversion->GetDexPc());
