...
//     obj.field = 3;
//     while (test()) {
//       if (test2()) { obj.field = 4; } else { obj.field = 5; }
//     }
//     break;
// }
// EXIT
...
#undef GET_BLOCK
  ...
  HInstruction* write_loop_left = new (GetAllocator()) HInstanceFieldSet(new_inst,
                                                                         c4,
                                                                         nullptr,
                                                                         DataType::Type::kInt32,
                                                                         MemberOffset(10),
  ...
  loop_if_left->AddInstruction(write_loop_left);
