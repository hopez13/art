...
#undef GET_BLOCK
  ...
  HInstruction* param2 = new (GetAllocator())
      HParameterValue(graph_->GetDexFile(), dex::TypeIndex(1), 2, DataType::Type::kBool);
  HInstruction* param3 = new (GetAllocator())
      HParameterValue(graph_->GetDexFile(), dex::TypeIndex(1), 3, DataType::Type::kBool);
  HInstruction* param_obj1 = new (GetAllocator())
      HParameterValue(graph_->GetDexFile(), dex::TypeIndex(2), 4, DataType::Type::kReference);
  HInstruction* param_obj2 = new (GetAllocator())
      HParameterValue(graph_->GetDexFile(), dex::TypeIndex(3), 5, DataType::Type::kReference);
  ...
  HInstruction* store_left = new (GetAllocator()) HInstanceFieldSet(new_inst2,
                                                                    new_inst1,
                                                                    nullptr,
                                                                    DataType::Type::kReference,
                                                                    MemberOffset(10),
  ...
  HInstruction* call_left_left = new (GetAllocator())
      HInvokeStaticOrDirect(GetAllocator(),
                            ...
                            HInvokeStaticOrDirect::ClinitCheckRequirement::kNone);
  HInstruction* goto_left_left = new (GetAllocator()) HGoto();
  call_left_left->AsInvoke()->SetRawInputAt(0, new_inst2);
...
#undef GET_BLOCK
  ...
  HInstruction* bottom_call = new (GetAllocator())
      HInvokeStaticOrDirect(GetAllocator(),
                            0,
                            DataType::Type::kVoid,
                            0u,
