...
class HVecOperation : public HVariableInputSizeInstruction {
 ...
 protected:
  ...
  explicit HVecOperation(const HVecOperation& other) = default;
...
class HVecUnaryOperation : public HVecOperation {
 ...
 protected:
  explicit HVecUnaryOperation(const HVecUnaryOperation& other) = default;
};
...
class HVecBinaryOperation : public HVecOperation {
 ...
 protected:
  explicit HVecBinaryOperation(const HVecBinaryOperation& other) = default;
};
...
class HVecMemoryOperation : public HVecOperation {
 ...
 protected:
  explicit HVecMemoryOperation(const HVecMemoryOperation& other) = default;
...
class HVecReplicateScalar FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecReplicateScalar(const HVecReplicateScalar& other) = default;
};
...
class HVecExtractScalar FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecExtractScalar(const HVecExtractScalar& other) = default;
};
...
class HVecReduce FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecReduce(const HVecReduce& other) = default;
...
class HVecCnv FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecCnv(const HVecCnv& other) = default;
};
...
class HVecNeg FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecNeg(const HVecNeg& other) = default;
};
...
class HVecAbs FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecAbs(const HVecAbs& other) = default;
};
...
class HVecNot FINAL : public HVecUnaryOperation {
 ...
 protected:
  explicit HVecNot(const HVecNot& other) = default;
};
...
class HVecAdd FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecAdd(const HVecAdd& other) = default;
};
...
class HVecHalvingAdd FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecHalvingAdd(const HVecHalvingAdd& other) = default;
...
class HVecSub FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecSub(const HVecSub& other) = default;
};
...
class HVecMul FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecMul(const HVecMul& other) = default;
};
...
class HVecDiv FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecDiv(const HVecDiv& other) = default;
};
...
class HVecMin FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecMin(const HVecMin& other) = default;
...
class HVecMax FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecMax(const HVecMax& other) = default;
...
class HVecAnd FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecAnd(const HVecAnd& other) = default;
};
...
class HVecAndNot FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecAndNot(const HVecAndNot& other) = default;
};
...
class HVecOr FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecOr(const HVecOr& other) = default;
};
...
class HVecXor FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecXor(const HVecXor& other) = default;
};
...
class HVecShl FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecShl(const HVecShl& other) = default;
};
...
class HVecShr FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecShr(const HVecShr& other) = default;
};
...
class HVecUShr FINAL : public HVecBinaryOperation {
 ...
 protected:
  explicit HVecUShr(const HVecUShr& other) = default;
};
...
class HVecSetScalars FINAL : public HVecOperation {
 ...
 protected:
  explicit HVecSetScalars(const HVecSetScalars& other) = default;
};
...
class HVecMultiplyAccumulate FINAL : public HVecOperation {
 ...
 protected:
  explicit HVecMultiplyAccumulate(const HVecMultiplyAccumulate& other) = default;
...
class HVecLoad FINAL : public HVecMemoryOperation {
 ...
 protected:
  explicit HVecLoad(const HVecLoad& other) = default;
...
class HVecStore FINAL : public HVecMemoryOperation {
 ...
 protected:
  explicit HVecStore(const HVecStore& other) = default;
};
