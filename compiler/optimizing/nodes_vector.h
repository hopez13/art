...
// Performs halving add on every component in the two vectors, either rounded (with extra +1)
// or unrounded, and for signed operands (sign extension) or unsigned operands (zero extension).
