...
class HVecLessThanOrEqual final : public HVecCondition {
 public:
  HVecLessThanOrEqual(ArenaAllocator* allocator,
               ...
               size_t vector_length,
               uint32_t dex_pc = kNoDexPc)
      : HVecCondition(kVecLessThanOrEqual, allocator, left, right, packed_type, vector_length, dex_pc) {
  }
...
class HVecGreaterThan final : public HVecCondition {
 public:
  HVecGreaterThan(ArenaAllocator* allocator,
               ...
               size_t vector_length,
               uint32_t dex_pc = kNoDexPc)
      : HVecCondition(kVecGreaterThan, allocator, left, right, packed_type, vector_length, dex_pc) {
  }
...
class HVecGreaterThanOrEqual final : public HVecCondition {
 public:
  HVecGreaterThanOrEqual(ArenaAllocator* allocator,
               ...
               size_t vector_length,
               uint32_t dex_pc = kNoDexPc)
      : HVecCondition(kVecGreaterThanOrEqual, allocator, left, right, packed_type, vector_length, dex_pc) {
  }
...
// Instruction to check if one unsigned vector input is less than the other.
...
// Instruction to check if one unsigned vector input is less than or equal to the other.
class HVecBelowOrEqual final : public HVecCondition {
 public:
  HVecBelowOrEqual(ArenaAllocator* allocator,
               ...
               size_t vector_length,
               uint32_t dex_pc = kNoDexPc)
      : HVecCondition(kVecBelowOrEqual, allocator, left, right, packed_type, vector_length, dex_pc) {
  }
...
// Instruction to check if one unsigned vector input is greater than the other.
...
// Instruction to check if one unsigned vector input is greater than or equal to the other.
class HVecAboveOrEqual final : public HVecCondition {
 public:
  HVecAboveOrEqual(ArenaAllocator* allocator,
               ...
               size_t vector_length,
               uint32_t dex_pc = kNoDexPc)
      : HVecCondition(kVecAboveOrEqual, allocator, left, right, packed_type, vector_length, dex_pc) {
  }
