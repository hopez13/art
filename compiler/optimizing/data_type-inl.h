...
// Note: Note declared in data_type.h to avoid pulling in "primitive.h".
constexpr DataType::Type DataTypeFromPrimitive(Primitive::Type type) {
  switch (type) {
    case Primitive::kPrimNot: return DataType::Type::kReference;
    case Primitive::kPrimBoolean: return DataType::Type::kBoolean;
    ...
    case Primitive::kPrimFloat: return DataType::Type::kFloat;
    case Primitive::kPrimDouble: return DataType::Type::kDouble;
...
constexpr char DataType::TypeId(DataType::Type type) {
  ...
  switch (type) {
    case DataType::Type::kBoolean: return 'z';
    ...
    case DataType::Type::kFloat: return 'f';
    case DataType::Type::kDouble: return 'd';
