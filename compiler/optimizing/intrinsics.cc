...
const char kIntegerCacheDescriptor[] = "Ljava/lang/Integer$IntegerCache;";
const char kIntegerDescriptor[] = "Ljava/lang/Integer;";
const char kIntegerArrayDescriptor[] = "[Ljava/lang/Integer;";
const char kLowFieldName[] = "low";
const char kHighFieldName[] = "high";
...
void IntrinsicVisitor::ComputeIntegerValueOfLocations(HInvoke* invoke,
  ...
  if (compiler_options.IsBootImage()) {
    ...
    if (!integer_class->IsInitialized()) {
  ...
  if (compiler_options.IsBootImage()) {
    ...
    if (invoke->InputAt(0)->IsIntConstant()) {
      ...
      if (index < static_cast<uint32_t>(info.length)) {
        ...
        info.value_boot_image_reference = 0u;  // Not in the cache.
      }
    } else {
