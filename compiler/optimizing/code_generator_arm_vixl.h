...
class FieldAccessCallingConventionARMVIXL : public FieldAccessCallingConvention {
 public:
  ...
  Location GetObjectLocation() const OVERRIDE {
    return LocationFrom(vixl::aarch32::r1);
  }
  Location GetFieldIndexLocation() const OVERRIDE {
    return LocationFrom(vixl::aarch32::r0);
  }
  Location GetReturnLocation(Primitive::Type type) const OVERRIDE {
    return Primitive::Is64BitType(type)
        ? LocationFrom(vixl::aarch32::r0, vixl::aarch32::r1)
        : LocationFrom(vixl::aarch32::r0);
  }
  Location GetSetValueLocation(Primitive::Type type, bool is_instance) const OVERRIDE {
    return Primitive::Is64BitType(type)
        ? LocationFrom(vixl::aarch32::r2, vixl::aarch32::r3)
        : (is_instance
            ? LocationFrom(vixl::aarch32::r2)
            : LocationFrom(vixl::aarch32::r1));
  }
  Location GetFpuLocation(Primitive::Type type) const OVERRIDE {
    return Primitive::Is64BitType(type)
        ? LocationFrom(vixl::aarch32::s0, vixl::aarch32::s1)
        : LocationFrom(vixl::aarch32::s0);
  }
