...
class TracingMethodEntryExitHooksSlowPathARM64 : public SlowPathCodeARM64 {
 public:
  explicit TracingMethodEntryExitHooksSlowPathARM64(bool is_method_entry)
      : SlowPathCodeARM64(nullptr), is_method_entry_(is_method_entry) {}
...
#ifdef ART_ALWAYS_ENABLE_PROFILE_CODE
void CodeGeneratorARM64::RecordTraceEvent(bool is_method_entry) {
  MacroAssembler* masm = GetVIXLAssembler();
  UseScratchRegisterScope temps(masm);
  Register addr = temps.AcquireX();
...
#else
void CodeGeneratorARM64::RecordTraceEvent([[maybe_unused]] bool is_method_entry) {
}
#endif
