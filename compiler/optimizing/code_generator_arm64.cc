...
class RawReferenceLoadARM64 : public ArenaObject<kArenaAllocCodeGenerator> {
 public:
  RawReferenceLoadARM64(HInstruction* instruction,
                        Location ref,
                        Register obj,
                        uint32_t offset,
                        Location index,
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(RawReferenceLoadARM64);
};
...
class LoadReferenceWithBakerReadBarrierSlowPathARM64 : public ReadBarrierMarkSlowPathBaseARM64 {
 public:
  LoadReferenceWithBakerReadBarrierSlowPathARM64(HInstruction* instruction,
                                                 RawReferenceLoadARM64* raw_ref_load,
                                                 Location ref,
                                                 Register obj,
 ...
 private:
  ...
  RawReferenceLoadARM64* raw_ref_load_;
...
void CodeGeneratorARM64::GenerateReferenceLoadWithBakerReadBarrier(HInstruction* instruction,
  ...
  // corresponding to register `ref`. If `temp2` is null, its means
  ...
  RawReferenceLoadARM64* raw_ref_load = new (GetGraph()->GetArena()) RawReferenceLoadARM64(
  ...
  if (always_update_field) {
    ...
    slow_path = new (GetGraph()->GetArena()) LoadReferenceWithBakerReadBarrierSlowPathARM64(
        instruction, raw_ref_load, ref, obj, needs_null_check, temp, /* entrypoint */ temp2_loc);
  }
  AddSlowPath(slow_path);
