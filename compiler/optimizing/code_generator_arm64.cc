...
size_t CodeGeneratorARM64::SaveFloatingPointRegister(size_t stack_index [[maybe_unused]],
...
size_t CodeGeneratorARM64::RestoreFloatingPointRegister(size_t stack_index [[maybe_unused]],
                                                        uint32_t reg_id [[maybe_unused]]) {
  LOG(FATAL) << "FP registers shouldn't be saved/restored individually, "
             << "use SaveRestoreLiveRegistersHelper";
  UNREACHABLE();
...
void InstructionCodeGeneratorARM64::VisitExit(HExit* exit [[maybe_unused]]) {}
...
void InstructionCodeGeneratorARM64::VisitFloatConstant(HFloatConstant* constant [[maybe_unused]]) {
  // Will be generated at use site.
}
...
void InstructionCodeGeneratorARM64::VisitIntConstant(HIntConstant* constant [[maybe_unused]]) {
  // Will be generated at use site.
}
...
void InstructionCodeGeneratorARM64::VisitNullConstant(HNullConstant* constant [[maybe_unused]]) {
  // Will be generated at use site.
}
...
void InstructionCodeGeneratorARM64::VisitClearException(HClearException* clear [[maybe_unused]]) {
...
void InstructionCodeGeneratorARM64::VisitLongConstant(HLongConstant* constant [[maybe_unused]]) {
  // Will be generated at use site.
}
...
void LocationsBuilderARM64::VisitParallelMove(HParallelMove* instruction [[maybe_unused]]) {
  LOG(FATAL) << "Unreachable";
}
...
void InstructionCodeGeneratorARM64::VisitPhi(HPhi* instruction [[maybe_unused]]) {
  LOG(FATAL) << "Unreachable";
}
...
void InstructionCodeGeneratorARM64::VisitConstructorFence(HConstructorFence* constructor_fence
                                                          [[maybe_unused]]) {
...
void InstructionCodeGeneratorARM64::VisitReturnVoid(HReturnVoid* instruction [[maybe_unused]]) {
  codegen_->GenerateFrameExit();
}
...
void LocationsBuilderARM64::VisitBoundType(HBoundType* instruction [[maybe_unused]]) {
  // Nothing to do, this should be removed during prepare for register allocator.
  LOG(FATAL) << "Unreachable";
}

void InstructionCodeGeneratorARM64::VisitBoundType(HBoundType* instruction [[maybe_unused]]) {
  // Nothing to do, this should be removed during prepare for register allocator.
  LOG(FATAL) << "Unreachable";
}
