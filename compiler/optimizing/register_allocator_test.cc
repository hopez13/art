...
TEST_F(RegisterAllocatorTest, SpillInactive) {
  ...
  first->uses_.emplace_front(user, false, 8);
  first->uses_.emplace_front(user, false, 7);
  first->uses_.emplace_front(user, false, 6);
  ...
  third->uses_.emplace_front(user, false, 8);
  third->uses_.emplace_front(user, false, 4);
  third->uses_.emplace_front(user, false, 3);
