...
TEST_F(RegisterAllocatorTest, ValidateIntervals) {
  ...
  // Test with two intervals of the same range.
  {
    ...
    ASSERT_TRUE(RegisterAllocator::ValidateIntervals(intervals, 0, 0, codegen, true, false));

    intervals[1]->SetRegister(0);
    ASSERT_FALSE(RegisterAllocator::ValidateIntervals(intervals, 0, 0, codegen, true, false));
    intervals.clear();
  }
