...
class RegisterAllocatorTest : public CommonCompilerTest, public OptimizingUnitTestHelper {
 protected:
  ...
  void SameAsFirstInputHint();
  void ExpectedInRegisterHint();
  ...
  void ExpectedExactInRegisterAndSameOutputHint();
...
void RegisterAllocatorTest::ExpectedExactInRegisterAndSameOutputHint() {
  HInstruction *div;
...
TEST_F(RegisterAllocatorTest, ExpectedExactInRegisterAndSameOutputHint) {
  ExpectedExactInRegisterAndSameOutputHint();
}
