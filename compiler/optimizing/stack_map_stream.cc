...
size_t StackMapStream::PrepareForFillIn() {
  ...
  size_t register_mask_size_in_bits = MinimumBitsToStore(register_mask_max_);
  size_t number_of_register_masks = PrepareRegisterMasks();
  ...
  size_t stack_masks_bits = number_of_stack_masks * stack_mask_size_in_bits;
  size_t register_masks_bits = number_of_register_masks * register_mask_size_in_bits;
