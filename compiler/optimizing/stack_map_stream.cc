      ...
      for (size_t depth = 0; depth < entry.inlining_depth; ++depth) {
        ...
        if (inline_entry.method != nullptr) {
          inline_info.SetMethodIndexAtDepth(
              inline_info_encoding_, depth, High32Bits(reinterpret_cast<uintptr_t>(inline_entry.method)));
          inline_info.SetExtraDataAtDepth(
              inline_info_encoding_, depth, Low32Bits(reinterpret_cast<uintptr_t>(inline_entry.method)));
        } else {
