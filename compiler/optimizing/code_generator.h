...
class CodeGenerator : public DeletableArenaObject<kArenaAllocCodeGenerator> {
 public:
  ...
  // Returns true if we should check the GC catd for consistency purposes.
  bool ShouldCheckGCCard(bool needs_write_barrier, DataType::Type type, HInstruction* value) const;
