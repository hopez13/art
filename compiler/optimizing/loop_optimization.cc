...
bool HLoopOptimization::VectorizeHalvingAddIdiom(LoopNode* node,
  ...
  int64_t value = 0;
  if (instruction->IsShr() && IsInt64AndGet(instruction->InputAt(1), &value) && value == 1) {
