...
static bool IsZeroExtension(HInstruction* instruction,
  ...
  if (instruction->IsAnd()) {
    ...
    // In a & b find either mask & b or a & mask.
    if ((IsInt64AndGet(a, /*out*/ &mask) && (IsSignExtension(b, type, /*out*/ operand) ||
                                             IsZeroExtension(b, type, /*out*/ operand))) ||
        (IsInt64AndGet(b, /*out*/ &mask) && (IsSignExtension(a, type, /*out*/ operand) ||
                                             IsZeroExtension(a, type, /*out*/ operand)))) {
