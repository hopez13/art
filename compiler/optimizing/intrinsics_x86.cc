...
class ReadBarrierSystemArrayCopySlowPathX86 : public SlowPathCode {
 public:
  ReadBarrierSystemArrayCopySlowPathX86(HInstruction* instruction) : SlowPathCode(instruction) {
  ...
  void EmitNativeCode(CodeGenerator* codegen) OVERRIDE {
    ...
    int32_t entry_point_offset =
        CodeGenerator::GetReadBarrierMarkEntryPointsOffset<kX86WordSize>(temp2);
