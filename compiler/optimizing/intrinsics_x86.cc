...
void IntrinsicCodeGeneratorX86::VisitStringEquals(HInvoke* invoke) {
  ...
  // Differ cases into both compressed or both not compressed. Different compression style
  // is cut above.
...
void IntrinsicCodeGeneratorX86::VisitStringGetCharsNoCheck(HInvoke* invoke) {
  ...
  NearLabel done;
  NearLabel copy_loop, pre_loop;
  NearLabel copy_uncompressed;
