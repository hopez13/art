...
HInductionVarAnalysis::InductionInfo* HInductionVarAnalysis::TransferAddSub(HBasicBlock* context,
                                                                            HLoopInformation* loop,
                                                                            InductionInfo* a,
                                                                            InductionInfo* b,
                                                                            InductionOp op,
...
HInductionVarAnalysis::InductionInfo* HInductionVarAnalysis::TransferNeg(HBasicBlock* context,
                                                                         HLoopInformation* loop,
                                                                         InductionInfo* a,
                                                                         DataType::Type type) {
...
HInductionVarAnalysis::InductionInfo* HInductionVarAnalysis::TransferMul(HBasicBlock* context,
                                                                         HLoopInformation* loop,
                                                                         InductionInfo* a,
                                                                         InductionInfo* b,
                                                                         DataType::Type type) {
...
HInductionVarAnalysis::InductionInfo* HInductionVarAnalysis::SolveConversion(
  ...
  if (entry_phi->InputCount() == 2 && conversion == entry_phi->InputAt(1)) {
    ...
    int64_t value = 0;
    HBasicBlock* context = conversion->GetBlock();
    InductionInfo* initial = LookupInfo(loop, entry_phi->InputAt(0));
    if (IsNarrowingIntegralConversion(from, to) &&
...
void HInductionVarAnalysis::VisitControl(HLoopInformation* loop) {
  ...
  if (control->IsIf()) {
    ...
    if (if_expr->IsCondition()) {
      ...
      HBasicBlock* context = condition->GetBlock();
...
void HInductionVarAnalysis::VisitCondition(HBasicBlock* context,
                                           HLoopInformation* loop,
                                           HBasicBlock* body,
                                           InductionInfo* a,
                                           InductionInfo* b,
...
void HInductionVarAnalysis::VisitTripCount(HBasicBlock* context,
                                           HLoopInformation* loop,
...
bool HInductionVarAnalysis::IsTaken(HBasicBlock* context,
                                    HLoopInformation* loop,
                                    InductionInfo* lower_expr,
                                    InductionInfo* upper_expr,
                                    IfCondition cmp) {
...
bool HInductionVarAnalysis::IsFinite(HBasicBlock* context,
                                     HLoopInformation* loop,
                                     InductionInfo* upper_expr,
                                     int64_t stride_value,
                                     DataType::Type type,
...
bool HInductionVarAnalysis::FitsNarrowerControl(HBasicBlock* context,
                                                HLoopInformation* loop,
                                                InductionInfo* lower_expr,
                                                InductionInfo* upper_expr,
                                                int64_t stride_value,
...
bool HInductionVarAnalysis::RewriteBreakLoop(HBasicBlock* context,
                                             HLoopInformation* loop,
                                             HBasicBlock* body,
                                             int64_t stride_value,
                                             DataType::Type type) {
...
bool HInductionVarAnalysis::IsExact(HBasicBlock* context,
                                    HLoopInformation* loop,
                                    InductionInfo* info,
                                    /*out*/int64_t* value) {
...
bool HInductionVarAnalysis::IsAtMost(HBasicBlock* context,
                                     HLoopInformation* loop,
                                     InductionInfo* info,
                                     /*out*/int64_t* value) {
  InductionVarRange range(this);
...
bool HInductionVarAnalysis::IsAtLeast(HBasicBlock* context,
                                      HLoopInformation* loop,
                                      InductionInfo* info,
                                      /*out*/int64_t* value) {
  InductionVarRange range(this);
