...
void OptimizingCompiler::RunOptimizations(HGraph* graph,
  ...
  OptimizationDef optimizations[] = {
    ...
    OptDef(OptimizationPass::kLoopFriendlyInstructionSimplifier),
    ...
    OptDef(OptimizationPass::kLoopFriendlyInstructionSimplifier,
           "loop_friendly_instruction_simplifier$after_inlining",
           OptimizationPass::kInliner),
    OptDef(OptimizationPass::kDeadCodeElimination,
    ...
    OptDef(OptimizationPass::kLoopFriendlyInstructionSimplifier,
           "loop_friendly_instruction_simplifier$after_gvn"),
    OptDef(OptimizationPass::kDeadCodeElimination,
