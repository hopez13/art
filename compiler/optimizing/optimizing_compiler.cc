...
bool OptimizingCompiler::CanCompileMethod(uint32_t method_idx [[maybe_unused]],
                                          const DexFile& dex_file [[maybe_unused]]) const {
  return true;
}
...
bool EncodeArtMethodInInlineInfo(ArtMethod* method [[maybe_unused]]) {
