...
bool OptimizingCompiler::JitCompile(Thread* self,
  ...
  size_t number_of_literals = codegen->GetNumberOfJitLiterals();
  ClassLinker* class_linker = Runtime::Current()->GetClassLinker();
  // We allocate an object array to ensure the literals that we will collect in EmitLiterals
