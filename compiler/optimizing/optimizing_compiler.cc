...
bool OptimizingCompiler::JitCompile(Thread* self,
  ...
  std::unique_ptr<FastCompiler> fast_compiler;
  {
    ...
    if (compilation_kind == CompilationKind::kBaseline && !compiler_options.GetDebuggable()) {
      ProfilingInfo* info = code_cache->GetProfilingInfo(method, self);
