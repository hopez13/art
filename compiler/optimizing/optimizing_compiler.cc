...
class OptimizingCompiler final : public Compiler {
 ...
 private:
  ...
  void GenerateJitDebugInfo(ArtMethod* method, const debug::MethodDebugInfo& method_debug_info)
      REQUIRES_SHARED(Locks::mutator_lock_);
...
void OptimizingCompiler::GenerateJitDebugInfo(ArtMethod* method, const debug::MethodDebugInfo& info) {
  const CompilerOptions& compiler_options = GetCompilerDriver()->GetCompilerOptions();
