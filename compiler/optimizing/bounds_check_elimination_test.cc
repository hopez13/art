...
TEST_F(BoundsCheckEliminationTest, NarrowingRangeArrayBoundsElimination) {
  HBasicBlock* entry = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(entry);
  graph_->SetEntryBlock(entry);
  HInstruction* parameter1 = new (GetArena()) HParameterValue(
      graph_->GetDexFile(), dex::TypeIndex(0), 0, DataType::Type::kReference);  // array
  HInstruction* parameter2 = new (GetArena()) HParameterValue(
  ...
  HBasicBlock* block1 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block1);
  HInstruction* cmp = new (GetArena()) HGreaterThanOrEqual(parameter2, constant_0);
  HIf* if_inst = new (GetArena()) HIf(cmp);
  block1->AddInstruction(cmp);
  block1->AddInstruction(if_inst);
  entry->AddSuccessor(block1);

  HBasicBlock* block2 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block2);
  HNullCheck* null_check = new (GetArena()) HNullCheck(parameter1, 0);
  HArrayLength* array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check2 = new (GetArena())
      HBoundsCheck(parameter2, array_length, 0);
  HArraySet* array_set = new (GetArena()) HArraySet(
  ...
  HBasicBlock* block3 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block3);
  null_check = new (GetArena()) HNullCheck(parameter1, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  cmp = new (GetArena()) HLessThan(parameter2, array_length);
  if_inst = new (GetArena()) HIf(cmp);
  block3->AddInstruction(null_check);
  block3->AddInstruction(array_length);
  block3->AddInstruction(cmp);
  block3->AddInstruction(if_inst);

  HBasicBlock* block4 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block4);
  null_check = new (GetArena()) HNullCheck(parameter1, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check4 = new (GetArena())
      HBoundsCheck(parameter2, array_length, 0);
  array_set = new (GetArena()) HArraySet(
  ...
  HBasicBlock* block5 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block5);
  null_check = new (GetArena()) HNullCheck(parameter1, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check5 = new (GetArena())
      HBoundsCheck(parameter2, array_length, 0);
  array_set = new (GetArena()) HArraySet(
  ...
  HBasicBlock* exit = new (GetArena()) HBasicBlock(graph_);
...
TEST_F(BoundsCheckEliminationTest, OverflowArrayBoundsElimination) {
  ...
  HBasicBlock* block1 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block1);
  HInstruction* cmp = new (GetArena()) HLessThanOrEqual(parameter2, constant_0);
  HIf* if_inst = new (GetArena()) HIf(cmp);
  block1->AddInstruction(cmp);
  block1->AddInstruction(if_inst);
  entry->AddSuccessor(block1);
  ...
  HBasicBlock* block2 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block2);
  HInstruction* add = new (GetArena()) HAdd(DataType::Type::kInt32, parameter2, constant_max_int);
  HNullCheck* null_check = new (GetArena()) HNullCheck(parameter1, 0);
  HArrayLength* array_length = new (GetArena()) HArrayLength(null_check, 0);
  HInstruction* cmp2 = new (GetArena()) HGreaterThanOrEqual(add, array_length);
  if_inst = new (GetArena()) HIf(cmp2);
  ...
  HBasicBlock* block3 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block3);
  HBoundsCheck* bounds_check = new (GetArena())
...
TEST_F(BoundsCheckEliminationTest, UnderflowArrayBoundsElimination) {
  ...
  HNullCheck* null_check = new (GetArena()) HNullCheck(parameter1, 0);
  HArrayLength* array_length = new (GetArena()) HArrayLength(null_check, 0);
  HInstruction* cmp = new (GetArena()) HGreaterThanOrEqual(parameter2, array_length);
  HIf* if_inst = new (GetArena()) HIf(cmp);
  ...
  HBasicBlock* block2 = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block2);
  HInstruction* sub1 = new (GetArena()) HSub(DataType::Type::kInt32, parameter2, constant_max_int);
  HInstruction* sub2 = new (GetArena()) HSub(DataType::Type::kInt32, sub1, constant_max_int);
  HInstruction* cmp2 = new (GetArena()) HLessThanOrEqual(sub2, constant_0);
  if_inst = new (GetArena()) HIf(cmp2);
...
TEST_F(BoundsCheckEliminationTest, ConstantArrayBoundsElimination) {
  ...
  graph_->AddBlock(entry);
  graph_->SetEntryBlock(entry);
  HInstruction* parameter = new (GetArena()) HParameterValue(
  ...
  HBasicBlock* block = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(block);
  entry->AddSuccessor(block);

  HNullCheck* null_check = new (GetArena()) HNullCheck(parameter, 0);
  HArrayLength* array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check6 = new (GetArena())
      HBoundsCheck(constant_6, array_length, 0);
  HInstruction* array_set = new (GetArena()) HArraySet(
  ...
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check5 = new (GetArena())
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination1a) {
  ...
  HInstruction* bounds_check = BuildSSAGraph1(graph_, GetArena(), 0, 1);
  RunBCE();
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination1b) {
  ...
  HInstruction* bounds_check = BuildSSAGraph1(graph_, GetArena(), 1, 1);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination1d) {
  ...
  HInstruction* bounds_check = BuildSSAGraph1(graph_, GetArena(), 0, 1, kCondGT);
  RunBCE();
  ASSERT_FALSE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination1e) {
  ...
  HInstruction* bounds_check = BuildSSAGraph1(graph_, GetArena(), 0, 2);
  RunBCE();
  ASSERT_FALSE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination1f) {
  ...
  HInstruction* bounds_check = BuildSSAGraph1(graph_, GetArena(), 1, 2);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination2a) {
  ...
  HInstruction* bounds_check = BuildSSAGraph2(graph_, GetArena(), 0);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination2b) {
  ...
  HInstruction* bounds_check = BuildSSAGraph2(graph_, GetArena(), 1);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination2d) {
  ...
  HInstruction* bounds_check = BuildSSAGraph2(graph_, GetArena(), 0, -1, kCondLT);
  RunBCE();
  ASSERT_FALSE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination2e) {
  ...
  HInstruction* bounds_check = BuildSSAGraph2(graph_, GetArena(), 0, -2);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination3a) {
  ...
  HInstruction* bounds_check = BuildSSAGraph3(graph_, GetArena(), 0, 1, kCondGE);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination3b) {
  ...
  HInstruction* bounds_check = BuildSSAGraph3(graph_, GetArena(), 1, 1, kCondGE);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination3c) {
  ...
  HInstruction* bounds_check = BuildSSAGraph3(graph_, GetArena(), 0, 1, kCondGT);
  RunBCE();
  ASSERT_FALSE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination3d) {
  ...
  HInstruction* bounds_check = BuildSSAGraph3(graph_, GetArena(), 1, 8, kCondGE);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination4a) {
  ...
  HInstruction* bounds_check = BuildSSAGraph4(graph_, GetArena(), 0);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination4b) {
  ...
  HInstruction* bounds_check = BuildSSAGraph4(graph_, GetArena(), 1);
  RunBCE();
  ASSERT_TRUE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, LoopArrayBoundsElimination4c) {
  ...
  HInstruction* bounds_check = BuildSSAGraph4(graph_, GetArena(), 0, kCondGT);
  RunBCE();
  ASSERT_FALSE(IsRemoved(bounds_check));
}
...
TEST_F(BoundsCheckEliminationTest, BubbleSortArrayBoundsElimination) {
  ...
  HBasicBlock* outer_header = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(outer_header);
  HPhi* phi_i = new (GetArena()) HPhi(GetArena(), 0, 0, DataType::Type::kInt32);
  HNullCheck* null_check = new (GetArena()) HNullCheck(parameter, 0);
  HArrayLength* array_length = new (GetArena()) HArrayLength(null_check, 0);
  HAdd* add = new (GetArena()) HAdd(DataType::Type::kInt32, array_length, constant_minus_1);
  HInstruction* cmp = new (GetArena()) HGreaterThanOrEqual(phi_i, add);
  HIf* if_inst = new (GetArena()) HIf(cmp);
  ...
  HBasicBlock* inner_header = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(inner_header);
  HPhi* phi_j = new (GetArena()) HPhi(GetArena(), 0, 0, DataType::Type::kInt32);
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HSub* sub = new (GetArena()) HSub(DataType::Type::kInt32, array_length, phi_i);
  add = new (GetArena()) HAdd(DataType::Type::kInt32, sub, constant_minus_1);
  cmp = new (GetArena()) HGreaterThanOrEqual(phi_j, add);
  if_inst = new (GetArena()) HIf(cmp);
  ...
  HBasicBlock* inner_body_compare = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(inner_body_compare);
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check1 = new (GetArena()) HBoundsCheck(phi_j, array_length, 0);
  HArrayGet* array_get_j = new (GetArena())
  ...
  HInstruction* j_plus_1 = new (GetArena()) HAdd(DataType::Type::kInt32, phi_j, constant_1);
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HBoundsCheck* bounds_check2 = new (GetArena()) HBoundsCheck(j_plus_1, array_length, 0);
  HArrayGet* array_get_j_plus_1 = new (GetArena())
      HArrayGet(null_check, bounds_check2, DataType::Type::kInt32, 0);
  cmp = new (GetArena()) HGreaterThanOrEqual(array_get_j, array_get_j_plus_1);
  if_inst = new (GetArena()) HIf(cmp);
  ...
  HBasicBlock* inner_body_swap = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(inner_body_swap);
  j_plus_1 = new (GetArena()) HAdd(DataType::Type::kInt32, phi_j, constant_1);
  // temp = array[j+1]
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HInstruction* bounds_check3 = new (GetArena()) HBoundsCheck(j_plus_1, array_length, 0);
  array_get_j_plus_1 = new (GetArena())
  ...
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HInstruction* bounds_check4 = new (GetArena()) HBoundsCheck(phi_j, array_length, 0);
  array_get_j = new (GetArena())
  ...
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HInstruction* bounds_check5 = new (GetArena()) HBoundsCheck(j_plus_1, array_length, 0);
  HArraySet* array_set_j_plus_1 = new (GetArena())
  ...
  null_check = new (GetArena()) HNullCheck(parameter, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HInstruction* bounds_check6 = new (GetArena()) HBoundsCheck(phi_j, array_length, 0);
  HArraySet* array_set_j = new (GetArena())
  ...
  inner_body_swap->AddInstruction(new (GetArena()) HGoto());

  HBasicBlock* inner_body_add = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(inner_body_add);
  add = new (GetArena()) HAdd(DataType::Type::kInt32, phi_j, constant_1);
  inner_body_add->AddInstruction(add);
  inner_body_add->AddInstruction(new (GetArena()) HGoto());
  phi_j->AddInput(add);

  HBasicBlock* outer_body_add = new (GetArena()) HBasicBlock(graph_);
  graph_->AddBlock(outer_body_add);
  add = new (GetArena()) HAdd(DataType::Type::kInt32, phi_i, constant_1);
  outer_body_add->AddInstruction(add);
  outer_body_add->AddInstruction(new (GetArena()) HGoto());
  phi_i->AddInput(add);
...
TEST_F(BoundsCheckEliminationTest, ModArrayBoundsElimination) {
  ...
  graph_->AddBlock(entry);
  graph_->SetEntryBlock(entry);
  HInstruction* param_i = new (GetArena())
  ...
  entry->AddSuccessor(block);
  // We pass a bogus constant for the class to avoid mocking one.
  HInstruction* new_array = new (GetArena()) HNewArray(constant_10, constant_10, 0);
  block->AddInstruction(new_array);
  block->AddInstruction(new (GetArena()) HGoto());

  HBasicBlock* loop_header = new (GetArena()) HBasicBlock(graph_);
  HBasicBlock* loop_body = new (GetArena()) HBasicBlock(graph_);
  HBasicBlock* exit = new (GetArena()) HBasicBlock(graph_);
  ...
  HInstruction* cmp = new (GetArena()) HGreaterThanOrEqual(phi, constant_200);
  HInstruction* if_inst = new (GetArena()) HIf(cmp);
  loop_header->AddPhi(phi);
  loop_header->AddInstruction(cmp);
  loop_header->AddInstruction(if_inst);
  ...
  // LOOP BODY:
  // array[i % 10] = 10;
  HRem* i_mod_10 = new (GetArena()) HRem(DataType::Type::kInt32, phi, constant_10, 0);
  HBoundsCheck* bounds_check_i_mod_10 = new (GetArena()) HBoundsCheck(i_mod_10, constant_10, 0);
  HInstruction* array_set = new (GetArena()) HArraySet(
  ...
  // array[i % 1] = 10;
  HRem* i_mod_1 = new (GetArena()) HRem(DataType::Type::kInt32, phi, constant_1, 0);
  HBoundsCheck* bounds_check_i_mod_1 = new (GetArena()) HBoundsCheck(i_mod_1, constant_10, 0);
  array_set = new (GetArena()) HArraySet(
  ...
  // array[i % 200] = 10;
  HRem* i_mod_200 = new (GetArena()) HRem(DataType::Type::kInt32, phi, constant_1, 0);
  HBoundsCheck* bounds_check_i_mod_200 = new (GetArena()) HBoundsCheck(i_mod_200, constant_10, 0);
  array_set = new (GetArena()) HArraySet(
  ...
  // array[i % -10] = 10;
  HRem* i_mod_minus_10 = new (GetArena()) HRem(DataType::Type::kInt32, phi, constant_minus_10, 0);
  HBoundsCheck* bounds_check_i_mod_minus_10 = new (GetArena()) HBoundsCheck(
  ...
  HNullCheck* null_check = new (GetArena()) HNullCheck(new_array, 0);
  HArrayLength* array_length = new (GetArena()) HArrayLength(null_check, 0);
  HRem* i_mod_array_length = new (GetArena()) HRem(DataType::Type::kInt32, phi, array_length, 0);
  HBoundsCheck* bounds_check_i_mod_array_len = new (GetArena()) HBoundsCheck(
  ...
  // array[param_i % 10] = 10;
  HRem* param_i_mod_10 = new (GetArena()) HRem(DataType::Type::kInt32, param_i, constant_10, 0);
  HBoundsCheck* bounds_check_param_i_mod_10 = new (GetArena()) HBoundsCheck(
  ...
  null_check = new (GetArena()) HNullCheck(new_array, 0);
  array_length = new (GetArena()) HArrayLength(null_check, 0);
  HRem* param_i_mod_array_length = new (GetArena()) HRem(
      DataType::Type::kInt32, param_i, array_length, 0);
  HBoundsCheck* bounds_check_param_i_mod_array_len = new (GetArena()) HBoundsCheck(
  ...
  // i++;
  HInstruction* add = new (GetArena()) HAdd(DataType::Type::kInt32, phi, constant_1);
  loop_body->AddInstruction(add);
