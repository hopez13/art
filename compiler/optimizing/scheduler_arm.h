...
class SchedulingLatencyVisitorARM : public SchedulingLatencyVisitor {
 public:
  SchedulingLatencyVisitorARM() : codegen_(nullptr) {}
...
#undef DECLARE_VISIT_INSTRUCTION
  ...
  void SetCodeGenenerator(CodeGeneratorARMType* codegen) { codegen_ = codegen; }
...
class HSchedulerARM : public HScheduler {
 public:
  ...
  void SetCodeGenenerator(CodeGenerator* codegen) {
    // ARM latency visitors need to know how later codegen generates instructions;
    // for example, how does it generate atomic loads and stores.
    arm_latency_visitor_.SetCodeGenenerator(down_cast<CodeGeneratorARMType*>(codegen));
  }
