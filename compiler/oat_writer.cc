 ...
 public:
  ...
  bool VisitMethod(size_t class_def_method_index, const ClassDataItemIterator& it)
    ...
    if (compiled_method != nullptr) {
      ...
      DCHECK_NE(quick_code_offset, 0u);
      uint32_t code_offset = quick_code_offset - thumb_offset;
      DCHECK_NE(code_offset, 0u);
      if (compiled_method->GetQuickCode().data() != nullptr) {
...
class OatWriter::InitMapMethodVisitor : public OatDexMethodVisitor {
 public:
  ...
  bool VisitMethod(size_t class_def_method_index, const ClassDataItemIterator& it ATTRIBUTE_UNUSED)
    ...
    if (compiled_method != nullptr) {
      DCHECK_LT(method_offsets_index_, oat_class->method_offsets_.size());
      if (compiled_method->GetQuickCode().data() != nullptr || !kIsVdexEnabled) {
 ...
 public:
  ...
  bool VisitMethod(size_t class_def_method_index, const ClassDataItemIterator& it) {
    ...
    if (compiled_method != nullptr) {  // ie. not an abstract method
      ...
      if (map_offset != 0u &&
          (!kIsVdexEnabled || compiled_method->GetQuickCode().data() != nullptr)) {
