 ...
 public:
  ...
  class BuildIdSection FINAL : public Section {
   public:
    ...
    void Write() {
      // The size fields are 32-bit on both 32-bit and 64-bit systems, see
      // the documentation on ELF format.  The size of name and desc must be
      // a multiple of 4 and it currently is.
