      ...
      if (!klass->IsInitialized()) {
        ...
        if (!klass->IsInitialized() &&
          ...
          if (is_boot_image) {
            ...
            // And optimization will be disabled in debuggable build, because this optimization slightly changed
            // the behaviour which will interfere development. And some test cases fail on debuggable build.
