...
void CompilerDriver::PreCompile(jobject class_loader,
  ...
  method_verification_bitmap_table_.AddDexFiles(GetCompilerOptions().GetDexFilesForOatFile());
...
void CompilerDriver::RecordClassMethodVerificationBitmap(ClassReference ref,
  ...
  CHECK(result != ClassMethodVerificationBitmapTable::kInsertResultInvalidDexFile)
