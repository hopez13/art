...
class LinkerPatch {
 public:
  ...
  static LinkerPatch BakerReadBarrierBranchPatch(size_t literal_offset,
    ...
    patch.custom_value1_ = custom_value1;
    patch.custom_value2_ = custom_value2;
    return patch;
  }
 ...
 private:
  ...
  union {
    ...
    static_assert(sizeof(custom_value1_) == sizeof(cmp1_), "needed by relational operators");
  };
  union {
    ...
    static_assert(sizeof(custom_value2_) <= sizeof(cmp2_), "needed by relational operators");
  };
