...
class Compiler {
 public:
  ...
  virtual bool JitCompile(Thread* self [[maybe_unused]],
                          jit::JitCodeCache* code_cache [[maybe_unused]],
                          jit::JitMemoryRegion* region [[maybe_unused]],
                          ArtMethod* method [[maybe_unused]],
                          CompilationKind compilation_kind [[maybe_unused]],
                          jit::JitLogger* jit_logger [[maybe_unused]])
