...
// Note: adding a new intrinsic in the middle of the list requires an art image version change
// as the modifiers flags for some ArtMethod will need to be change. Adding at the end of the
// list does not require any version change.
