...
struct DebugInfo {
  ...
  const std::vector<const DexFile*>* dex_files;  // Describes dex bytecode in .vdex section.
  size_t vdex_dex_files_offset;  // Offset of the first dex-file from the start of .vdex.
