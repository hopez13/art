...
static JniCompiledMethod ArtJniCompileMethodInternal(const CompilerOptions& compiler_options,
  ...
  if (LIKELY(!is_critical_native)) {
    ...
    __ LoadLocalReferenceFrameStates(jni_env_reg, previous_state_reg, current_state_reg);
  ...
  if (LIKELY(!is_critical_native)) {
    __ StoreLocalReferenceFrameStates(jni_env_reg, previous_state_reg, current_state_reg);
