...
std::unique_ptr<JniCallingConvention> JniCallingConvention::Create(ArenaAllocator* arena,
  ...
  if (is_critical_native) {
    switch (instruction_set) {
      case kX86_64:  // gtest passing
        break;
      case kX86:     // gtest passing
        break;
      case kArm64:
        break;       // gtest passing
    case kArm:       // gtest passing
    case kThumb2:
        break;
      default:
        // TODO: implement for other architectures.
        UNIMPLEMENTED(FATAL) << "not yet implemented @CriticalNative support for other architectures";
    }
  }
