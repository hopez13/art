...
size_t count_nonnull_refs_single_helper(
    T arg [[maybe_unused]], typename std::enable_if<!jni_type_traits<T>::is_ref>::type* = nullptr) {
  return 0;
}
...
class CountReferencesVisitor : public RootVisitor {
 public:
  ...
  void VisitRoots(mirror::CompressedReference<mirror::Object>** roots [[maybe_unused]],
...
jint Java_MyClassNatives_fooSII(JNIEnv* env [[maybe_unused]],
...
jdouble Java_MyClassNatives_fooSDD(JNIEnv* env [[maybe_unused]],
                                   jclass klass [[maybe_unused]],
                                   jdouble x,
                                   jdouble y) {
...
void Java_MyClassNatives_checkParameterAlign(JNIEnv* env [[maybe_unused]],
                                             jobject thisObj [[maybe_unused]],
                                             jint i1,
                                             jlong l1) {
  EXPECT_EQ(i1, 1234);
