...
MipsAssembler::NoImplicitNullChecker MipsAssembler::no_implicit_null_checker_;

void MipsAssembler::StoreConst32ToOffset(int32_t value,
                                         Register base,
                                         int32_t offset,
                                         Register temp) {
  StoreConst32ToOffset<>(value, base, offset, temp);
}
...
void MipsAssembler::StoreConst64ToOffset(int64_t value,
                                         ...
                                         int32_t offset,
                                         Register temp) {
  StoreConst64ToOffset<>(value, base, offset, temp);
}
