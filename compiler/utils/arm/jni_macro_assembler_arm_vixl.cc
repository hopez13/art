...
void ArmVIXLJNIMacroAssembler::LoadRef(ManagedRegister /*dest*/, FrameOffset /*src*/) {
  UNIMPLEMENTED(FATAL);
}

void ArmVIXLJNIMacroAssembler::LoadRawPtr(ManagedRegister /*dest*/,
                                          ManagedRegister /*base*/,
                                          Offset /*offs*/) {
  UNIMPLEMENTED(FATAL);
}
...
void ArmVIXLJNIMacroAssembler::CopyRawPtrToThread(ThreadOffset32 /*thr_offs*/,
                                                  FrameOffset /*fr_offs*/,
                                                  ManagedRegister /*mscratch*/) {
  UNIMPLEMENTED(FATAL);
}
...
void ArmVIXLJNIMacroAssembler::SignExtend(ManagedRegister /*mreg*/, size_t /*size*/) {
  UNIMPLEMENTED(FATAL) << "no sign extension necessary for arm";
}

void ArmVIXLJNIMacroAssembler::ZeroExtend(ManagedRegister /*mreg*/, size_t /*size*/) {
...
void ArmVIXLJNIMacroAssembler::Copy(ManagedRegister /*dest_base*/,
                                    Offset /*dest_offset*/,
                                    FrameOffset /*src*/,
                                    ManagedRegister /*mscratch*/,
                                    size_t /*size*/) {
...
void ArmVIXLJNIMacroAssembler::Copy(FrameOffset /*dst*/,
...
void ArmVIXLJNIMacroAssembler::Copy(ManagedRegister /*dest*/,
                                    Offset /*dest_offset*/,
                                    ManagedRegister /*src*/,
                                    Offset /*src_offset*/,
                                    ManagedRegister /*mscratch*/,
...
void ArmVIXLJNIMacroAssembler::LoadReferenceFromHandleScope(ManagedRegister /*mout_reg*/,
                                                            ManagedRegister /*min_reg*/) {
  UNIMPLEMENTED(FATAL);
}

void ArmVIXLJNIMacroAssembler::VerifyObject(ManagedRegister /*src*/, bool /*could_be_null*/) {
  // TODO: not validating references.
}

void ArmVIXLJNIMacroAssembler::VerifyObject(FrameOffset /*src*/, bool /*could_be_null*/) {
  // TODO: not validating references.
}
...
void ArmVIXLJNIMacroAssembler::MemoryBarrier(ManagedRegister /*scratch*/) {
  UNIMPLEMENTED(FATAL);
}
