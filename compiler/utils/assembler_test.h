...
class AssemblerTest : public AssemblerTestBase {
 public:
  ...
  virtual std::string GetSecondaryRegisterName(const Reg& reg [[maybe_unused]]) {
  ...
  virtual std::string GetTertiaryRegisterName(const Reg& reg [[maybe_unused]]) {
  ...
  virtual std::string GetQuaternaryRegisterName(const Reg& reg [[maybe_unused]]) {
 ...
 private:
  ...
  virtual void Pad(std::vector<uint8_t>& data [[maybe_unused]]) {}
