...
struct LoadConst64Tester {
  LoadConst64Tester() {
    for (int r = 0; r < 32; r++)
      regs_[r] = 0;
    loadConst64Path_ = art::mips64::kLoadConst64PathZero;
  }
  ...
  int GetPathsCovered() {
    return loadConst64Path_;
  }

  void RecordLoadConst64Path(int value) {
    loadConst64Path_ |= value;
  }

  private:
  int loadConst64Path_;
};
...
TEST_F(AssemblerMIPS64Test, LoadConst64) {
  ...
  CHECK_EQ(tester.GetPathsCovered(), art::mips64::kLoadConst64PathAllPaths);
}
