...
class Mips64Assembler FINAL : public Assembler, public JNIMacroAssembler<PointerSize::k64> {
 public:
  ...
  void SplatiB(VectorRegister wd, VectorRegister ws, int shamt4);
  void SplatiH(VectorRegister wd, VectorRegister ws, int shamt3);
  void SplatiW(VectorRegister wd, VectorRegister ws, int shamt2);
  void SplatiD(VectorRegister wd, VectorRegister ws, int shamt1);
