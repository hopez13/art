...
class Riscv64JNIMacroAssembler final
    : public JNIMacroAssemblerFwd<Riscv64Assembler, PointerSize::k64> {
 public:
...
class Riscv64JNIMacroLabel final : public JNIMacroLabelCommon<Riscv64JNIMacroLabel,
                                                              art::riscv64::Riscv64Label,
                                                              InstructionSet::kRiscv64> {
 public:
  art::riscv64::Riscv64Label* AsRiscv64() { return AsPlatformLabel(); }
};
