...
void Riscv64Assembler::FCvtDS(FRegister rd, FRegister rs1) {
  // No rounding, the result can represent every value of the source exactly.
...
void Riscv64Assembler::FCvtDW(FRegister rd, XRegister rs1) {
  // No rounding, the result can represent every value of the source exactly.
