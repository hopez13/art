...
void Riscv64Assembler::VSetvli(XRegister rd, XRegister rs1, uint32_t vtypei) {
  ...
  EmitI(vtypei, rs1, enum_cast<uint32_t>(VAIEncodings::kOPCFG), rd, 0x57);
}
...
void Riscv64Assembler::VSetivli(XRegister rd, uint32_t uimm, uint32_t vtypei) {
  ...
  EmitI((~0U << 10 | vtypei), uimm, enum_cast<uint32_t>(VAIEncodings::kOPCFG), rd, 0x57);
}

void Riscv64Assembler::VSetvl(XRegister rd, XRegister rs1, XRegister rs2) {
  EmitR(0x40, rs2, rs1, enum_cast<uint32_t>(VAIEncodings::kOPCFG), rd, 0x57);
}
...
void Riscv64Assembler::VLe8(VRegister vd, XRegister rs1) {
  EmitVLoadStoreUS(Nf::k1,
                   0x0,
                   MemAddressMode::kUnitStride,
                   VM::kUnmasked,
                   0b00000,
                   rs1,
                   VectorWidth::k8,
...
void Riscv64Assembler::VLse8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLse16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLse32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLse64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VSse8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSse16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSse32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSse64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  EmitVLoadStoreS(Nf::k1, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VLoxe8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxe16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxe32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxe64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxe8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxe16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxe32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxe64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VSoxe8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxe16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxe32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxe64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxe8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxe16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxe32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxe64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  EmitVLoadStoreI(
      Nf::k1, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VLseg2e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg2e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg2e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg2e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg3e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg3e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg3e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg3e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg4e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg4e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg4e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg4e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg5e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg5e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg5e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg5e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg6e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg6e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg6e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg6e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg7e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg7e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg7e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg7e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg8e8(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg8e16(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg8e32(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg8e64(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VSseg2e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg2e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg2e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg2e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSseg3e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg3e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg3e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg3e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSseg4e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg4e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg4e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg4e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSseg5e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg5e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg5e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg5e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSseg6e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg6e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg6e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg6e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSseg7e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg7e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg7e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg7e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSseg8e8(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSseg8e16(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSseg8e32(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSseg8e64(VRegister vs3, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b00000, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VLseg2e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg2e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg2e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg2e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg3e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg3e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg3e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg3e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg4e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg4e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg4e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg4e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg5e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg5e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg5e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg5e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg6e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg6e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg6e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg6e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg7e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg7e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg7e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg7e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLseg8e8ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLseg8e16ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLseg8e32ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLseg8e64ff(VRegister vd, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kUnitStride, vm, 0b10000, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg2e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg2e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg2e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg2e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg3e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg3e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg3e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg3e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg4e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg4e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg4e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg4e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg5e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg5e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg5e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg5e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg6e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg6e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg6e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg6e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg7e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg7e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg7e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg7e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLsseg8e8(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLsseg8e16(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLsseg8e32(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLsseg8e64(VRegister vd, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VSsseg2e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg2e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg2e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg2e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSsseg3e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg3e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg3e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg3e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSsseg4e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg4e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg4e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg4e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSsseg5e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg5e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg5e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg5e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSsseg6e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg6e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg6e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg6e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSsseg7e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg7e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg7e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg7e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSsseg8e8(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSsseg8e16(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSsseg8e32(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSsseg8e64(VRegister vs3, XRegister rs1, XRegister rs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kStrided, vm, rs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VLuxseg2ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg2ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg2ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg2ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxseg3ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg3ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg3ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg3ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxseg4ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg4ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg4ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg4ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxseg5ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg5ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg5ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg5ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxseg6ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg6ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg6ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg6ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxseg7ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg7ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg7ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg7ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLuxseg8ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLuxseg8ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLuxseg8ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLuxseg8ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VSuxseg2ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg2ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg2ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg2ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg3ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg3ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg3ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg3ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg4ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg4ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg4ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg4ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg5ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg5ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg5ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg5ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg6ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg6ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg6ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg6ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg7ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg7ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg7ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg7ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg8ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg8ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg8ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSuxseg8ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedUnordered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VLoxseg2ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg2ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg2ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg2ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLoxseg3ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg3ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg3ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg3ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLoxseg4ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg4ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg4ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg4ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLoxseg5ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg5ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg5ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg5ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLoxseg6ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg6ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg6ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg6ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLoxseg7ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg7ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg7ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg7ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VLoxseg8ei8(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vd, 0x7);
}

void Riscv64Assembler::VLoxseg8ei16(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vd, 0x7);
}

void Riscv64Assembler::VLoxseg8ei32(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vd, 0x7);
}

void Riscv64Assembler::VLoxseg8ei64(VRegister vd, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vd, 0x7);
}

void Riscv64Assembler::VSoxseg2ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg2ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg2ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg2ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k2, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg3ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg3ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg3ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg3ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k3, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg4ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg4ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg4ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg4ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k4, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg5ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg5ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg5ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg5ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k5, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg6ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg6ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg6ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg6ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k6, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg7ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg7ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg7ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg7ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k7, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg8ei8(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k8, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg8ei16(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k16, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg8ei32(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k32, vs3, 0x27);
}

void Riscv64Assembler::VSoxseg8ei64(VRegister vs3, XRegister rs1, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vs3 != V0);
  EmitVLoadStoreUS(
      Nf::k8, 0x0, MemAddressMode::kIndexedOrdered, vm, vs2, rs1, VectorWidth::k64, vs3, 0x27);
}
...
void Riscv64Assembler::VAdd_vv(VRegister vd, VRegister vs2, VRegister vs1, VM vm) {
  ...
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}

void Riscv64Assembler::VAdd_vx(VRegister vd, VRegister vs2, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000000, vm);
  EmitR(funct7, vs2, rs1, enum_cast<uint32_t>(VAIEncodings::kOPIVX), vd, 0x57);
}

void Riscv64Assembler::VAdd_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000000, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VRsub_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000011, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VAnd_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001001, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VOr_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001010, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VXor_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001011, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VRgather_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001100, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VSlideup_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001110, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VSlidedown_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001111, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VAdc_vvm(VRegister vd, VRegister vs2, VRegister vs1) {
  DCHECK(vd != vs1 && vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010000, VM::kV0_t);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMadc_vvm(VRegister vd, VRegister vs2, VRegister vs1) {
  const uint32_t funct7 = computeRVVF7(0b010001, VM::kV0_t);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMadc_vv(VRegister vd, VRegister vs2, VRegister vs1) {
  const uint32_t funct7 = computeRVVF7(0b010001, VM::kUnmasked);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VSbc_vvm(VRegister vd, VRegister vs2, VRegister vs1) {
  DCHECK(vd != vs1 && vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, VM::kV0_t);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMsbc_vvm(VRegister vd, VRegister vs2, VRegister vs1) {
  const uint32_t funct7 = computeRVVF7(0b010011, VM::kV0_t);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMsbc_vv(VRegister vd, VRegister vs2, VRegister vs1) {
  const uint32_t funct7 = computeRVVF7(0b010011, VM::kUnmasked);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMerge_vvm(VRegister vd, VRegister vs2, VRegister vs1) {
  DCHECK(vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010111, VM::kV0_t /* 0 */);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMv_vv(VRegister vd, VRegister vs1) {
  const uint32_t funct7 = computeRVVF7(0b010111, VM::kUnmasked /* 1 */);
  EmitR(funct7, V0, vs1, enum_cast<uint32_t>(VAIEncodings::kOPIVV), vd, 0x57);
}

void Riscv64Assembler::VMv_vx(VRegister vd, XRegister rs1) {
  const uint32_t funct7 = computeRVVF7(0b010111, VM::kUnmasked /* 1 */);
  EmitR(funct7, V0, rs1, enum_cast<uint32_t>(VAIEncodings::kOPIVX), vd, 0x57);
}

void Riscv64Assembler::VMv_vi(VRegister vd, uint32_t imm1) {
  const uint32_t funct7 = computeRVVF7(0b010111, VM::kUnmasked /* 1 */);
  EmitRVV(funct7, V0, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VMseq_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b011000, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VMsne_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b011001, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VMsleu_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b011100, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VMsle_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b011101, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VMsgtu_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b011110, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VMsgt_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b011111, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VSaddu_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  const uint32_t funct7 = computeRVVF7(0b100000, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VSadd_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b100001, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57);
}
...
void Riscv64Assembler::VSll_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b100101, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VSrl_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101000, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VSra_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101001, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VSsrl_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101010, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VSsra_vi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101011, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VNsrl_wi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101100, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VNsra_wi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101101, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VNclipu_wi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101110, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VNclip_wi(VRegister vd, VRegister vs2, uint32_t imm1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b101111, vm);
  EmitRVV(funct7, vs2, imm1, enum_cast<uint32_t>(VAIEncodings::kOPIVI), vd, 0x57, true);
}
...
void Riscv64Assembler::VRedsum_vs(VRegister vd, VRegister vs2, VRegister vs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000000, vm);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57);
}
...
void Riscv64Assembler::VAaddu_vx(VRegister vd, VRegister vs2, XRegister rs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b001000, vm);
  EmitR(funct7, vs2, rs1, enum_cast<uint32_t>(VAIEncodings::kOPMVX), vd, 0x57);
}
...
void Riscv64Assembler::VFadd_vv(VRegister vd, VRegister vs2, VRegister vs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000000, vm);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57);
}

void Riscv64Assembler::VFadd_vf(VRegister vd, VRegister vs2, FRegister fs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000000, vm);
  EmitR(funct7, vs2, fs1, enum_cast<uint32_t>(VAIEncodings::kOPFVF), vd, 0x57);
}
...
void Riscv64Assembler::VFredmax_vv(VRegister vd, VRegister vs2, VRegister vs1, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b000111, vm);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57);
}
...
void Riscv64Assembler::VFmerge_vfm(VRegister vd, VRegister vs2, FRegister fs1) {
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010111, VM::kV0_t);
  EmitR(funct7, vs2, fs1, enum_cast<uint32_t>(VAIEncodings::kOPFVF), vd, 0x57);
}
...
void Riscv64Assembler::VMv_s_x(VRegister vd, XRegister rs1) {
  const uint32_t imm12 = computeRVVImm12(0b010000, 0b00000, VM::kUnmasked);
  EmitI(imm12, rs1, enum_cast<uint32_t>(VAIEncodings::kOPMVX), vd, 0x57);
}

void Riscv64Assembler::VMv_x_s(XRegister vd, VRegister vs2) {
  const uint32_t funct7 = computeRVVF7(0b010000, VM::kUnmasked);
  EmitRVV(funct7, vs2, 0b00000, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VPopc_m(XRegister vd, VRegister vs2, VM vm) {
  const uint32_t funct7 = computeRVVF7(0b010000, vm);
  EmitRVV(funct7, vs2, 0b10000, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VFirst_m(XRegister vd, VRegister vs2, VM vm) {
  const uint32_t funct7 = computeRVVF7(0b010000, vm);
  EmitRVV(funct7, vs2, 0b10001, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VZext_vf8(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00010, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VSext_vf8(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00011, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VZext_vf4(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00100, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VSext_vf4(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00101, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VZext_vf2(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00110, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VSext_vf2(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00111, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}

void Riscv64Assembler::VFmv_s_f(VRegister vd, FRegister fs1) {
  const uint32_t imm12 = computeRVVImm12(0b010000, 0b00000, VM::kUnmasked);
  EmitI(imm12, fs1, enum_cast<uint32_t>(VAIEncodings::kOPFVF), vd, 0x57);
}

void Riscv64Assembler::VFmv_f_s(FRegister vd, VRegister vs2) {
  const uint32_t funct7 = computeRVVF7(0b010000, VM::kUnmasked);
  EmitRVV(funct7, vs2, 0b00000, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFcvt_x_f_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00001, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFcvt_f_xu_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00010, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFcvt_f_x_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00011, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFcvt_rtz_xu_f_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00110, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFcvt_rtz_x_f_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b00111, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_xu_f_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01000, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_x_f_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01001, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_f_xu_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01010, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_f_x_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01011, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_f_f_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01100, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_rtz_xu_f_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01110, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFwcvt_rtz_x_f_v(VRegister vd, VRegister vs2, VM vm) {
  ...
  DCHECK(vd != vs2);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b01111, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_xu_f_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10000, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_x_f_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10001, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_f_xu_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10010, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_f_x_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10011, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_f_f_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10100, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_rod_f_f_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10101, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_rtz_xu_f_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10110, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFncvt_rtz_x_f_w(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010010, vm);
  EmitRVV(funct7, vs2, 0b10111, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VFrsqrt7_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010011, vm);
  EmitRVV(funct7, vs2, 0b00100, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}

void Riscv64Assembler::VFrec7_v(VRegister vd, VRegister vs2, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010011, vm);
  EmitRVV(funct7, vs2, 0b00101, enum_cast<uint32_t>(VAIEncodings::kOPFVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VMsbf_m(VRegister vd, VRegister vs2, VM vm) {
  ...
  EmitRVV(funct7, vs2, 0b00001, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}
...
void Riscv64Assembler::VId_v(VRegister vd, VM vm) {
  DCHECK(vm != VM::kV0_t || vd != V0);
  const uint32_t funct7 = computeRVVF7(0b010100, vm);
  EmitRVV(funct7, V0, 0b10001, enum_cast<uint32_t>(VAIEncodings::kOPMVV), vd, 0x57, true);
}
