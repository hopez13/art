...
void Riscv64Assembler::VMerge_vvm(VRegister vd, VRegister vs2, VRegister vs1) {
  DCHECK(vd != V0);
  const uint32_t funct7 = EncodeRVVF7(0b010111, VM::kV0_t /* 0 */);
  EmitR(funct7, vs2, vs1, enum_cast<uint32_t>(VAIEncoding::kOPIVV), vd, 0x57);
}
...
void Riscv64Assembler::VMv_vv(VRegister vd, VRegister vs1) {
  const uint32_t funct7 = EncodeRVVF7(0b010111, VM::kUnmasked /* 1 */);
...
void Riscv64Assembler::VMsgeu_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm) {
  DCHECK(IsUint<4>(imm5 - 1)) << "Should be between [1, 16]" << imm5;
  VMsgtu_vi(vd, vs2, imm5 - 1, vm);
}
...
void Riscv64Assembler::VMsltu_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm) {
  DCHECK(IsUint<4>(imm5 - 1)) << "Should be between [1, 16]" << imm5;
  VMsleu_vi(vd, vs2, imm5 - 1, vm);
}
...
void Riscv64Assembler::VMsge_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm) {
  VMsgt_vi(vd, vs2, imm5 - 1, vm);
}

void Riscv64Assembler::VMslt_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm) {
  VMsle_vi(vd, vs2, imm5 - 1, vm);
}
