...
class AssemblerRISCV64Test : public AssemblerTest<Riscv64Assembler,
 ...
 protected:
  ...
  std::string RepeatVVIbFiltered(void (Riscv64Assembler::*f)(VRegister, VRegister, ImmType),
                                 int imm_bits,
                                 const std::string& fmt,
                                 Pred&& predicate) {
    CHECK(f != nullptr);
  ...
  template <typename Pred, typename ImmType>
  std::string RepeatVVIVmFiltered(
  ...
  template <typename Pred>
  std::string RepeatVVmFiltered(void (Riscv64Assembler::*f)(VRegister, Riscv64Assembler::VM vm),
                                const std::string& fmt,
                                Pred&& predicate) {
    CHECK(f != nullptr);
    std::string str;
  ...
  auto VmIdPredicate() {
    return [](Reg1, Reg2, Reg3, Riscv64Assembler::VM) { return true; };
  }

  template <typename Reg1, typename Reg2>
  auto VmIdPredicate() {
    return [](Reg1, Reg2, Riscv64Assembler::VM) { return true; };
  }

  template <typename Reg1>
  auto VmIdPredicate() {
    return [](Reg1, Riscv64Assembler::VM) { return true; };
  }

  template <typename Reg2>
  auto VXVVmSkipV0V1Overlap() {
    return [](VRegister vd, Reg2, VRegister vs1, Riscv64Assembler::VM vm) {
      if (vm == Riscv64Assembler::VM::kV0_t && vd == V0)
        return false;
  ...
  auto SkipV0VmFiltered() {
    return [](VRegister vd, Reg2, Reg3, Riscv64Assembler::VM vm) {
  ...
  template <typename Reg2>
  auto SkipV0VmFiltered() {
    return [](VRegister vd, Reg2, Riscv64Assembler::VM vm) {
      return vm != Riscv64Assembler::VM::kV0_t || vd != V0;
    };
  }

  auto SkipV0VmFiltered0() {
    return [](VRegister vd, Riscv64Assembler::VM vm) {
      return vm != Riscv64Assembler::VM::kV0_t || vd != V0;
    };
  }
  ...
  auto VVVNoV0Overlap() {
    return [](VRegister vd, VRegister vs2, VRegister vs1) {
      return vd != vs1 && vd != vs2 && vd != V0;
    };
  }
...
TEST_F(AssemblerRISCV64Test, VLe8) {
  DriverStr(
      RepeatVRVmFiltered(
          &Riscv64Assembler::VLe8, "vle8.v {reg1}, ({reg2}){vm}", SkipV0VmFiltered<XRegister>()),
      "VLe8");
}
...
TEST_F(AssemblerRISCV64Test, VLe16) {
  DriverStr(
      RepeatVRVmFiltered(
          &Riscv64Assembler::VLe16, "vle16.v {reg1}, ({reg2}){vm}", SkipV0VmFiltered<XRegister>()),
      "VLe16");
}
...
TEST_F(AssemblerRISCV64Test, VLe32) {
  DriverStr(
      RepeatVRVmFiltered(
          &Riscv64Assembler::VLe32, "vle32.v {reg1}, ({reg2}){vm}", SkipV0VmFiltered<XRegister>()),
      "VLe32");
}
...
TEST_F(AssemblerRISCV64Test, VLe64) {
  DriverStr(
      RepeatVRVmFiltered(
          &Riscv64Assembler::VLe64, "vle64.v {reg1}, ({reg2}){vm}", SkipV0VmFiltered<XRegister>()),
      "VLe64");
}
...
TEST_F(AssemblerRISCV64Test, VSe8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSe8,
                               "vse8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSe8");
}

TEST_F(AssemblerRISCV64Test, VSe16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSe16,
                               "vse16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSe16");
}

TEST_F(AssemblerRISCV64Test, VSe32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSe32,
                               "vse32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSe32");
}

TEST_F(AssemblerRISCV64Test, VSe64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSe64,
                               "vse64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSe64");
}
...
TEST_F(AssemblerRISCV64Test, VLse8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VLse8,
                                ...
                                SkipV0VmFiltered<XRegister, XRegister>()),
            "VLse8");
}
...
TEST_F(AssemblerRISCV64Test, VSse8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSse8,
                                "vsse8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSse8");
}

TEST_F(AssemblerRISCV64Test, VSse16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSse16,
                                "vsse16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSse16");
}

TEST_F(AssemblerRISCV64Test, VSse32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSse32,
                                "vsse32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSse32");
}

TEST_F(AssemblerRISCV64Test, VSse64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSse64,
                                "vsse64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSse64");
}

TEST_F(AssemblerRISCV64Test, VLoxe8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLoxe8,
                                "vloxei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                SkipV0VmFiltered<XRegister, VRegister>()),
            "VLoxe8");
}

TEST_F(AssemblerRISCV64Test, VLoxe16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLoxe16,
...
TEST_F(AssemblerRISCV64Test, VLoxe32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLoxe32,
...
TEST_F(AssemblerRISCV64Test, VLoxe64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLoxe64,
...
TEST_F(AssemblerRISCV64Test, VLuxe8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLuxe8,
...
TEST_F(AssemblerRISCV64Test, VLuxe16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLuxe16,
...
TEST_F(AssemblerRISCV64Test, VLuxe32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLuxe32,
...
TEST_F(AssemblerRISCV64Test, VLuxe64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VLuxe64,
...
TEST_F(AssemblerRISCV64Test, VSoxe8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxe8,
                                "vsoxei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxe8");
}

TEST_F(AssemblerRISCV64Test, VSoxe16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxe16,
                                "vsoxei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxe16");
}

TEST_F(AssemblerRISCV64Test, VSoxe32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxe32,
                                "vsoxei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxe32");
}

TEST_F(AssemblerRISCV64Test, VSoxe64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxe64,
                                "vsoxei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxe64");
}

TEST_F(AssemblerRISCV64Test, VSuxe8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxe8,
                                "vsuxei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxe8");
}

TEST_F(AssemblerRISCV64Test, VSuxe16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxe16,
                                "vsuxei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxe16");
}

TEST_F(AssemblerRISCV64Test, VSuxe32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxe32,
                                "vsuxei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxe32");
}

TEST_F(AssemblerRISCV64Test, VSuxe64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxe64,
                                "vsuxei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxe64");
}

TEST_F(AssemblerRISCV64Test, VLseg2e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg2e8,
                               "vlseg2e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg2e8");
}

TEST_F(AssemblerRISCV64Test, VLseg2e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg2e16,
                               "vlseg2e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg2e16");
}

TEST_F(AssemblerRISCV64Test, VLseg2e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg2e32,
                               "vlseg2e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg2e32");
}

TEST_F(AssemblerRISCV64Test, VLseg2e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg2e64,
                               "vlseg2e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg2e64");
}

TEST_F(AssemblerRISCV64Test, VLseg3e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg3e8,
                               "vlseg3e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg3e8");
}

TEST_F(AssemblerRISCV64Test, VLseg3e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg3e16,
                               "vlseg3e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg3e16");
}

TEST_F(AssemblerRISCV64Test, VLseg3e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg3e32,
                               "vlseg3e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg3e32");
}

TEST_F(AssemblerRISCV64Test, VLseg3e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg3e64,
                               "vlseg3e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg3e64");
}

TEST_F(AssemblerRISCV64Test, VLseg4e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg4e8,
                               "vlseg4e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg4e8");
}

TEST_F(AssemblerRISCV64Test, VLseg4e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg4e16,
                               "vlseg4e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg4e16");
}

TEST_F(AssemblerRISCV64Test, VLseg4e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg4e32,
                               "vlseg4e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg4e32");
}

TEST_F(AssemblerRISCV64Test, VLseg4e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg4e64,
                               "vlseg4e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg4e64");
}

TEST_F(AssemblerRISCV64Test, VLseg5e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg5e8,
                               "vlseg5e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg5e8");
}

TEST_F(AssemblerRISCV64Test, VLseg5e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg5e16,
                               "vlseg5e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg5e16");
}

TEST_F(AssemblerRISCV64Test, VLseg5e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg5e32,
                               "vlseg5e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg5e32");
}

TEST_F(AssemblerRISCV64Test, VLseg5e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg5e64,
                               "vlseg5e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg5e64");
}

TEST_F(AssemblerRISCV64Test, VLseg6e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg6e8,
                               "vlseg6e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg6e8");
}

TEST_F(AssemblerRISCV64Test, VLseg6e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg6e16,
                               "vlseg6e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg6e16");
}

TEST_F(AssemblerRISCV64Test, VLseg6e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg6e32,
                               "vlseg6e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg6e32");
}

TEST_F(AssemblerRISCV64Test, VLseg6e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg6e64,
                               "vlseg6e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg6e64");
}

TEST_F(AssemblerRISCV64Test, VLseg7e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg7e8,
                               "vlseg7e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg7e8");
}

TEST_F(AssemblerRISCV64Test, VLseg7e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg7e16,
                               "vlseg7e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg7e16");
}

TEST_F(AssemblerRISCV64Test, VLseg7e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg7e32,
                               "vlseg7e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg7e32");
}

TEST_F(AssemblerRISCV64Test, VLseg7e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg7e64,
                               "vlseg7e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg7e64");
}

TEST_F(AssemblerRISCV64Test, VLseg8e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg8e8,
                               "vlseg8e8.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg8e8");
}

TEST_F(AssemblerRISCV64Test, VLseg8e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg8e16,
                               "vlseg8e16.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg8e16");
}

TEST_F(AssemblerRISCV64Test, VLseg8e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg8e32,
                               "vlseg8e32.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg8e32");
}

TEST_F(AssemblerRISCV64Test, VLseg8e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VLseg8e64,
                               "vlseg8e64.v {reg1}, ({reg2}){vm}",
                               SkipV0VmFiltered<XRegister>()),
            "VLseg8e64");
}

TEST_F(AssemblerRISCV64Test, VSseg2e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg2e8,
                               "vsseg2e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg2e8");
}

TEST_F(AssemblerRISCV64Test, VSseg2e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg2e16,
                               "vsseg2e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg2e16");
}

TEST_F(AssemblerRISCV64Test, VSseg2e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg2e32,
                               "vsseg2e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg2e32");
}

TEST_F(AssemblerRISCV64Test, VSseg2e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg2e64,
                               "vsseg2e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg2e64");
}

TEST_F(AssemblerRISCV64Test, VSseg3e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg3e8,
                               "vsseg3e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg3e8");
}

TEST_F(AssemblerRISCV64Test, VSseg3e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg3e16,
                               "vsseg3e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg3e16");
}

TEST_F(AssemblerRISCV64Test, VSseg3e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg3e32,
                               "vsseg3e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg3e32");
}

TEST_F(AssemblerRISCV64Test, VSseg3e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg3e64,
                               "vsseg3e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg3e64");
}

TEST_F(AssemblerRISCV64Test, VSseg4e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg4e8,
                               "vsseg4e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg4e8");
}

TEST_F(AssemblerRISCV64Test, VSseg4e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg4e16,
                               "vsseg4e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg4e16");
}

TEST_F(AssemblerRISCV64Test, VSseg4e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg4e32,
                               "vsseg4e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg4e32");
}

TEST_F(AssemblerRISCV64Test, VSseg4e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg4e64,
                               "vsseg4e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg4e64");
}

TEST_F(AssemblerRISCV64Test, VSseg5e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg5e8,
                               "vsseg5e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg5e8");
}

TEST_F(AssemblerRISCV64Test, VSseg5e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg5e16,
                               "vsseg5e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg5e16");
}

TEST_F(AssemblerRISCV64Test, VSseg5e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg5e32,
                               "vsseg5e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg5e32");
}

TEST_F(AssemblerRISCV64Test, VSseg5e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg5e64,
                               "vsseg5e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg5e64");
}

TEST_F(AssemblerRISCV64Test, VSseg6e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg6e8,
                               "vsseg6e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg6e8");
}

TEST_F(AssemblerRISCV64Test, VSseg6e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg6e16,
                               "vsseg6e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg6e16");
}

TEST_F(AssemblerRISCV64Test, VSseg6e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg6e32,
                               "vsseg6e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg6e32");
}

TEST_F(AssemblerRISCV64Test, VSseg6e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg6e64,
                               "vsseg6e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg6e64");
}

TEST_F(AssemblerRISCV64Test, VSseg7e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg7e8,
                               "vsseg7e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg7e8");
}

TEST_F(AssemblerRISCV64Test, VSseg7e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg7e16,
                               "vsseg7e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg7e16");
}

TEST_F(AssemblerRISCV64Test, VSseg7e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg7e32,
                               "vsseg7e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg7e32");
}

TEST_F(AssemblerRISCV64Test, VSseg7e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg7e64,
                               "vsseg7e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg7e64");
}

TEST_F(AssemblerRISCV64Test, VSseg8e8) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg8e8,
                               "vsseg8e8.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg8e8");
}

TEST_F(AssemblerRISCV64Test, VSseg8e16) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg8e16,
                               "vsseg8e16.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg8e16");
}

TEST_F(AssemblerRISCV64Test, VSseg8e32) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg8e32,
                               "vsseg8e32.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg8e32");
}

TEST_F(AssemblerRISCV64Test, VSseg8e64) {
  DriverStr(RepeatVRVmFiltered(&Riscv64Assembler::VSseg8e64,
                               "vsseg8e64.v {reg1}, ({reg2}){vm}",
                               VmIdPredicate<VRegister, XRegister>()),
            "VSseg8e64");
}
...
TEST_F(AssemblerRISCV64Test, VSsseg2e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg2e8,
                                "vssseg2e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg2e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg2e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg2e16,
                                "vssseg2e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg2e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg2e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg2e32,
                                "vssseg2e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg2e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg2e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg2e64,
                                "vssseg2e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg2e64");
}

TEST_F(AssemblerRISCV64Test, VSsseg3e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg3e8,
                                "vssseg3e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg3e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg3e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg3e16,
                                "vssseg3e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg3e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg3e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg3e32,
                                "vssseg3e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg3e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg3e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg3e64,
                                "vssseg3e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg3e64");
}

TEST_F(AssemblerRISCV64Test, VSsseg4e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg4e8,
                                "vssseg4e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg4e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg4e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg4e16,
                                "vssseg4e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg4e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg4e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg4e32,
                                "vssseg4e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg4e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg4e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg4e64,
                                "vssseg4e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg4e64");
}

TEST_F(AssemblerRISCV64Test, VSsseg5e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg5e8,
                                "vssseg5e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg5e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg5e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg5e16,
                                "vssseg5e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg5e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg5e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg5e32,
                                "vssseg5e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg5e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg5e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg5e64,
                                "vssseg5e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg5e64");
}

TEST_F(AssemblerRISCV64Test, VSsseg6e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg6e8,
                                "vssseg6e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg6e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg6e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg6e16,
                                "vssseg6e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg6e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg6e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg6e32,
                                "vssseg6e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg6e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg6e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg6e64,
                                "vssseg6e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg6e64");
}

TEST_F(AssemblerRISCV64Test, VSsseg7e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg7e8,
                                "vssseg7e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg7e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg7e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg7e16,
                                "vssseg7e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg7e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg7e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg7e32,
                                "vssseg7e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg7e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg7e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg7e64,
                                "vssseg7e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg7e64");
}

TEST_F(AssemblerRISCV64Test, VSsseg8e8) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg8e8,
                                "vssseg8e8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg8e8");
}

TEST_F(AssemblerRISCV64Test, VSsseg8e16) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg8e16,
                                "vssseg8e16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg8e16");
}

TEST_F(AssemblerRISCV64Test, VSsseg8e32) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg8e32,
                                "vssseg8e32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg8e32");
}

TEST_F(AssemblerRISCV64Test, VSsseg8e64) {
  DriverStr(RepeatVRRVmFiltered(&Riscv64Assembler::VSsseg8e64,
                                "vssseg8e64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, XRegister>()),
            "VSsseg8e64");
}
...
TEST_F(AssemblerRISCV64Test, VSuxseg2ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg2ei8,
                                "vsuxseg2ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg2ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg2ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg2ei16,
                                "vsuxseg2ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg2ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg2ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg2ei32,
                                "vsuxseg2ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg2ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg2ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg2ei64,
                                "vsuxseg2ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg2ei64");
}

TEST_F(AssemblerRISCV64Test, VSuxseg3ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg3ei8,
                                "vsuxseg3ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg3ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg3ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg3ei16,
                                "vsuxseg3ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg3ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg3ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg3ei32,
                                "vsuxseg3ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg3ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg3ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg3ei64,
                                "vsuxseg3ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg3ei64");
}

TEST_F(AssemblerRISCV64Test, VSuxseg4ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg4ei8,
                                "vsuxseg4ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg4ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg4ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg4ei16,
                                "vsuxseg4ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg4ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg4ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg4ei32,
                                "vsuxseg4ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg4ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg4ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg4ei64,
                                "vsuxseg4ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg4ei64");
}

TEST_F(AssemblerRISCV64Test, VSuxseg5ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg5ei8,
                                "vsuxseg5ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg5ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg5ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg5ei16,
                                "vsuxseg5ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg5ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg5ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg5ei32,
                                "vsuxseg5ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg5ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg5ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg5ei64,
                                "vsuxseg5ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg5ei64");
}

TEST_F(AssemblerRISCV64Test, VSuxseg6ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg6ei8,
                                "vsuxseg6ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg6ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg6ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg6ei16,
                                "vsuxseg6ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg6ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg6ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg6ei32,
                                "vsuxseg6ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg6ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg6ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg6ei64,
                                "vsuxseg6ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg6ei64");
}

TEST_F(AssemblerRISCV64Test, VSuxseg7ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg7ei8,
                                "vsuxseg7ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg7ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg7ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg7ei16,
                                "vsuxseg7ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg7ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg7ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg7ei32,
                                "vsuxseg7ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg7ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg7ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg7ei64,
                                "vsuxseg7ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg7ei64");
}

TEST_F(AssemblerRISCV64Test, VSuxseg8ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg8ei8,
                                "vsuxseg8ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg8ei8");
}

TEST_F(AssemblerRISCV64Test, VSuxseg8ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg8ei16,
                                "vsuxseg8ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg8ei16");
}

TEST_F(AssemblerRISCV64Test, VSuxseg8ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg8ei32,
                                "vsuxseg8ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg8ei32");
}

TEST_F(AssemblerRISCV64Test, VSuxseg8ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSuxseg8ei64,
                                "vsuxseg8ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSuxseg8ei64");
}
...
TEST_F(AssemblerRISCV64Test, VSoxseg2ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg2ei8,
                                "vsoxseg2ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg2ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg2ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg2ei16,
                                "vsoxseg2ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg2ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg2ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg2ei32,
                                "vsoxseg2ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg2ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg2ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg2ei64,
                                "vsoxseg2ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg2ei64");
}

TEST_F(AssemblerRISCV64Test, VSoxseg3ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg3ei8,
                                "vsoxseg3ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg3ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg3ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg3ei16,
                                "vsoxseg3ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg3ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg3ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg3ei32,
                                "vsoxseg3ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg3ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg3ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg3ei64,
                                "vsoxseg3ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg3ei64");
}

TEST_F(AssemblerRISCV64Test, VSoxseg4ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg4ei8,
                                "vsoxseg4ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg4ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg4ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg4ei16,
                                "vsoxseg4ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg4ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg4ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg4ei32,
                                "vsoxseg4ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg4ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg4ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg4ei64,
                                "vsoxseg4ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg4ei64");
}

TEST_F(AssemblerRISCV64Test, VSoxseg5ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg5ei8,
                                "vsoxseg5ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg5ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg5ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg5ei16,
                                "vsoxseg5ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg5ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg5ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg5ei32,
                                "vsoxseg5ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg5ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg5ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg5ei64,
                                "vsoxseg5ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg5ei64");
}

TEST_F(AssemblerRISCV64Test, VSoxseg6ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg6ei8,
                                "vsoxseg6ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg6ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg6ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg6ei16,
                                "vsoxseg6ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg6ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg6ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg6ei32,
                                "vsoxseg6ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg6ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg6ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg6ei64,
                                "vsoxseg6ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg6ei64");
}

TEST_F(AssemblerRISCV64Test, VSoxseg7ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg7ei8,
                                "vsoxseg7ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg7ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg7ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg7ei16,
                                "vsoxseg7ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg7ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg7ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg7ei32,
                                "vsoxseg7ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg7ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg7ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg7ei64,
                                "vsoxseg7ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg7ei64");
}

TEST_F(AssemblerRISCV64Test, VSoxseg8ei8) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg8ei8,
                                "vsoxseg8ei8.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg8ei8");
}

TEST_F(AssemblerRISCV64Test, VSoxseg8ei16) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg8ei16,
                                "vsoxseg8ei16.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg8ei16");
}

TEST_F(AssemblerRISCV64Test, VSoxseg8ei32) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg8ei32,
                                "vsoxseg8ei32.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg8ei32");
}

TEST_F(AssemblerRISCV64Test, VSoxseg8ei64) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VSoxseg8ei64,
                                "vsoxseg8ei64.v {reg1}, ({reg2}), {reg3}{vm}",
                                VmIdPredicate<VRegister, XRegister, VRegister>()),
            "VSoxseg8ei64");
}
...
TEST_F(AssemblerRISCV64Test, VAdd_vv) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VAdd_vv,
                                ...
                                SkipV0VmFiltered<VRegister, VRegister>()),
            "VAdd_vv");
}
...
TEST_F(AssemblerRISCV64Test, VAdd_vx) {
  DriverStr(RepeatVVRVmFiltered(&Riscv64Assembler::VAdd_vx,
                                ...
                                SkipV0VmFiltered<VRegister, XRegister>()),
            "VAdd_vx");
}

TEST_F(AssemblerRISCV64Test, VAdd_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VAdd_vi,
                                -5,
                                "vadd.vi {reg1}, {reg2}, {imm}{vm}",
                                SkipV0VmFiltered<VRegister, int32_t>()),
            "VAdd_vi");
}
...
TEST_F(AssemblerRISCV64Test, VRsub_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VRsub_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VAnd_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VAnd_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VOr_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VOr_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VXor_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VXor_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VNot_v) {
  DriverStr(
      RepeatVVVmFiltered(
          &Riscv64Assembler::VNot_v, "vnot.v {reg1}, {reg2}{vm}", SkipV0VmFiltered<VRegister>()),
      "VNot_v");
}
...
TEST_F(AssemblerRISCV64Test, VRgather_vx) {
  DriverStr(RepeatVVRVmFiltered(&Riscv64Assembler::VRgather_vx,
                                ...
                                VVXVmSkipV0V2Overlap<XRegister>()),
            "VRgather_vx");
}

TEST_F(AssemblerRISCV64Test, VRgather_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VRgather_vi,
                                5,
                                "vrgather.vi {reg1}, {reg2}, {imm}{vm}",
                                VVXVmSkipV0V2Overlap<uint32_t>()),
            "VRgather_vi");
}
...
TEST_F(AssemblerRISCV64Test, VSlideup_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSlideup_vi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VSlidedown_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSlidedown_vi,
                                5,
                                "vslidedown.vi {reg1}, {reg2}, {imm}{vm}",
                                SkipV0VmFiltered<VRegister, uint32_t>()),
            "VSlidedown_vi");
}
...
TEST_F(AssemblerRISCV64Test, VAdc_vim) {
  DriverStr(RepeatVVIbFiltered(&Riscv64Assembler::VAdc_vim,
                               -5,
...
TEST_F(AssemblerRISCV64Test, VMerge_vim) {
  DriverStr(RepeatVVIbFiltered(&Riscv64Assembler::VMerge_vim,
                               -5,
...
TEST_F(AssemblerRISCV64Test, VMseq_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMseq_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMsne_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsne_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMsleu_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsleu_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMsltu_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsltu_vi,
                                4,
...
TEST_F(AssemblerRISCV64Test, VMsle_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsle_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMslt_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMslt_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMsge_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsge_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMsgtu_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsgtu_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VMsgeu_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsgeu_vi,
                                4,
...
TEST_F(AssemblerRISCV64Test, VMsgt_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VMsgt_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VSaddu_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSaddu_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VSadd_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSadd_vi,
                                -5,
...
TEST_F(AssemblerRISCV64Test, VSll_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSll_vi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VSrl_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSrl_vi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VSra_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSra_vi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VSsrl_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSsrl_vi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VSsra_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VSsra_vi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VNsrl_wi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VNsrl_wi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VNcvt_x_x_w) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VNcvt_x_x_w,
                               "vncvt.x.x.w {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VNcvt_x_x_w");
}
...
TEST_F(AssemblerRISCV64Test, VNsra_wi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VNsra_wi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VNclipu_wi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VNclipu_wi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VNclip_wi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VNclip_wi,
                                5,
...
TEST_F(AssemblerRISCV64Test, VWredsumu_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VWredsumu_vs,
                                "vwredsumu.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VWredsumu_vs");
}

TEST_F(AssemblerRISCV64Test, VWredsum_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VWredsum_vs,
                                "vwredsum.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VWredsum_vs");
}

TEST_F(AssemblerRISCV64Test, VRedsum_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedsum_vs,
                                "vredsum.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedsum_vs");
}

TEST_F(AssemblerRISCV64Test, VRedand_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedand_vs,
                                "vredand.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedand_vs");
}

TEST_F(AssemblerRISCV64Test, VRedor_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedor_vs,
                                "vredor.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedor_vs");
}

TEST_F(AssemblerRISCV64Test, VRedxor_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedxor_vs,
                                "vredxor.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedxor_vs");
}

TEST_F(AssemblerRISCV64Test, VRedminu_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedminu_vs,
                                "vredminu.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedminu_vs");
}

TEST_F(AssemblerRISCV64Test, VRedmin_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedmin_vs,
                                "vredmin.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedmin_vs");
}

TEST_F(AssemblerRISCV64Test, VRedmaxu_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedmaxu_vs,
                                "vredmaxu.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedmaxu_vs");
}

TEST_F(AssemblerRISCV64Test, VRedmax_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRedmax_vs,
                                "vredmax.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VRedmax_vs");
}
...
TEST_F(AssemblerRISCV64Test, VCompress_vm) {
  DriverStr(
      RepeatVVVFiltered(
          &Riscv64Assembler::VCompress_vm, "vcompress.vm {reg1}, {reg2}, {reg3}", VVVNoOverlap()),
      "VCompress_vm");
}
...
TEST_F(AssemblerRISCV64Test, VWcvt_x_x_v) {
  DriverStr(
      RepeatVVVmFiltered(
          &Riscv64Assembler::VWcvt_x_x_v, "vwcvt.x.x.v {reg1}, {reg2}{vm}", VVVmSkipV0V2Overlap()),
      "VWcvt_x_x_v");
}
...
TEST_F(AssemblerRISCV64Test, VWaddu_wv) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VWaddu_wv,
                                ...
                                VXVVmSkipV0V1Overlap<VRegister>()),
            "VWaddu_wv");
}
...
TEST_F(AssemblerRISCV64Test, VWmaccu_vx) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VWmaccu_vx,
                                ...
                                VXVVmSkipV0V1Overlap<XRegister>()),
            "VWmaccu_vx");
}
...
TEST_F(AssemblerRISCV64Test, VFadd_vf) {
  DriverStr(RepeatVVFVmFiltered(&Riscv64Assembler::VFadd_vf,
                                ...
                                SkipV0VmFiltered<VRegister, FRegister>()),
            "VFadd_vf");
}

TEST_F(AssemblerRISCV64Test, VFredusum_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VFredusum_vs,
                                "vfredusum.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VFredusum_vs");
}
...
TEST_F(AssemblerRISCV64Test, VFredosum_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VFredosum_vs,
                                "vfredosum.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VFredosum_vs");
}
...
TEST_F(AssemblerRISCV64Test, VFredmin_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VFredmin_vs,
                                "vfredmin.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VFredmin_vs");
}
...
TEST_F(AssemblerRISCV64Test, VFredmax_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VFredmax_vs,
                                "vfredmax.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VFredmax_vs");
}
...
TEST_F(AssemblerRISCV64Test, VFslide1up_vf) {
  DriverStr(RepeatVVFVmFiltered(&Riscv64Assembler::VFslide1up_vf,
                                ...
                                VVXVmSkipV0V2Overlap<FRegister>()),
            "VFslide1up_vf");
}
...
TEST_F(AssemblerRISCV64Test, VFmadd_vf) {
  DriverStr(RepeatVFVVmFiltered(&Riscv64Assembler::VFmadd_vf,
                                ...
                                SkipV0VmFiltered<FRegister, VRegister>()),
            "VFmadd_vf");
}
...
TEST_F(AssemblerRISCV64Test, VFwredosum_vs) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VFwredosum_vs,
                                "vfwredosum.vs {reg1}, {reg2}, {reg3}{vm}",
                                VmIdPredicate<VRegister, VRegister, VRegister>()),
            "VFwredosum_vs");
}
...
TEST_F(AssemblerRISCV64Test, VFwmacc_vf) {
  DriverStr(RepeatVFVVmFiltered(&Riscv64Assembler::VFwmacc_vf,
                                ...
                                VXVVmSkipV0V1Overlap<FRegister>()),
            "VFwmacc_vf");
}
...
TEST_F(AssemblerRISCV64Test, VCpop_m) {
  DriverStr(RepeatRVVmFiltered(&Riscv64Assembler::VCpop_m,
                               "vcpop.m {reg1}, {reg2}{vm}",
                               VmIdPredicate<XRegister, VRegister>()),
            "VCpop_m");
}

TEST_F(AssemblerRISCV64Test, VFirst_m) {
  DriverStr(RepeatRVVmFiltered(&Riscv64Assembler::VFirst_m,
                               "vfirst.m {reg1}, {reg2}{vm}",
                               VmIdPredicate<XRegister, VRegister>()),
            "VFirst_m");
}

TEST_F(AssemblerRISCV64Test, VZext_vf8) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VZext_vf8,
                               "vzext.vf8 {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VZext_vf8");
}

TEST_F(AssemblerRISCV64Test, VSext_vf8) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VSext_vf8,
                               "vsext.vf8 {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VSext_vf8");
}

TEST_F(AssemblerRISCV64Test, VZext_vf4) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VZext_vf4,
                               "vzext.vf4 {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VZext_vf4");
}

TEST_F(AssemblerRISCV64Test, VSext_vf4) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VSext_vf4,
                               "vsext.vf4 {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VSext_vf4");
}

TEST_F(AssemblerRISCV64Test, VZext_vf2) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VZext_vf2,
                               "vzext.vf2 {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VZext_vf2");
}

TEST_F(AssemblerRISCV64Test, VSext_vf2) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VSext_vf2,
                               "vsext.vf2 {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VSext_vf2");
}
...
TEST_F(AssemblerRISCV64Test, VFcvt_x_f_v) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VFcvt_x_f_v,
                               "vfcvt.x.f.v {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VFcvt_x_f_v");
}
...
TEST_F(AssemblerRISCV64Test, VFcvt_f_x_v) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VFcvt_f_x_v,
                               "vfcvt.f.x.v {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VFcvt_f_x_v");
}
...
TEST_F(AssemblerRISCV64Test, VFsqrt_v) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VFsqrt_v,
                               "vfsqrt.v {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VFsqrt_v");
}

TEST_F(AssemblerRISCV64Test, VFrsqrt7_v) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VFrsqrt7_v,
                               "vfrsqrt7.v {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VFrsqrt7_v");
}

TEST_F(AssemblerRISCV64Test, VFrec7_v) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VFrec7_v,
                               "vfrec7.v {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VFrec7_v");
}

TEST_F(AssemblerRISCV64Test, VFclass_v) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VFclass_v,
                               "vfclass.v {reg1}, {reg2}{vm}",
                               SkipV0VmFiltered<VRegister>()),
            "VFclass_v");
}
...
TEST_F(AssemblerRISCV64Test, VMsbf_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VMsbf_m, "vmsbf.m {reg1}, {reg2}{vm}", VVVmSkipV0V2Overlap()),
            "VMsbf_m");
}

TEST_F(AssemblerRISCV64Test, VMsof_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VMsof_m, "vmsof.m {reg1}, {reg2}{vm}", VVVmSkipV0V2Overlap()),
            "VMsof_m");
}

TEST_F(AssemblerRISCV64Test, VMsif_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VMsif_m, "vmsif.m {reg1}, {reg2}{vm}", VVVmSkipV0V2Overlap()),
            "VMsif_m");
}

TEST_F(AssemblerRISCV64Test, VIota_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VIota_m, "viota.m {reg1}, {reg2}{vm}", VVVmSkipV0V2Overlap()),
            "VIota_m");
}

TEST_F(AssemblerRISCV64Test, VId_v) {
  DriverStr(RepeatVVmFiltered(&Riscv64Assembler::VId_v, "vid.v {reg} {vm}", SkipV0VmFiltered0()),
            "VId_v");
}
