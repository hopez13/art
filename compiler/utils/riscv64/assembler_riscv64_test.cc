...
class AssemblerRISCV64Test : public AssemblerTest<Riscv64Assembler,
 ...
 protected:
  ...
  std::string RepeatCRRImm(void (Riscv64Assembler::*f)(XRegister, XRegister, uint32_t),
                           int immBits,
                           int shift,
                           bool noZeroImm,
                           const std::string& fmt) {
  ...
  std::string RepeatCFRImm(void (Riscv64Assembler::*f)(FRegister, XRegister, uint32_t),
                           int immBits,
                           int shift,
                           bool noZeroImm,
                           const std::string& fmt) {
