...
TEST_F(AssemblerRISCV64Test, VMsbf_m) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VMsbf_m,
                               "vmsbf.m {reg1}, {reg2}{vm}",
                               VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VMsbf_m");
}

TEST_F(AssemblerRISCV64Test, VMsof_m) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VMsof_m,
                               "vmsof.m {reg1}, {reg2}{vm}",
                               VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VMsof_m");
}

TEST_F(AssemblerRISCV64Test, VMsif_m) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VMsif_m,
                               "vmsif.m {reg1}, {reg2}{vm}",
                               VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VMsif_m");
}

TEST_F(AssemblerRISCV64Test, VIota_m) {
  DriverStr(RepeatVVVmFiltered(&Riscv64Assembler::VIota_m,
                               "viota.m {reg1}, {reg2}{vm}",
                               VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VIota_m");
}
