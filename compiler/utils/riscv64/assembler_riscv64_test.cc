...
TEST_F(AssemblerRISCV64Test, Lui_C) {
  ...
  DriverStr(RepeatRIb(&Riscv64Assembler::Lui, 20, "lui {reg}, {imm}"), "Lui_C");
}
...
TEST_F(AssemblerRISCV64Test, Lw_C) {
  ...
  DriverStr(RepeatRRIb(&Riscv64Assembler::Lw, -12, "lw {reg1}, {imm}({reg2})"), "Lw_C");
}
...
TEST_F(AssemblerRISCV64Test, Ld_C) {
  ...
  DriverStr(RepeatRRIb(&Riscv64Assembler::Ld, -12, "ld {reg1}, {imm}({reg2})"), "Ld_C");
}
...
TEST_F(AssemblerRISCV64Test, FLd_C) {
  ...
  DriverStr(RepeatFRIb(&Riscv64Assembler::FLd, -12, "fld {reg1}, {imm}({reg2})"), "FLd_C");
}
...
TEST_F(AssemblerRISCV64Test, FSd_C) {
  ...
  DriverStr(RepeatFRIb(&Riscv64Assembler::FSd, -12, "fsd {reg1}, {imm}({reg2})"), "FSd_C");
}
...
TEST_F(AssemblerRISCV64Test, CLui) {
  ...
  imms.push_back(0xfffe0);
  imms.push_back(0xfffff);
  imms.push_back((0xfffe0 + 0xfffff) / 2);
...
TEST_F(AssemblerRISCV64Test, CLbu) {
  ScopedCompressedMode cm(this);
  DriverStr(RepeatCRRImm(&Riscv64Assembler::CLbu, 2, 0, "c.lbu {reg1}, {imm}({reg2})"), "CLbu");
}

TEST_F(AssemblerRISCV64Test, CLhu) {
  ScopedCompressedMode cm(this);
  DriverStr(RepeatCRRImm(&Riscv64Assembler::CLhu, 1, 1, "c.lhu {reg1}, {imm}({reg2})"), "CLhu");
}

TEST_F(AssemblerRISCV64Test, CLh) {
  ScopedCompressedMode cm(this);
  DriverStr(RepeatCRRImm(&Riscv64Assembler::CLh, 1, 1, "c.lh {reg1}, {imm}({reg2})"), "CLh");
}

TEST_F(AssemblerRISCV64Test, CSb) {
  ScopedCompressedMode cm(this);
  DriverStr(RepeatCRRImm(&Riscv64Assembler::CSb, 2, 0, "c.sb {reg1}, {imm}({reg2})"), "CSb");
}

TEST_F(AssemblerRISCV64Test, CSh) {
  ScopedCompressedMode cm(this);
  DriverStr(RepeatCRRImm(&Riscv64Assembler::CSh, 1, 1, "c.sh {reg1}, {imm}({reg2})"), "CSh");
}
