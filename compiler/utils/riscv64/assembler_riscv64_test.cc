...
TEST_F(AssemblerRISCV64Test, FCvtWS) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtWS,
                                 "fcvt.w.s {reg1}, {reg2}, {rm}"), "FCvtWS");
}

TEST_F(AssemblerRISCV64Test, FCvtWS_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtWS,
                     "fcvt.w.s {reg1}, {reg2}"), "FCvtWS_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtWD) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtWD,
                                 "fcvt.w.d {reg1}, {reg2}, {rm}"), "FCvtWD");
}

TEST_F(AssemblerRISCV64Test, FCvtWD_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtWD,
                     "fcvt.w.d {reg1}, {reg2}"), "FCvtWD_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtWuS) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtWuS,
                                 "fcvt.wu.s {reg1}, {reg2}, {rm}"), "FCvtWuS");
}

TEST_F(AssemblerRISCV64Test, FCvtWuS_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtWuS,
                     "fcvt.wu.s {reg1}, {reg2}"), "FCvtWuS_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtWuD) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtWuD,
                                 "fcvt.wu.d {reg1}, {reg2}, {rm}"), "FCvtWuD");
}

TEST_F(AssemblerRISCV64Test, FCvtWuD_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtWuD,
                     "fcvt.wu.d {reg1}, {reg2}"), "FCvtWuD_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtLS) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtLS,
                                 "fcvt.l.s {reg1}, {reg2}, {rm}"), "FCvtLS");
}

TEST_F(AssemblerRISCV64Test, FCvtLS_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtLS,
                     "fcvt.l.s {reg1}, {reg2}"), "FCvtLS_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtLD) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtLD,
                                 "fcvt.l.d {reg1}, {reg2}, {rm}"), "FCvtLD");
}

TEST_F(AssemblerRISCV64Test, FCvtLD_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtLD,
                     "fcvt.l.d {reg1}, {reg2}"), "FCvtLD_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtLuS) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtLuS,
                                 "fcvt.lu.s {reg1}, {reg2}, {rm}"), "FCvtLuS");
}

TEST_F(AssemblerRISCV64Test, FCvtLuS_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtLuS,
                     "fcvt.lu.s {reg1}, {reg2}"), "FCvtLuS_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtLuD) {
  DriverStr(RepeatrFRoundingMode(&riscv64::Riscv64Assembler::FCvtLuD,
                                 "fcvt.lu.d {reg1}, {reg2}, {rm}"), "FCvtLuD");
}

TEST_F(AssemblerRISCV64Test, FCvtLuD_Default) {
  DriverStr(RepeatrF(&riscv64::Riscv64Assembler::FCvtLuD,
                     "fcvt.lu.d {reg1}, {reg2}"), "FCvtLuD_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtSW) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtSW,
                                 "fcvt.s.w {reg1}, {reg2}, {rm}"), "FCvtSW");
}

TEST_F(AssemblerRISCV64Test, FCvtSW_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtSW,
                     "fcvt.s.w {reg1}, {reg2}"), "FCvtSW_Default");
}

// This conversion is lossless, so the rounding mode is meaningless and the assembler we're
// testing against does not even accept the rounding mode argument, so this test is disabled.
TEST_F(AssemblerRISCV64Test, DISABLED_FCvtDW) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtDW,
                                 "fcvt.d.w {reg1}, {reg2}, {rm}"), "FCvtDW");
}

TEST_F(AssemblerRISCV64Test, FCvtDW_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtDW,
                     "fcvt.d.w {reg1}, {reg2}"), "FCvtDW_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtSWu) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtSWu,
                                 "fcvt.s.wu {reg1}, {reg2}, {rm}"), "FCvtSWu");
}

TEST_F(AssemblerRISCV64Test, FCvtSWu_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtSWu,
                     "fcvt.s.wu {reg1}, {reg2}"), "FCvtSWu_Default");
}

// This conversion is lossless, so the rounding mode is meaningless and the assembler we're
// testing against does not even accept the rounding mode argument, so this test is disabled.
TEST_F(AssemblerRISCV64Test, DISABLED_FCvtDWu) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtDWu,
                                 "fcvt.d.wu {reg1}, {reg2}, {rm}"), "FCvtDWu");
}

TEST_F(AssemblerRISCV64Test, FCvtDWu_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtDWu,
                     "fcvt.d.wu {reg1}, {reg2}"), "FCvtDWu_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtSL) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtSL,
                                 "fcvt.s.l {reg1}, {reg2}, {rm}"), "FCvtSL");
}

TEST_F(AssemblerRISCV64Test, FCvtSL_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtSL,
                     "fcvt.s.l {reg1}, {reg2}"), "FCvtSL_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtDL) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtDL,
                                 "fcvt.d.l {reg1}, {reg2}, {rm}"), "FCvtDL");
}

TEST_F(AssemblerRISCV64Test, FCvtDL_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtDL,
                     "fcvt.d.l {reg1}, {reg2}"), "FCvtDL_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtSLu) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtSLu,
                                 "fcvt.s.lu {reg1}, {reg2}, {rm}"), "FCvtSLu");
}

TEST_F(AssemblerRISCV64Test, FCvtSLu_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtSLu,
                     "fcvt.s.lu {reg1}, {reg2}"), "FCvtSLu_Default");
}

TEST_F(AssemblerRISCV64Test, FCvtDLu) {
  DriverStr(RepeatFrRoundingMode(&riscv64::Riscv64Assembler::FCvtDLu,
                                 "fcvt.d.lu {reg1}, {reg2}, {rm}"), "FCvtDLu");
}

TEST_F(AssemblerRISCV64Test, FCvtDLu_Default) {
  DriverStr(RepeatFr(&riscv64::Riscv64Assembler::FCvtDLu,
                     "fcvt.d.lu {reg1}, {reg2}"), "FCvtDLu_Default");
}
