...
class AssemblerRISCV64Test : public AssemblerTest<Riscv64Assembler,
 ...
 protected:
  ...
  auto VXVVmSkipV0VmAndNoVdVs1Overlap() {
  ...
  auto VVXVmSkipV0VmAndNoVdVs2Overlap() {
  ...
  auto VVVVmSkipV0VmAndNoVdVs1Vs2Overlap() {
  ...
  auto VVVmSkipV0VmAndNoVdVs2Overlap() {
...
TEST_F(AssemblerRISCV64Test, VL1re16) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL1re16, 1, "vl1re16.v {reg1}, ({reg2})"), "VL1re16");
}

TEST_F(AssemblerRISCV64Test, VL1re32) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL1re32, 1, "vl1re32.v {reg1}, ({reg2})"), "VL1re32");
}

TEST_F(AssemblerRISCV64Test, VL1re64) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL1re64, 1, "vl1re64.v {reg1}, ({reg2})"), "VL1re64");
}
...
TEST_F(AssemblerRISCV64Test, VL2re16) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL2re16, 2, "vl2re16.v {reg1}, ({reg2})"), "VL2re16");
}

TEST_F(AssemblerRISCV64Test, VL2re32) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL2re32, 2, "vl2re32.v {reg1}, ({reg2})"), "VL2re32");
}

TEST_F(AssemblerRISCV64Test, VL2re64) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL2re64, 2, "vl2re64.v {reg1}, ({reg2})"), "VL2re64");
}
...
TEST_F(AssemblerRISCV64Test, VL4re16) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL4re16, 4, "vl4re16.v {reg1}, ({reg2})"), "VL4re16");
}

TEST_F(AssemblerRISCV64Test, VL4re32) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL4re32, 4, "vl4re32.v {reg1}, ({reg2})"), "VL4re32");
}

TEST_F(AssemblerRISCV64Test, VL4re64) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL4re64, 4, "vl4re64.v {reg1}, ({reg2})"), "VL4re64");
}
...
TEST_F(AssemblerRISCV64Test, VL8re16) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL8re16, 8, "vl8re16.v {reg1}, ({reg2})"), "VL8re16");
}

TEST_F(AssemblerRISCV64Test, VL8re32) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL8re32, 8, "vl8re32.v {reg1}, ({reg2})"), "VL8re32");
}

TEST_F(AssemblerRISCV64Test, VL8re64) {
  DriverStr(RepeatVRAligned(&Riscv64Assembler::VL8re64, 8, "vl8re64.v {reg1}, ({reg2})"), "VL8re64");
}
...
TEST_F(AssemblerRISCV64Test, VRgather_vv) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VRgather_vv,
                                ...
                                VVVVmSkipV0VmAndNoVdVs1Vs2Overlap()),
            "VRgather_vv");
}
...
TEST_F(AssemblerRISCV64Test, VRgather_vx) {
  DriverStr(RepeatVVRVmFiltered(&Riscv64Assembler::VRgather_vx,
                                ...
                                VVXVmSkipV0VmAndNoVdVs2Overlap<XRegister>()),
            "VRgather_vx");
}
...
TEST_F(AssemblerRISCV64Test, VRgather_vi) {
  DriverStr(RepeatVVIVmFiltered(&Riscv64Assembler::VRgather_vi,
                                ...
                                VVXVmSkipV0VmAndNoVdVs2Overlap<uint32_t>()),
            "VRgather_vi");
}
...
TEST_F(AssemblerRISCV64Test, VCompress_vm) {
  DriverStr(
      RepeatVVVFiltered(
          &Riscv64Assembler::VCompress_vm, "vcompress.vm {reg1}, {reg2}, {reg3}", VVVNoVdVs1Vs2Overlap()),
      "VCompress_vm");
}
...
TEST_F(AssemblerRISCV64Test, VWcvt_x_x_v) {
  DriverStr(
      RepeatVVVmFiltered(
          &Riscv64Assembler::VWcvt_x_x_v, "vwcvt.x.x.v {reg1}, {reg2}{vm}", VVVmSkipV0VmAndNoVdVs2Overlap()),
      "VWcvt_x_x_v");
}
...
TEST_F(AssemblerRISCV64Test, VWaddu_wv) {
  DriverStr(RepeatVVVVmFiltered(&Riscv64Assembler::VWaddu_wv,
                                ...
                                VXVVmSkipV0VmAndNoVdVs1Overlap<VRegister>()),
            "VWaddu_wv");
}
...
TEST_F(AssemblerRISCV64Test, VWmaccu_vx) {
  DriverStr(RepeatVRVVmFiltered(&Riscv64Assembler::VWmaccu_vx,
                                ...
                                VXVVmSkipV0VmAndNoVdVs1Overlap<XRegister>()),
            "VWmaccu_vx");
}
...
TEST_F(AssemblerRISCV64Test, VFslide1up_vf) {
  DriverStr(RepeatVVFVmFiltered(&Riscv64Assembler::VFslide1up_vf,
                                ...
                                VVXVmSkipV0VmAndNoVdVs2Overlap<FRegister>()),
            "VFslide1up_vf");
}
...
TEST_F(AssemblerRISCV64Test, VFwmacc_vf) {
  DriverStr(RepeatVFVVmFiltered(&Riscv64Assembler::VFwmacc_vf,
                                ...
                                VXVVmSkipV0VmAndNoVdVs1Overlap<FRegister>()),
            "VFwmacc_vf");
}
...
TEST_F(AssemblerRISCV64Test, VMsbf_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VMsbf_m, "vmsbf.m {reg1}, {reg2}{vm}", VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VMsbf_m");
}

TEST_F(AssemblerRISCV64Test, VMsof_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VMsof_m, "vmsof.m {reg1}, {reg2}{vm}", VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VMsof_m");
}

TEST_F(AssemblerRISCV64Test, VMsif_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VMsif_m, "vmsif.m {reg1}, {reg2}{vm}", VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VMsif_m");
}

TEST_F(AssemblerRISCV64Test, VIota_m) {
  DriverStr(RepeatVVVmFiltered(
                &Riscv64Assembler::VIota_m, "viota.m {reg1}, {reg2}{vm}", VVVmSkipV0VmAndNoVdVs2Overlap()),
            "VIota_m");
}
