...
class ScratchRegisterScope {
 public:
  ...
  XRegister AllocateXRegister() {
    ...
    // Allocate the highest available scratch registers (prefer TMP(T6) over TMP2(T5)).
  ...
  FRegister AllocateFRegister() {
    ...
    // Allocate the highest available scratch registers (same as for core registers).
