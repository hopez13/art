...
class Riscv64Assembler final : public Assembler {
 public:
  ...
  void VMsltu_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm = VM::kUnmasked);
  ...
  void VMslt_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm = VM::kUnmasked);
  ...
  void VMsgeu_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm = VM::kUnmasked);
  ...
  void VMsge_vi(VRegister vd, VRegister vs2, int32_t imm5, VM vm = VM::kUnmasked);
  ...
  ////////////////////////////// RISC-V Vector Pseudo-Instructions  START /////////////////////

  ////////////////////////////// RISC-V Vector Pseudo-Instructions  END ///////////////////////
