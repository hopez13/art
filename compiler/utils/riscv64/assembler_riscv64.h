...
class Riscv64Assembler final : public Assembler {
 public:
  ...
  // Pseduo-instruction over VNsrl_wx
  ...
  // Pseduo-instruction over VMand_mm
  ...
  // Pseduo-instruction over VMxor_mm
  ...
  // Pseduo-instruction over VMnand_mm
  ...
  // Pseduo-instruction over VMxnor_mm
  ...
  // Pseduo-instruction over VFsgnjn_vv
  ...
  // Pseduo-instruction over VFsgnjx_vv
  ...
  // Pseduo-instruction over VMfle_vv
  ...
  // Pseduo-instruction over VMflt_vv
