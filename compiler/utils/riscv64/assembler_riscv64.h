...
class Riscv64Assembler final : public Assembler {
 ...
 private:
  ...
  static constexpr uint32_t EncodeInt6(const int32_t imm) {
  ...
  static constexpr uint32_t ExtractOffset52_76(int32_t offset) {
    ...
    uint32_t imm52 = BitFieldExtract(u_offset, 2, 4);
    uint32_t imm76 = BitFieldExtract(u_offset, 6, 2);
  ...
  static constexpr uint32_t ExtractOffset53_86(int32_t offset) {
    ...
    uint32_t imm53 = BitFieldExtract(u_offset, 3, 3);
    uint32_t imm86 = BitFieldExtract(u_offset, 6, 3);
  ...
  static constexpr uint32_t ExtractOffset52_6(int32_t offset) {
    ...
    uint32_t imms1 = BitFieldExtract(u_offset, 2, 4);
    uint32_t imms0  = BitFieldExtract(u_offset, 6, 1);

    return BitFieldInsert(imms0, imms1, 1, 4);
  }
  ...
  static constexpr uint32_t ExtractOffset53_76(int32_t offset) {
    ...
    uint32_t imms1 = BitFieldExtract(u_offset, 3, 3);
    uint32_t imms0 = BitFieldExtract(u_offset, 6, 2);
  ...
  static constexpr bool IsImmCLuiEncodable(uint32_t uimm) {
    ...
    // of the destination
    return IsUint<5>(uimm) || IsUint<5>(uimm - 0xfffe0u);
  }
