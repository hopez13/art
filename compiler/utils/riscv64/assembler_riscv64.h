...
class Riscv64Assembler final : public Assembler {
 public:
  ...
  // Accroding to "The RISC-V Instruction Set Manual"
  // RV32 "I" Standard Extension
  ...
  // RV64M Standard Exetension (in addition to RV32M)
  ...
  // RV64A Standard Exetension (in addition to RV32A)
  ...
  // RV64F Standard Exetension (in addition to RV32F)
