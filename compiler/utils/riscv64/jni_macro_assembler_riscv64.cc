...
void Riscv64JNIMacroAssembler::FinalizeCode() { __ FinalizeCode(); }

void Riscv64JNIMacroAssembler::GetCurrentThread(ManagedRegister tr) { __ GetCurrentThread(tr); }
...
void Riscv64JNIMacroAssembler::IncreaseFrameSize(size_t adjust) { __ IncreaseFrameSize(adjust); }

// See Riscv64 PCS Section 5.2.2.1.
void Riscv64JNIMacroAssembler::DecreaseFrameSize(size_t adjust) { __ DecreaseFrameSize(adjust); }
...
void Riscv64JNIMacroAssembler::StoreImmediateToFrame(FrameOffset offs, uint32_t imm) {
...
void Riscv64JNIMacroAssembler::CopyRawPtrFromThread(FrameOffset fr_offs, ThreadOffset64 tr_offs) {
...
void Riscv64JNIMacroAssembler::Copy(FrameOffset dest, FrameOffset src, size_t size) {
