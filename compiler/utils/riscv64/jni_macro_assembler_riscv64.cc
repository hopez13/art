...
void Riscv64JNIMacroAssembler::GetCurrentThread(FrameOffset offset) {
  __ GetCurrentThread(offset, Riscv64ManagedRegister::FromXRegister(TMP2));
}
...
void Riscv64JNIMacroAssembler::StoreImmediateToFrame(FrameOffset offs,
                                                   uint32_t imm) {
  __ StoreImmediateToFrame(offs, imm, Riscv64ManagedRegister::FromXRegister(TMP2));
}

void Riscv64JNIMacroAssembler::StoreStackOffsetToThread(ThreadOffset64 tr_offs,
                                                      FrameOffset fr_offs) {
  __ StoreStackOffsetToThread(tr_offs, fr_offs, Riscv64ManagedRegister::FromXRegister(TMP2));
}
...
void Riscv64JNIMacroAssembler::StoreSpanning(FrameOffset dest_off,
                                           ...
                                           FrameOffset in_off) {
  __ StoreSpanning(dest_off, m_source, in_off, Riscv64ManagedRegister::FromXRegister(TMP2));
}
...
void Riscv64JNIMacroAssembler::CopyRawPtrFromThread(FrameOffset fr_offs,
  ...
  __ CopyRawPtrFromThread(fr_offs, tr_offs, Riscv64ManagedRegister::FromXRegister(TMP2));
}
...
void Riscv64JNIMacroAssembler::CopyRef(FrameOffset dest, FrameOffset src) {
  __ CopyRef(dest, src, Riscv64ManagedRegister::FromXRegister(TMP2));
}
...
void Riscv64JNIMacroAssembler::CopyRef(FrameOffset dest,
  ...
  __ Daddiu64(scratch, base.AsRiscv64().AsXRegister(), offs.Int32Value());
...
void Riscv64JNIMacroAssembler::Copy(FrameOffset dest,
                                  FrameOffset src,
                                  size_t size) {
  __ Copy(dest, src, Riscv64ManagedRegister::FromXRegister(TMP2), size);
}
...
void Riscv64JNIMacroAssembler::Call(ManagedRegister m_base, Offset offs) {
  __ Call(m_base, offs, Riscv64ManagedRegister::FromXRegister(TMP2));
}


void Riscv64JNIMacroAssembler::CallFromThread(ThreadOffset64 offset) {
  __ CallFromThread(offset, Riscv64ManagedRegister::FromXRegister(TMP2));
}
...
void Riscv64JNIMacroAssembler::CreateJObject(ManagedRegister m_out_reg,
  ...
  if (null_allowed) {
    ...
    if (in_reg.IsNoRegister()) {
      __ Daddiu64(out_reg.AsXRegister(), SP, spilled_reference_offset.Int32Value());
      __ Lw(out_reg.AsXRegister(), out_reg.AsXRegister(), 0);
    ...
    if (!out_reg.Equals(in_reg)) {
      ...
      __ Bnezc(in_reg.AsXRegister(), &non_null_arg);
      __ Move(out_reg.AsXRegister(), ZERO);;
    ...
    __ Beqzc(in_reg.AsXRegister(), &null_arg);
    __ Daddiu64(out_reg.AsXRegister(), SP, spilled_reference_offset.Int32Value());
    __ Bind(&null_arg);
  } else {
...
void Riscv64JNIMacroAssembler::Jump(ManagedRegister m_base, Offset offs) {
  ...
  XRegister scratch = TMP;
  __ Daddiu64(scratch, base.AsXRegister(), offs.Int32Value());
  __ Ld(scratch, scratch, 0);
  __ Jr(scratch);
}
