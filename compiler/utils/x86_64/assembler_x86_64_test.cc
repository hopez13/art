...
TEST_F(AssemblerX86_64Test, XaddqReg) {
  DriverStr(RepeatRR(&x86_64::X86_64Assembler::xaddq, "xaddq %{reg1}, %{reg2}"), "xaddq");
}

TEST_F(AssemblerX86_64Test, XaddqMem) {
  DriverStr(RepeatRA(&x86_64::X86_64Assembler::xaddq, "xaddq %{reg}, {mem}"), "xaddq");
}

TEST_F(AssemblerX86_64Test, XaddlReg) {
  DriverStr(Repeatrr(&x86_64::X86_64Assembler::xaddl, "xaddl %{reg1}, %{reg2}"), "xaddl");
}

TEST_F(AssemblerX86_64Test, XaddlMem) {
  DriverStr(RepeatrA(&x86_64::X86_64Assembler::xaddl, "xaddl %{reg}, {mem}"), "xaddl");
}

TEST_F(AssemblerX86_64Test, XaddwReg) {
  DriverStr(Repeatww(&x86_64::X86_64Assembler::xaddw, "xaddw %{reg1}, %{reg2}"), "xaddw");
}

TEST_F(AssemblerX86_64Test, XaddwMem) {
  DriverStr(RepeatwA(&x86_64::X86_64Assembler::xaddw, "xaddw %{reg}, {mem}"), "xaddw");
}

TEST_F(AssemblerX86_64Test, XaddbReg) {
  DriverStr(Repeatbb(&x86_64::X86_64Assembler::xaddb, "xaddb %{reg1}, %{reg2}"), "xaddb");
}
