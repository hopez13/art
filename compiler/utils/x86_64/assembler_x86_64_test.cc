...
TEST_F(AssemblerX86_64AVXTest, Addps) {
  DriverStr(
      RepeatFFF(&x86_64::X86_64Assembler::addps, "vaddps %{reg3}, %{reg2}, %{reg1}"), "avx_addps");
}
...
TEST_F(AssemblerX86_64AVXTest, Pmullw) {
  DriverStr(
      RepeatFFF(
          &x86_64::X86_64Assembler::pmullw, "vpmullw %{reg3}, %{reg2}, %{reg1}"), "avx_pmullw");
}
...
TEST_F(AssemblerX86_64AVXTest, Pmulld) {
  DriverStr(
      RepeatFFF(
          &x86_64::X86_64Assembler::pmulld, "vpmulld %{reg3}, %{reg2}, %{reg1}"), "avx_pmulld");
}
