...
TEST_F(AssemblerX86_64Test, LockXaddq) {
  DriverStr(RepeatAR(&x86_64::X86_64Assembler::LockXaddq, "lock xaddq %{reg}, {mem}"), "lock_xaddq");
}

TEST_F(AssemblerX86_64Test, LockXaddl) {
  DriverStr(RepeatAr(&x86_64::X86_64Assembler::LockXaddl, "lock xaddl %{reg}, {mem}"), "lock_xaddl");
}

TEST_F(AssemblerX86_64Test, LockXaddw) {
  DriverStr(RepeatAw(&x86_64::X86_64Assembler::LockXaddw, "lock xaddw %{reg}, {mem}"), "lock_xaddw");
}

TEST_F(AssemblerX86_64Test, LockXaddb) {
  DriverStr(RepeatAb(&x86_64::X86_64Assembler::LockXaddb, "lock xaddb %{reg}, {mem}"), "lock_xaddb");
}
