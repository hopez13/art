...
class AssemblerX86_64Test : public AssemblerTest<x86_64::X86_64Assembler,
 ...
 protected:
  ...
  static void VerifyDisassemblerDriver(const std::vector<uint8_t>& art_code,
    ...
    x86::DisassemblerX86* disasm = static_cast<art::x86::DisassemblerX86*>(Disassembler::Create(
...
TEST_F(AssemblerX86_64AVXTest, DisassVMovd1) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatFR(&x86_64::X86_64Assembler::vmovd, "vmovq {reg1}, {reg2}"),
                  "disass-vmovd.1");
}

TEST_F(AssemblerX86_64AVXTest, DisassVMovd2) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatRF(&x86_64::X86_64Assembler::vmovd, "vmovq {reg1}, {reg2}"),
                  "disass-vmovd.2");
}

TEST_F(AssemblerX86_64AVXTest, DisassVAddps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vaddps, "vaddps {reg1}, {reg2}, {reg3}"),
                  "disass-vaddps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVAddpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vaddpd, "vaddpd {reg1}, {reg2}, {reg3}"),
                  "disass-vaddpd");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVMulps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vmulps, "vmulps {reg1}, {reg2}, {reg3}"),
                  "disass-vmulps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVMulpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vmulpd, "vmulpd {reg1}, {reg2}, {reg3}"),
                  "disass-vmulpd");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPaddb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddb, "vpaddb {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddb");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPaddw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddw, "vpaddw {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPmullw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpmullw, "vpmullw {reg1}, {reg2}, {reg3}"),
                  "disass-vpmullw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPaddd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddd, "vpaddd {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddd");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPaddq) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddq, "vpaddq {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddq");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPaddusb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddusb, "vpaddusb {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddusb");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPaddsb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddsb, "vpaddsb {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddsb");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPaddusw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddusw, "vpaddusw {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddusw");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPaddsw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpaddsw, "vpaddsw {reg1}, {reg2}, {reg3}"),
                  "disass-vpaddsw");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPXor) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpxor, "vpxor {reg1}, {reg2}, {reg3}"),
                  "disass-vpxor");
}

TEST_F(AssemblerX86_64AVXTest, DisassVXorps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vxorps, "vxorps {reg1}, {reg2}, {reg3}"),
                  "disass-vxorps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVXorpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vxorpd, "vxorpd {reg1}, {reg2}, {reg3}"),
                  "disass-vxorpd");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPAnd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpand, "vpand {reg1}, {reg2}, {reg3}"),
                  "disass-vpand");
}

TEST_F(AssemblerX86_64AVXTest, DisassVAndps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vandps, "vandps {reg1}, {reg2}, {reg3}"),
                  "disass-vandps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVAndpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vandpd, "vandpd {reg1}, {reg2}, {reg3}"),
                  "disass-vandpd");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPor) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpor, "vpor {reg1}, {reg2}, {reg3}"),
                  "disass-vpor");
}

TEST_F(AssemblerX86_64AVXTest, DisassVorps) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vorps, "vorps {reg1}, {reg2}, {reg3}"),
                  "disass-vorps");
}

TEST_F(AssemblerX86_64AVXTest, DisassVorpd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vorpd, "vorpd {reg1}, {reg2}, {reg3}"),
                  "disass-vorpd");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPavgb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpavgb, "vpavgb {reg1}, {reg2}, {reg3}"),
                  "disass-vpavgb");
}

TEST_F(AssemblerX86_64AVXTest, DisassVPavgw) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpavgw, "vpavgw {reg1}, {reg2}, {reg3}"),
                  "disass-vpavgw");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPmaddwd) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpmaddwd, "vpmaddwd {reg1}, {reg2}, {reg3}"),
                  "disass-vpmaddwd");
}
...
TEST_F(AssemblerX86_64AVXTest, DisassVPcmpeqb) {
  CustomDriverStr(VerifyDisassemblerDriver,
                  RepeatVVV(&x86_64::X86_64Assembler::vpcmpeqb, "vpcmpeqb {reg1}, {reg2}, {reg3}"),
                  "disass-vpcmpeqb");
}
