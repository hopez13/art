...
void X86Assembler::blsi(Register dst, Register src) {
  ...
  uint8_t byte_one = EmitVexByte1(/*r*/ false, /*x*/ false, /*b*/ false, 2);
  uint8_t byte_two = EmitVexByte2(/*w*/ false, 128,
                                  X86ManagedRegister::FromCpuRegister(dst), 0);
  EmitUint8(byte_zero);
  EmitUint8(byte_one);
  EmitUint8(byte_two);
  EmitUint8(0xF3);
...
void X86Assembler::andn(Register dst, Register src1, Register src2) {
  ...
  uint8_t byte_one = EmitVexByte1(/*r*/ false, /*x*/ false, /*b*/ false, 2);
  uint8_t byte_two = EmitVexByte2(/*w*/ false, 128,
                                  X86ManagedRegister::FromCpuRegister(src1), 0);
  EmitUint8(byte_zero);
  EmitUint8(byte_one);
  EmitUint8(byte_two);
  // Opcode field
