 ...
 protected:
  ...
  void SetUpHelpers() override {
    ...
    if (registers_.size() == 0) {
      ...
      tertiary_register_names_.emplace(x86::Register(x86::EBP), "bpl");
      tertiary_register_names_.emplace(x86::Register(x86::ESP), "spl");
      tertiary_register_names_.emplace(x86::Register(x86::ESI), "sil");
      tertiary_register_names_.emplace(x86::Register(x86::EDI), "dil");
    }
