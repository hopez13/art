...
template <PointerSize kPointerSize>
void JNIMacroAssembler<kPointerSize>::LoadLocalReferenceFrameStates(
...
template
void JNIMacroAssembler<PointerSize::k32>::LoadLocalReferenceFrameStates(
    ManagedRegister jni_env_reg,
    ManagedRegister previous_state_reg,
    ManagedRegister current_state_reg);
template
void JNIMacroAssembler<PointerSize::k64>::LoadLocalReferenceFrameStates(
    ManagedRegister jni_env_reg,
    ManagedRegister previous_state_reg,
    ManagedRegister current_state_reg);

template <PointerSize kPointerSize>
void JNIMacroAssembler<kPointerSize>::StoreLocalReferenceFrameStates(
    ManagedRegister jni_env_reg,
    ManagedRegister previous_state_reg,
    ManagedRegister current_state_reg) {
  constexpr size_t kLRTSegmentStateSize = sizeof(jni::LRTSegmentState);
...
template
void JNIMacroAssembler<PointerSize::k32>::StoreLocalReferenceFrameStates(
    ManagedRegister jni_env_reg,
    ManagedRegister previous_state_reg,
    ManagedRegister current_state_reg);
template
void JNIMacroAssembler<PointerSize::k64>::StoreLocalReferenceFrameStates(
    ManagedRegister jni_env_reg,
    ManagedRegister previous_state_reg,
    ManagedRegister current_state_reg);
