 ...
 */
static int ValidatePath(const std::string& dir, const std::string& path, int maxSubdirs) {
 ...
 * is encountered.
 */
static int ValidateApkPathInternal(const std::string& path, int maxSubdirs) {
