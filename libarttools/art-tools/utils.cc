...
// No APK path is allowed to be more than 2 subdirectories deep, relative to their base path.
static constexpr int VALIDATE_APK_PATH_RECURSION_LIMIT = 2;
...
bool ValidateApkPath(const std::string& path) {
  return ValidateApkPathInternal(path, VALIDATE_APK_PATH_RECURSION_LIMIT /* maxSubdirs */);
}
