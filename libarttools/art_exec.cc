...
Supported options:
  ...
  --process-name-suffix=SUFFIX: Add a suffix to argv[0] when calling `execv`. This suffix will show
      up as part of the process name in tombstone when the process crashes.
)";
