...
static int DEXOPTANALYZER_RETURN_CODE_BASE = 100;

class DexoptAnalyzerTest : public OatFileAssistantTest {
 protected:
  ...
  void Verify(const std::string& dex_file,
    ...
    dexoptanalyzerResult -= DEXOPTANALYZER_RETURN_CODE_BASE;
...
// Expect: The status is kDex2OatNeeded.
TEST_F(DexoptAnalyzerTest, OatForDifferentDex) {
