...
ART_CPPLINT := $(LOCAL_PATH)/../external/google-styleguide/cpplint/cpplint.py
...
ART_CPPLINT_FLAGS :=
ART_CPPLINT_QUIET := --quiet # No output when there are no errors.
...
#  2) Prepends 'art/' to each of them to make the full name.
#ART_CPPLINT_CFG := $(filter-out $(patsubst %,$(LOCAL_PATH)/%,$(ART_CPPLINT_INGORED)), $(addprefix $(LOCAL_PATH)/, $(call all-subdir-named-files,CPPLINT.cfg)))
