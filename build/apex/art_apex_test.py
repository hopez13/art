...
class ReleaseChecker:
  ...
  def run(self):
    ...
    # Check Android Core java libraries.
    ...
    # Check Android Core internal native libraries.
...
class ReleaseTargetChecker:
  ...
  def run(self):
    ...
    # Check Android Core exported native libraries.
...
class ReleaseHostChecker:
  ...
  def run(self):
    # Check that the mounted image contains Android Core support libraries.
...
class DebugChecker:
  ...
  def run(self):
    ...
    # Check Android Core internal libraries.
