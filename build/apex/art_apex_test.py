...
class Arch32Checker(Checker):
  def __init__(self, provider):
    super(Arch32Checker, self).__init__(provider)
    self.lib_dirs = ['lib']
...
class Arch64Checker(Checker):
  def __init__(self, provider):
    super(Arch64Checker, self).__init__(provider)
    self.lib_dirs = ['lib64']
...
class MultilibChecker(Checker):
  def __init__(self, provider):
    super(MultilibChecker, self).__init__(provider)
