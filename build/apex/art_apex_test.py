...
class TestingTargetChecker:
  ...
  def run(self):
    ...
    self._checker.check_file('art-gtest-jars-AbstractMethod.jar')
    self._checker.check_file('art-gtest-jars-MyClassNatives.jar')
    self._checker.check_file('art-gtest-jars-Main.jar')
    self._checker.check_file('art-gtest-jars-ProtoCompare.jar')
    self._checker.check_file('art-gtest-jars-Transaction.jar')
    self._checker.check_file('art-gtest-jars-VerifierDepsMulti.jar')
    self._checker.check_file('art-gtest-jars-Nested.jar')
    self._checker.check_file('art-gtest-jars-MyClass.jar')
    self._checker.check_file('art-gtest-jars-ManyMethods.jar')
    self._checker.check_file('art-gtest-jars-GetMethodSignature.jar')
    self._checker.check_file('art-gtest-jars-Lookup.jar')
    self._checker.check_file('art-gtest-jars-Instrumentation.jar')
    self._checker.check_file('art-gtest-jars-MainUncompressedAligned.jar')
    self._checker.check_file('art-gtest-jars-ForClassLoaderD.jar')
    self._checker.check_file('art-gtest-jars-ForClassLoaderC.jar')
    self._checker.check_file('art-gtest-jars-ErroneousA.jar')
    self._checker.check_file('art-gtest-jars-DexToDexDecompiler.jar')
    self._checker.check_file('art-gtest-jars-HiddenApiSignatures.jar')
    self._checker.check_file('art-gtest-jars-ForClassLoaderB.jar')
    self._checker.check_file('art-gtest-jars-LinkageTest.jar')
    self._checker.check_file('art-gtest-jars-MethodTypes.jar')
    self._checker.check_file('art-gtest-jars-ErroneousInit.jar')
    self._checker.check_file('art-gtest-jars-VerifierDeps.jar')
    self._checker.check_file('art-gtest-jars-StringLiterals.jar')
    self._checker.check_file('art-gtest-jars-XandY.jar')
    self._checker.check_file('art-gtest-jars-ExceptionHandle.jar')
    self._checker.check_file('art-gtest-jars-ImageLayoutB.jar')
    self._checker.check_file('art-gtest-jars-Interfaces.jar')
    self._checker.check_file('art-gtest-jars-IMTB.jar')
    self._checker.check_file('art-gtest-jars-Extension2.jar')
    self._checker.check_file('art-gtest-jars-Extension1.jar')
    self._checker.check_file('art-gtest-jars-MainEmptyUncompressedAligned.jar')
    self._checker.check_file('art-gtest-jars-ErroneousB.jar')
    self._checker.check_file('art-gtest-jars-MultiDexModifiedSecondary.jar')
    self._checker.check_file('art-gtest-jars-NonStaticLeafMethods.jar')
    self._checker.check_file('art-gtest-jars-DefaultMethods.jar')
    self._checker.check_file('art-gtest-jars-MultiDexUncompressedAligned.jar')
    self._checker.check_file('art-gtest-jars-StaticsFromCode.jar')
    self._checker.check_file('art-gtest-jars-ProfileTestMultiDex.jar')
    self._checker.check_file('art-gtest-jars-VerifySoftFailDuringClinit.jar')
    self._checker.check_file('art-gtest-jars-MainStripped.jar')
    self._checker.check_file('art-gtest-jars-ForClassLoaderA.jar')
    self._checker.check_file('art-gtest-jars-StaticLeafMethods.jar')
    self._checker.check_file('art-gtest-jars-MultiDex.jar')
    self._checker.check_file('art-gtest-jars-Packages.jar')
    self._checker.check_file('art-gtest-jars-ProtoCompare2.jar')
    self._checker.check_file('art-gtest-jars-Statics.jar')
    self._checker.check_file('art-gtest-jars-AllFields.jar')
    self._checker.check_file('art-gtest-jars-IMTA.jar')
    self._checker.check_file('art-gtest-jars-ImageLayoutA.jar')
    self._checker.check_file('art-gtest-jars-MainEmptyUncompressed.jar')
