...
class Checker:
  ...
  def check_32only_binary(self, filename):
    raise NotImplementedError
  ...
  def check_preferred_only_library(self, filename):
    raise NotImplementedError
...
class ReleaseTargetChecker:
  ...
  def run(self):
    ...
    # TODO(b/124293228): Cuttlefish put ARM libs in a lib/arm subdirectory.
...
class DebugChecker:
  ...
  def run(self):
    ...
    self._checker.check_32only_binary('dex2oatd')
...
class DebugTargetChecker:
  ...
  def run(self):
    ...
    # Check internal native library dependencies.
    self._checker.check_preferred_only_library('libjsoncpp.so')
    self._checker.check_preferred_only_library('libmeminfo.so')
    self._checker.check_preferred_only_library('libprocessgroup.so')
    self._checker.check_preferred_only_library('libprocinfo.so')
    self._checker.check_preferred_only_library('libutils.so')
