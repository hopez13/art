...
# same source for `CORE_IMG_JARS` to match the behavior. We can still use the host variant of
# `conscrypt` and `core-icu4j` because they don't go into the primary boot image that is used in
# host gtests.
...
HOST_TEST_CORE_JARS := $(CORE_IMG_JARS) $(addsuffix -hostdex,$(HOST_TEST_ADDITIONAL_JARS))
