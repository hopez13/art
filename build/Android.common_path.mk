...
# for each module
ART_TARGET_EXECUTABLES := $(foreach name,$(ART_CORE_EXECUTABLES),$(name)-target $(name)d-target)
ART_HOST_EXECUTABLES := $(foreach name,$(ART_CORE_EXECUTABLES),$(name)-host $(name)d-host)
