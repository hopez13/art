...
TARGET_CORE_IMG_DEX_FILES := $(foreach jar,$(TARGET_CORE_IMG_JARS),$(TARGET_OUT)/apex/com.android.art.testing/javalib/$(jar).jar)

# Jar files for the boot class path for testing. Must start with CORE_IMG_JARS.
HOST_TEST_CORE_JARS   := $(addsuffix -hostdex,$(TEST_CORE_JARS)) conscrypt-hostdex
TARGET_TEST_CORE_JARS := $(CORE_IMG_JARS)
...
TARGET_CORE_DEX_FILES := $(foreach jar,$(TARGET_TEST_CORE_JARS),$(TARGET_OUT)/apex/com.android.art.testing/javalib/$(jar).jar)
TARGET_CORE_DEX_FILES += $(TARGET_OUT)/apex/com.android.conscrypt/javalib/conscrypt.jar
