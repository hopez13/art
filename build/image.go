...
func (i *image) GenerateAndroidBuildActions(ctx android.ModuleContext) {
	...
	outputPath := outputDir.Join(ctx, "core"+proptools.String(i.properties.Suffix)+".art")
	...
	i.installPath = ctx.InstallFile(android.PathForModuleInstall(ctx, installDir, ctx.Arch().ArchType.String()),
		"core"+proptools.String(i.properties.Suffix)+".art", outputPath)
