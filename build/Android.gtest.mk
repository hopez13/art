...
ART_GTEST_TARGET_ANDROID_RUNTIME := '/apex/com.android.runtime'
...
$$(gtest_rule): test-art-target-sync
	...
	$(hide) $$(call ART_TEST_SKIP,$$@) && \
	  ($(ADB) shell "$$(PRIVATE_MAYBE_CHROOT_COMMAND) env $(GCOV_ENV) LD_LIBRARY_PATH=$(4) \
	       ANDROID_ROOT=$(ART_GTEST_TARGET_ANDROID_ROOT) ANDROID_RUNTIME=$(ART_GTEST_TARGET_ANDROID_RUNTIME) \
	       $$(PRIVATE_TARGET_EXE) \
...
ART_GTEST_TARGET_ANDROID_RUNTIME :=
