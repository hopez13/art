...
// These libraries are loaded at runtime by dalvikvm with run with debugging enabled.  The dalvikvm binary depends on
...
func debugFlags(ctx android.BaseModuleContext) []string {
	var cflags []string
...
func deviceFlags(ctx android.BaseModuleContext) []string {
	var cflags []string
...
func hostFlags(ctx android.BaseModuleContext) []string {
	var cflags []string
