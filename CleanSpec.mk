...
$(call add-clean-step, find $(HOST_OUT)/apex -name 'libart*-simulator-container.so' -type f | xargs rm -f)
$(call add-clean-step, find $(PRODUCT_OUT)/apex -name 'libart*-simulator-container.so' -type f | xargs rm -f)
