...
class Artd : public aidl::com::android::server::art::BnArtd {
 public:
  explicit Artd(
      ...
      std::function<int(const char*, const char*, const char*, unsigned long, const void*)>
          mount_func = mount,
 ...
 private:
  ...
  const std::function<int(const char*, const char*, const char*, unsigned long, const void*)>
      mount_;
