...
class Artd : public aidl::com::android::server::art::BnArtd {
 ...
 private:
  ...
  android::base::Result<void> PreRebootInitDeriveClasspath();
  android::base::Result<void> PreRebootMountArtApexData();
  android::base::Result<void> PreRebootMountOdrefresh();
