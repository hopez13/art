...
bool AddDex2oatArgsFromBcpExtensionArgs(const aidl::com::android::art::DexoptBcpExtArgs& dexopt_args,
                                        std::vector<std::string>& dex2oat_args);
bool AddDex2oatArgsFromSystemServerArgs(const aidl::com::android::art::DexoptSystemServerArgs& dexopt_args,
                                        std::vector<std::string>& dex2oat_args);
