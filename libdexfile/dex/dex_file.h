...
class DexFile {
 public:
  ...
  bool IsMultiDexV41() const { return GetDexVersion() >= kMultidexVersion; }

  bool IsMultiDexV41Primary() const {
    return IsMultiDexV41() && GetHeaderV41().container_offset == 0;
  }

  bool IsMultiDexV41Secondary() const {
    return IsMultiDexV41() && GetHeaderV41().container_offset != 0;
  }
