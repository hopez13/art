...
class DexFile {
 public:
  ...
  ALWAYS_INLINE bool IsFrameworkDexFile() const {
    return is_framework_dex_;
  }

  ALWAYS_INLINE void SetIsFrameworkDexFile() {
    is_framework_dex_ = true;
  }
