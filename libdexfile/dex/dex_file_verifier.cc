...
bool DexFileVerifier::CheckIntraClassDataItem() {
  ...
  ClassAccessor::Field field(*dex_file_, accessor.ptr_pos_, accessor.hiddenapi_ptr_pos_);
  // Check fields.
  ...
  // Check methods.
  ClassAccessor::Method method(*dex_file_, field.ptr_pos_, field.hiddenapi_ptr_pos_);
  ...
  ClassAccessor::Method direct_methods(*dex_file_, field.ptr_pos_, field.hiddenapi_ptr_pos_);
  method.NextSection();
...
dex::TypeIndex DexFileVerifier::FindFirstClassDataDefiner(const uint8_t* ptr, bool* success) {
  ...
  *success = true;
  ...
  if (accessor.NumFields() != 0) {
    ClassAccessor::Field read_field(*dex_file_, accessor.ptr_pos_, accessor.hiddenapi_ptr_pos_);
    read_field.Read();
  ...
  if (accessor.NumMethods() != 0) {
    ClassAccessor::Method read_method(*dex_file_, accessor.ptr_pos_, accessor.hiddenapi_ptr_pos_);
    read_method.Read();
