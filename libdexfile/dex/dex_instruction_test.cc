...
TEST(Instruction, PropertiesOf45cc) {
  ...
  Build45cc(/* num_args= */ 4u, /* method_idx= */ 16u, /* proto_idx= */ 32u,
            /* arg_regs= */ 0xcafe, instruction);
...
TEST(Instruction, PropertiesOf4rcc) {
  uint16_t instruction[4];
  Build4rcc(/* num_args= */ 4u, /* method_idx= */ 16u, /* proto_idx= */ 32u,
            /* arg_regs_start= */ 0xcafe, instruction);
