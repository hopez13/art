...
#ifndef ART_LIBDEXFILE_EXTERNAL_INCLUDE_ART_API_DEXFILE_EXTERNAL_H_
#define ART_LIBDEXFILE_EXTERNAL_INCLUDE_ART_API_DEXFILE_EXTERNAL_H_
...
// may only be added here. C++ users are encouraged to use dex_file_ext.h instead.
...
#endif  // ART_LIBDEXFILE_EXTERNAL_INCLUDE_ART_API_DEXFILE_EXTERNAL_H_
