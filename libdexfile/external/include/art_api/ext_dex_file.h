...
class DexFile {
 public:
  ...
  MethodInfo GetMethodInfoForOffset(int64_t dex_offset, bool with_signature = true) {
    ExtDexFileMethodInfo ext_method_info;
    if (ExtDexFileGetMethodInfoForOffset(
            ext_dex_file_, dex_offset, with_signature, &ext_method_info)) {
