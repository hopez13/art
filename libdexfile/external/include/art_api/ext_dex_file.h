...
class DexFile {
 public:
  ...
  std::vector<MethodInfo> GetAllMethodInfos(bool with_signature = true) {
    ...
    ExtDexFileGetAllMethodInfos(ext_dex_file_, with_signature, AddMethodInfoCb,
 ...
 private:
  ...
  static void AddMethodInfoCb(const ExtDexFileMethodInfo* ext_method_info, void* ctx);
