...
// Returns a pointer to the underlying C string and its size for the given
// ExtDexFileString.
...
// See art_api::dex::DexFile::OpenFromMemory.
...
class DexFile {
 public:
  ...
  std::vector<MethodInfo> GetAllMethodInfos(bool with_signature = true) {
    ...
    ExtDexFileGetAllMethodInfos(ext_dex_file_, with_signature, AddMethodInfoCallback,
 ...
 private:
  ...
  static void AddMethodInfoCallback(const ExtDexFileMethodInfo* ext_method_info, void* ctx);
