...
public class LibnativeloaderTest extends BaseHostJUnit4Test {
    ...
    public static void beforeClassWithDevice(TestInformation testInfo) throws Exception {
        ...
        // Vendor native libraries aren't accessible by any apps by sepolicy rules. For that they
        // need to be labelled same_process_hal_file in a vendor specific file_contexts file (see
        // https://source.android.com/docs/core/permissions/namespaces_libraries#adding-additional-native-libraries).
        // To avoid setting that up when testing loading libvendor_private*.so, disable sepolicy
        // checks while running the tests. It's libnativeloader logic we want to test here.
    ...
    public static void afterClassWithDevice(TestInformation testInfo) throws Exception {
        ...
        ctx.assertCommandSucceeds("setenforce 1");
