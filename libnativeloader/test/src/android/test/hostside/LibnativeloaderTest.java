...
public class LibnativeloaderTest extends BaseHostJUnit4Test {
    ...
    public static void beforeClassWithDevice(TestInformation testInfo) throws Exception {
        ...
        ctx.pushSystemSharedLib("/system/framework",
                "android.test.systemsharedlib", "libnativeloader_system_shared_lib.jar");
        ctx.pushSystemSharedLib("/system_ext/framework",
                "android.test.systemextsharedlib", "libnativeloader_system_ext_shared_lib.jar");
    ...
    private static class DeviceContext implements AutoCloseable {
        ...
        void pushSystemSharedLib(String packageDir, String packageName, String buildJarName) throws Exception {
