...
public class ProductAppTest {
    ...
    // cannot test that libs in system and system_ext get blocked. That got
    // supported in T.
    ...
    public void testLoadPrivateLibrariesViaVendorSharedLib() {
        if (!productAppsAreShared()) {
            ...
            // since the app doesn't have access to /vendor/${LIB}, the
            // VendorSharedLib here won't have access to it either, and this
            // would fail.
