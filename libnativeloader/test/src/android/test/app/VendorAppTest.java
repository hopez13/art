...
public class VendorAppTest {
    ...
    private void assertLinkerNamespaceError(String libraryName) {
        Throwable t = assertThrows(UnsatisfiedLinkError.class, () -> System.loadLibrary(libraryName));
        assertThat(t.getMessage()).containsMatch("dlopen failed: .* is not accessible for the namespace");
    }
