...
class NativeLoaderTest_Create : public NativeLoaderTest {
 protected:
  ...
  std::string expected_namespace_name = "clns";
  ...
  void SetExpectations() {
    ...
    EXPECT_CALL(*mock, mock_create_namespace(
                           Eq(IsBridged()), StartsWith(expected_namespace_name + "-"), nullptr,
...
TEST_P(NativeLoaderTest_Create, BundledSystemApp) {
  ...
  expected_namespace_name = "clns-shared";
...
TEST_P(NativeLoaderTest_Create, UnbundledVendorApp) {
  ...
  expected_namespace_name = "vendor-clns";
...
TEST_P(NativeLoaderTest_Create, UnbundledProductApp) {
  ...
  if (is_product_vndk_version_defined()) {
    expected_namespace_name = "product-clns";
