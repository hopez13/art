...
<<<<<<< TARGET BRANCH (f1a0e8 Mark android12L-tests-dev@8941410 as merged. am: 63db938afa)
    expected_shared_libs_to_platform_ns =
        append_extended_libraries(default_public_libraries() + ":" + llndk_libraries_product());
=======
>>>>>>> SOURCE BRANCH (43b3ca [DO NOT MERGE] Make a CTS test more lenient to work with and)
