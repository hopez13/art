...
PRIVATE_I18N_NATIVE_LIB_FILES := \
  $(patsubst %,prebuilts/runtime/mainline/i18n/test-exports/android/$(TARGET_ARCH)/lib/%.so,libicui18n libicu_jni libicuuc) \
  $(patsubst %,prebuilts/runtime/mainline/i18n/sdk/android/$(TARGET_ARCH)/lib/%.so,libicu libandroidicu) \

PRIVATE_ART_TARGET_EXTRA_LIB_FILES := $(PRIVATE_CONSTRYPT_NATIVE_LIB_FILES) $(PRIVATE_I18N_NATIVE_LIB_FILES)
...
standalone-apex-files: deapexer \
	...
	mkdir -p $(TARGET_OUT)/apex/com.android.conscrypt/javalib
