...
# file which is the file that is guranteed to be created regardless of the
# value of TARGET_FLATTEN_APEX.
$(PRODUCT_OUT)/apex/$(TARGET_RUNTIME_APEX)/apex_manifest.json: $(TARGET_OUT_UNSTRIPPED)/apex/com.android.runtime
