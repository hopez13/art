...
class ProfileAssistantTest : public CommonRuntimeTest {
 ...
 protected:
  ...
  bool AddMethod(ProfileCompilationInfo* info,
                 ...
                 uint16_t method_idx,
                 Hotness::Flag flags,
                 ProfileCompilationInfo::ProfileSampleAnnotation annotation
...
TEST_F(ProfileAssistantTest, BootImageMerge) {
  ...
  ASSERT_EQ(return_code, ProfileAssistant::kForceMerge);

  // Verify the result: it should be equal info2 since info1 is a regular profile
