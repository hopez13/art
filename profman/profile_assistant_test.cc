 ...
 protected:
  ...
  int CheckCompilationClassPercentChange(uint16_t classes_in_cur_profile,
    ...
    const DexFile* dex1_x = BuildDex(
        "location1_x", /*location_checksum=*/ 0x101, "LUnique1_x;", /*num_method_ids=*/ 0, max_classes);
    const DexFile* dex2_x = BuildDex(
        "location2_x", /*location_checksum=*/ 0x102, "LUnique2_x;", /*num_method_ids=*/ 0, max_classes);
